...
- **`runnerCommand` 跳过平台链，却仍用 bwrap 形 profile。** 操作员必须自备能吃 `--ro-bind` / `--bind` 的 runner，并提供 `runnerFailureSignatures`。[E: packages/sandbox/sandbox-local/src/index.ts:319] [E: packages/sandbox/sandbox-local/tests/local.spec.ts:140]
