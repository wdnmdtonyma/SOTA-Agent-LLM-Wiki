...
source:
  ...
  - packages/subagent/subagent-claude-code/tests/fixtures/loader/cordis.yml
...
| `packages/subagent/subagent-claude-code/tests/fixtures/loader/cordis.yml` | 测试专用 opt-in 组合（含可改名实例），不是 shipped bundle |
