...
| `DEFAULT_HOOK_TIMEOUT_MS` | `600_000`（10 分钟）。两座桥的 `defaultTimeoutMs` config 默认都指它。 [E: packages/hooks/hook-protocol/src/runner.ts:20] [E: packages/hooks/hooks-claude-code/src/index.ts:77] [E: packages/hooks/hooks-codex/src/index.ts:64] |
