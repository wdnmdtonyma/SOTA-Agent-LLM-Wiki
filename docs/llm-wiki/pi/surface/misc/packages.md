...
`PackageSource` 的导出类型本身不在本节点 index source 中:package-manager 只把它作为来自 settings-manager 的 type import 使用 [E: packages/coding-agent/src/core/package-manager.ts:47]。从 index source 能核到 runtime 消费形态:package entry 若为 string 就直接作为 source,若为 object 就取 `source` 并把 object 当 filter;filter keys 覆盖 `extensions`、`skills`、`prompts`、`themes` [E: packages/coding-agent/src/core/package-manager.ts:1256] [E: packages/coding-agent/src/core/package-manager.ts:1257] [E: packages/coding-agent/src/core/package-manager.ts:1258] [E: packages/coding-agent/src/core/package-manager.ts:1410] [E: packages/coding-agent/src/core/package-manager.ts:194] [E: packages/coding-agent/src/core/package-manager.ts:196] [E: packages/coding-agent/src/core/package-manager.ts:197] [E: packages/coding-agent/src/core/package-manager.ts:198] [E: packages/coding-agent/src/core/package-manager.ts:199]。完整 public settings schema 的定义位置超出本节点 index source,仍作为 source-set 不确定项保留 [U]。

package-manager 的解析顺序是:以 `npm:` 开头的 source 解析为 npm package;命中本地路径规则的 source 解析为 local path;剩余输入先尝试按 git URL 解析,解析失败再退回 local path [E: packages/coding-agent/src/core/package-manager.ts:1446] [E: packages/coding-agent/src/core/package-manager.ts:1447] [E: packages/coding-agent/src/core/package-manager.ts:1460] [E: packages/coding-agent/src/core/package-manager.ts:1465] [E: packages/coding-agent/src/core/package-manager.ts:1470]。

用户文档列出的 npm source 形态是 `npm:@scope/pkg@1.2.3` 和 `npm:pkg`;带版本 spec 的 npm package 被视为 pinned,在 package update 中跳过 [E: packages/coding-agent/docs/packages.md:59] [E: packages/coding-agent/docs/packages.md:60] [E: packages/coding-agent/docs/packages.md:63]。npm user installs 位于 `~/.pi/agent/npm/`,project installs 位于 `.pi/npm/`;源码对应的 managed install path 是 `<agentDir>/npm/node_modules/<name>` 和 `<cwd>/.pi/npm/node_modules/<name>` [E: packages/coding-agent/docs/packages.md:64] [E: packages/coding-agent/docs/packages.md:65] [E: packages/coding-agent/src/core/package-manager.ts:2066] [E: packages/coding-agent/src/core/package-manager.ts:2070] [E: packages/coding-agent/src/core/package-manager.ts:2074]。

git source 支持 `git:` 前缀的 shorthand、裸协议 URL、HTTPS 和 SSH;没有 `git:` 前缀时只有 `https://`、`http://`、`ssh://`、`git://` 这类协议 URL 被文档承诺为 git source [E: packages/coding-agent/docs/packages.md:79] [E: packages/coding-agent/docs/packages.md:81] [E: packages/coding-agent/docs/packages.md:85] [E: packages/coding-agent/docs/packages.md:86] [E: packages/coding-agent/docs/packages.md:87]。git user clones 位于 `~/.pi/agent/git/<host>/<path>`,project clones 位于 `.pi/git/<host>/<path>`;源码通过 `getGitInstallPath()` 把 host/path 放在 scope install root 下并防止逃逸 managed root [E: packages/coding-agent/docs/packages.md:92] [E: packages/coding-agent/src/core/package-manager.ts:2094] [E: packages/coding-agent/src/core/package-manager.ts:2102] [E: packages/coding-agent/src/core/package-manager.ts:2125] [E: packages/coding-agent/src/core/package-manager.ts:2129]。

local path 可以是绝对路径或相对路径,文档说它不会被复制到 managed storage;相对路径按其所在 settings file 解析,文件路径作为单个 extension 加载,目录路径按 package 规则加载 [E: packages/coding-agent/docs/packages.md:110] [E: packages/coding-agent/docs/packages.md:111] [E: packages/coding-agent/docs/packages.md:114]。源码的 local source 也体现了这个分支:文件直接加入 extensions,目录交给 `collectPackageResources()`,如果目录没有 manifest/filter 产出的 package resources 且没有约定资源目录,则把目录本身作为 extension source 加入 [E: packages/coding-agent/src/core/package-manager.ts:1327] [E: packages/coding-agent/src/core/package-manager.ts:1340] [E: packages/coding-agent/src/core/package-manager.ts:1342] [E: packages/coding-agent/src/core/package-manager.ts:1343] [E: packages/coding-agent/src/core/package-manager.ts:1346] [E: packages/coding-agent/src/core/package-manager.ts:1348] [E: packages/coding-agent/src/core/package-manager.ts:1350]。

## Manifest 与约定目录

package 作者可以在 `package.json` 写 `pi` manifest,把 `extensions`、`skills`、`prompts`、`themes` 指向 package root 下的路径或 glob;文档示例还建议加 `pi-package` keyword 便于发现 [E: packages/coding-agent/docs/packages.md:118] [E: packages/coding-agent/docs/packages.md:120] [E: packages/coding-agent/docs/packages.md:124] [E: packages/coding-agent/docs/packages.md:125] [E: packages/coding-agent/docs/packages.md:126] [E: packages/coding-agent/docs/packages.md:127] [E: packages/coding-agent/docs/packages.md:128] [E: packages/coding-agent/docs/packages.md:133]。positive glob 按 lexical order 发现可见 path; 点前缀路径和需要穿过 symlink 的资源根必须写成 exact path。[E: packages/coding-agent/docs/packages.md:133] [E: packages/coding-agent/src/core/package-manager.ts:288] [E: packages/coding-agent/src/core/package-manager.ts:288] [E: packages/coding-agent/src/core/package-manager.ts:291] `PiManifest` 投影只读取这四类资源 key；`readPiManifest()` 解析 package root 的 `package.json`，要求 `pkg.pi` 是 object，再复制其中全为 string 的 arrays，否则返回 null [E: packages/coding-agent/src/core/pi-manifest.ts:4] [E: packages/coding-agent/src/core/pi-manifest.ts:5] [E: packages/coding-agent/src/core/pi-manifest.ts:8] [E: packages/coding-agent/src/core/pi-manifest.ts:17] [E: packages/coding-agent/src/core/pi-manifest.ts:19] [E: packages/coding-agent/src/core/pi-manifest.ts:20] [E: packages/coding-agent/src/core/pi-manifest.ts:24] [E: packages/coding-agent/src/core/pi-manifest.ts:31]。

没有 `pi` manifest 时,文档承诺约定目录: `extensions/` 加载 `.ts` 和 `.js`,`skills/` 递归发现 `SKILL.md` folders 并把顶层 `.md` 当作 skills,`prompts/` 加载 `.md`,`themes/` 加载 `.json` [E: packages/coding-agent/docs/packages.md:160] [E: packages/coding-agent/docs/packages.md:162] [E: packages/coding-agent/docs/packages.md:163] [E: packages/coding-agent/docs/packages.md:164] [E: packages/coding-agent/docs/packages.md:165]。源码 fallback 同样扫描 package root 下的四个 resource type 目录,存在则按 resource type 收集文件 [E: packages/coding-agent/src/core/package-manager.ts:2189] [E: packages/coding-agent/src/core/package-manager.ts:2191] [E: packages/coding-agent/src/core/package-manager.ts:2194] [E: packages/coding-agent/src/core/package-manager.ts:2196]。
...
`install` 和 `remove` 默认写 user settings `~/.pi/agent/settings.json`;使用 `-l` 写 project settings `.pi/settings.json`,project settings 可与团队共享,项目被 trust 后 pi 会在启动时自动安装缺失 packages [E: packages/coding-agent/docs/packages.md:43]。源码的 package resolution 也先读取 project settings packages,再读取 global settings packages,随后按 package identity 去重 [E: packages/coding-agent/src/core/package-manager.ts:914] [E: packages/coding-agent/src/core/package-manager.ts:915] [E: packages/coding-agent/src/core/package-manager.ts:918] [E: packages/coding-agent/src/core/package-manager.ts:919] [E: packages/coding-agent/src/core/package-manager.ts:922] [E: packages/coding-agent/src/core/package-manager.ts:927]。

project scope 通常在冲突时优先于 user scope；例外是 project object entry 设置 `autoload: false`，此时 dedupe 保留 global entry，并让 project patterns 作为 delta 应用在 global package 安装/路径上 [E: packages/coding-agent/docs/packages.md:224] [E: packages/coding-agent/src/core/package-manager.ts:1708] [E: packages/coding-agent/src/core/package-manager.ts:1721] [E: packages/coding-agent/src/core/package-manager.ts:1723] [E: packages/coding-agent/src/core/package-manager.ts:1725] [E: packages/coding-agent/src/core/package-manager.ts:1312] [E: packages/coding-agent/src/core/package-manager.ts:1322]。identity 对 npm 是 package name,对 git 是 normalized repository host/path,对 local 是按 scope base 解析后的 absolute path [E: packages/coding-agent/src/core/package-manager.ts:1687] [E: packages/coding-agent/src/core/package-manager.ts:1696]。

`pi update --models` 是只刷新 model catalogs 的 package CLI target，直接调用 model-catalog refresh 而不进入 extension package update；这条用户入口对应 model catalog publication/下载管线 [E: packages/coding-agent/docs/packages.md:34] [E: packages/coding-agent/src/package-manager-cli.ts:345] [E: packages/coding-agent/src/package-manager-cli.ts:914]。

temporary package source 用于“试用不安装”:文档把 `pi -e npm:@foo/bar` 和 `pi -e git:github.com/user/repo` 描述为只安装到当前 run 的 temporary directory [E: packages/coding-agent/docs/packages.md:45] [E: packages/coding-agent/docs/packages.md:48] [E: packages/coding-agent/docs/packages.md:49]。源码为 temporary npm/git 使用 `getExtensionTempFolder(agentDir)` 下的 managed temp path,并通过 hash/suffix 组合防止路径逃逸 [E: packages/coding-agent/src/core/package-manager.ts:225] [E: packages/coding-agent/src/core/package-manager.ts:2026] [E: packages/coding-agent/src/core/package-manager.ts:2067] [E: packages/coding-agent/src/core/package-manager.ts:2095] [E: packages/coding-agent/src/core/package-manager.ts:2116] [E: packages/coding-agent/src/core/package-manager.ts:2122] [I]。

`PI_OFFLINE=1|true|yes` 会让 package-manager 避免网络安装或 update checks;源码在 missing npm/git source 时若 offline 就不 install,在 npm/git update check 中也直接返回 false [E: packages/coding-agent/src/core/package-manager.ts:53] [E: packages/coding-agent/src/core/package-manager.ts:56] [E: packages/coding-agent/src/core/package-manager.ts:1271] [E: packages/coding-agent/src/core/package-manager.ts:1248] [E: packages/coding-agent/src/core/package-manager.ts:1481] [E: packages/coding-agent/src/core/package-manager.ts:1483] [E: packages/coding-agent/src/core/package-manager.ts:1532] [E: packages/coding-agent/src/core/package-manager.ts:1534]。

## 依赖与安装行为

文档要求第三方 runtime dependencies 放进 `dependencies`,因为 pi 从 npm 或 git 安装 package 时会运行 `npm install`;导入 pi core packages 时应放进 `peerDependencies` 且使用 `"*"` range,不要 bundle `@earendil-works/pi-ai`、`@earendil-works/pi-agent-core`、`@earendil-works/pi-coding-agent`、`@earendil-works/pi-tui` 和 `typebox` [E: packages/coding-agent/docs/packages.md:169] [E: packages/coding-agent/docs/packages.md:171]。源码的 managed npm install 会创建私有 npm project,对 npm/pnpm/bun 分别加参数来避免安装或解析 host-provided pi peer dependencies [E: packages/coding-agent/src/core/package-manager.ts:2002] [E: packages/coding-agent/src/core/package-manager.ts:2010] [E: packages/coding-agent/src/core/package-manager.ts:1785] [E: packages/coding-agent/src/core/package-manager.ts:1791] [E: packages/coding-agent/src/core/package-manager.ts:1794] [E: packages/coding-agent/src/core/package-manager.ts:1805] [I]。

git source clone 后如果 package root 有 `package.json`,install flow 会运行 npm install;git update 也会在 checkout 变更后重新运行依赖安装 [E: packages/coding-agent/src/core/package-manager.ts:1850] [E: packages/coding-agent/src/core/package-manager.ts:1854] [E: packages/coding-agent/src/core/package-manager.ts:1856] [E: packages/coding-agent/src/core/package-manager.ts:1956] [E: packages/coding-agent/src/core/package-manager.ts:1919] [E: packages/coding-agent/src/core/package-manager.ts:1925] [E: packages/coding-agent/src/core/package-manager.ts:1927]。文档把这一点暴露为“reconciliation changes checkout 时 reset/clean clone,然后如果存在 package.json 就 npm install” [E: packages/coding-agent/docs/packages.md:93]。
...
[subsys.coding-agent.resource-loader](../../subsystems/coding-agent/resource-loader.md) 是 package-manager 的下游:package-manager 产出 extensions、skills、prompts、themes 的 `ResolvedPaths`,resource-loader 再负责真正加载 extension module、skill markdown、prompt template 和 theme JSON [E: packages/coding-agent/src/core/package-manager.ts:80] [E: packages/coding-agent/src/core/package-manager.ts:81] [E: packages/coding-agent/src/core/package-manager.ts:82] [E: packages/coding-agent/src/core/package-manager.ts:83] [I]。
