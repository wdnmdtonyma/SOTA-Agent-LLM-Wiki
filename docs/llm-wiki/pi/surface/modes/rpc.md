...
`runRpcMode(runtimeHost)` 是运行时入口,函数体先接管 stdout,随后用 `output(...)` 写 JSONL 输出,并在底部把 stdin JSONL reader 接到 `handleInputLine(line)`。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:54][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:55][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:60][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:61][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:810][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:811]
...
framing 采用 strict JSONL:只用 LF (`\n`) 作为 record delimiter,client 应只按 `\n` 分割、可剥离输入端尾随 `\r`,且不要使用会把 `U+2028`/`U+2029` 当换行的 generic line reader。[E: packages/coding-agent/docs/rpc.md:28][E: packages/coding-agent/docs/rpc.md:30][E: packages/coding-agent/docs/rpc.md:33][E: packages/coding-agent/docs/rpc.md:34][E: packages/coding-agent/docs/rpc.md:35][E: packages/coding-agent/docs/rpc.md:37] `attachJsonlLineReader(process.stdin, ...)` 在进程 stdin 上接线,每条 line 交给 `handleInputLine(line)`。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:810][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:811]

## Dispatch 与 response 语义

`handleInputLine` 先 `JSON.parse(line)`,parse 失败时输出 `command:"parse"` 的 error response;parse 成功后先处理 `type:"extension_ui_response"`,普通 command 才 cast 成 `RpcCommand` 并进入 `handleCommand(command)`。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:752][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:755][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:757][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:760][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:769][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:773][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:775][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:784][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:786] 失败 command response 的 shape 也在文档中示例为 `type:"response"`,带 `command`、`success:false`、`error`。[E: packages/coding-agent/docs/rpc.md:1376][E: packages/coding-agent/docs/rpc.md:1378][E: packages/coding-agent/docs/rpc.md:1380][E: packages/coding-agent/docs/rpc.md:1382][E: packages/coding-agent/docs/rpc.md:1383][E: packages/coding-agent/docs/rpc.md:1384][E: packages/coding-agent/docs/rpc.md:1385]
...
`runRpcMode` 把 `runtimeHost.session` 保存到局部 `session`,并通过 `runtimeHost.setRebindSession()` 暴露重新绑定回调。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:56][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:313][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:314] `rebindSession()` 重新读取 `runtimeHost.session`,以 `{ uiContext, mode:"rpc", commandContextActions, shutdownHandler, onError }` 绑定 extensions,随后取消旧订阅并订阅新 session events,把每个 event 交给 `output(toJsonEvent(event))`。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:317][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:318][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:319][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:320][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:321][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:322][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:345][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:348][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:353][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:355][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:356]

`new_session`、`switch_session`、`fork`、`clone` 在 runtimeHost 返回未取消时都会调用 `rebindSession()`。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:437][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:439][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:440][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:441][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:605][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:608][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:613][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:616][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:621][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:626][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:628] 这些 branch 使用 runtimeHost 级 session 操作,因此需要重新读取并重新订阅当前 session;这是从控制流与 `runtimeHost.session` 的重新赋值方式归纳出的原因。[I]

RPC mode 的 event 一般不带 request `id`,但 `bash_execution_update` 是明确例外：`bash` command 的 envelope id 会传入 `executeBash`,后续 update event 可用同一可选 `id` 做 streaming correlation。[E: packages/coding-agent/docs/rpc.md:855][E: packages/coding-agent/docs/rpc.md:857][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:578][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:580][E: packages/coding-agent/src/core/agent-session.ts:185] 其它异步生命周期仍由 response `id` 关联 command 接受/失败，再由无 id 的 event stream 观察。[I]

## Extension UI bridge

RPC mode 为 extensions 提供专用 `ExtensionUIContext`:select/confirm/input 通过 `createDialogPromise(...)` 建 pending request、输出 `extension_ui_request`,再等待 host 写回 matching `extension_ui_response`;editor 也创建 pending request 并输出 `method:"editor"` request。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:80][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:91][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:99][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:122][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:129][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:136][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:137][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:142][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:147][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:254][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:257][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:269] 文档把这些称为 dialog methods:stdout 发 `extension_ui_request`,并阻塞到 client 以相同 `id` 发回 `extension_ui_response`。[E: packages/coding-agent/docs/rpc.md:1184][E: packages/coding-agent/docs/rpc.md:1186][E: packages/coding-agent/docs/rpc.md:1188][E: packages/coding-agent/docs/rpc.md:1190]

notify/status/widget/title/editor-text 这类方法直接发 `extension_ui_request`,文档称为 fire-and-forget methods,host 可以展示也可以忽略。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:152][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:154][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:168][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:170][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:195][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:198][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:218][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:220][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:238][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:240][E: packages/coding-agent/docs/rpc.md:1191] 部分 TUI-only 能力在 RPC mode 明确不可用或降级,包括 custom UI、working indicators、footer/header、editor component、tool expansion、theme switching 等。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:163][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:179][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:187][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:191][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:210][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:214][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:228][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:298][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:303][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:308][E: packages/coding-agent/docs/rpc.md:1195][E: packages/coding-agent/docs/rpc.md:1196][E: packages/coding-agent/docs/rpc.md:1197][E: packages/coding-agent/docs/rpc.md:1198][E: packages/coding-agent/docs/rpc.md:1199][E: packages/coding-agent/docs/rpc.md:1200][E: packages/coding-agent/docs/rpc.md:1201][E: packages/coding-agent/docs/rpc.md:1202][E: packages/coding-agent/docs/rpc.md:1203]

## 生命周期与关闭

RPC mode 会注册 `SIGTERM`,并在非 Windows 平台注册 `SIGHUP`;handler 先 `killTrackedDetachedChildren()`,再调用 shutdown,其中 `SIGHUP` 映射 exit code 129,`SIGTERM` 映射 exit code 143。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:366][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:367][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:368][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:374][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:375] `shutdown()` 会移除 signal handler、取消 session subscriptions、dispose runtimeHost、detach stdin、pause stdin,并在非 SIGTERM 路径 flush stdout 后退出。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:728][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:733][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:736][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:737][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:738][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:739][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:740][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:741][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:742][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:744]

stdin `end` 也触发 shutdown;每个 command 处理后会检查 extension shutdown request,如果 extension handler 设置了 `shutdownRequested`,RPC loop 会关闭进程。[E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:345][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:346][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:747][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:748][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:749][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:791][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:804][E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:805]

## 跨包关系

开发文档的 Python client 示例通过 `subprocess.Popen(["pi", "--mode", "rpc", "--no-session"], stdin=PIPE, stdout=PIPE, text=True)` 启动 RPC 子进程,说明 RPC mode 的公开嵌入面仍是 stdin/stdout 子进程协议,不是 server package 的 listener/service。[E: packages/coding-agent/docs/rpc.md:1526][E: packages/coding-agent/docs/rpc.md:1532][E: packages/coding-agent/docs/rpc.md:1533][E: packages/coding-agent/docs/rpc.md:1534][E: packages/coding-agent/docs/rpc.md:1535][E: packages/coding-agent/docs/rpc.md:1536]
