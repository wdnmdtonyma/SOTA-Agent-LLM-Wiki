...
thinking 命令组新增 `get_available_thinking_levels`：请求无额外字段，成功 response 的 `data.levels` 是当前模型可选的 `ThinkingLevel[]` [E: packages/coding-agent/src/modes/rpc/rpc-types.ts:39] [E: packages/coding-agent/src/modes/rpc/rpc-types.ts:158] [E: packages/coding-agent/src/modes/rpc/rpc-types.ts:163]。服务端直接调用 `session.getAvailableThinkingLevels()` [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:507] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:509]，typed client 也暴露同名 camelCase 方法 [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:286] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:288]。
...
parse error 不属于某个有效 command, 因此服务端用 `id: undefined` 和 `command: "parse"` 写 failure response [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:747] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:750] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:752] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:755] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:756]。命令执行抛出的异常会在 `catch` 中转换为同 command/id 的 failure response [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:787] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:790] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:791] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:792]。

## 4 Prompt acceptance 与事件流

`prompt` command 是异步语义: `RpcResponse` 只表示 prompt 被 accepted、queued 或 immediately handled; 后续生成内容继续作为 event stream 输出 [E: packages/coding-agent/docs/rpc.md:45] [E: packages/coding-agent/docs/rpc.md:76]。`runRpcMode()` 对 `prompt` 不等待整轮 agent 完成; 它调用 `session.prompt(..., { source: "rpc", preflightResult })`, 在 preflight 成功时输出一次 `success(id, "prompt")`, preflight 之前失败时输出一次 failure response [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:393] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:397] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:401] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:402] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:405] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:410] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:411]。
...
所有 `AgentSessionEvent` 由 `session.subscribe()` 直接 output 到 stdout JSONL [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:354] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:355]。RPC docs 明确说明 event 一般不带 request `id`,但 `bash_execution_update` 可带发起 `bash` command 的 id；`rpc-mode` 把 request id 传给 `executeBash` 以建立这条关联 [E: packages/coding-agent/docs/rpc.md:832] [E: packages/coding-agent/docs/rpc.md:834] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:573] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:575]。`ref.coding-agent.json-events` 应覆盖 event payload catalog; 本节点只说明 RPC protocol 如何承载这些 events [I]。
...
运行时构造 `get_state` payload 时逐项读取当前 `AgentSession`: `model` 来自 `session.model`, streaming/compacting flags 来自 session 状态, queue mode 来自 session queue settings, message count 来自 `session.messages.length`, pending count 来自 `session.pendingMessageCount` [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:445] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:447] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:449] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:450] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:451] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:452] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:457] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:458]。docs 的示例也把这些字段作为 `get_state` response data 展示; 源码类型把 `model` 声明为可选完整 `Model` object, `sessionName` 也为可选字段, 运行时分别把 `session.model` 与 `session.sessionName` 放入 state [E: packages/coding-agent/docs/rpc.md:170] [E: packages/coding-agent/docs/rpc.md:176] [E: packages/coding-agent/docs/rpc.md:177] [E: packages/coding-agent/docs/rpc.md:185] [E: packages/coding-agent/src/modes/rpc/rpc-types.ts:95] [E: packages/coding-agent/src/modes/rpc/rpc-types.ts:96] [E: packages/coding-agent/src/modes/rpc/rpc-types.ts:104] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:447] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:455]。
...
`RpcClient.send()` 为每个 public method 生成递增 id `req_N`, 把 command body 扩展成 `RpcCommand`, 在 `pendingRequests` 里注册 30 秒 timeout, 然后用 `serializeJsonLine(fullCommand)` 写 stdin [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:539] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:559] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:560] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:563] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:565] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:568] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:580]。stdout line 解析后, 如果 `data.type === "response"` 且 `data.id` 命中 pending map, client resolve 对应 request; 否则把这条 JSON 当作 `AgentEvent` 分发给所有 event listeners [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:507] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:509] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:512] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:514] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:515] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:520] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:521]。

`RpcClient` 的 public methods 基本是一层 typed wrapper: 例如 `prompt()` 发送 `{ type: "prompt", message, images }`, `getState()` 发送 `get_state` 并返回 `RpcSessionState`, `bash()` 发送 `{ type: "bash", command }` 并返回 `BashResult`, `getCommands()` 返回 `RpcSlashCommand[]` [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:197] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:198] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:235] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:236] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:337] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:338] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:442] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:443]。`getData()` 对 `success: false` response 抛出 `error`, 对 success response 则信任 command-specific generic type 取 `data` [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:590] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:591] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:593] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:597] [E: packages/coding-agent/src/modes/rpc/rpc-client.ts:598]。
...
服务端在写出普通 command response 后会 `await waitForRawStdoutBackpressure()`, parse error 和 command exception path 也会等待 backpressure [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:782] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:784] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:759] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:795]。`session.agent.subscribe()` 也注册了 backpressure callback, agent event flow 可以等待 raw stdout backpressure [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:360] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:361]。这些代码只说明 RPC mode 尝试尊重 stdout backpressure; 具体 `output-guard` 实现属于 coding-agent 输出守卫子系统, 不在本节点展开 [I]。
