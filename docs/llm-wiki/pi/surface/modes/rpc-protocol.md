...
parse error 不属于某个有效 command, 因此服务端用 `id: undefined` 和 `command: "parse"` 写 failure response [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:732] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:735] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:737] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:740] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:741]。命令执行抛出的异常会在 `catch` 中转换为同 command/id 的 failure response [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:772] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:775] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:776] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:777]。
...
所有 `AgentSessionEvent` 由 `session.subscribe()` 直接 output 到 stdout JSONL [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:354] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:355]。RPC docs 明确说明 event 一般不带 request `id`,但 `bash_execution_update` 可带发起 `bash` command 的 id；`rpc-mode` 把 request id 传给 `executeBash` 以建立这条关联 [E: packages/coding-agent/docs/rpc.md:832] [E: packages/coding-agent/docs/rpc.md:834] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:559] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:561]。`ref.coding-agent.json-events` 应覆盖 event payload catalog; 本节点只说明 RPC protocol 如何承载这些 events [I]。
...
服务端在写出普通 command response 后会 `await waitForRawStdoutBackpressure()`, parse error 和 command exception path 也会等待 backpressure [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:767] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:769] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:744] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:780]。`session.agent.subscribe()` 也注册了 backpressure callback, agent event flow 可以等待 raw stdout backpressure [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:360] [E: packages/coding-agent/src/modes/rpc/rpc-mode.ts:361]。这些代码只说明 RPC mode 尝试尊重 stdout backpressure; 具体 `output-guard` 实现属于 coding-agent 输出守卫子系统, 不在本节点展开 [I]。
