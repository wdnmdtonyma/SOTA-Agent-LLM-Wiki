...
| 6 | `cerebras` / `Cerebras` | `CEREBRAS_API_KEY`；base `https://api.cerebras.ai/v1` [E: packages/ai/src/providers/cerebras.ts:10] [E: packages/ai/src/providers/cerebras.ts:11] | `openai-completions` [E: packages/ai/src/providers/cerebras.ts:13] | `zai-glm-4.7` [E: packages/coding-agent/src/core/model-resolver.ts:38] | `packages/ai/src/providers/cerebras.ts` [E: packages/ai/src/providers/all.ts:96] |
