...
`thinkingLevel` 只在 model supports reasoning 且值不是 `"off"` 时进入 summary request options;该行为属于 summary call options,不属于 compaction config object。[E: packages/agent/src/harness/compaction/compaction.ts:494][E: packages/agent/src/harness/compaction/compaction.ts:495][E: packages/agent/src/harness/compaction/compaction.ts:496][E: packages/agent/src/harness/compaction/compaction.ts:731][E: packages/agent/src/harness/compaction/compaction.ts:732]
