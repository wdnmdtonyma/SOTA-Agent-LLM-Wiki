...
`resolveModelSelection()` 优先取 harness 的 `{ provider, id }`，否则读取 `PI_PROVIDER` / `PI_MODEL`；结果会 trim，缺任一字段立即报错。单元测试覆盖显式 model 覆盖环境 default、trim 与不完整选择。[E: packages/evals/src/pi-harness.ts:48] [E: packages/evals/src/pi-harness.ts:52] [E: packages/evals/src/pi-harness.ts:54] [E: packages/evals/src/pi-harness.ts:57] [E: packages/evals/test/pi-harness.test.ts:5] [E: packages/evals/test/pi-harness.test.ts:14] [E: packages/evals/test/pi-harness.test.ts:29]
...
- native artifacts 可能含 prompts、responses、source code 与 tool output，应按敏感运行记录处理。[E: packages/evals/README.md:34] [E: packages/evals/README.md:33]
