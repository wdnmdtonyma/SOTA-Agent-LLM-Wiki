...
1. `convertToLlm@packages/agent/src/harness/messages.ts:120` 对输入 messages 执行 `.map()`,每个 `AgentMessage` 按 `m.role` 转成 `Message | undefined`。[E: packages/agent/src/harness/messages.ts:124] [E: packages/agent/src/harness/messages.ts:125] [E: packages/agent/src/harness/messages.ts:126] [E: packages/agent/src/harness/messages.ts:127]
