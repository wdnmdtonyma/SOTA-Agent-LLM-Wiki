...
本节点只覆盖 `packages/agent/src/harness/skills.ts` 内的加载、解析、diagnostic 和 source tagging 行为。`Skill` 的完整接口定义来自 `./types.ts` 的 type import,但本节点的 source 只证明本文件如何使用和构造 `Skill` 字段。[E: packages/agent/src/harness/skills.ts:3] [E: packages/agent/src/harness/skills.ts:53] [E: packages/agent/src/harness/skills.ts:279] [I]

## 关键文件

- `packages/agent/src/harness/skills.ts`:定义 skill metadata 限制、diagnostic code、frontmatter shape、`formatSkillInvocation()`、`loadSkills()`、`loadSourcedSkills()`、recursive directory walk、ignore-file handling、frontmatter parser 和 name/description validation。[E: packages/agent/src/harness/skills.ts:5] [E: packages/agent/src/harness/skills.ts:7] [E: packages/agent/src/harness/skills.ts:11] [E: packages/agent/src/harness/skills.ts:30] [E: packages/agent/src/harness/skills.ts:38] [E: packages/agent/src/harness/skills.ts:49] [E: packages/agent/src/harness/skills.ts:83] [E: packages/agent/src/harness/skills.ts:103] [E: packages/agent/src/harness/skills.ts:177] [E: packages/agent/src/harness/skills.ts:312]

## 数据模型

`SkillDiagnosticCode` 覆盖五类 warning: file-info/canonical-path failure、directory listing failure、file read failure、frontmatter parse failure、metadata validation failure。[E: packages/agent/src/harness/skills.ts:11] [E: packages/agent/src/harness/skills.ts:12] [E: packages/agent/src/harness/skills.ts:13] [E: packages/agent/src/harness/skills.ts:14] [E: packages/agent/src/harness/skills.ts:15] [E: packages/agent/src/harness/skills.ts:16] [E: packages/agent/src/harness/skills.ts:334] [E: packages/agent/src/harness/skills.ts:339] `SkillDiagnostic` 固定带 `type: "warning"`、stable `code`、human-readable `message` 和 associated `path`。[E: packages/agent/src/harness/skills.ts:19] [E: packages/agent/src/harness/skills.ts:21] [E: packages/agent/src/harness/skills.ts:23] [E: packages/agent/src/harness/skills.ts:25] [E: packages/agent/src/harness/skills.ts:27]

`SkillFrontmatter` 在本文件中只读取 `name`、`description` 和 `disable-model-invocation`;其它 frontmatter key 允许存在但不参与 `Skill` 构造。[E: packages/agent/src/harness/skills.ts:30] [E: packages/agent/src/harness/skills.ts:31] [E: packages/agent/src/harness/skills.ts:32] [E: packages/agent/src/harness/skills.ts:33] [E: packages/agent/src/harness/skills.ts:34] `loadSkillFromFile()` 生成的 `Skill` 字段是 `name`、`description`、`content`、`filePath`、`disableModelInvocation`。[E: packages/agent/src/harness/skills.ts:278] [E: packages/agent/src/harness/skills.ts:279] [E: packages/agent/src/harness/skills.ts:280] [E: packages/agent/src/harness/skills.ts:281] [E: packages/agent/src/harness/skills.ts:282] [E: packages/agent/src/harness/skills.ts:283] [E: packages/agent/src/harness/skills.ts:284]

`name` 来自 frontmatter `name` 或 skill 文件父目录名;`description` 必须是 string 且非空白,否则 `loadSkillFromFile()` 返回 `skill: null`。[E: packages/agent/src/harness/skills.ts:251] [E: packages/agent/src/harness/skills.ts:252] [E: packages/agent/src/harness/skills.ts:262] [E: packages/agent/src/harness/skills.ts:268] [E: packages/agent/src/harness/skills.ts:269] [E: packages/agent/src/harness/skills.ts:274] [E: packages/agent/src/harness/skills.ts:275]
...
The loader recognizes `.gitignore`, `.ignore`, and `.fdignore` in each visited directory.[E: packages/agent/src/harness/skills.ts:7] `addIgnoreRules()` tries each filename, reads file content when present, drops blank/comment lines, prefixes patterns by the current relative directory, and adds resulting patterns to the shared `ignore` matcher.[E: packages/agent/src/harness/skills.ts:187] [E: packages/agent/src/harness/skills.ts:199] [E: packages/agent/src/harness/skills.ts:211] [E: packages/agent/src/harness/skills.ts:212] [E: packages/agent/src/harness/skills.ts:217] [E: packages/agent/src/harness/skills.ts:219] [E: packages/agent/src/harness/skills.ts:221]

Ignore checks are applied before loading `SKILL.md`, before recursing into child directories, and before loading root markdown files.[E: packages/agent/src/harness/skills.ts:142] [E: packages/agent/src/harness/skills.ts:143] [E: packages/agent/src/harness/skills.ts:157] [E: packages/agent/src/harness/skills.ts:158] [E: packages/agent/src/harness/skills.ts:159] Negated patterns are preserved with a leading `!`, and leading slash patterns are normalized by removing the slash before prefixing.[E: packages/agent/src/harness/skills.ts:232] [E: packages/agent/src/harness/skills.ts:238] [E: packages/agent/src/harness/skills.ts:239] [E: packages/agent/src/harness/skills.ts:240]

## Parsing 与 validation

`loadSkillFromFile()` reads raw text, parses frontmatter, then validates description and name before deciding whether to return a `Skill`.[E: packages/agent/src/harness/skills.ts:249] [E: packages/agent/src/harness/skills.ts:255] [E: packages/agent/src/harness/skills.ts:264] [E: packages/agent/src/harness/skills.ts:270] [E: packages/agent/src/harness/skills.ts:278] Read errors and parse errors become warning diagnostics and suppress the skill object.[E: packages/agent/src/harness/skills.ts:250] [E: packages/agent/src/harness/skills.ts:251] [E: packages/agent/src/harness/skills.ts:252] [E: packages/agent/src/harness/skills.ts:256] [E: packages/agent/src/harness/skills.ts:257] [E: packages/agent/src/harness/skills.ts:258]

`parseFrontmatter()` normalizes CRLF/CR line endings to LF, treats content without a complete leading `--- ... ---` block as empty frontmatter plus full body, parses YAML through `parse()`, and trims the body after the closing marker.[E: packages/agent/src/harness/skills.ts:316] [E: packages/agent/src/harness/skills.ts:317] [E: packages/agent/src/harness/skills.ts:318] [E: packages/agent/src/harness/skills.ts:319] [E: packages/agent/src/harness/skills.ts:320] [E: packages/agent/src/harness/skills.ts:321] [E: packages/agent/src/harness/skills.ts:322]

`validateName()` requires the effective name to equal the parent directory name, stay within 64 chars, use only lowercase letters, digits and hyphens, avoid leading/trailing hyphen, and avoid consecutive hyphens.[E: packages/agent/src/harness/skills.ts:5] [E: packages/agent/src/harness/skills.ts:290] [E: packages/agent/src/harness/skills.ts:292] [E: packages/agent/src/harness/skills.ts:293] [E: packages/agent/src/harness/skills.ts:294] [E: packages/agent/src/harness/skills.ts:297] [E: packages/agent/src/harness/skills.ts:298] `validateDescription()` requires a non-empty description and caps it at 1024 characters.[E: packages/agent/src/harness/skills.ts:6] [E: packages/agent/src/harness/skills.ts:302] [E: packages/agent/src/harness/skills.ts:304] [E: packages/agent/src/harness/skills.ts:306]
...
- Invalid metadata diagnostics do not automatically suppress a skill if the description is present: `validateDescription()` and `validateName()` push warnings, but the only metadata gate that returns `skill: null` is missing or blank description.[E: packages/agent/src/harness/skills.ts:264] [E: packages/agent/src/harness/skills.ts:265] [E: packages/agent/src/harness/skills.ts:270] [E: packages/agent/src/harness/skills.ts:271] [E: packages/agent/src/harness/skills.ts:274] [E: packages/agent/src/harness/skills.ts:275] [E: packages/agent/src/harness/skills.ts:278]
...
- `disable-model-invocation` is parsed only when it is exactly boolean `true`; any other value yields `disableModelInvocation: false` through the strict comparison.[E: packages/agent/src/harness/skills.ts:33] [E: packages/agent/src/harness/skills.ts:284]
...
`subsys.agent-core.system-prompt` should describe broader harness system prompt assembly. This node only proves the selected-skill invocation formatter and the fields available on loaded `Skill` objects.[E: packages/agent/src/harness/skills.ts:38] [E: packages/agent/src/harness/skills.ts:279] [I]
