...
`NodeExecutionEnv` 是 `packages/agent` 中以 Node APIs 落地的 execution environment: 源码将 `ExecutionEnv` 类型、`ExecutionError`、`FileError`、`Result` helper 从 `../types.ts` 引入, 并由 `NodeExecutionEnv implements ExecutionEnv` 绑定到本地实现 [E: packages/agent/src/harness/env/nodejs.ts:22] [E: packages/agent/src/harness/env/nodejs.ts:23] [E: packages/agent/src/harness/env/nodejs.ts:25] [E: packages/agent/src/harness/env/nodejs.ts:29] [E: packages/agent/src/harness/env/nodejs.ts:353]。

`NodeExecutionEnv` 的构造参数只保存 `cwd`、可选 `shellPath` 和可选 `shellEnv`; `packages/agent/src/node.ts` 是 Node-facing public export, 重新导出 `NodeExecutionEnv` 并透传 package index [E: packages/agent/src/harness/env/nodejs.ts:359] [E: packages/agent/src/harness/env/nodejs.ts:360] [E: packages/agent/src/harness/env/nodejs.ts:361] [E: packages/agent/src/harness/env/nodejs.ts:362] [E: packages/agent/src/node.ts:1] [E: packages/agent/src/node.ts:2]。

本节点只覆盖 `packages/agent` harness 层的 Node execution env 和 truncation helpers。能从本轮 source 直接证明的是 agent-core 的 `exec(command, options)` 接收 shell command string, spawn 后返回 stdout、stderr 和 exitCode; coding-agent 的 tool schema、argv helper、UI 和 product-level bash policy 不在本节点 source 范围内 [E: packages/agent/src/harness/env/nodejs.ts:373] [E: packages/agent/src/harness/env/nodejs.ts:376] [E: packages/agent/src/harness/env/nodejs.ts:424] [E: packages/agent/src/harness/env/nodejs.ts:426] [E: packages/agent/src/harness/env/nodejs.ts:501]。

## 关键文件

- `packages/agent/src/harness/env/nodejs.ts`: `NodeExecutionEnv`、path helpers、Node errno 到 `FileError` 的映射、shell discovery、process tree kill、file/process API 的本地实现 [E: packages/agent/src/harness/env/nodejs.ts:51] [E: packages/agent/src/harness/env/nodejs.ts:94] [E: packages/agent/src/harness/env/nodejs.ts:196] [E: packages/agent/src/harness/env/nodejs.ts:253] [E: packages/agent/src/harness/env/nodejs.ts:353]。
...
`exec(command, options)` resolves `options.cwd` relative to environment cwd, obtains shell config, spawns the shell with process-group detaching on non-Windows, and sets spawn `env` via `getShellEnv(this.shellEnv, options?.env, options?.inheritEnv)`: when `inheritEnv` is true (default) it merges `process.env`, constructor `shellEnv`, then per-call `options.env`; when `inheritEnv` is false it returns only `{ ...extraEnv }`, omitting `process.env` and `shellEnv`. stdin is wired only for stdin transport [E: packages/agent/src/harness/env/nodejs.ts:373] [E: packages/agent/src/harness/env/nodejs.ts:380] [E: packages/agent/src/harness/env/nodejs.ts:240] [E: packages/agent/src/harness/env/nodejs.ts:243] [E: packages/agent/src/harness/env/nodejs.ts:245] [E: packages/agent/src/harness/env/nodejs.ts:246] [E: packages/agent/src/harness/env/nodejs.ts:424] [E: packages/agent/src/harness/env/nodejs.ts:426] [E: packages/agent/src/harness/env/nodejs.ts:430] [E: packages/agent/src/harness/env/nodejs.ts:431] [E: packages/agent/src/harness/env/nodejs.ts:436] [E: packages/agent/src/harness/env/nodejs.ts:438]。

`exec()` treats `options.timeout` as seconds in this implementation: it multiplies the value by 1000 for `setTimeout`, kills the child tree, then returns `ExecutionError("timeout", "timeout:N")` on close [E: packages/agent/src/harness/env/nodejs.ts:446] [E: packages/agent/src/harness/env/nodejs.ts:447] [E: packages/agent/src/harness/env/nodejs.ts:449] [E: packages/agent/src/harness/env/nodejs.ts:451] [E: packages/agent/src/harness/env/nodejs.ts:453] [E: packages/agent/src/harness/env/nodejs.ts:493] [E: packages/agent/src/harness/env/nodejs.ts:494]。

Abort and callback errors both terminate the child tree: abort listeners call `killProcessTree`, stdout/stderr callback exceptions become `ExecutionError("callback_error", ...)`, and close handling returns `ExecutionError("aborted", "aborted")` if the abort signal is set [E: packages/agent/src/harness/env/nodejs.ts:407] [E: packages/agent/src/harness/env/nodejs.ts:409] [E: packages/agent/src/harness/env/nodejs.ts:456] [E: packages/agent/src/harness/env/nodejs.ts:460] [E: packages/agent/src/harness/env/nodejs.ts:466] [E: packages/agent/src/harness/env/nodejs.ts:469] [E: packages/agent/src/harness/env/nodejs.ts:472] [E: packages/agent/src/harness/env/nodejs.ts:473] [E: packages/agent/src/harness/env/nodejs.ts:476] [E: packages/agent/src/harness/env/nodejs.ts:479] [E: packages/agent/src/harness/env/nodejs.ts:482] [E: packages/agent/src/harness/env/nodejs.ts:483] [E: packages/agent/src/harness/env/nodejs.ts:497] [E: packages/agent/src/harness/env/nodejs.ts:498]。

`killProcessTree()` uses `taskkill /F /T /PID` on Windows, and on non-Windows tries `process.kill(-pid, "SIGKILL")` before falling back to killing the single pid [E: packages/agent/src/harness/env/nodejs.ts:253] [E: packages/agent/src/harness/env/nodejs.ts:254] [E: packages/agent/src/harness/env/nodejs.ts:258] [E: packages/agent/src/harness/env/nodejs.ts:273] [E: packages/agent/src/harness/env/nodejs.ts:274] [E: packages/agent/src/harness/env/nodejs.ts:277]。

## File API

Path helpers are syntactic unless explicitly canonicalized: `absolutePath()` resolves relative paths against `cwd`, `joinPath()` delegates to `path.join`, and `canonicalPath()` calls `realpath()` on the resolved path [E: packages/agent/src/harness/env/nodejs.ts:51] [E: packages/agent/src/harness/env/nodejs.ts:365] [E: packages/agent/src/harness/env/nodejs.ts:366] [E: packages/agent/src/harness/env/nodejs.ts:369] [E: packages/agent/src/harness/env/nodejs.ts:370] [E: packages/agent/src/harness/env/nodejs.ts:641] [E: packages/agent/src/harness/env/nodejs.ts:644]。

Text and binary reads resolve the requested path against `cwd`, check for an already-aborted signal before touching the filesystem, pass the abort signal to Node read APIs, and convert thrown errors through `toFileError()` [E: packages/agent/src/harness/env/nodejs.ts:508] [E: packages/agent/src/harness/env/nodejs.ts:509] [E: packages/agent/src/harness/env/nodejs.ts:510] [E: packages/agent/src/harness/env/nodejs.ts:513] [E: packages/agent/src/harness/env/nodejs.ts:515] [E: packages/agent/src/harness/env/nodejs.ts:550] [E: packages/agent/src/harness/env/nodejs.ts:552] [E: packages/agent/src/harness/env/nodejs.ts:555] [E: packages/agent/src/harness/env/nodejs.ts:557]。

`readTextLines()` streams UTF-8 through `createReadStream()` and `readline.createInterface()`, returns early for `maxLines <= 0`, checks abort during iteration, stops after `maxLines`, then closes the line reader and destroys the stream in `finally` [E: packages/agent/src/harness/env/nodejs.ts:519] [E: packages/agent/src/harness/env/nodejs.ts:526] [E: packages/agent/src/harness/env/nodejs.ts:530] [E: packages/agent/src/harness/env/nodejs.ts:531] [E: packages/agent/src/harness/env/nodejs.ts:533] [E: packages/agent/src/harness/env/nodejs.ts:534] [E: packages/agent/src/harness/env/nodejs.ts:536] [E: packages/agent/src/harness/env/nodejs.ts:537] [E: packages/agent/src/harness/env/nodejs.ts:545] [E: packages/agent/src/harness/env/nodejs.ts:546]。

Writes and appends auto-create parent directories before writing; `writeFile()` supports abort checks before and after mkdir, while `appendFile()` has no abort-signal parameter in this implementation [E: packages/agent/src/harness/env/nodejs.ts:561] [E: packages/agent/src/harness/env/nodejs.ts:564] [E: packages/agent/src/harness/env/nodejs.ts:566] [E: packages/agent/src/harness/env/nodejs.ts:567] [E: packages/agent/src/harness/env/nodejs.ts:570] [E: packages/agent/src/harness/env/nodejs.ts:571] [E: packages/agent/src/harness/env/nodejs.ts:573] [E: packages/agent/src/harness/env/nodejs.ts:580] [E: packages/agent/src/harness/env/nodejs.ts:583] [E: packages/agent/src/harness/env/nodejs.ts:584]。

Metadata and directory APIs use `lstat()` rather than following symlinks: `fileInfo()` wraps `lstat`, `listDir()` uses `readdir(..., { withFileTypes: true })`, then lstat per child and returns supported file/directory/symlink entries [E: packages/agent/src/harness/env/nodejs.ts:67] [E: packages/agent/src/harness/env/nodejs.ts:72] [E: packages/agent/src/harness/env/nodejs.ts:74] [E: packages/agent/src/harness/env/nodejs.ts:78] [E: packages/agent/src/harness/env/nodejs.ts:82] [E: packages/agent/src/harness/env/nodejs.ts:83] [E: packages/agent/src/harness/env/nodejs.ts:608] [E: packages/agent/src/harness/env/nodejs.ts:611] [E: packages/agent/src/harness/env/nodejs.ts:617] [E: packages/agent/src/harness/env/nodejs.ts:622] [E: packages/agent/src/harness/env/nodejs.ts:629] [E: packages/agent/src/harness/env/nodejs.ts:630]。

`exists()` reports missing paths as `ok(false)` but propagates other file errors; `createDir()` defaults to recursive mkdir, `remove()` defaults to non-recursive and non-force rm, `createTempDir()` uses `mkdtemp(join(tmpdir(), prefix))`, and `createTempFile()` creates an empty randomUUID-named file inside a temp dir [E: packages/agent/src/harness/env/nodejs.ts:650] [E: packages/agent/src/harness/env/nodejs.ts:652] [E: packages/agent/src/harness/env/nodejs.ts:653] [E: packages/agent/src/harness/env/nodejs.ts:657] [E: packages/agent/src/harness/env/nodejs.ts:660] [E: packages/agent/src/harness/env/nodejs.ts:667] [E: packages/agent/src/harness/env/nodejs.ts:670] [E: packages/agent/src/harness/env/nodejs.ts:677] [E: packages/agent/src/harness/env/nodejs.ts:679] [E: packages/agent/src/harness/env/nodejs.ts:685] [E: packages/agent/src/harness/env/nodejs.ts:686] [E: packages/agent/src/harness/env/nodejs.ts:688] [E: packages/agent/src/harness/env/nodejs.ts:690]。
...
Agent-core `exec()` returns separate stdout/stderr strings and an exit code, and invokes optional stdout/stderr callbacks per stream. This source set does not define the product-level `bash` tool UI/schema or coding-agent bash executor policy, so those details remain owned by `subsys.coding-agent.bash-executor` [E: packages/agent/src/harness/env/nodejs.ts:376] [E: packages/agent/src/harness/env/nodejs.ts:466] [E: packages/agent/src/harness/env/nodejs.ts:476] [E: packages/agent/src/harness/env/nodejs.ts:501]。
...
- `NodeExecutionEnv.exec()` does not throw on nonzero exit; it returns `ok({ stdout, stderr, exitCode: code ?? 0 })`, so callers decide whether a nonzero exit is an error [E: packages/agent/src/harness/env/nodejs.ts:488] [E: packages/agent/src/harness/env/nodejs.ts:501]。
- `cleanup()` iterates `activeChildPids`, calls `killProcessTree` for each pid, then clears the set [E: packages/agent/src/harness/env/nodejs.ts:697] [E: packages/agent/src/harness/env/nodejs.ts:698] [E: packages/agent/src/harness/env/nodejs.ts:699]。
...
- `createTempFile(options)` currently accepts only prefix/suffix at the implementation signature and does not read an abort signal field in this implementation [E: packages/agent/src/harness/env/nodejs.ts:685] [E: packages/agent/src/harness/env/nodejs.ts:688] [E: packages/agent/src/harness/env/nodejs.ts:690]。
