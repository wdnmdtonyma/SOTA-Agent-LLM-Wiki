...
| `qwen-token-plan-individual` | `QWEN_TOKEN_PLAN_API_KEY`（与 `qwen-token-plan` 共享，不是独立密钥） | [E: packages/ai/src/env-api-keys.ts:83] [E: packages/ai/src/providers/qwen-token-plan-individual.ts:8] [E: packages/ai/src/providers/qwen-token-plan-individual.ts:11] |
| `openai` | `OPENAI_API_KEY` | [E: packages/ai/src/env-api-keys.ts:84] |
| `azure-openai-responses` | `AZURE_OPENAI_API_KEY` | [E: packages/ai/src/env-api-keys.ts:85] |
| `nvidia` | `NVIDIA_API_KEY` | [E: packages/ai/src/env-api-keys.ts:86] |
| `deepseek` | `DEEPSEEK_API_KEY` | [E: packages/ai/src/env-api-keys.ts:87] |
| `google` | `GEMINI_API_KEY` | [E: packages/ai/src/env-api-keys.ts:88] |
| `google-vertex` | `GOOGLE_CLOUD_API_KEY` | [E: packages/ai/src/env-api-keys.ts:89] |
