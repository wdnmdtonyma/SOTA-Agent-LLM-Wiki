...
`packages/ai/src/models.generated.ts` 是文字模型静态目录的 aggregator：它 import 38 个 `providers/<id>.models.ts` catalog，并把它们挂到 `MODELS` 的 provider key 下；本轮新增 `BASETEN_MODELS`。[E: packages/ai/src/models.generated.ts:4] [E: packages/ai/src/models.generated.ts:8] [E: packages/ai/src/models.generated.ts:44] [E: packages/ai/src/models.generated.ts:49] [E: packages/ai/src/models.generated.ts:83] 每个 shard 现在只 import ignored `./data/<provider>.json`，再由 `ModelCatalog` / `flattenModelCatalog()` 提供 typed flattening；model value 不再内联于 TypeScript source [E: packages/ai/src/providers/baseten.models.ts:4] [E: packages/ai/src/providers/baseten.models.ts:7] [E: packages/ai/src/model-catalog.ts:15] [E: packages/ai/src/model-catalog.ts:22]。
...
- `packages/ai/src/models.generated.ts`: generated `MODELS` aggregator，当前把 38 个 provider id 映射到 per-provider model catalog constant [E: packages/ai/src/models.generated.ts:44] [E: packages/ai/src/models.generated.ts:83] [I]。
...
- `packages/ai/src/types.ts`: `Model<TApi>` 的字段 contract, 包括 `api`、`provider`、`cost`、context/token limits 和 optional compat/header fields [E: packages/ai/src/types.ts:794] [E: packages/ai/src/types.ts:797] [E: packages/ai/src/types.ts:798] [E: packages/ai/src/types.ts:384] [E: packages/ai/src/types.ts:808] [E: packages/ai/src/types.ts:809] [E: packages/ai/src/types.ts:812] [E: packages/ai/src/types.ts:814]。
...
`Model<TApi>` 的核心字段把一个模型绑定到协议和 provider ownership: `api` 是 wire API key, `provider` 是 owning provider id, `baseUrl` 是 request base URL, `reasoning` 标识 reasoning capability, `input` 列出 text/image 输入 modality, `cost` 记录基础 input/output/cacheRead/cacheWrite 单价并可带 request-wide `tiers`, `contextWindow` 与 `maxTokens` 记录上下文和输出 token limit [E: packages/ai/src/types.ts:776] [E: packages/ai/src/types.ts:783] [E: packages/ai/src/types.ts:788] [E: packages/ai/src/types.ts:790] [E: packages/ai/src/types.ts:794] [E: packages/ai/src/types.ts:807] [E: packages/ai/src/types.ts:808] [E: packages/ai/src/types.ts:809]。
...
1. Catalog generation: `generate-models.ts` 为每个排序 provider 写一个只 import JSON data 的 structural shard，再生成带显式 readonly provider mapping 的 aggregator；data directory 通过 staging/rename 原子替换并调用 validator [E: packages/ai/scripts/generate-models.ts:2852] [E: packages/ai/scripts/generate-models.ts:2859] [E: packages/ai/scripts/generate-models.ts:2873] [E: packages/ai/scripts/generate-models.ts:2890] [E: packages/ai/scripts/generate-models.ts:2894]。
...
6. Runtime refresh: `ModelsImpl.refresh(options)` selects every provider exposing `refreshModels`, runs them concurrently with `Promise.all()`, and gives each hook a credential plus provider-scoped `ModelsStore` adapter [E: packages/ai/src/models.ts:386] [E: packages/ai/src/models.ts:392] [E: packages/ai/src/models.ts:283] [E: packages/ai/src/models.ts:287] [E: packages/ai/src/models.ts:294] [E: packages/ai/src/models.ts:376]。Each task catches its own failure into the result's `errors` map and retries the same hook with `allowNetwork: false` to restore cached models best-effort, so one provider failure is reported without rejecting the aggregate refresh [E: packages/ai/src/models.ts:422] [E: packages/ai/src/models.ts:376] [E: packages/ai/src/models.ts:326]。
...
8. Reasoning metadata generation: generator 先按 `provider:id` 记录 models.dev 的 `reasoning_options`，再只为直接支持 effort 的 adapter 合并 `thinkingLevelMap`：Anthropic 需 adaptive thinking；OpenAI Responses、Azure Responses、Codex Responses 直接支持；Completions 需 compat 同时满足 OpenAI thinking format 与 reasoning effort。[E: packages/ai/scripts/generate-models.ts:466] [E: packages/ai/scripts/generate-models.ts:472] [E: packages/ai/scripts/generate-models.ts:474] [E: packages/ai/scripts/generate-models.ts:478] [E: packages/ai/scripts/generate-models.ts:479] [E: packages/ai/scripts/generate-models.ts:481] [E: packages/ai/scripts/generate-models.ts:483] [E: packages/ai/scripts/generate-models.ts:487] [E: packages/ai/scripts/generate-models.ts:493] [E: packages/ai/scripts/generate-models.ts:496] [E: packages/ai/scripts/generate-models.ts:500] [E: packages/ai/scripts/generate-models.ts:2749] [E: packages/ai/scripts/generate-models.ts:2751]
...
- `models.generated.ts`、provider `.models.ts` 与 ignored `providers/data/*.json` 是同一次生成的耦合输出；`build:offline` 会先校验 data manifest，再把 data 复制到 dist [E: packages/ai/package.json:52] [E: packages/ai/package.json:56] [E: packages/ai/package.json:58] [E: packages/ai/scripts/generate-models.ts:2890] [I]。
...
本次 `a8ee03b815 → c1019d9202` follow-up 明确修改 `models.generated.ts` 并新增 `baseten.models.ts` structural shard，使 membership 从 37 增至 38 个静态 bucket；Baseten generator 再为非 deprecated rows 生成 reasoning compat 与 `openai-completions` metadata。[E: packages/ai/src/models.generated.ts:8] [E: packages/ai/src/models.generated.ts:49] [E: packages/ai/src/models.generated.ts:89] [E: packages/ai/src/providers/baseten.models.ts:4] [E: packages/ai/src/providers/baseten.models.ts:7] [E: packages/ai/scripts/generate-models.ts:1136] [E: packages/ai/scripts/generate-models.ts:1185] [E: packages/ai/scripts/generate-models.ts:1221]

Generator 会读取 models.dev、OpenRouter、Vercel 与 NVIDIA 等远端目录，ignored `providers/data/*.json` 不在 target tree；因此今天在同一 commit 重跑 generator 可以得到不同 snapshot。Baseten 特别从 models.dev response 的 `data.baseten` 取所有非 deprecated rows，不要求 `tool_call` flag，再统一生成 `openai-completions` models。[E: packages/ai/scripts/generate-models.ts:1136] [E: packages/ai/scripts/generate-models.ts:1184] [E: packages/ai/scripts/generate-models.ts:1185] [E: packages/ai/scripts/generate-models.ts:1206] [E: packages/ai/scripts/generate-models.ts:1209] [E: packages/ai/scripts/generate-models.ts:1210] [E: packages/ai/scripts/generate-models.ts:1311] [E: packages/ai/scripts/generate-models.ts:1313] [E: packages/ai/scripts/generate-models.ts:1830] [I] 目标模型数必须绑定官方 artifact 与带 hash 的远端快照，不能仅由 aggregator 的 38 个 key 推导 model row 数。
...
[ref.ai.model-catalog](../../reference/model-catalog.md) should enumerate generated model rows; this node documents the mechanics around the generated catalog, not every model id or provider-specific model capability row [E: packages/ai/src/models.generated.ts:44] [E: packages/ai/src/models.generated.ts:123] [I]。
