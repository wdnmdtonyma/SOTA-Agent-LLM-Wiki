...
`stream` 是该 wire adapter 的权威入口:它同步返回 `AssistantMessageEventStream`,在内部异步初始化 `AssistantMessage` 输出骨架、client、params、request options,再调用 `client.beta.messages.create(params, requestOptions).asResponse()`。[E: packages/ai/src/api/anthropic-messages.ts:502] [E: packages/ai/src/api/anthropic-messages.ts:507] [E: packages/ai/src/api/anthropic-messages.ts:511] [E: packages/ai/src/api/anthropic-messages.ts:566] [E: packages/ai/src/api/anthropic-messages.ts:571] [E: packages/ai/src/api/anthropic-messages.ts:577]
...
`buildParams` 先调用 `transformMessages(context.messages, model, normalizeToolCallId)` 再把结果交给 `convertMessages`;因此 Anthropic adapter 在 wire serialization 前复用跨 provider 的 message normalization;`normalizeToolCallId` 会把非 `[A-Za-z0-9_-]` 字符替换为 `_`,并截断到 64 字符。[E: packages/ai/src/api/anthropic-messages.ts:1029] [E: packages/ai/src/api/anthropic-messages.ts:1043] [E: packages/ai/src/api/anthropic-messages.ts:1180] [E: packages/ai/src/api/anthropic-messages.ts:1223]
...
assistant message 会把非空 text 写为 Anthropic `text`,redacted thinking 写回 `redacted_thinking`,带 signature 的 thinking 写回 `thinking`,缺 signature 的 thinking 默认降级成 plain text,但 `allowEmptySignature` compat 可保留空 signature thinking block。[E: packages/ai/src/api/anthropic-messages.ts:1277] [E: packages/ai/src/api/anthropic-messages.ts:1281] [E: packages/ai/src/api/anthropic-messages.ts:1284] [E: packages/ai/src/api/anthropic-messages.ts:1289] [E: packages/ai/src/api/anthropic-messages.ts:1291] [E: packages/ai/src/api/anthropic-messages.ts:1304] [E: packages/ai/src/api/anthropic-messages.ts:1306] [E: packages/ai/src/api/anthropic-messages.ts:1311] [E: packages/ai/src/api/anthropic-messages.ts:1316]
...
`iterateSseMessages` 是本文件内的 SSE decoder:它从 `ReadableStream<Uint8Array>` 读 chunks,用 `TextDecoder` 和 line parser 累积 `event:` / `data:` 字段,遇到空行 flush 为 `ServerSentEvent`,并在 finally 中释放 reader lock。[E: packages/ai/src/api/anthropic-messages.ts:347] [E: packages/ai/src/api/anthropic-messages.ts:364] [E: packages/ai/src/api/anthropic-messages.ts:366] [E: packages/ai/src/api/anthropic-messages.ts:402] [E: packages/ai/src/api/anthropic-messages.ts:406] [E: packages/ai/src/api/anthropic-messages.ts:408] [E: packages/ai/src/api/anthropic-messages.ts:422] [E: packages/ai/src/api/anthropic-messages.ts:426] [E: packages/ai/src/api/anthropic-messages.ts:456] [E: packages/ai/src/api/anthropic-messages.ts:457]

`iterateAnthropicEvents` 只放行 Anthropic message event set,遇到 SSE `error` event 直接 throw,JSON parse 失败时把 event name、data 和 raw lines 包进错误;如果看到 `message_start` 但没有看到 `message_stop`,stream 结束后会抛出 `"Anthropic stream ended before message_stop"`。[E: packages/ai/src/api/anthropic-messages.ts:461] [E: packages/ai/src/api/anthropic-messages.ts:472] [E: packages/ai/src/api/anthropic-messages.ts:473] [E: packages/ai/src/api/anthropic-messages.ts:477] [E: packages/ai/src/api/anthropic-messages.ts:483] [E: packages/ai/src/api/anthropic-messages.ts:486] [E: packages/ai/src/api/anthropic-messages.ts:491] [E: packages/ai/src/api/anthropic-messages.ts:497] [E: packages/ai/src/api/anthropic-messages.ts:498]
...
`message_start` 把 `event.message.model` 写回 `output.model`。若返回 model 与请求 id 不同，adapter 在 `allowedFallbackModels` 里找同 provider 的 cost，构造 `usageModel = { ...model, id: output.model, cost: fallbackCost }`，再在 `message_start` / `message_delta` 用 **returned model** 计价 [E: packages/ai/src/api/anthropic-messages.ts:533] [E: packages/ai/src/api/anthropic-messages.ts:595] [E: packages/ai/src/api/anthropic-messages.ts:602] [E: packages/ai/src/api/anthropic-messages.ts:613] [E: packages/ai/src/api/anthropic-messages.ts:775]。adapter 用 input + output + cacheRead + cacheWrite 计算 `usage.totalTokens`;1h cache creation token 会额外写入 `cacheWrite1h`。[E: packages/ai/src/api/anthropic-messages.ts:609] [E: packages/ai/src/api/anthropic-messages.ts:611] [E: packages/ai/src/api/anthropic-messages.ts:612]
...
fine-grained tool streaming beta 只在有 tools 且 compat 不支持 eager tool input streaming 时启用;interleaved thinking beta 在调用方允许且 model 不是 force-adaptive thinking 时加入 beta header。[E: packages/ai/src/api/anthropic-messages.ts:1421] [E: packages/ai/src/api/anthropic-messages.ts:1422] [E: packages/ai/src/api/anthropic-messages.ts:1005] [E: packages/ai/src/api/anthropic-messages.ts:1006] [E: packages/ai/src/api/anthropic-messages.ts:1012]
