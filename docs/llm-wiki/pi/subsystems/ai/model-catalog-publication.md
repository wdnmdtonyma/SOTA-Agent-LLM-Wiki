...
`generate-models.ts` 的 CLI 明确区分 `strict`、`jsonOnly`、`jsonOutputDir` 与 `pretty`，并拒绝没有 output directory 的 `--json-only` [E: packages/ai/scripts/generate-models.ts:36] [E: packages/ai/scripts/generate-models.ts:51] [E: packages/ai/scripts/generate-models.ts:59] [E: packages/ai/scripts/generate-models.ts:67] [E: packages/ai/scripts/generate-models.ts:76]。

JSON output directory 被重建后包含三层：聚合 `models.json`、排序的 `providers.json`、以及 `providers/<provider>.json` shards [E: packages/ai/scripts/generate-models.ts:2914] [E: packages/ai/scripts/generate-models.ts:2918] [E: packages/ai/scripts/generate-models.ts:2919] [E: packages/ai/scripts/generate-models.ts:2920]。普通 package build 还生成只保留类型结构的 `.models.ts` 与 gitignored adjacent JSON values；两者来自同一 provider data，但输出位置和消费方不同 [E: packages/ai/scripts/generate-models.ts:2859] [E: packages/ai/scripts/generate-models.ts:2861] [E: packages/ai/scripts/generate-models.ts:2890]。
...
- 本轮目标 tree 不包含 ignored model JSON；可复现的 membership 证据必须组合 publication/npm artifact 与带时间/hash 的 generator 输入。官方 v0.83.0 artifact 的 registry `gitHead=845d6ff1f6643aba440341cce877ce1c43ebbc39` 是 target 祖先，flatten count 为 1,153；target 又新增 Baseten structural shard，审计时 models.dev snapshot 经 deprecated filter 得到 16 rows，因此当前 1,169 仍只能标 `[I]`，不能标成 target checkout 内显式 `[E]`。[E: packages/ai/scripts/generate-models.ts:1136] [E: packages/ai/scripts/generate-models.ts:1184] [E: packages/ai/scripts/generate-models.ts:1185]
