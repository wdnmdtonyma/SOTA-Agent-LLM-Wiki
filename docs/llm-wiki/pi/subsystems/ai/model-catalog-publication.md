...
JSON output directory 被重建后包含三层：聚合 `models.json`、排序的 `providers.json`、以及 `providers/<provider>.json` shards [E: packages/ai/scripts/generate-models.ts:3049] [E: packages/ai/scripts/generate-models.ts:3053] [E: packages/ai/scripts/generate-models.ts:3054] [E: packages/ai/scripts/generate-models.ts:3056]。普通 package build 还生成只保留类型结构的 `.models.ts` 与 gitignored adjacent JSON values；两者来自同一 provider data，但输出位置和消费方不同 [E: packages/ai/scripts/generate-models.ts:2996] [E: packages/ai/scripts/generate-models.ts:2999] [E: packages/ai/scripts/generate-models.ts:3021]。
...
- 本轮目标 tree 仍不包含 ignored model JSON；可复现的 membership 证据必须组合 publication/npm artifact 与带时间/hash 的 generator 输入。structural bucket 仍是 39，flattened model count 不能从 checkout 标成 `[E]`。[E: packages/ai/scripts/generate-models.ts:2996] [E: packages/ai/scripts/generate-models.ts:3021] [I]
