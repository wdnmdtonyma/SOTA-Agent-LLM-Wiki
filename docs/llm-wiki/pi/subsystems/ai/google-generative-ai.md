...
assistant `toolCall` block 会变成 Gemini `functionCall` part,包括 `name`、`args`,并在 `requiresToolCallId(model.id)` 为真时携带 `id`;当前代码对 `claude-`、`gpt-oss-` 前缀以及 Gemini major>=3(含 `gemini-live-N`)要求显式 tool call id。[E: packages/ai/src/api/google-shared.ts:105][E: packages/ai/src/api/google-shared.ts:107][E: packages/ai/src/api/google-shared.ts:108][E: packages/ai/src/api/google-shared.ts:109][E: packages/ai/src/api/google-shared.ts:110][E: packages/ai/src/api/google-shared.ts:114][E: packages/ai/src/api/google-shared.ts:115][E: packages/ai/src/api/google-shared.ts:203][E: packages/ai/src/api/google-shared.ts:206][E: packages/ai/src/api/google-shared.ts:207][E: packages/ai/src/api/google-shared.ts:208][E: packages/ai/src/api/google-shared.ts:209]
...
当存在工具时,`buildParams` 用 `resolveGoogleFunctionCallingMode(tools, toolChoice, supportsStrictMode)` 决定 mode:任意 tool 使用 strict sampling 时即使 `toolChoice` 缺失或 `auto` 也会得到 `VALIDATED`;只有 mode 非 `undefined` 才写入 `config.toolConfig`。Vertex 同样调用 `resolveGoogleFunctionCallingMode`,不直接 import/call `mapToolChoice`。[E: packages/ai/src/api/google-generative-ai.ts:374][E: packages/ai/src/api/google-generative-ai.ts:375][E: packages/ai/src/api/google-generative-ai.ts:376][E: packages/ai/src/api/google-generative-ai.ts:385][E: packages/ai/src/api/google-generative-ai.ts:386][E: packages/ai/src/api/google-shared.ts:361][E: packages/ai/src/api/google-shared.ts:366][E: packages/ai/src/api/google-shared.ts:370][E: packages/ai/src/api/google-shared.ts:371][E: packages/ai/src/api/google-shared.ts:373][E: packages/ai/src/api/google-vertex.ts:38][E: packages/ai/src/api/google-vertex.ts:474][E: packages/ai/src/api/google-vertex.ts:475]
...
两者共享 message/tool/stop-reason 转换入口,因为 Vertex 也导入同一组 shared helpers,并在 `buildParams` 中调用 `convertMessages`、`convertTools`、`resolveGoogleFunctionCallingMode`。[E: packages/ai/src/api/google-vertex.ts:33][E: packages/ai/src/api/google-vertex.ts:34][E: packages/ai/src/api/google-vertex.ts:35][E: packages/ai/src/api/google-vertex.ts:38][E: packages/ai/src/api/google-vertex.ts:458][E: packages/ai/src/api/google-vertex.ts:463][E: packages/ai/src/api/google-vertex.ts:475][E: packages/ai/src/api/google-vertex.ts:479]
