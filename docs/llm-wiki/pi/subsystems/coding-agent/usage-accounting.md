...
> 会话统计现在归集 assistant、tool result、compaction 和 branch summary 的 usage；交互式 `/session` UI 可按模型与“Tools/summaries”分桶展示成本。[E: packages/coding-agent/src/modes/interactive/interactive-mode.ts:5634] [E: packages/coding-agent/src/modes/interactive/interactive-mode.ts:5643] [E: packages/coding-agent/src/modes/interactive/interactive-mode.ts:5674] [E: packages/coding-agent/src/modes/interactive/interactive-mode.ts:5677]
...
usage 已进入持久化 entry contract：`CompactionEntry` 与 `BranchSummaryEntry` 都有 optional usage；extension 的 tool-result patch、compact result 与 tree summary override 也可返回 usage。[E: packages/agent/src/harness/types.ts:403] [E: packages/agent/src/harness/types.ts:410] [E: packages/agent/src/harness/types.ts:414] [E: packages/agent/src/harness/types.ts:419] [E: packages/agent/src/harness/types.ts:768] [E: packages/agent/src/harness/types.ts:772] [E: packages/agent/src/harness/types.ts:781] [E: packages/agent/src/harness/types.ts:787] [E: packages/agent/src/harness/types.ts:828] [E: packages/agent/src/harness/types.ts:833]

tool usage 的 carrier chain 是 `AgentToolResult.usage` → `afterToolCall` 保留或覆盖 → `ToolResultMessage.usage` → session message entry；源码不会另行估算缺失的 tool usage。[E: packages/agent/src/types.ts:355] [E: packages/agent/src/types.ts:361] [E: packages/agent/src/agent-loop.ts:720] [E: packages/agent/src/agent-loop.ts:738] [E: packages/agent/src/agent-loop.ts:773] [E: packages/agent/src/agent-loop.ts:782] [E: packages/coding-agent/src/core/agent-session.ts:625] [E: packages/coding-agent/src/core/agent-session.ts:641]

branch summarization 的 provider usage 或 extension-supplied usage 会进入随后持久化的 summary entry。[E: packages/coding-agent/src/core/agent-session.ts:2998] [E: packages/coding-agent/src/core/agent-session.ts:2999] [E: packages/coding-agent/src/core/agent-session.ts:3004] [E: packages/coding-agent/src/core/agent-session.ts:3007] [E: packages/coding-agent/src/core/agent-session.ts:3032] [E: packages/coding-agent/src/core/agent-session.ts:3037]

`getSessionStats()` 遍历 `sessionManager.getEntries()` 的完整集合，把 summary entries、tool-result messages 与 assistant messages 的 usage 累加；因此 totals 反映整个会话实际记账，包括已从 active context 压缩掉的历史，而不是只统计当前 branch context。[E: packages/coding-agent/src/core/agent-session.ts:3104] [E: packages/coding-agent/src/core/agent-session.ts:3112] [E: packages/coding-agent/src/core/agent-session.ts:3113] [E: packages/coding-agent/src/core/agent-session.ts:3121] [E: packages/coding-agent/src/core/agent-session.ts:3123] [E: packages/coding-agent/src/core/agent-session.ts:3126] [E: packages/coding-agent/src/core/agent-session.ts:3132] [E: packages/coding-agent/src/core/agent-session.ts:3136] [E: packages/coding-agent/src/core/agent-session.ts:3151]
