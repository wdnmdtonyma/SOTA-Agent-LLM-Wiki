...
9. Legacy table lookup `LEGACY_SEQUENCE_KEY_IDS[data]` 覆盖 named arrows、Home/End、insert/delete/page、F keys 等。命中后直接 return。未命中时后面还有大量 multi-byte 分支（escape、tab、`\r`/`\n`/`\x1bOM` enter、shift+tab、alt+enter/space/backspace、CSI arrows 等），然后才是 1..26 / printable 单字节 map。[E: packages/tui/src/keys.ts:1270] [E: packages/tui/src/keys.ts:1271] [E: packages/tui/src/keys.ts:1274] [E: packages/tui/src/keys.ts:1282] [E: packages/tui/src/keys.ts:1283]
