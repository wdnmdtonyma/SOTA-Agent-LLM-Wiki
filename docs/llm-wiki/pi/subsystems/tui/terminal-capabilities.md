...
Kitty negotiation 使用 "request desired flags + query flags + DA sentinel" 的 progressive enhancement pattern: query 常量发送 desired flags、当前 flags query 和 DA query;收到 DA 且 Kitty 还未 active 时会启用 `modifyOtherKeys` fallback [E: packages/tui/src/terminal.ts:17] [E: packages/tui/src/terminal.ts:252] [E: packages/tui/src/terminal.ts:273] [E: packages/tui/src/terminal.ts:274] [I]。
