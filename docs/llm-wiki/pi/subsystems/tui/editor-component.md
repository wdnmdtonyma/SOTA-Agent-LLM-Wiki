...
4. `handleInput@packages/tui/src/components/editor.ts:591` 是 raw terminal input dispatcher: 它先处理 jump mode、bracketed paste、copy/undo/autocomplete mode, 再按 keybinding 分发 deletion、kill/yank、dedicated history browse、cursor movement、newline、submit、page scroll、character jump 和 printable insertion。[E: packages/tui/src/components/editor.ts:603][E: packages/tui/src/components/editor.ts:607][E: packages/tui/src/components/editor.ts:628][E: packages/tui/src/components/editor.ts:654][E: packages/tui/src/components/editor.ts:659][E: packages/tui/src/components/editor.ts:665][E: packages/tui/src/components/editor.ts:732][E: packages/tui/src/components/editor.ts:758][E: packages/tui/src/components/editor.ts:768][E: packages/tui/src/components/editor.ts:773][E: packages/tui/src/components/editor.ts:780][E: packages/tui/src/components/editor.ts:798][E: packages/tui/src/components/editor.ts:816][E: packages/tui/src/components/editor.ts:868][E: packages/tui/src/components/editor.ts:878][E: packages/tui/src/components/editor.ts:893]
...
6. `setText@packages/tui/src/components/editor.ts:998` 是 programmatic replace path: 它取消 autocomplete、退出 history browsing、normalize line endings/tabs, 如果内容变化则压入 undo snapshot, 然后经 `setTextInternal()` 更新状态并触发 `onChange`。[E: packages/tui/src/components/editor.ts:1022][E: packages/tui/src/components/editor.ts:1023][E: packages/tui/src/components/editor.ts:1025][E: packages/tui/src/components/editor.ts:1026][E: packages/tui/src/components/editor.ts:1028][E: packages/tui/src/components/editor.ts:1029][E: packages/tui/src/components/editor.ts:1033][E: packages/tui/src/components/editor.ts:1055][E: packages/tui/src/components/editor.ts:1056]
...
8. `requestAutocomplete@packages/tui/src/components/editor.ts:2121` 取消旧请求并生成 start token; 非 explicit tab/force 场景可按 trigger pattern 使用 20ms debounce, 请求执行时串行等待 previous task, 使用 `AbortController` 和 snapshot 校验丢弃 stale result。[E: packages/tui/src/components/editor.ts:2177][E: packages/tui/src/components/editor.ts:2193][E: packages/tui/src/components/editor.ts:2194][E: packages/tui/src/components/editor.ts:2196][E: packages/tui/src/components/editor.ts:2198][E: packages/tui/src/components/editor.ts:2212][E: packages/tui/src/components/editor.ts:2214][E: packages/tui/src/components/editor.ts:2219][E: packages/tui/src/components/editor.ts:2222][E: packages/tui/src/components/editor.ts:2271][E: packages/tui/src/components/editor.ts:2313]
