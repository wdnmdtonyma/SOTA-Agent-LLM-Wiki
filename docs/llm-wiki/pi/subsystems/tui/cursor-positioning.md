...
main-screen 在 overlay 合成后、line reset与 diff 前提取 marker。[E: packages/tui/src/tui-main-screen.ts:271] [E: packages/tui/src/tui-main-screen.ts:273] 它同时维护内容末尾的 `cursorRow` 与 terminal 实际位置 `hardwareCursorRow`，因为 IME 定位会让两者分离。[E: packages/tui/src/tui-main-screen.ts:129] [E: packages/tui/src/tui-main-screen.ts:130]

`positionHardwareCursor()` 没有 marker 时隐藏 cursor；有 marker 时从当前 hardware row 做相对上下移动，再用 1-indexed absolute column 定位，最后按 runtime setting show/hide cursor。[E: packages/tui/src/tui-main-screen.ts:622] [E: packages/tui/src/tui-main-screen.ts:623] [E: packages/tui/src/tui-main-screen.ts:633] [E: packages/tui/src/tui-main-screen.ts:641] [E: packages/tui/src/tui-main-screen.ts:648]

即使文本行没有变化，main-screen 仍调用该定位函数，所以只有 marker 移动也能更新 IME 光标。[E: packages/tui/src/tui-main-screen.ts:391] [E: packages/tui/src/tui-main-screen.ts:392]
...
alternate-screen 在 overlay/selection/flash 合成后提取 marker，并在同一个 synchronized frame buffer 中写绝对 `row;col H`；column 会 clamp 到 viewport width。[E: packages/tui/src/tui-alt-screen.ts:1321] [E: packages/tui/src/tui-alt-screen.ts:1326] [E: packages/tui/src/tui-alt-screen.ts:1345] [E: packages/tui/src/tui-alt-screen.ts:1364] [E: packages/tui/src/tui-alt-screen.ts:1365]
...
- main-screen 的 target column只做非负 clamp，fullscreen 额外 clamp 到 viewport width；两种 renderer 的边界行为不同。[E: packages/tui/src/tui-main-screen.ts:630] [E: packages/tui/src/tui-alt-screen.ts:1365]
