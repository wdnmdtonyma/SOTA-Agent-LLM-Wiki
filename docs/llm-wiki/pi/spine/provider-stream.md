...
9. 具体 wire module 的 `streamSimple` 会把统一 `reasoning` 收窄成 provider-specific options:OpenAI Responses/Completions clamp 后传 `reasoningEffort`,Anthropic 无 reasoning 时显式禁用 thinking,adaptive thinking 时传 `effort`,非 adaptive thinking 时计算 `thinkingBudgetTokens`。[E: packages/ai/src/api/openai-responses.ts:206][E: packages/ai/src/api/openai-responses.ts:209][E: packages/ai/src/api/openai-responses.ts:210][E: packages/ai/src/api/openai-responses.ts:212][E: packages/ai/src/api/openai-responses.ts:214][E: packages/ai/src/api/openai-completions.ts:729][E: packages/ai/src/api/openai-completions.ts:732][E: packages/ai/src/api/openai-completions.ts:733][E: packages/ai/src/api/openai-completions.ts:735][E: packages/ai/src/api/openai-completions.ts:737][E: packages/ai/src/api/anthropic-messages.ts:833][E: packages/ai/src/api/anthropic-messages.ts:836][E: packages/ai/src/api/anthropic-messages.ts:837][E: packages/ai/src/api/anthropic-messages.ts:845][E: packages/ai/src/api/anthropic-messages.ts:846][E: packages/ai/src/api/anthropic-messages.ts:849][E: packages/ai/src/api/anthropic-messages.ts:850][E: packages/ai/src/api/anthropic-messages.ts:856][E: packages/ai/src/api/anthropic-messages.ts:863][E: packages/ai/src/api/anthropic-messages.ts:865][E: packages/ai/src/api/anthropic-messages.ts:868][E: packages/ai/src/api/anthropic-messages.ts:869]
...
多个 wire builders 在生成 provider payload 前显式调用 `transformMessages`,但传入的 tool-call id normalizer 按 API 约束不同:OpenAI Responses 处理 `callId|itemId` 并确保 item id 以 `fc_` 开头,OpenAI Completions 提取/截断 call id,Anthropic 把 id 限定为字母数字 `_` `-` 且最多 64 字符。[E: packages/ai/src/api/openai-responses-shared.ts:159][E: packages/ai/src/api/openai-responses-shared.ts:162][E: packages/ai/src/api/openai-responses-shared.ts:164][E: packages/ai/src/api/openai-responses-shared.ts:166][E: packages/ai/src/api/openai-responses-shared.ts:167][E: packages/ai/src/api/openai-responses-shared.ts:169][E: packages/ai/src/api/openai-responses-shared.ts:172][E: packages/ai/src/api/openai-completions.ts:1185][E: packages/ai/src/api/openai-completions.ts:1187][E: packages/ai/src/api/openai-completions.ts:1188][E: packages/ai/src/api/openai-completions.ts:1199][E: packages/ai/src/api/openai-completions.ts:1200][E: packages/ai/src/api/openai-completions.ts:1203][E: packages/ai/src/api/anthropic-messages.ts:1116][E: packages/ai/src/api/anthropic-messages.ts:1117][E: packages/ai/src/api/anthropic-messages.ts:981]
...
`AssistantMessageEvent` 类型把 normalized stream 限定为 start/text/thinking/toolcall/done/error 事件集合,其中 `done` 携带 final `message`,`error` 携带 final `error`;`StreamFunction` contract 的返回类型同样是 `AssistantMessageEventStream`。[E: packages/ai/src/types.ts:535][E: packages/ai/src/types.ts:536][E: packages/ai/src/types.ts:538][E: packages/ai/src/types.ts:541][E: packages/ai/src/types.ts:545][E: packages/ai/src/types.ts:524][E: packages/ai/src/types.ts:551][E: packages/ai/src/types.ts:332][E: packages/ai/src/types.ts:333][E: packages/ai/src/types.ts:336]

OpenAI Responses wire implementation 先创建 `AssistantMessageEventStream`,HTTP stream 建立后 push `start`,再由 `processResponsesStream` 将 Responses output item / delta / done events 归一为 `thinking_*`、`text_*`、`toolcall_*`,最后按 final `output.stopReason` push `done` 或 catch 中 push `error`。[E: packages/ai/src/api/openai-responses.ts:108][E: packages/ai/src/api/openai-responses.ts:152][E: packages/ai/src/api/openai-responses.ts:160][E: packages/ai/src/api/openai-responses.ts:162][E: packages/ai/src/api/openai-responses.ts:179][E: packages/ai/src/api/openai-responses.ts:190][E: packages/ai/src/api/openai-responses-shared.ts:463][E: packages/ai/src/api/openai-responses-shared.ts:473][E: packages/ai/src/api/openai-responses-shared.ts:482][E: packages/ai/src/api/openai-responses-shared.ts:525][E: packages/ai/src/api/openai-responses-shared.ts:606][E: packages/ai/src/api/openai-responses-shared.ts:636][E: packages/ai/src/api/openai-responses-shared.ts:456][E: packages/ai/src/api/openai-responses-shared.ts:691][E: packages/ai/src/api/openai-responses-shared.ts:701][E: packages/ai/src/api/openai-responses-shared.ts:718]

Anthropic Messages wire implementation 同样创建 `AssistantMessageEventStream`,在 `messages.create(...stream: true)` 后 push `start`,再把 Anthropic `content_block_start` 映射到 text/thinking/toolcall start,`content_block_delta` 映射到 text/thinking/toolcall delta,`content_block_stop` 映射到 corresponding end,最后 push `done` 或 catch 中 push `error`。[E: packages/ai/src/api/anthropic-messages.ts:506][E: packages/ai/src/api/anthropic-messages.ts:576][E: packages/ai/src/api/anthropic-messages.ts:584][E: packages/ai/src/api/anthropic-messages.ts:611][E: packages/ai/src/api/anthropic-messages.ts:619][E: packages/ai/src/api/anthropic-messages.ts:628][E: packages/ai/src/api/anthropic-messages.ts:651][E: packages/ai/src/api/anthropic-messages.ts:653][E: packages/ai/src/api/anthropic-messages.ts:659][E: packages/ai/src/api/anthropic-messages.ts:671][E: packages/ai/src/api/anthropic-messages.ts:684][E: packages/ai/src/api/anthropic-messages.ts:699][E: packages/ai/src/api/anthropic-messages.ts:705][E: packages/ai/src/api/anthropic-messages.ts:712][E: packages/ai/src/api/anthropic-messages.ts:723][E: packages/ai/src/api/anthropic-messages.ts:782][E: packages/ai/src/api/anthropic-messages.ts:792]
...
- `transformMessages` 是 replay compatibility layer,不是 wire serializer:它返回仍然是 `Message[]`。[E: packages/ai/src/api/transform-messages.ts:64][E: packages/ai/src/api/transform-messages.ts:222] provider-specific builders 再把这些 message 转成 Responses `input`、Chat Completions `messages` 或 Anthropic `messages` payload shape。[E: packages/ai/src/api/openai-responses.ts:263][E: packages/ai/src/api/openai-responses.ts:278][E: packages/ai/src/api/openai-responses.ts:290][E: packages/ai/src/api/openai-responses.ts:292][E: packages/ai/src/api/openai-completions.ts:798][E: packages/ai/src/api/openai-completions.ts:801][E: packages/ai/src/api/openai-completions.ts:803][E: packages/ai/src/api/anthropic-messages.ts:995][E: packages/ai/src/api/anthropic-messages.ts:963]
