...
V1 registry 的内置工具顺序是 invalid、可选 question、shell、read、glob、grep、edit、write、task、fetch/webfetch、todo/todowrite、search/websearch、skill、patch/apply_patch、可选 `execute`、可选 lsp、可选 plan。[E: packages/opencode/src/tool/registry.ts:227] [E: packages/opencode/src/tool/registry.ts:241] [E: packages/opencode/src/tool/registry.ts:243] V1 materialization 还会按 provider/model 过滤：websearch 受 provider/Exa/Parallel flags 控制，GPT 非 OSS 且非 GPT-4 model 使用 `apply_patch` 并隐藏 `edit/write`。[E: packages/opencode/src/tool/registry.ts:288] [E: packages/opencode/src/tool/registry.ts:292] [E: packages/opencode/src/tool/registry.ts:294] [E: packages/opencode/src/tool/registry.ts:295]
...
| --- | --- | --- |
| file read/list/media | `read` built-in active。[E: packages/opencode/src/tool/registry.ts:231] | `read` built-in active via built-in tools node。[E: packages/core/src/tool/builtins.ts:41] |
...
| write | `write` active but hidden when patch is selected for certain GPT models。[E: packages/opencode/src/tool/registry.ts:295] | `write` active via built-in tools node。[E: packages/core/src/tool/builtins.ts:46] |
...
| task/subagent | Active in V1 built-ins。[E: packages/opencode/src/tool/registry.ts:236] | Not in current V2 built-in deps list。[I] |
| CodeMode/MCP orchestration | `execute` 在实验 CodeMode flag 下注册；启用时 session tool assembly 不再把每个 MCP tool 作为独立 wire tool 追加，MCP catalog 改由 `execute` description 与 confined runtime 暴露。[E: packages/opencode/src/tool/registry.ts:113] [E: packages/opencode/src/tool/registry.ts:241] [E: packages/opencode/src/session/tools.ts:388] [E: packages/opencode/src/session/tools.ts:390] | Not in current V2 built-in deps list。[I] |
| LSP | Experimental V1 built-in.[E: packages/opencode/src/tool/registry.ts:243] | Not in current V2 built-in deps list。[I] |
| plan exit | Experimental CLI-only V1 built-in.[E: packages/opencode/src/tool/registry.ts:243] | Not in current V2 built-in deps list。[I] |
| plugin/MCP dynamic tools | V1 registry imports plugin tools from `.opencode/{tool,tools}` and service hooks。[E: packages/opencode/src/tool/registry.ts:179] [E: packages/opencode/src/tool/registry.ts:195] | V2 MCP/plugin canonical registration is outside the current static built-in deps list。[I] |
