...
V1 registry 的内置工具顺序是 invalid、可选 question、shell、read、glob、grep、edit、write、task、fetch/webfetch、todo/todowrite、search/websearch、skill、patch/apply_patch、可选 lsp、可选 plan。[E: packages/opencode/src/tool/registry.ts:219] [E: packages/opencode/src/tool/registry.ts:234] V1 materialization 还会按 provider/model 过滤：websearch 受 provider/Exa/Parallel flags 控制，GPT 非 OSS 且非 GPT-4 model 使用 `apply_patch` 并隐藏 `edit/write`。[E: packages/opencode/src/tool/registry.ts:269] [E: packages/opencode/src/tool/registry.ts:275]
...
| `plan_exit` | `plan.ts` | 空 object。[E: packages/opencode/src/tool/plan.ts:13] | 仅 `experimentalPlanMode && client === "cli"` 暴露；asks 用户是否切到 build agent。[E: packages/opencode/src/tool/registry.ts:234] [E: packages/opencode/src/tool/plan.ts:30] | 拒绝时失败；同意时创建 build agent user message。[E: packages/opencode/src/tool/plan.ts:46] [E: packages/opencode/src/tool/plan.ts:53] |

## V2

V2 built-ins 由 `BuiltInTools.node` 依赖列表合并，当前包括 `apply_patch/bash/edit/glob/grep/question/read/skill/todowrite/webfetch/websearch/write`。[E: packages/core/src/tool/builtins.ts:31] [E: packages/core/src/tool/builtins.ts:46] `task`、`LSP`、`repo_clone`、`repo_overview`、`plan_exit`、Rune/code mode、MCP/plugin canonical registration 不在当前 static built-in deps 列表内。[I]
...
| `bash` | `bash.ts` | `command`, `workdir?`, `timeout?` 默认 120000 ms 最大 600000 ms；capture output 上限 1 MiB。[E: packages/core/src/tool/bash.ts:23] [E: packages/core/src/tool/bash.ts:28] [E: packages/core/src/tool/bash.ts:19] [E: packages/core/src/tool/bash.ts:20] [E: packages/core/src/tool/bash.ts:21] | external workdir permission；command path warnings advisory；`bash` permission；用 configured shell 或 platform default。[E: packages/core/src/tool/bash.ts:125] [E: packages/core/src/tool/bash.ts:134] [E: packages/core/src/tool/bash.ts:138] [E: packages/core/src/tool/bash.ts:150] | output 含 exit/output/timeout/truncated flags；capture loss 不是 generic model-output truncation。[E: packages/core/src/tool/bash.ts:35] [E: packages/core/src/tool/bash.ts:189] |
...
| --- | --- | --- |
| file read/list/media | `read` built-in active。[E: packages/opencode/src/tool/registry.ts:223] | `read` built-in active via built-in tools node。[E: packages/core/src/tool/builtins.ts:41] |
...
| write | `write` active but hidden when patch is selected for certain GPT models。[E: packages/opencode/src/tool/registry.ts:275] | `write` active via built-in tools node。[E: packages/core/src/tool/builtins.ts:46] |
...
| task/subagent | Active in V1 built-ins。[E: packages/opencode/src/tool/registry.ts:228] | Not in current V2 built-in deps list。[I] |
| LSP | Experimental V1 built-in.[E: packages/opencode/src/tool/registry.ts:234] | Not in current V2 built-in deps list。[I] |
| plan exit | Experimental CLI-only V1 built-in.[E: packages/opencode/src/tool/registry.ts:234] | Not in current V2 built-in deps list。[I] |
| plugin/MCP dynamic tools | V1 registry imports plugin tools from `.opencode/{tool,tools}` and service hooks。[E: packages/opencode/src/tool/registry.ts:172] [E: packages/opencode/src/tool/registry.ts:188] | V2 MCP/plugin canonical registration is outside the current static built-in deps list。[I] |
