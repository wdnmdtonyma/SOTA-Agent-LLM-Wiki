...
| `GitHubCopilotProvider` | `id = "github-copilot"`；routes 是 Responses 与 Chat。[E: packages/llm/src/providers/github-copilot.ts:8] [E: packages/llm/src/providers/github-copilot.ts:27] | baseURL required；可用 `endpoint?: "chat" | "responses"` 强制路由，provider 无 canonical public URL。[E: packages/llm/src/providers/github-copilot.ts:12] [E: packages/llm/src/providers/github-copilot.ts:14] [E: packages/llm/src/providers/github-copilot.ts:15] | bearer auth 用 explicit `apiKey`。[E: packages/llm/src/providers/github-copilot.ts:40] | 给了 `endpoint` 时以它为准；未给时 GPT major >= 5 且非 `gpt-5-mini` 用 Responses，否则 Chat。[E: packages/llm/src/providers/github-copilot.ts:19] [E: packages/llm/src/providers/github-copilot.ts:20] [E: packages/llm/src/providers/github-copilot.ts:24] [E: packages/llm/src/providers/github-copilot.ts:58] [E: packages/llm/src/providers/github-copilot.ts:59] |
