...
| `DialogPrompt` | `show()` resolve string 或 null [E: packages/tui/src/ui/dialog-prompt.tsx:118] [E: packages/tui/src/ui/dialog-prompt.tsx:122] [E: packages/tui/src/ui/dialog-prompt.tsx:124] | Textarea prompt，submit 命令读取 value；busy 时给 textarea 加 `BUSY` trait 并 blur [E: packages/tui/src/ui/dialog-prompt.tsx:33] [E: packages/tui/src/ui/dialog-prompt.tsx:64] [E: packages/tui/src/ui/dialog-prompt.tsx:69]。 |
...
| `DialogExportOptions` | `show()` 返回 filename 和 export options [E: packages/tui/src/ui/dialog-export-options.tsx:190] [E: packages/tui/src/ui/dialog-export-options.tsx:198] [E: packages/tui/src/ui/dialog-export-options.tsx:203] [E: packages/tui/src/ui/dialog-export-options.tsx:213] [E: packages/tui/src/ui/dialog-export-options.tsx:217] | Tab 循环选项，Space toggle boolean，filename textarea submit 后返回 options [E: packages/tui/src/ui/dialog-export-options.tsx:38] [E: packages/tui/src/ui/dialog-export-options.tsx:102] [E: packages/tui/src/ui/dialog-export-options.tsx:107]。 |
...
| `DialogDebug` | `component/dialog-debug.tsx` | Debug info dialog，展示 version/channel、OS、terminal、session ID 和 model，Return 复制到剪贴板 [E: packages/tui/src/component/dialog-debug.tsx:13] [E: packages/tui/src/component/dialog-debug.tsx:27] [E: packages/tui/src/component/dialog-debug.tsx:50]。 |
