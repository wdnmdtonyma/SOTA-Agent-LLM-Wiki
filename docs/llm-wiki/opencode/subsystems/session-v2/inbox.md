...
| `session_message.seq` | projected message chronology follows synchronized event aggregate sequence。 | [E: packages/core/src/session/sql.ts:128][E: packages/core/src/session/projector.ts:202][E: specs/v2/session.md:175] |
