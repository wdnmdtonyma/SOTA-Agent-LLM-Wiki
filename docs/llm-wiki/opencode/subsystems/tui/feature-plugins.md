...
`createTuiApiAdapters(input)` 返回 `Omit<TuiPluginApi, "lifecycle">`，包含 app version、attention、legacy command shim、keys formatting、keymap、mode stack、route、ui components、tuiConfig、kv、state、client、event、renderer、slots、plugins、theme 等。[E: packages/tui/src/plugin/adapters.tsx:172] [E: packages/tui/src/plugin/adapters.tsx:174] [E: packages/tui/src/plugin/adapters.tsx:175] [E: packages/tui/src/plugin/adapters.tsx:177] [E: packages/tui/src/plugin/adapters.tsx:178] [E: packages/tui/src/plugin/adapters.tsx:183] [E: packages/tui/src/plugin/adapters.tsx:186] [E: packages/tui/src/plugin/adapters.tsx:187] [E: packages/tui/src/plugin/adapters.tsx:192] [E: packages/tui/src/plugin/adapters.tsx:195] [E: packages/tui/src/plugin/adapters.tsx:206] [E: packages/tui/src/plugin/adapters.tsx:285] [E: packages/tui/src/plugin/adapters.tsx:288] [E: packages/tui/src/plugin/adapters.tsx:299] [E: packages/tui/src/plugin/adapters.tsx:300] [E: packages/tui/src/plugin/adapters.tsx:303] [E: packages/tui/src/plugin/adapters.tsx:304] [E: packages/tui/src/plugin/adapters.tsx:305] [E: packages/tui/src/plugin/adapters.tsx:310] [E: packages/tui/src/plugin/adapters.tsx:330]

Base adapter 的 `slots.register()` 会抛错 “only available in plugin context”，`plugins.list()` 返回空数组，activate/deactivate/add 返回 false，install 返回失败消息；真正 scoped slots/plugins/theme install 在 host runtime 的 plugin-scoped API 中覆盖。[E: packages/tui/src/plugin/adapters.tsx:305] [E: packages/tui/src/plugin/adapters.tsx:307] [E: packages/tui/src/plugin/adapters.tsx:311] [E: packages/tui/src/plugin/adapters.tsx:312] [E: packages/tui/src/plugin/adapters.tsx:314] [E: packages/tui/src/plugin/adapters.tsx:317] [E: packages/tui/src/plugin/adapters.tsx:320] [E: packages/tui/src/plugin/adapters.tsx:323] [E: packages/tui/src/plugin/adapters.tsx:326] [E: packages/opencode/src/plugin/tui/runtime.ts:588] [E: packages/opencode/src/plugin/tui/runtime.ts:589] [I]

`createTuiApi()` 当前只补一个 lifecycle stub：new AbortController signal，`onDispose()` 返回 no-op disposer。真正 plugin lifecycle 由 legacy host runtime 为每个 plugin 建 scope。[E: packages/tui/src/plugin/api.ts:42] [E: packages/tui/src/plugin/api.ts:46] [E: packages/tui/src/plugin/api.ts:48] [E: packages/opencode/src/plugin/tui/runtime.ts:419] [E: packages/opencode/src/plugin/tui/runtime.ts:420] [I]

## Host boundary

Root `App` 创建 API adapters 后调用 `props.pluginHost.start({ api, config, runtime, dispose })`；失败只 console.error，finally 设置 TUI ready。[E: packages/tui/src/app.tsx:375] [E: packages/tui/src/app.tsx:395] [E: packages/tui/src/app.tsx:396] [E: packages/tui/src/app.tsx:397] [E: packages/tui/src/app.tsx:398] [E: packages/tui/src/app.tsx:399] [E: packages/tui/src/app.tsx:402] [E: packages/tui/src/app.tsx:405]
...
- `packages/tui/src/plugin/runtime.tsx` 是 TUI-side view/runtime state；`packages/opencode/src/plugin/tui/runtime.ts` 才是 V1 legacy host plugin runtime。两者同名但职责不同。[E: packages/tui/src/plugin/runtime.tsx:12] [E: packages/opencode/src/plugin/tui/runtime.ts:987] [I]
