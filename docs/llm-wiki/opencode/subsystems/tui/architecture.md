...
- `packages/tui` 是 terminal UI package，不是 V2 core；节点 `v: na` 表示它是 client/presentation layer，但它同时消费 legacy SDK events 和 V2 `session.next.*` events。[E: packages/tui/src/context/sync.tsx:176] [E: packages/tui/src/context/data.tsx:132] [I]
