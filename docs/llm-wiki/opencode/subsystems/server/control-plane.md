...
`server.control-plane` 描述 workspace adapter orchestration、remote workspace sync/session warp，以及 V2 core 的 `MoveSession`。需要避免的命名陷阱: `packages/core/src/connector.ts` 的 `@opencode/v2/Connector` 暴露 credential/auth connector operations；它不是 workspace remote connector 是从该 interface surface 得出的 disambiguation。[E: packages/core/src/connector.ts:180][E: packages/core/src/connector.ts:193][E: packages/core/src/connector.ts:401][I]
...
`packages/core/src/connector.ts` 的 connector interface 是 credential/auth registry: 它提供 transform/update/get/list/refresh，以及 key/OAuth connect begin/status/complete/cancel。[E: packages/core/src/connector.ts:180][E: packages/core/src/connector.ts:190][E: packages/core/src/connector.ts:205][E: packages/core/src/connector.ts:227] `connect.key` 调 `credentials.create(...)` 存 credential；OAuth begin/status/complete/cancel 都围绕 attempt state 运作。[E: packages/core/src/connector.ts:395][E: packages/core/src/connector.ts:401][E: packages/core/src/connector.ts:409][E: packages/core/src/connector.ts:449][E: packages/core/src/connector.ts:457][E: packages/core/src/connector.ts:478] 因此它不是 workspace adapter/remote target 的实现点。[I]
