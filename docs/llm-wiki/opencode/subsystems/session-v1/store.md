...
`Session.get`、`list`、`listGlobal`、`children`、`getPart` 是直接 SQLite read 或 thin query wrapper;`Session.messages` 和 `findMessage` 则通过 `MessageV2.page` 分页读取并 hydrate parts。[E: packages/opencode/src/session/session.ts:542][E: packages/opencode/src/session/session.ts:548][E: packages/opencode/src/session/session.ts:557][E: packages/opencode/src/session/session.ts:598][E: packages/opencode/src/session/session.ts:647][E: packages/opencode/src/session/session.ts:830][E: packages/opencode/src/session/session.ts:841][E: packages/opencode/src/session/session.ts:890][E: packages/opencode/src/session/session.ts:894]
...
- `Session.diff` 当前返回空数组;实际 revert/diff summary 由 `SessionSummary` 与 `SessionRevert` 维护。[E: packages/opencode/src/session/session.ts:825][E: packages/opencode/src/session/session.ts:827][E: packages/opencode/src/session/revert.ts:76]
