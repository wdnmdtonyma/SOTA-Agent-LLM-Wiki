...
symbols: [Session, Session.create, Session.messages, Session.updateMessage, Session.updatePart, Session.updatePartDelta, Session.getUsage, MessageV2.toModelMessagesEffect, MessageV2.filterCompacted, SessionRevert.revert, SessionRevert.cleanup]
...
`Session.Interface` 覆盖 session 。[E: packages/opencode/src/session/session.ts:413][E: packages/opencode/src/session/session.ts:414][E: packages/opencode/src/session/session.ts:415][E: packages/opencode/src/session/session.ts:416][E: packages/opencode/src/session/session.ts:425][E: packages/opencode/src/session/session.ts:426][E: packages/opencode/src/session/session.ts:428][E: packages/opencode/src/session/session.ts:431][E: packages/opencode/src/session/session.ts:437][E: packages/opencode/src/session/session.ts:448][E: packages/opencode/src/session/session.ts:451][E: packages/opencode/src/session/session.ts:459][E: packages/opencode/src/session/session.ts:460][E: packages/opencode/src/session/session.ts:468]

`Session.Service` 名称是 `@opencode/Session`,仍属于 `packages/opencode/src` 的 V1 compatibility service;当前 `session.ts` 只从 core session 包导入 `SessionV2` 用于 ID/schema interop,没有在本文件提供 V2 runner layer。[E: packages/opencode/src/session/session.ts:13][E: packages/opencode/src/session/session.ts:474][I]

`Session.getUsage` 用 `finite()` 把 NaN/Infinity 的 usage token 与 `costInfo` 单价当成 0,再交给 Decimal 做 cost 乘法,避免畸形 model cost 污染累计。[E: packages/opencode/src/session/session.ts:339][E: packages/opencode/src/session/session.ts:394]
...
| `MessageTable` | `id`, `session_id`, timestamps, JSON `data` | 存 V1 `SessionV1.Info` 去掉 id/sessionID 后的 JSON data;`MessageV2.page/get` 从这里 hydrate message info。[E: packages/core/src/session/sql.ts:19][E: packages/core/src/session/sql.ts:68][E: packages/core/src/session/sql.ts:71][E: packages/core/src/session/sql.ts:72][E: packages/core/src/session/sql.ts:77][E: packages/opencode/src/session/message-v2.ts:80][E: packages/opencode/src/session/message-v2.ts:83][E: packages/opencode/src/session/message-v2.ts:435][E: packages/opencode/src/session/message-v2.ts:459][E: packages/opencode/src/session/message-v2.ts:506][E: packages/opencode/src/session/message-v2.ts:516] |
...
`Session.get`、`list`、`listGlobal`、`children`、`getPart` 是直接 SQLite read 或 thin query wrapper;`Session.messages` 和 `findMessage` 则通过 `MessageV2.page` 分页读取并 hydrate parts。[E: packages/opencode/src/session/session.ts:540][E: packages/opencode/src/session/session.ts:546][E: packages/opencode/src/session/session.ts:555][E: packages/opencode/src/session/session.ts:596][E: packages/opencode/src/session/session.ts:645][E: packages/opencode/src/session/session.ts:828][E: packages/opencode/src/session/session.ts:839][E: packages/opencode/src/session/session.ts:888][E: packages/opencode/src/session/session.ts:892]

## 写路径与事件桥

`Session.createNext` 构造 V1 `Info` 后发布 `SessionV1.Event.Created`;`patch` 发布 `SessionV1.Event.Updated`,`updateMessage` 发布 `SessionV1.Event.MessageUpdated`,`updatePart` 发布 `SessionV1.Event.PartUpdated`,remove path 发布 deleted/remove events。[E: packages/opencode/src/session/session.ts:499][E: packages/opencode/src/session/session.ts:512][E: packages/opencode/src/session/session.ts:535][E: packages/opencode/src/session/session.ts:734][E: packages/opencode/src/session/session.ts:746][E: packages/opencode/src/session/session.ts:629][E: packages/opencode/src/session/session.ts:631][E: packages/opencode/src/session/session.ts:635][E: packages/opencode/src/session/session.ts:637][E: packages/opencode/src/session/session.ts:622][E: packages/opencode/src/session/session.ts:857][E: packages/opencode/src/session/session.ts:869]

`Session.updatePartDelta` 发布的是 `MessageV2.Event.PartDelta`,该 event schema 包含 `sessionID/messageID/partID/field/delta`;processor 的 text/reasoning delta caller 用这个 generic delta event 做 chunk update。[E: packages/opencode/src/session/session.ts:877][E: packages/opencode/src/session/session.ts:884][E: packages/opencode/src/session/message-v2.ts:55][E: packages/opencode/src/session/message-v2.ts:59][E: packages/opencode/src/session/processor.ts:299][E: packages/opencode/src/session/processor.ts:303][E: packages/opencode/src/session/processor.ts:517][E: packages/opencode/src/session/processor.ts:521]
...
`MessageV2.latest` 在重排后的 history 上按 `time.created` 选 latest user/assistant/finished,`id` 只做同时间 tie-breaker;queued compaction/subtask 只来自 finished 之后的 messages。[E: packages/opencode/src/session/message-v2.ts:582][E: packages/opencode/src/session/message-v2.ts:588][E: packages/opencode/src/session/message-v2.ts:593][E: packages/opencode/src/session/message-v2.ts:600][E: packages/opencode/src/session/message-v2.ts:602]

`MessageV2.fromError` 把 DOM abort、AI SDK auth error、ECONNRESET、decompression failure、provider header timeout、stream error、APICallError 和 provider stream parsed error 映射成 V1 assistant error union;context overflow 被映射为 `ContextOverflowError`,非 overflow parsed stream errors 被映射为 `APIError`,processor 再据此触发 compaction 或 retry/error path。[E: packages/opencode/src/session/message-v2.ts:620][E: packages/opencode/src/session/message-v2.ts:628][E: packages/opencode/src/session/message-v2.ts:641][E: packages/opencode/src/session/message-v2.ts:656][E: packages/opencode/src/session/message-v2.ts:668][E: packages/opencode/src/session/message-v2.ts:679][E: packages/opencode/src/session/message-v2.ts:684][E: packages/opencode/src/session/message-v2.ts:694][E: packages/opencode/src/session/message-v2.ts:711][E: packages/opencode/src/session/message-v2.ts:720][E: packages/opencode/src/session/processor.ts:621][E: packages/opencode/src/session/processor.ts:629][E: packages/opencode/src/session/processor.ts:674][E: packages/opencode/src/session/processor.ts:693]
...
revert 完成后,service 计算 diff,写 `Storage` key `["session_diff", sessionID]`,发布 `Session.Event.Diff`,并通过 `sessions.setRevert` 把 revert pointer 与 summary totals 写回 session。[E: packages/opencode/src/session/revert.ts:73][E: packages/opencode/src/session/revert.ts:76][E: packages/opencode/src/session/revert.ts:77][E: packages/opencode/src/session/revert.ts:78][E: packages/opencode/src/session/revert.ts:79][E: packages/opencode/src/session/revert.ts:82][E: packages/opencode/src/session/revert.ts:83][E: packages/opencode/src/session/revert.ts:84]

`SessionRevert.unrevert` 同样要求 session 不 busy,若 session 有 revert snapshot 就 restore,然后 `sessions.clearRevert(sessionID)`。[E: packages/opencode/src/session/revert.ts:91][E: packages/opencode/src/session/revert.ts:93][E: packages/opencode/src/session/revert.ts:95][E: packages/opencode/src/session/revert.ts:96][E: packages/opencode/src/session/revert.ts:97]

`SessionRevert.cleanup` 先按 revert `messageID` 找边界 index。没有 `partID` 时从该 message 起整段删除;有 `partID` 时只删除该 message 之后的 messages,再从目标 part 起删除同 message 上的后续 parts,最后 `clearRevert`。`SessionPrompt.prompt` 在新 prompt 前调用该 cleanup。[E: packages/opencode/src/session/revert.ts:101][E: packages/opencode/src/session/revert.ts:102][E: packages/opencode/src/session/revert.ts:106][E: packages/opencode/src/session/revert.ts:108][E: packages/opencode/src/session/revert.ts:110][E: packages/opencode/src/session/revert.ts:112][E: packages/opencode/src/session/revert.ts:116][E: packages/opencode/src/session/revert.ts:119][E: packages/opencode/src/session/revert.ts:123][E: packages/opencode/src/session/prompt.ts:1056]

## gotcha

- `Session.remove` 递归删除 child session 并发布 `SessionV1.Event.Deleted`,还调用 `events.remove(sessionID)`;它包在 try/catch 中记录 cleanup error,因此破损 session 也尽量可删除。[E: packages/opencode/src/session/session.ts:618][E: packages/opencode/src/session/session.ts:619][E: packages/opencode/src/session/session.ts:622][E: packages/opencode/src/session/session.ts:623][E: packages/opencode/src/session/session.ts:624][E: packages/opencode/src/session/session.ts:625]
- `Session.diff` 当前返回空数组;实际 revert/diff summary 由 `SessionSummary` 与 `SessionRevert` 维护。[E: packages/opencode/src/session/session.ts:823][E: packages/opencode/src/session/session.ts:825][E: packages/opencode/src/session/revert.ts:76]
- `MessageV2.page` 按 `time_created,id` 倒序取 `limit+1`,hydrate 后再 reverse 返回 chronological page;`Session.messages` 为取全量会循环 page 并最终 `result.reverse()`。[E: packages/opencode/src/session/message-v2.ts:435][E: packages/opencode/src/session/message-v2.ts:439][E: packages/opencode/src/session/message-v2.ts:440][E: packages/opencode/src/session/message-v2.ts:459][E: packages/opencode/src/session/message-v2.ts:460][E: packages/opencode/src/session/session.ts:839][E: packages/opencode/src/session/session.ts:843][E: packages/opencode/src/session/session.ts:847][E: packages/opencode/src/session/session.ts:850]
- `getUsage` 的 `finite()` 同时罩住 token 计数与 `costInfo.input/output/cache` 单价;Infinity/NaN cost 不会再把 Decimal 乘成 NaN。[E: packages/opencode/src/session/session.ts:339][E: packages/opencode/src/session/session.ts:394]
