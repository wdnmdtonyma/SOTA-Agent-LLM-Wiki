...
`Instruction.Interface` 暴露 `clear`、`systemPaths`、`system`、`find`、`resolve` 五个操作。[E: packages/opencode/src/session/instruction.ts:34][E: packages/opencode/src/session/instruction.ts:35][E: packages/opencode/src/session/instruction.ts:36][E: packages/opencode/src/session/instruction.ts:37][E: packages/opencode/src/session/instruction.ts:38][E: packages/opencode/src/session/instruction.ts:39] `system()` 是 provider turn 前的全局/project/config instruction 注入,`resolve(messages, filepath, messageID)` 是读取具体文件后的 nearby instruction 增量注入。[E: packages/opencode/src/session/instruction.ts:110][E: packages/opencode/src/session/instruction.ts:155][E: packages/opencode/src/session/instruction.ts:166][E: packages/opencode/src/session/instruction.ts:167][E: packages/opencode/src/session/instruction.ts:179][E: packages/opencode/src/session/instruction.ts:184][E: packages/opencode/src/session/instruction.ts:195][E: packages/opencode/src/session/instruction.ts:214][E: packages/opencode/src/session/prompt.ts:1260][E: packages/opencode/src/session/prompt.ts:1264][E: packages/opencode/src/tool/read.ts:300]

`SessionPrompt.runLoop` 在组装 provider request 时调用 `instruction.system()` 并把结果拼到 system array 中;`handle.process` 随后接收该 system array。[E: packages/opencode/src/session/prompt.ts:1257][E: packages/opencode/src/session/prompt.ts:1260][E: packages/opencode/src/session/prompt.ts:1264][E: packages/opencode/src/session/prompt.ts:1266][E: packages/opencode/src/session/prompt.ts:1272]
...
`instruction.ts` 本 range 无 diff。`config.instructions` 仍由 `cfg.get()` 读出已 decode 的 V1 `Info`；变化在 V1 Config **load path**：`decodeConfig` 先 `ConfigV2Compat.lower` 再 schema，不改变 `Instruction.systemPaths` / `system` 的发现规则。[E: packages/opencode/src/config/config.ts:188][E: packages/opencode/src/config/config.ts:198][E: packages/opencode/src/session/instruction.ts:111][E: packages/opencode/src/session/instruction.ts:135]
...
| `config.instructions` local | V1 config schema 把 `instructions` 定义成 string array;`mergeConfigConcatArrays` 在 `merge()` 与 MDM merge call site 中被使用,其 array merge 逻辑会去重 concat。[E: packages/core/src/v1/config/config.ts:124][E: packages/core/src/v1/config/config.ts:125][E: packages/opencode/src/config/config.ts:46][E: packages/opencode/src/config/config.ts:48][E: packages/opencode/src/config/config.ts:49][E: packages/opencode/src/config/config.ts:366][E: packages/opencode/src/config/config.ts:407][E: packages/opencode/src/config/config.ts:413][E: packages/opencode/src/config/config.ts:422][E: packages/opencode/src/config/config.ts:541] | 非 URL instruction 支持 `~/`,absolute glob 和 relative upward glob。[E: packages/opencode/src/session/instruction.ts:135][E: packages/opencode/src/session/instruction.ts:137][E: packages/opencode/src/session/instruction.ts:138][E: packages/opencode/src/session/instruction.ts:141][E: packages/opencode/src/session/instruction.ts:142][E: packages/opencode/src/session/instruction.ts:143][E: packages/opencode/src/session/instruction.ts:146] |
...
V1 instruction 注入是 immediate string assembly:`Instruction.system()` 返回 string array,`SessionPrompt.runLoop` 每次 provider turn 都把它拼进 system prompt。[E: packages/opencode/src/session/instruction.ts:155][E: packages/opencode/src/session/instruction.ts:165][E: packages/opencode/src/session/prompt.ts:1260][E: packages/opencode/src/session/prompt.ts:1266]
