...
| 实体 | 字段/行为 | 证据 |
| --- | --- | --- |
| `FileSystem.ReadInput` | `path: RelativePath`。 | [E: packages/core/src/filesystem.ts:14][E: packages/core/src/filesystem.ts:15] |
| `FileSystem.FindInput` | `query`，optional `type: "file" | "directory"`，optional positive `limit`。 | [E: packages/core/src/filesystem.ts:33][E: packages/core/src/filesystem.ts:34][E: packages/core/src/filesystem.ts:35][E: packages/core/src/filesystem.ts:36] |
| `FileSystem.GlobInput` | `pattern`，optional relative `path`，optional positive `limit`。 | [E: packages/core/src/filesystem.ts:39][E: packages/core/src/filesystem.ts:40][E: packages/core/src/filesystem.ts:41][E: packages/core/src/filesystem.ts:42] |
| `FileSystem.GrepInput` | `pattern`，optional relative `path`，optional `include` glob，optional positive `limit`。 | [E: packages/core/src/filesystem.ts:45][E: packages/core/src/filesystem.ts:46][E: packages/core/src/filesystem.ts:47][E: packages/core/src/filesystem.ts:48][E: packages/core/src/filesystem.ts:49] |
...
| `FileSystem.Service` | tag 是 `@opencode/v2/FileSystem`，接口暴露 `read/list/find/glob/grep`。 | [E: packages/core/src/filesystem.ts:61][E: packages/core/src/filesystem.ts:62][E: packages/core/src/filesystem.ts:63][E: packages/core/src/filesystem.ts:64][E: packages/core/src/filesystem.ts:65][E: packages/core/src/filesystem.ts:66][E: packages/core/src/filesystem.ts:69] |
...
1. `baseLayer` 依赖 `FSUtil.Service`、`Location.Service`、`FileSystemSearch.Service`，并把 `root` 设为 `realPath(location.directory)`。[E: packages/core/src/filesystem.ts:74][E: packages/core/src/filesystem.ts:75][E: packages/core/src/filesystem.ts:76][E: packages/core/src/filesystem.ts:77]
2. internal `resolve(input?)` 先用 `path.resolve(location.directory, input ?? ".")` 得到 absolute path。[E: packages/core/src/filesystem.ts:78][E: packages/core/src/filesystem.ts:79]
3. absolute path 必须仍在 `location.directory` 内，否则 die `Path escapes the location`。[E: packages/core/src/filesystem.ts:80][E: packages/core/src/filesystem.ts:81]
4. `realPath(absolute)` 后的 real path 也必须仍在 root 内，防止 symlink escape。[E: packages/core/src/filesystem.ts:82][E: packages/core/src/filesystem.ts:83]
5. service 的 `find/glob/grep` 直接委托给 `FileSystemSearch.Service`。[E: packages/core/src/filesystem.ts:86][E: packages/core/src/filesystem.ts:87][E: packages/core/src/filesystem.ts:88][E: packages/core/src/filesystem.ts:89]
6. `read` 要求 resolved target 是 file；二进制判断用 `bytes.includes(0)`，UTF-8 decode 成功返回 `encoding: "utf8"`，否则返回 base64。[E: packages/core/src/filesystem.ts:90][E: packages/core/src/filesystem.ts:92][E: packages/core/src/filesystem.ts:93][E: packages/core/src/filesystem.ts:96][E: packages/core/src/filesystem.ts:97][E: packages/core/src/filesystem.ts:105][E: packages/core/src/filesystem.ts:112][E: packages/core/src/filesystem.ts:113]
7. `list` 要求 target 是 directory；只返回 file/directory，directory-first，再按 path 排序。[E: packages/core/src/filesystem.ts:117][E: packages/core/src/filesystem.ts:119][E: packages/core/src/filesystem.ts:120][E: packages/core/src/filesystem.ts:126][E: packages/core/src/filesystem.ts:130][E: packages/core/src/filesystem.ts:137]
8. exported `layer` 把 base layer 与 `FileSystemSearch.defaultLayer`、`FSUtil.defaultLayer` 组合；`locationLayer = layer`。[E: packages/core/src/filesystem.ts:145][E: packages/core/src/filesystem.ts:147]
...
`RipgrepBinary` namespace 内部 `VERSION` const 是 `15.1.0`，platform matrix 覆盖 arm64/x64 darwin/linux、arm64/ia32/x64 win32。[E: packages/core/src/ripgrep/binary.ts:11][E: packages/core/src/ripgrep/binary.ts:12][E: packages/core/src/ripgrep/binary.ts:14][E: packages/core/src/ripgrep/binary.ts:15][E: packages/core/src/ripgrep/binary.ts:16][E: packages/core/src/ripgrep/binary.ts:17][E: packages/core/src/ripgrep/binary.ts:18][E: packages/core/src/ripgrep/binary.ts:19][E: packages/core/src/ripgrep/binary.ts:20] `filepath` 是 cached effect：先查系统 `rg`/`rg.exe`，再查 `Global.Path.bin/rg`，否则根据 platform 下载 GitHub release archive、写到 bin dir、extract executable、删除 archive。[E: packages/core/src/ripgrep/binary.ts:90][E: packages/core/src/ripgrep/binary.ts:92][E: packages/core/src/ripgrep/binary.ts:93][E: packages/core/src/ripgrep/binary.ts:95][E: packages/core/src/ripgrep/binary.ts:96][E: packages/core/src/ripgrep/binary.ts:102][E: packages/core/src/ripgrep/binary.ts:103][E: packages/core/src/ripgrep/binary.ts:107][E: packages/core/src/ripgrep/binary.ts:108][E: packages/core/src/ripgrep/binary.ts:109][E: packages/core/src/ripgrep/binary.ts:110][E: packages/core/src/ripgrep/binary.ts:115][E: packages/core/src/ripgrep/binary.ts:116][E: packages/core/src/ripgrep/binary.ts:117]

Archive extraction 用 PowerShell `Expand-Archive` 处理 zip，用 `tar -xzf` 处理 tar.gz，抽出的 executable 路径固定在 `ripgrep-<VERSION>-<platform>/rg(.exe)`。[E: packages/core/src/ripgrep/binary.ts:56][E: packages/core/src/ripgrep/binary.ts:58][E: packages/core/src/ripgrep/binary.ts:62][E: packages/core/src/ripgrep/binary.ts:70][E: packages/core/src/ripgrep/binary.ts:71][E: packages/core/src/ripgrep/binary.ts:78][E: packages/core/src/ripgrep/binary.ts:80][E: packages/core/src/ripgrep/binary.ts:81]

### Command adapter

`Ripgrep.Service` tag 是 `@opencode/v2/Ripgrep`，接口有 `find/glob/grep`。[E: packages/core/src/ripgrep.ts:80][E: packages/core/src/ripgrep.ts:81][E: packages/core/src/ripgrep.ts:82][E: packages/core/src/ripgrep.ts:83][E: packages/core/src/ripgrep.ts:86] adapter 的 `run()` spawn `binary.filepath`，用 `Stream.splitLines` 解析 stdout，`Stream.take(limit + 1)` 判断 truncated，并收集最多 8KiB stderr。[E: packages/core/src/ripgrep.ts:19][E: packages/core/src/ripgrep.ts:110][E: packages/core/src/ripgrep.ts:111][E: packages/core/src/ripgrep.ts:113][E: packages/core/src/ripgrep.ts:118][E: packages/core/src/ripgrep.ts:119][E: packages/core/src/ripgrep.ts:127][E: packages/core/src/ripgrep.ts:131] exit code 1 表示 no matches，exit code 2 可产生 partial result 或 invalid regex error，其他非 0 code 是 failure。[E: packages/core/src/ripgrep.ts:136][E: packages/core/src/ripgrep.ts:137][E: packages/core/src/ripgrep.ts:139][E: packages/core/src/ripgrep.ts:142]

`glob` 和 `find` 都用 `rg --no-config --files`；`glob` 总是加 `--glob=<pattern>`，`find` 只有在 pattern 不是 `"*"` 时加 `--glob=<pattern>`，二者都排除 `.git`。[E: packages/core/src/ripgrep.ts:161][E: packages/core/src/ripgrep.ts:162][E: packages/core/src/ripgrep.ts:163][E: packages/core/src/ripgrep.ts:166][E: packages/core/src/ripgrep.ts:167][E: packages/core/src/ripgrep.ts:195][E: packages/core/src/ripgrep.ts:196][E: packages/core/src/ripgrep.ts:197][E: packages/core/src/ripgrep.ts:200][E: packages/core/src/ripgrep.ts:201] `grep` 用 `rg --json --hidden --no-messages`，optional include glob，显式 `--` 后传 pattern 和 file/dot。[E: packages/core/src/ripgrep.ts:225][E: packages/core/src/ripgrep.ts:226][E: packages/core/src/ripgrep.ts:227][E: packages/core/src/ripgrep.ts:228][E: packages/core/src/ripgrep.ts:229][E: packages/core/src/ripgrep.ts:230][E: packages/core/src/ripgrep.ts:232][E: packages/core/src/ripgrep.ts:233][E: packages/core/src/ripgrep.ts:234]

`grep` JSON record 超过 64KiB 失败，最多保留 100 个 submatches，match line 超过 2000 chars 会截断加 `...`。[E: packages/core/src/ripgrep.ts:20][E: packages/core/src/ripgrep.ts:21][E: packages/core/src/ripgrep.ts:237][E: packages/core/src/ripgrep.ts:238][E: packages/core/src/ripgrep.ts:251][E: packages/core/src/ripgrep.ts:273]
...
- V2 filesystem facade 把 path containment 放在 read/list boundary，search backend 结果再映射成 Location-relative entries；这让 leaf tools 可以把权限和 presentation 放在工具层，而不是直接暴露 raw rg output。[E: packages/core/src/filesystem.ts:80][E: packages/core/src/filesystem/search.ts:64][E: packages/core/src/filesystem/search.ts:66][E: packages/core/src/filesystem/search.ts:90][E: packages/core/src/filesystem/search.ts:94][I]
- `Ripgrep` adapter 的硬接口只返回 `Entry[]`/`Match[]`，raw JSON parsing 在 `grep` adapter 的 `parse` pipeline 内完成；filesystem search layer 再把这些结果包成 `FileSystem.Entry` 和 `FileSystem.Match`。[E: packages/core/src/ripgrep.ts:80][E: packages/core/src/ripgrep.ts:81][E: packages/core/src/ripgrep.ts:82][E: packages/core/src/ripgrep.ts:83][E: packages/core/src/ripgrep.ts:236][E: packages/core/src/ripgrep.ts:237][E: packages/core/src/ripgrep.ts:240][E: packages/core/src/ripgrep.ts:247][E: packages/core/src/filesystem/search.ts:64][E: packages/core/src/filesystem/search.ts:90]
- Root `AGENTS.md` says V2 SessionRunner、model resolution、tool registry、permissions、filesystem must stay Location-scoped；`LocationServiceMap` 把 `FileSystem.locationLayer` 纳入 Location graph。[E: AGENTS.md:153][E: packages/core/src/location-layer.ts:66]
...
- `grep` in ripgrep adapter passes `--hidden` and only excludes `.git` explicitly; broader ignores are a watcher/default-ignore concern unless passed through backend-specific flags elsewhere。[E: packages/core/src/ripgrep.ts:228][E: packages/core/src/ripgrep.ts:231][I]
