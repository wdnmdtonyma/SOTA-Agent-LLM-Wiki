...
- Preview decorators use SolidJS JSX decorator API [E: packages/storybook/.storybook/preview.tsx:11] [E: packages/storybook/.storybook/preview.tsx:58]。

## 关键文件

| 文件 | 角色 |
| --- | --- |
| `packages/storybook/.storybook/main.ts` | Storybook main config。选择 `storybook-solidjs-vite`, addons, stories glob, viteFinal aliases/mocks/fs allow [E: packages/storybook/.storybook/main.ts:13] [E: packages/storybook/.storybook/main.ts:15] [E: packages/storybook/.storybook/main.ts:18] [E: packages/storybook/.storybook/main.ts:25] [E: packages/storybook/.storybook/main.ts:33] [E: packages/storybook/.storybook/main.ts:36] [E: packages/storybook/.storybook/main.ts:69]。 |
| `packages/storybook/.storybook/preview.tsx` | Preview decorator。注入 UI/session-ui styles、ThemeProvider、DialogProvider、MarkedProvider、Font, 并定义 global theme control [E: packages/storybook/.storybook/preview.tsx:1] [E: packages/storybook/.storybook/preview.tsx:2] [E: packages/storybook/.storybook/preview.tsx:3] [E: packages/storybook/.storybook/preview.tsx:64] [E: packages/storybook/.storybook/preview.tsx:65] [E: packages/storybook/.storybook/preview.tsx:66] [E: packages/storybook/.storybook/preview.tsx:69] [E: packages/storybook/.storybook/preview.tsx:70] [E: packages/storybook/.storybook/preview.tsx:88] [E: packages/storybook/.storybook/preview.tsx:91] [E: packages/storybook/.storybook/preview.tsx:95]。 |
...
`main.ts` 的 story sources 是 `../../ui/src/**/*.stories.@(...)`, `../../session-ui/src/**/*.stories.@(...)`, `../../app/src/**/*.stories.@(...)`, 所以 Storybook 的 catalog 覆盖 UI package、session UI package 和 app package stories [E: packages/storybook/.storybook/main.ts:25] [E: packages/storybook/.storybook/main.ts:26] [E: packages/storybook/.storybook/main.ts:27] [E: packages/storybook/.storybook/main.ts:28]。`viteFinal` 把 `@` alias 指向 `packages/app/src`, 同时对 app contexts、router、model dialogs 等路径设置 mock replacement, 让 UI stories 可以渲染依赖 app context 的组件 [E: packages/storybook/.storybook/main.ts:10] [E: packages/storybook/.storybook/main.ts:37] [E: packages/storybook/.storybook/main.ts:38] [E: packages/storybook/.storybook/main.ts:52] [E: packages/storybook/.storybook/main.ts:54] [E: packages/storybook/.storybook/main.ts:59] [E: packages/storybook/.storybook/main.ts:61]。

Preview 的 `globalTypes.theme` 定义了 Storybook 全局 theme selector, default 是 `light` [E: packages/storybook/.storybook/preview.tsx:91] [E: packages/storybook/.storybook/preview.tsx:92] [E: packages/storybook/.storybook/preview.tsx:95]。
...
3. Preview decorator 对每个 story 包一层 MetaProvider、Font、ThemeProvider、DialogProvider、MarkedProvider, 再放入有 background/text color 的 frame div [E: packages/storybook/.storybook/preview.tsx:58] [E: packages/storybook/.storybook/preview.tsx:63] [E: packages/storybook/.storybook/preview.tsx:64] [E: packages/storybook/.storybook/preview.tsx:65] [E: packages/storybook/.storybook/preview.tsx:66] [E: packages/storybook/.storybook/preview.tsx:69] [E: packages/storybook/.storybook/preview.tsx:70] [E: packages/storybook/.storybook/preview.tsx:71]。
...
Storybook 使用 mock aliases 而不是启动完整 opencode server, 这让 UI stories 可以覆盖需要 app context 的组件, 同时把 runtime state 和 network behavior 留在 mocked boundary [E: packages/storybook/.storybook/main.ts:37] [E: packages/storybook/.storybook/main.ts:52] [E: packages/storybook/.storybook/main.ts:54] [I]。Preview 统一注入 ThemeProvider/DialogProvider/MarkedProvider, 让 stories 与 app shell 中的 UI 环境更接近 [E: packages/storybook/.storybook/preview.tsx:66] [E: packages/storybook/.storybook/preview.tsx:69] [E: packages/storybook/.storybook/preview.tsx:70]。
