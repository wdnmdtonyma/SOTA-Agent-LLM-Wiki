...
- Tailwind v4/Vite plugin、Kobalte、Solid primitives、Solid Router、TanStack Solid Query 共同组成 UI runtime [E: packages/app/package.json:34] [E: packages/app/package.json:46] [E: packages/app/package.json:53] [E: packages/app/package.json:66] [E: packages/app/package.json:68]。
- 测试层是 Bun unit + Playwright e2e, package scripts 明确把 unit 和 e2e 分开 [E: packages/app/package.json:20] [E: packages/app/package.json:24]。
...
| `packages/app/src/app.tsx` | 共享 shell。定义 `AppBaseProviders`, `ConnectionGate`, `AppInterface` 和 routes [E: packages/app/src/app.tsx:263] [E: packages/app/src/app.tsx:297] [E: packages/app/src/app.tsx:413] [E: packages/app/src/app.tsx:451]。 |
| `packages/app/src/context/platform.tsx` | host capability contract。`Platform` discriminated union 分 `web` 与 `desktop`, desktop 分支要求 `openDirectoryPickerDialog` [E: packages/app/src/context/platform.tsx:116] [E: packages/app/src/context/platform.tsx:118] [E: packages/app/src/context/platform.tsx:120] [E: packages/app/src/context/platform.tsx:122]。 |
...
| `packages/app/src/context/server-sync.tsx` | server state sync root。创建 SDK cache、bootstrap query、global store 和 directory child stores [E: packages/app/src/context/server-sync.tsx:92] [E: packages/app/src/context/server-sync.tsx:115] [E: packages/app/src/context/server-sync.tsx:165] [E: packages/app/src/context/server-sync.tsx:213]。 |
...
4. `AppBaseProviders` 安装 Meta、Font、Theme、Language、I18n bridge、ErrorBoundary、QueryClient、WSL、Dialog、Marked、File providers [E: packages/app/src/app.tsx:263] [E: packages/app/src/app.tsx:265] [E: packages/app/src/app.tsx:267] [E: packages/app/src/app.tsx:272] [E: packages/app/src/app.tsx:280] [E: packages/app/src/app.tsx:281] [E: packages/app/src/app.tsx:282] [E: packages/app/src/app.tsx:283] [E: packages/app/src/app.tsx:284]。
5. `AppInterface` 安装 `ServerProvider`, `GlobalProvider`, `ConnectionGate`, Router, Tabs, shared shell providers, 然后挂 `/`, `/new-session`, `/:dir/session/:id?` routes [E: packages/app/src/app.tsx:436] [E: packages/app/src/app.tsx:441] [E: packages/app/src/app.tsx:442] [E: packages/app/src/app.tsx:443] [E: packages/app/src/app.tsx:446] [E: packages/app/src/app.tsx:451] [E: packages/app/src/app.tsx:452] [E: packages/app/src/app.tsx:453] [E: packages/app/src/app.tsx:455] [E: packages/app/src/app.tsx:459]。
6. `ConnectionGate` 在未禁用时循环调用 `checkServerHealth(http)`, blocking 模式最多 10 秒, 之后用 error UI 或后台 retry [E: packages/app/src/app.tsx:305] [E: packages/app/src/app.tsx:313] [E: packages/app/src/app.tsx:318] [E: packages/app/src/app.tsx:357]。
...
`Platform` 把 host-specific 能力全部推到边界, 使 `AppInterface` 可以在 browser 和 Electron 内共享同一套路由、providers 和 server sync 代码 [E: packages/app/src/context/platform.tsx:116] [E: packages/app/src/app.tsx:413]。Server connection 使用 union 而不是单纯 URL; 这个形状能表达 HTTP、sidecar、WSL 和 SSH proxy 这类连接形态 [E: packages/app/src/context/server.tsx:157] [E: packages/app/src/context/server.tsx:163] [E: packages/app/src/context/server.tsx:170] [E: packages/app/src/context/server.tsx:178] [I]。

## Gotcha

- Browser entry 的 default server 不等于 Desktop sidecar。Desktop renderer 自己创建 `Platform` 并传 `MemoryRouter`; browser entry 使用普通 `Router` 和 HTTP connection [E: packages/app/src/entry.tsx:159] [E: packages/app/src/entry.tsx:171] [E: packages/app/src/app.tsx:444] [E: packages/desktop/src/renderer/index.tsx:81] [E: packages/desktop/src/renderer/index.tsx:370]。
