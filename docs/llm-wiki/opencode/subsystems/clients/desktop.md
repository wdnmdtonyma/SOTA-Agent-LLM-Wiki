...
| `packages/desktop/src/main/server.ts` | sidecar process manager。负责 fork、ready/error handshake、current `/api/health` 与 legacy `/global/health` 轮询、stop timeout [E: packages/desktop/src/main/server.ts:62] [E: packages/desktop/src/main/server.ts:106] [E: packages/desktop/src/main/server.ts:114] [E: packages/desktop/src/main/server.ts:170] [E: packages/desktop/src/main/server.ts:173] [E: packages/desktop/src/main/server.ts:184] [E: packages/desktop/src/main/server.ts:187]。 |
...
7. main 把 `url`, `username: "opencode"`, `password` resolve 到 `serverReady`, renderer 的 `awaitInitialization()` 得到这些凭据；main 之后还等待 health check 最多 30 秒并记录失败。health helper 依次接受 current `/api/health` 或 legacy `/global/health` 的任一成功响应。[E: packages/desktop/src/main/index.ts:358] [E: packages/desktop/src/main/index.ts:368] [E: packages/desktop/src/main/index.ts:369] [E: packages/desktop/src/main/index.ts:372] [E: packages/desktop/src/renderer/index.tsx:349] [E: packages/desktop/src/main/server.ts:184] [E: packages/desktop/src/main/server.ts:187] [E: packages/desktop/src/main/server.ts:198] [E: packages/desktop/src/main/server.ts:205]。
...
Desktop 把 server 放在 utility process, 而不是 renderer [E: packages/desktop/src/main/server.ts:62], 这种进程边界可以隔离 long-running server、保留 Electron main 对 lifecycle 的控制 [I]。main 会用兼容两代 endpoint 的 health helper 确认 server 可用后再完成 loading task [E: packages/desktop/src/main/server.ts:150] [E: packages/desktop/src/main/server.ts:153] [E: packages/desktop/src/main/server.ts:184] [E: packages/desktop/src/main/server.ts:187] [E: packages/desktop/src/main/index.ts:368]。`OPENCODE_DISABLE_EMBEDDED_WEB_UI = "true"` 表明 desktop 不需要 server 自己再 serve embedded web UI, 因为 renderer 由 Electron bundle 提供 [E: packages/desktop/src/main/index.ts:121]。
