...
`ModelsDevPlugin` 仍是 provider catalog 的主要 registration source：`item.env.length === 0` 的 provider 跳过 integration 注册；其余 provider 会 `integration.transform` 写入 integration ref、key method、env method，再 `catalog.transform` 写入 provider/model catalog。[E: packages/core/src/plugin/models-dev.ts:124] [E: packages/core/src/plugin/models-dev.ts:128] [E: packages/core/src/plugin/models-dev.ts:130] [E: packages/core/src/plugin/models-dev.ts:131] [E: packages/core/src/plugin/models-dev.ts:135] [E: packages/core/src/plugin/models-dev.ts:142] [E: packages/core/src/plugin/models-dev.ts:147] [E: packages/core/src/plugin/models-dev.ts:150] [E: packages/core/src/plugin/models-dev.ts:162] [E: packages/core/src/plugin/models-dev.ts:164]
