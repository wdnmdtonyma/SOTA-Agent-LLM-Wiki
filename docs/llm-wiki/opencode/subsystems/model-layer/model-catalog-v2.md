...
命名陷阱:V2 `ProviderV2.Info` / `ModelV2.Info`、V1 `Provider.Info` / `Provider.Model`、`packages/llm` 的 `ProviderID` 是三套 schema/type 命名。[E: packages/schema/src/provider.ts:53][E: packages/schema/src/model.ts:60][E: packages/opencode/src/provider/provider.ts:1036][E: packages/opencode/src/provider/provider.ts:1053][E: packages/llm/src/schema/ids.ts:17] 它们不能混用。[I]
