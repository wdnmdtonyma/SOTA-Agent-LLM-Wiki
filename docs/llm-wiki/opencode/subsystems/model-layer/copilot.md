...
`toolChoice` 只对 `code_interpreter`、`file_search`、`image_generation`、`web_search_preview`、`web_search` 返回 hosted `{ type: toolName }`；`local_shell` 虽在 prepare-tools 中作为 provider tool case 处理，但 toolChoice 分支会落到普通 `{ type: "function", name }` fallback。[E: packages/core/src/github-copilot/responses/openai-responses-prepare-tools.ts:157][E: packages/core/src/github-copilot/responses/openai-responses-prepare-tools.ts:158][E: packages/core/src/github-copilot/responses/openai-responses-prepare-tools.ts:159][E: packages/core/src/github-copilot/responses/openai-responses-prepare-tools.ts:160][E: packages/core/src/github-copilot/responses/openai-responses-prepare-tools.ts:161][E: packages/core/src/github-copilot/responses/openai-responses-prepare-tools.ts:162][E: packages/core/src/github-copilot/responses/openai-responses-prepare-tools.ts:163]
