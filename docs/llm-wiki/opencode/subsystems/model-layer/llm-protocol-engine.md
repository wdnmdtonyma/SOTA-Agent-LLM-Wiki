...
`Route.make` 的设计动机是把 provider 差异拆成四个互相可换的轴:protocol 是 semantic API shape,endpoint 是 base URL/path/query,auth 是 request header mutation,framing 是 byte stream 到 event frame 的切分。[E: packages/llm/src/route/client.ts:188][E: packages/llm/src/route/client.ts:190][E: packages/llm/src/route/client.ts:192][E: packages/llm/src/route/client.ts:194] 默认 overload 会用 `HttpTransport.httpJson({ framing })`,所以只传 `framing` 的 route 实际仍然会得到 HTTP JSON transport。[E: packages/llm/src/route/client.ts:327][E: packages/llm/src/route/client.ts:336]

## 职责边界

- `Protocol` 描述 provider-native JSON body 与 streaming state machine;它只包含 `id/body/stream`,不包含 endpoint/auth/header 字段,所以 deployment 关切被留给 route。[E: packages/llm/src/route/protocol.ts:36][E: packages/llm/src/route/protocol.ts:38][E: packages/llm/src/route/protocol.ts:40][E: packages/llm/src/route/protocol.ts:42]
...
- `Auth` 的 `apply` 输出 headers;`bearer`/`apiKey`/`header` 是 header mutation helper,missing credential 会转成 authentication-class `LLMError`。[E: packages/llm/src/route/auth.ts:33][E: packages/llm/src/route/auth.ts:67][E: packages/llm/src/route/auth.ts:112][E: packages/llm/src/route/auth.ts:117][E: packages/llm/src/route/auth.ts:119][E: packages/llm/src/route/auth.ts:121][E: packages/llm/src/route/auth.ts:137]
...
- `Transport` 是 request preparation 与 frame streaming 的边界,运行时只要求 HTTP executor,WebSocket executor 是可选项。[E: packages/llm/src/route/transport/index.ts:8][E: packages/llm/src/route/transport/index.ts:13][E: packages/llm/src/route/client.ts:420][E: packages/llm/src/route/client.ts:421][E: packages/llm/src/route/client.ts:422]
...
1. 调用方把 `LLMRequest` 与 route-bound model 交给 `streamRequestWith` 或 `generateWith`;`streamRequestWith` 先 `compile`,再调用 `compiled.route.streamPrepared`。[E: packages/llm/src/route/client.ts:374][E: packages/llm/src/route/client.ts:377][E: packages/llm/src/route/client.ts:378]

2. `compile` 先合并 route defaults、model defaults 与 request 的 generation/providerOptions/http,再调用 `route.body.from(request)` 生成 provider-native body。[E: packages/llm/src/route/client.ts:167][E: packages/llm/src/route/client.ts:170][E: packages/llm/src/route/client.ts:178][E: packages/llm/src/route/client.ts:345][E: packages/llm/src/route/client.ts:348][E: packages/llm/src/route/client.ts:349]

3. `compile` 随即用 route body schema 对 native body 做 `Schema.decodeUnknown` 校验,通过后才 `prepareTransport`。[E: packages/llm/src/route/client.ts:350][E: packages/llm/src/route/client.ts:351]

4. `prepareTransport` 把 endpoint/auth/body encoder/headers/request 全部传给 transport,让 HTTP 或 WebSocket transport 自己完成 URL、headers、body 的最终装配。[E: packages/llm/src/route/client.ts:270][E: packages/llm/src/route/client.ts:271][E: packages/llm/src/route/client.ts:273][E: packages/llm/src/route/client.ts:274][E: packages/llm/src/route/client.ts:275][E: packages/llm/src/route/client.ts:276][E: packages/llm/src/route/client.ts:277]

5. `streamPrepared` 从 transport 取 frames,把每个 frame decode 成 protocol event,遇到 protocol terminal event 时停止,再用 protocol `step` 累积 parser state 与输出 `LLMEvent`。[E: packages/llm/src/route/client.ts:279][E: packages/llm/src/route/client.ts:281][E: packages/llm/src/route/client.ts:282][E: packages/llm/src/route/client.ts:284][E: packages/llm/src/route/client.ts:285][E: packages/llm/src/route/client.ts:289][E: packages/llm/src/route/client.ts:290]

6. `generateWith` 不走另一套 API,而是 fold 同一个 stream 成 `LLMResponse`;`LLMResponse.complete` 只在 terminal finish/provider-error 后返回 response,usage 来自 reducer state。[E: packages/llm/src/route/client.ts:382][E: packages/llm/src/route/client.ts:384][E: packages/llm/src/route/client.ts:385][E: packages/llm/src/schema/events.ts:594][E: packages/llm/src/schema/events.ts:595][E: packages/llm/src/schema/events.ts:600]
...
OpenAI Responses 同时拥有 HTTP+SSE route 与 WebSocket route,两条 route 都引用同一个 `protocol` 字段;这种 transport 分离的意图是复用协议 state machine。[E: packages/llm/src/protocols/openai-responses.ts:984][E: packages/llm/src/protocols/openai-responses.ts:987][E: packages/llm/src/protocols/openai-responses.ts:1012][E: packages/llm/src/protocols/openai-responses.ts:1015][I]
