...
- Console 迁移 Linkable 与 `SUPPORT_API_KEY` 绑在哪里?
...
- Cloudflare-first surfaces: `Api` Worker、R2 Bucket、Astro docs、StaticSite app、AuthApi Worker、Console SolidStart、Stat Worker、Enterprise SolidStart 都是 `sst.cloudflare.*` 资源 [E: infra/app.ts:11] [E: infra/app.ts:13] [E: infra/app.ts:52] [E: infra/app.ts:62] [E: infra/console.ts:63] [E: infra/console.ts:258] [E: infra/console.ts:319] [E: infra/enterprise.ts:6]。
...
| `infra/console.ts` | Console infra。创建 PlanetScale branch/password Linkable, Auth Worker, Stripe webhook/products/prices, `ConsoleMigration` Linkable, LogProcessor Worker, Console SolidStart, Stat Worker [E: infra/console.ts:11] [E: infra/console.ts:29] [E: infra/console.ts:36] [E: infra/console.ts:63] [E: infra/console.ts:74] [E: infra/console.ts:227] [E: infra/console.ts:253] [E: infra/console.ts:258] [E: infra/console.ts:319]。 |
...
Linkable 是跨资源配置模型。Console database Linkable 暴露 host/database/username/password/port [E: infra/console.ts:36] [E: infra/console.ts:38] [E: infra/console.ts:39] [E: infra/console.ts:40] [E: infra/console.ts:41] [E: infra/console.ts:42]。`ConsoleMigration` 只在 production/`dev` 填 `consoleUrl` / `inferenceUrl`（`https://{domain}/console` 与 `https://{domain}/inference`）；其它 preview stage 是空字符串，避免把独立 DB 的 workspace 送到 shared dev。[E: infra/console.ts:225][E: infra/console.ts:227][E: infra/console.ts:229][E: infra/console.ts:230] Lake ingest Linkable 暴露 ingest service URL 和 secret [E: infra/lake.ts:274] [E: infra/lake.ts:276] [E: infra/lake.ts:277]。Secret 模块还把 random password 包装成 Linkable property, 并集中声明 R2、Honeycomb、`SUPPORT_API_KEY`、Upstash secrets [E: infra/secret.ts:1] [E: infra/secret.ts:7] [E: infra/secret.ts:8] [E: infra/secret.ts:9] [E: infra/secret.ts:10] [E: infra/secret.ts:12] [E: infra/secret.ts:13] [E: infra/secret.ts:14]。
...
6. Console SolidStart 的 link 除 buckets/database/Upstash/auth/Stripe/SES/Salesforce 外，还包含 `consoleMigration` 与 `SECRET.SupportApiKey`。[E: infra/console.ts:268][E: infra/console.ts:270]
7. Lake module 的 Firehose destination 是 Iceberg, metadata extraction query 从 record 中读取 `_lake_database`, `_lake_table`, `_lake_operation` [E: infra/lake.ts:160] [E: infra/lake.ts:164] [E: infra/lake.ts:174] [E: infra/lake.ts:180]。
8. Stats module 把 `StatsSyncService` 放进 lake cluster，architecture `arm64`，运行 `bun src/stat-sync.ts`。link 包含 database、legacy `inferenceEvent`、`r2Sql`、`r2SqlAuthToken`、`statsSyncConfig`，并使用 lake query permissions [E: infra/stats.ts:185] [E: infra/stats.ts:194] [E: infra/stats.ts:195] [E: infra/stats.ts:196] [E: infra/stats.ts:205] [E: infra/stats.ts:208] [E: infra/stats.ts:209]。
...
- `ConsoleMigration.inferenceUrl` 在非 production/dev stage 为空；`proxyInference` 仍会在有 `migratedAt` 时构造 destination，空 URL 会在运行时失败而不是静默回本地 handler。[E: infra/console.ts:230][I]
