...
| `packages/enterprise/test/core/share.test.ts` | 覆盖 create、sync、duplicate overwrite、legacy migration、invalid secret 等行为 [E: packages/enterprise/test/core/share.test.ts:7] [E: packages/enterprise/test/core/share.test.ts:17] [E: packages/enterprise/test/core/share.test.ts:148] [E: packages/enterprise/test/core/share.test.ts:197] [E: packages/enterprise/test/core/share.test.ts:219]。 |
...
3. `Share.sync` 校验 share 存在和 secret 匹配，再读取 snapshot；snapshot 不存在时回退 `legacy(shareID)`，最后写入 `merge(data, input.data)` 的新 snapshot [E: packages/enterprise/src/core/share.ts:150] [E: packages/enterprise/src/core/share.ts:156] [E: packages/enterprise/src/core/share.ts:157] [E: packages/enterprise/src/core/share.ts:158] [E: packages/enterprise/src/core/share.ts:159] [E: packages/enterprise/src/core/share.ts:160]。
4. `Share.data(shareID)` 同样优先读 snapshot，缺失时执行 legacy migration path [E: packages/enterprise/src/core/share.ts:164] [E: packages/enterprise/src/core/share.ts:165]。
...
- `Share.syncOld` 仍存在，会把每个 item 写入 `share_data/...` 分散 key，但主 `Share.sync` 已写 snapshot；读路径 `Share.data` 优先读 snapshot 并在缺失时走 legacy path，不读取 `share_data` 是从当前 `Share.data` body 得出的结论 [E: packages/enterprise/src/core/share.ts:160] [E: packages/enterprise/src/core/share.ts:165] [E: packages/enterprise/src/core/share.ts:168] [E: packages/enterprise/src/core/share.ts:183] [E: packages/enterprise/src/core/share.ts:187] [E: packages/enterprise/src/core/share.ts:192] [E: packages/enterprise/src/core/share.ts:196] [E: packages/enterprise/src/core/share.ts:199] [I]。
