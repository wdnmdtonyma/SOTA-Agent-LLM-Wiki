...
`packages/sdk/js/package.json` 的 package name 是 `@opencode-ai/sdk`，根 export `"."` 指向 `./src/index.ts`，`./client` 指向 `./src/client.ts`，`./server` 指向 `./src/server.ts`。[E: packages/sdk/js/package.json:3][E: packages/sdk/js/package.json:13][E: packages/sdk/js/package.json:14][E: packages/sdk/js/package.json:15] `src/index.ts` re-export client/server，并提供 `createOpencode(options)`：它先 `createOpencodeServer(options)`，再用 server url 创建 client，最后返回 `{ client, server }`。[E: packages/sdk/js/src/index.ts:1][E: packages/sdk/js/src/index.ts:2][E: packages/sdk/js/src/index.ts:8][E: packages/sdk/js/src/index.ts:9][E: packages/sdk/js/src/index.ts:13][E: packages/sdk/js/src/index.ts:17]
...
`package.json` export `./v2` 指向 `./src/v2/index.ts`，`./v2/client` 指向 `./src/v2/client.ts`，`./v2/server` 指向 `./src/v2/server.ts`，并额外公开 `./v2/gen/client` 与 `./v2/types` generated entrypoints。[E: packages/sdk/js/package.json:16][E: packages/sdk/js/package.json:17][E: packages/sdk/js/package.json:18][E: packages/sdk/js/package.json:19][E: packages/sdk/js/package.json:20] `src/v2/index.ts` 与 legacy root 一样 export client/server 并提供 `createOpencode(options)`；它还 `export * as data from "./data.js"`。[E: packages/sdk/js/src/v2/index.ts:1][E: packages/sdk/js/src/v2/index.ts:2][E: packages/sdk/js/src/v2/index.ts:8][E: packages/sdk/js/src/v2/index.ts:10][E: packages/sdk/js/src/v2/index.ts:15]

`src/v2/client.ts` 使用 `./gen/*` 的 current generated SDK。它导出 V2 types，并把 `FileSystemEntry` 重新命名为 `LocationFileSystemEntry` 供 callers 使用。[E: packages/sdk/js/src/v2/client.ts:1][E: packages/sdk/js/src/v2/client.ts:2][E: packages/sdk/js/src/v2/client.ts:4][E: packages/sdk/js/src/v2/client.ts:6] V2 wrapper 接受 `directory` 与 `experimental_workspaceID`，分别写入 `x-opencode-directory` 与 `x-opencode-workspace` headers。[E: packages/sdk/js/src/v2/client.ts:50][E: packages/sdk/js/src/v2/client.ts:63][E: packages/sdk/js/src/v2/client.ts:66][E: packages/sdk/js/src/v2/client.ts:70][E: packages/sdk/js/src/v2/client.ts:73]
...
V2 generated `OpencodeClient` 有 legacy namespaces，也有 `v2` getter；`V2` class 下面挂 `health/location/agent/session/model/provider/integration/credential/permission/fs/command/skill/event/pty/question/reference/projectCopy` namespaces，对应 `/api/*` 与 experimental project-copy routes。[E: packages/sdk/js/src/v2/gen/sdk.gen.ts:7077][E: packages/sdk/js/src/v2/gen/sdk.gen.ts:7216][E: packages/sdk/js/src/v2/gen/sdk.gen.ts:6990][E: packages/sdk/js/src/v2/gen/sdk.gen.ts:6992][E: packages/sdk/js/src/v2/gen/sdk.gen.ts:7007][E: packages/sdk/js/src/v2/gen/sdk.gen.ts:7072]

## Generation

`script/build.ts` 生成过程先在 `packages/opencode` 下运行 `bun dev generate > openapi.json`，然后调用 `@hey-api/openapi-ts` 的 `createClient()`，输出路径固定为 `./src/v2/gen` 且 `clean: true`。[E: packages/sdk/js/script/build.ts:12][E: packages/sdk/js/script/build.ts:14][E: packages/sdk/js/script/build.ts:47][E: packages/sdk/js/script/build.ts:50][E: packages/sdk/js/script/build.ts:52] 这意味着当前 build script 重新生成的是 `src/v2/gen`，不是旧 `src/gen`；旧 `src/gen` 只在后续 prettier 步骤里被格式化。[E: packages/sdk/js/script/build.ts:115][I]

The generator config uses `@hey-api/typescript`、`@hey-api/sdk` with `instance: "OpencodeClient"` and `paramsStructure: "flat"`、以及 `@hey-api/client-fetch` baseUrl `http://localhost:4096`。[E: packages/sdk/js/script/build.ts:56][E: packages/sdk/js/script/build.ts:60][E: packages/sdk/js/script/build.ts:61][E: packages/sdk/js/script/build.ts:64][E: packages/sdk/js/script/build.ts:67][E: packages/sdk/js/script/build.ts:69] Build script patches generated history query types from string to number in both `types.gen.ts` and `sdk.gen.ts`。[E: packages/sdk/js/script/build.ts:74][E: packages/sdk/js/script/build.ts:79][E: packages/sdk/js/script/build.ts:85][E: packages/sdk/js/script/build.ts:87][E: packages/sdk/js/script/build.ts:89][E: packages/sdk/js/script/build.ts:95] Build script also patches a `@hey-api/openapi-ts` SSE type bug in `src/v2/gen/client/types.gen.ts` by removing the erroneous `TError` generic from `ServerSentEventsResult`.[E: packages/sdk/js/script/build.ts:103][E: packages/sdk/js/script/build.ts:107][E: packages/sdk/js/script/build.ts:113]
...
|---|---|---|
| export path | `"." -> ./src/index.ts`。[E: packages/sdk/js/package.json:13] | `"./v2" -> ./src/v2/index.ts`。[E: packages/sdk/js/package.json:16] |
...
| surface | Legacy V1 namespaces only plus one direct permission method。[E: packages/sdk/js/src/gen/sdk.gen.ts:1161][E: packages/sdk/js/src/gen/sdk.gen.ts:1177] | Legacy compatibility namespaces plus `.v2.*` native `/api/*` namespaces。[E: packages/sdk/js/src/v2/gen/sdk.gen.ts:7077][E: packages/sdk/js/src/v2/gen/sdk.gen.ts:7216] |
| regeneration | Not regenerated by current `script/build.ts`; only prettier touches `src/gen`。[E: packages/sdk/js/script/build.ts:115][I] | Regenerated from `bun dev generate` into `src/v2/gen` with clean output。[E: packages/sdk/js/script/build.ts:14][E: packages/sdk/js/script/build.ts:50][E: packages/sdk/js/script/build.ts:52] |
