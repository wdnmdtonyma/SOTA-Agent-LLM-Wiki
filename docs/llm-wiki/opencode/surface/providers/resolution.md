...
`ProviderTransform.options()` 根据 provider/model 设置默认 request options，例如 OpenAI/GitHub Copilot/Amazon Mantle/xAI store false、OpenAI-package 与 xAI prompt cache key、OpenRouter/LLMGateway usage include、Google thinkingConfig、Meta xhigh 和 GPT-5 reasoning defaults。[E: packages/opencode/src/provider/transform.ts:1101][E: packages/opencode/src/provider/transform.ts:1106][E: packages/opencode/src/provider/transform.ts:1108][E: packages/opencode/src/provider/transform.ts:1116][E: packages/opencode/src/provider/transform.ts:1142][E: packages/opencode/src/provider/transform.ts:1149][E: packages/opencode/src/provider/transform.ts:1152][E: packages/opencode/src/provider/transform.ts:1155][E: packages/opencode/src/provider/transform.ts:1158][E: packages/opencode/src/provider/transform.ts:1206]

`ProviderTransform.providerOptions()` 把 model-level options 放到 AI SDK 期望的 providerOptions namespace；Gateway 特殊处理 `gateway` 和 upstream slug，Azure 同时传 `openai` 与 `azure` namespace。[E: packages/opencode/src/provider/transform.ts:1287][E: packages/opencode/src/provider/transform.ts:1298][E: packages/opencode/src/provider/transform.ts:1304][E: packages/opencode/src/provider/transform.ts:1312][E: packages/opencode/src/provider/transform.ts:1341][E: packages/opencode/src/provider/transform.ts:1342] `maxOutputTokens()` 把 model output limit 与默认 `OUTPUT_TOKEN_MAX = 32000` 取最小值。[E: packages/opencode/src/provider/transform.ts:1347][E: packages/opencode/src/provider/transform.ts:1348]
