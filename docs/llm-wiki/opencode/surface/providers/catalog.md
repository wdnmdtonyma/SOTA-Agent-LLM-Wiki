...
ModelsDev service 的默认 catalog host 已是 `https://models.opencode.ai`，fetch path 仍为 `/api.json`；`OPENCODE_MODELS_URL` 可覆盖它。[E: packages/core/src/models-dev.ts:160][E: packages/core/src/models-dev.ts:175][E: packages/core/src/models-dev.ts:176]
...
| providerOptions | V1 `ProviderTransform.providerOptions()` 把 options 转成 AI SDK namespace。[E: packages/opencode/src/provider/transform.ts:1346][E: packages/opencode/src/provider/transform.ts:1396][E: packages/opencode/src/provider/transform.ts:1403] | packages/llm facade 的 options 更靠近 provider protocol；例如 OpenAI facade 分 `responses()` 与 `chat()`。[E: packages/llm/src/providers/openai.ts:42][E: packages/llm/src/providers/openai.ts:46] |
