...
V1 `LspTool` 通过 `Tool.define("lsp", ...)` 注册；V1 registry 初始化 `lsptool`，但只有 `flags.experimentalLspTool` 为 true 时才把 `tool.lsp` 加入 builtin 列表。[E: packages/opencode/src/tool/lsp.ts:37][E: packages/opencode/src/tool/lsp.ts:38][E: packages/opencode/src/tool/registry.ts:106][E: packages/opencode/src/tool/registry.ts:224][E: packages/opencode/src/tool/registry.ts:247] `experimentalLspTool` 来自 `enabledByExperimental("OPENCODE_EXPERIMENTAL_LSP_TOOL")`，所以可由专门 flag 或总开关 `OPENCODE_EXPERIMENTAL` 打开。[E: packages/opencode/src/effect/runtime-flags.ts:10][E: packages/opencode/src/effect/runtime-flags.ts:11][E: packages/opencode/src/effect/runtime-flags.ts:12][E: packages/opencode/src/effect/runtime-flags.ts:13][E: packages/opencode/src/effect/runtime-flags.ts:45]
...
| 维度 | V1 | V2 |
|---|---|---|
| 注册 | `OPENCODE_EXPERIMENTAL_LSP_TOOL` 或 `OPENCODE_EXPERIMENTAL` 开启时暴露。[E: packages/opencode/src/effect/runtime-flags.ts:10][E: packages/opencode/src/effect/runtime-flags.ts:12][E: packages/opencode/src/effect/runtime-flags.ts:13][E: packages/opencode/src/effect/runtime-flags.ts:45][E: packages/opencode/src/tool/registry.ts:247] | V2 shipped built-ins node 当前没有注册 LSP。[E: packages/core/src/tool/builtins.ts:31][E: packages/core/src/tool/builtins.ts:35][E: packages/core/src/tool/builtins.ts:46][I] |
