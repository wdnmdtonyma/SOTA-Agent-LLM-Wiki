...
| 字段 | 类型 | 必填 | 默认 | 约束 | 说明 |
|---|---|---:|---|---|---|
| `description` | `string` | 是 | 无 | schema 描述为 3-5 words | task 在 UI/metadata/title 中展示的短描述。[E: packages/opencode/src/tool/task.ts:43][E: packages/opencode/src/tool/task.ts:193][E: packages/opencode/src/tool/task.ts:258] |
...
7. 新 job 通过 `background.start()` 注册；`onPromote` 会把 parent tool metadata 改成 background 并启动 completion notification。[E: packages/opencode/src/tool/task.ts:273][E: packages/opencode/src/tool/task.ts:278][E: packages/opencode/src/tool/task.ts:281][E: packages/opencode/src/tool/task.ts:283]
8. foreground 默认等待 `background.wait()` 或 `waitForPromotion()`；如果 job 被 promote 成 background，foreground 调用也返回 running background result。[E: packages/opencode/src/tool/task.ts:324][E: packages/opencode/src/tool/task.ts:325][E: packages/opencode/src/tool/task.ts:327]
9. foreground abort 会触发 child session cancel；Effect interrupt release 阶段还会 cancel background job。[E: packages/opencode/src/tool/task.ts:311][E: packages/opencode/src/tool/task.ts:314][E: packages/opencode/src/tool/task.ts:319][E: packages/opencode/src/tool/task.ts:338][E: packages/opencode/src/tool/task.ts:339]
