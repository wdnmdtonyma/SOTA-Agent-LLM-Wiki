...
V1 `WebSearchTool` 通过 `Tool.define("websearch", ...)` 注册，`ToolRegistry` 初始化 `websearch` 并加入 builtin 列表。[E: packages/opencode/src/tool/websearch.ts:99][E: packages/opencode/src/tool/websearch.ts:100][E: packages/opencode/src/tool/registry.ts:109][E: packages/opencode/src/tool/registry.ts:220][E: packages/opencode/src/tool/registry.ts:243] 但 V1 registry 后续会过滤：只有 `webSearchEnabled(input.providerID, { exa: flags.enableExa, parallel: flags.enableParallel })` 为 true 时才把 `websearch` 暴露给模型。[E: packages/opencode/src/tool/registry.ts:293][E: packages/opencode/src/tool/registry.ts:294]
...
1. `webSearchEnabled()` 的逻辑是：provider id 是 `opencode`，或 `ProviderV2.ID.make("opencode-go")`，或 Exa flag 开启，或 Parallel flag 开启。[E: packages/opencode/src/tool/registry.ts:58][E: packages/opencode/src/tool/registry.ts:60][E: packages/opencode/src/tool/registry.ts:61][E: packages/opencode/src/tool/registry.ts:62][E: packages/opencode/src/tool/registry.ts:63]
...
| 维度 | V1 | V2 |
|---|---|---|
| 门控 | `webSearchEnabled()` 要求 provider 是 `opencode` 或 `opencode-go`，或 Exa/Parallel flag 开启。[E: packages/opencode/src/tool/registry.ts:58][E: packages/opencode/src/tool/registry.ts:60][E: packages/opencode/src/tool/registry.ts:61] | V2 builtins 注册 websearch；源码没有 V1 registry 的 provider gate。[E: packages/core/src/tool/builtins.ts:45][E: packages/core/src/tool/websearch.ts:199][I] |
