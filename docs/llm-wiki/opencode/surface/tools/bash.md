...
| approval reduction | tree-sitter + command/path scan + `BashArity.prefix`。[E: packages/opencode/src/tool/shell.ts:257][E: packages/opencode/src/tool/shell.ts:398][E: packages/opencode/src/tool/shell.ts:409] | command permission 是整条 command；absolute path token 只生成 warnings。[E: packages/core/src/tool/bash.ts:142][E: packages/core/src/tool/bash.ts:138][E: packages/core/src/tool/bash.ts:140] |
