...
V2 `EditTool` 的 name 是 `edit`，注册时使用 `[name]: Tool.withPermission(Tool.make(...), "edit")`。[E: packages/core/src/tool/edit.ts:18][E: packages/core/src/tool/edit.ts:97][E: packages/core/src/tool/edit.ts:99][E: packages/core/src/tool/edit.ts:194] `Tool.withPermission(..., "edit")` 让 registry 在 permission ruleset 过滤时使用 `edit` action，而不是依赖其他别名。[E: packages/core/src/tool/tool.ts:121][E: packages/core/src/tool/tool.ts:130][E: packages/core/src/tool/registry.ts:111]

### 2 用途定位

V2 Edit 是 exact-edit leaf：description 字段明确写 “Replace exact text in one file”，并有 TODO 明确把 V1 fuzzy correction strategies 留到 exact-edit 行为建立后再移植。[E: packages/core/src/tool/edit.ts:101][E: packages/core/src/tool/edit.ts:165][E: packages/core/src/tool/edit.ts:168]

### 3 输入 schema 表

| 字段 | 类型 | 必填 | 默认 | 约束 | 说明 |
|---|---|---:|---|---|---|
| `path` | `string` | 是 | 无 | relative paths resolve within active `Location`；external absolute path 需要 `external_directory` approval | 目标文件路径。[E: packages/core/src/tool/edit.ts:20][E: packages/core/src/tool/edit.ts:21][E: packages/core/src/tool/edit.ts:23] |
| `oldString` | `string` | 是 | 无 | 必须非空，且必须 exact match | 待替换文本。[E: packages/core/src/tool/edit.ts:25][E: packages/core/src/tool/edit.ts:131][E: packages/core/src/tool/edit.ts:165] |
| `newString` | `string` | 是 | 无 | 必须不同于 `oldString` | 替换文本。[E: packages/core/src/tool/edit.ts:26][E: packages/core/src/tool/edit.ts:126] |
| `replaceAll` | optional `boolean` | 否 | `false` | 多个 exact match 时必须 true，否则失败 | 是否替换所有 exact occurrences。[E: packages/core/src/tool/edit.ts:27][E: packages/core/src/tool/edit.ts:171][E: packages/core/src/tool/edit.ts:178] |

### 4 输出 & 大小/截断限制

V2 Edit 的 structured `Output` 是 `{ operation: "write", target, resource, existed, replacements }`。[E: packages/core/src/tool/edit.ts:32][E: packages/core/src/tool/edit.ts:37] `toModelOutput` 生成简短 diff preview，最多展示 old/new 各 6 行，每行 240 字符后加省略。[E: packages/core/src/tool/edit.ts:65][E: packages/core/src/tool/edit.ts:67][E: packages/core/src/tool/edit.ts:72][E: packages/core/src/tool/edit.ts:105][E: packages/core/src/tool/edit.ts:106] V2 registry settlement 会再调用 `ToolOutputStore.bound`，统一处理 2000 行 / 50KB model-facing 限制。[E: packages/core/src/tool/registry.ts:73][E: packages/core/src/tool/registry.ts:74][E: packages/core/src/tool-output-store.ts:12][E: packages/core/src/tool-output-store.ts:13]

### 5 权限

V2 Edit 先通过 `LocationMutation.resolve` 得到 target；如果 target 是 external absolute path，就调用 `LocationMutation.externalDirectoryPermission(external)` 生成 `external_directory` approval，再请求 `edit` approval。[E: packages/core/src/tool/edit.ts:137][E: packages/core/src/tool/edit.ts:138][E: packages/core/src/tool/edit.ts:141][E: packages/core/src/tool/edit.ts:150] V2 edit permission 的 action 是 `edit`，resources 是 `target.resource`，save 是 `["*"]`，source 带 assistant message 和 tool call ID。[E: packages/core/src/tool/edit.ts:151][E: packages/core/src/tool/edit.ts:152][E: packages/core/src/tool/edit.ts:153][E: packages/core/src/tool/edit.ts:154][E: packages/core/src/tool/edit.ts:155][E: packages/core/src/tool/edit.ts:157]

### 6 execute() 走读

1. V2 Edit 创建 permission source，拒绝 `oldString === newString`，并拒绝空 `oldString`。[E: packages/core/src/tool/edit.ts:121][E: packages/core/src/tool/edit.ts:126][E: packages/core/src/tool/edit.ts:131]
2. V2 Edit resolve target 与 external approval 后，读取 canonical 文件 bytes 并 decode UTF-8/BOM。[E: packages/core/src/tool/edit.ts:137][E: packages/core/src/tool/edit.ts:160][E: packages/core/src/tool/edit.ts:49]
3. V2 Edit 保持源文件换行风格，把输入 old/new 转为 `\n` 或 `\r\n`，再计算 exact occurrences。[E: packages/core/src/tool/edit.ts:161][E: packages/core/src/tool/edit.ts:162][E: packages/core/src/tool/edit.ts:164]
4. V2 Edit 对 0 次 exact match 返回 ToolFailure；对多次 exact match 且 `replaceAll !== true` 返回 ToolFailure。[E: packages/core/src/tool/edit.ts:165][E: packages/core/src/tool/edit.ts:166][E: packages/core/src/tool/edit.ts:171][E: packages/core/src/tool/edit.ts:172]
5. V2 Edit 使用 `FileMutation.writeIfUnchanged` 写入，expected 是之前读到的 source bytes；如果文件在 approval 后变化，映射成 “Read it again before editing.” 的 ToolFailure。[E: packages/core/src/tool/edit.ts:183][E: packages/core/src/tool/edit.ts:184][E: packages/core/src/tool/edit.ts:186][E: packages/core/src/tool/edit.ts:112][E: packages/core/src/tool/edit.ts:114]

## V1 vs V2 差异

| 维度 | V1 | V2 |
|---|---|---|
| 匹配策略 | 9 路 replacer，含 block-anchor similarity 0.65。[E: packages/opencode/src/tool/edit.ts:694][E: packages/opencode/src/tool/edit.ts:704][E: packages/opencode/src/tool/edit.ts:220] | exact match；fuzzy parity 是 TODO。[E: packages/core/src/tool/edit.ts:165][E: packages/core/src/tool/edit.ts:168] |
| 空 `oldString` | 文件不存在时可创建文件；文件存在时拒绝。[E: packages/opencode/src/tool/edit.ts:90][E: packages/opencode/src/tool/edit.ts:91][E: packages/opencode/src/tool/edit.ts:111] | 一律拒绝，提示用 `write` 创建或覆盖。[E: packages/core/src/tool/edit.ts:131][E: packages/core/src/tool/edit.ts:133] |
| mutation safety | process-local semaphore 锁住同一 file path。[E: packages/opencode/src/tool/edit.ts:35][E: packages/opencode/src/tool/edit.ts:88] | `FileMutation.writeIfUnchanged` 在 per-target lock 下比较 expected bytes 再写。[E: packages/core/src/file-mutation.ts:73][E: packages/core/src/file-mutation.ts:143][E: packages/core/src/file-mutation.ts:147] |
| 后置集成 | formatter、watcher/file edit events、LSP diagnostics 都已接入。[E: packages/opencode/src/tool/edit.ts:156][E: packages/opencode/src/tool/edit.ts:159][E: packages/opencode/src/tool/edit.ts:197] | formatter、watcher、snapshot、LSP 仍是 TODO；execute 在 `writeIfUnchanged` 后直接 return，无 formatter/LSP 调用。[E: packages/core/src/tool/edit.ts:183][E: packages/core/src/tool/edit.ts:190] |

## 设计动机·edge·历史

V1 fuzzy edit 的文件头注释列出 Cline 和 Gemini CLI diff-edit corrector 作为来源（`edit.ts` 前 5 行）；结合 9 路 replacer，可推断 V1 目标是尽量把模型略有偏差的 `oldString` 修正到可执行替换。[E: packages/opencode/src/tool/edit.ts:6][E: packages/opencode/src/tool/edit.ts:682][I] V2 则先收敛到 exact-edit seam，把 fuzzy、formatter、watcher、snapshot、LSP 都显式列为 deferred work（文件 82–87 行的 TODO 块），避免新内核初期把历史复杂度一次搬入 core。[E: packages/core/src/tool/edit.ts:89][E: packages/core/src/tool/edit.ts:190][I]
