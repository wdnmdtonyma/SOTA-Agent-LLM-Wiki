...
V1 host service 名称是 `@opencode/TuiConfig`，接口暴露 `get`、`pluginOrigins`、`waitForDependencies`。[E: packages/opencode/src/config/tui.ts:47] [E: packages/opencode/src/config/tui.ts:41] Host loader 会先展开 config variables，再用 JSONC parser 解析。[E: packages/opencode/src/config/tui.ts:101] [E: packages/opencode/src/config/tui.ts:104] 它会 flatten nested `tui` key，兼容用户在 `tui.json` 中写 `{ "tui": { ... } }` 的旧形状。[E: packages/opencode/src/config/tui.ts:55] [E: packages/opencode/src/config/tui.ts:65] unknown keybind keys 会被过滤掉而不是让整个 config 失败。[E: packages/opencode/src/config/tui.ts:71] [E: packages/opencode/src/config/tui.ts:74] [E: packages/opencode/src/config/tui.ts:79]

V1 host 解析 `attention.sounds` 后，会把 sound paths 按 config file 所在目录解析成 host-local path。[E: packages/opencode/src/config/tui.ts:115] plugin spec 也由 host 按 config file path resolve，并记录 plugin origin scope。[E: packages/opencode/src/config/tui.ts:87] [E: packages/opencode/src/config/tui.ts:94] plugin origins 会 deduplicate 后重新写入 merged result。[E: packages/opencode/src/config/tui.ts:159] [E: packages/opencode/src/config/tui.ts:160] [E: packages/opencode/src/config/tui.ts:166]

加载优先级为：global `tui.json` 最低，循环读取 `Global.Path.config` 下的 `tui` 文件。[E: packages/opencode/src/config/tui.ts:184] [E: packages/opencode/src/config/tui.ts:185] `OPENCODE_TUI_CONFIG` 是显式 config file，应用顺序在 global 之后、project 和 `.opencode` config 之前。[E: packages/opencode/src/config/tui.ts:189] [E: packages/opencode/src/config/tui.ts:191] project `tui` files 由 `ConfigPaths.files` 反转成 root-first 后应用。[E: packages/opencode/src/config/paths.ts:16] [E: packages/opencode/src/config/paths.ts:20] [E: packages/opencode/src/config/tui.ts:196] [E: packages/opencode/src/config/tui.ts:197] `.opencode` directories 和 `OPENCODE_CONFIG_DIR` 过滤成 `dirs` 后再应用。[E: packages/opencode/src/config/tui.ts:203] [E: packages/opencode/src/config/tui.ts:205] 最终 host 调用 `TuiConfig.resolve(..., { terminalSuspend: process.platform !== "win32" })`。[E: packages/opencode/src/config/tui.ts:212] [E: packages/opencode/src/config/tui.ts:217]
...
V2 preview CLI 的 `runTui` 直接调用 `@opencode-ai/tui` 的 `run`，传入默认 `TuiConfig.resolve({}, { terminalSuspend: false })` 结果和 `gracefulFetch`。[E: packages/cli/src/tui.ts:8] [E: packages/cli/src/tui.ts:9] [E: packages/cli/src/tui.ts:13] 因此当前 `packages/cli` host 没有复用 V1 `packages/opencode/src/config/tui.ts` 的文件发现流程。[I]
...
`migrateTuiConfig` extracts `theme`、`keybinds`、`tui` from legacy opencode config data。[E: packages/opencode/src/config/tui-migrate.ts:38] [E: packages/opencode/src/config/tui-migrate.ts:39] [E: packages/opencode/src/config/tui-migrate.ts:40] It skips a directory if the target `tui.json` already exists。[E: packages/opencode/src/config/tui-migrate.ts:49] [E: packages/opencode/src/config/tui-migrate.ts:51] It parses JSONC with trailing commas。[E: packages/opencode/src/config/tui-migrate.ts:34] [E: packages/opencode/src/config/tui-migrate.ts:35] The generated payload includes `$schema` and whichever migrated keys are present。[E: packages/opencode/src/config/tui-migrate.ts:53] [E: packages/opencode/src/config/tui-migrate.ts:54] [E: packages/opencode/src/config/tui-migrate.ts:56] [E: packages/opencode/src/config/tui-migrate.ts:57] [E: packages/opencode/src/config/tui-migrate.ts:58]

After writing `tui.json`, migration backs up the original file to `.tui-migration.bak` if needed。[E: packages/opencode/src/config/tui-migrate.ts:89] [E: packages/opencode/src/config/tui-migrate.ts:90] [E: packages/opencode/src/config/tui-migrate.ts:94] It then removes `theme`、`keybinds`、`tui` from the original `opencode.json` using JSONC edits。[E: packages/opencode/src/config/tui-migrate.ts:99] [E: packages/opencode/src/config/tui-migrate.ts:100] [E: packages/opencode/src/config/tui-migrate.ts:107] Migration scans global `opencode` config, root-first project `opencode.json/jsonc`, config directories, and explicit `OPENCODE_CONFIG` if set。[E: packages/opencode/src/config/tui-migrate.ts:115] [E: packages/opencode/src/config/tui-migrate.ts:117] [E: packages/opencode/src/config/tui-migrate.ts:118] [E: packages/opencode/src/config/tui-migrate.ts:120] [E: packages/opencode/src/config/tui-migrate.ts:123]
