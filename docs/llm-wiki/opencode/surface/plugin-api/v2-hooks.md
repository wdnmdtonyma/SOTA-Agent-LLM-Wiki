...
`PluginV2.Service.add()` closes any existing plugin scope for the same id, forks a child scope, runs the plugin effect inside that child scope, stores returned hooks, and publishes `plugin.added`.[E: packages/core/src/plugin.ts:105][E: packages/core/src/plugin.ts:108][E: packages/core/src/plugin.ts:110][E: packages/core/src/plugin.ts:111][E: packages/core/src/plugin.ts:120][E: packages/core/src/plugin.ts:128] `PluginBoot.add()` provides core services such as Catalog, Command, Credential, Connector, Agent, Config, Location, ModelsDev, Npm, EventV2, FSUtil, Global, Skill, Reference and Plugin service into each plugin effect.[E: packages/core/src/plugin/boot.ts:78][E: packages/core/src/plugin/boot.ts:82][E: packages/core/src/plugin/boot.ts:96]
