...
`packages/opencode/src/plugin/index.ts` loads built-in plugins first, then external plugins from config, and executes plugin loading sequentially so hook registration order remains deterministic.[E: packages/opencode/src/plugin/index.ts:67][E: packages/opencode/src/plugin/index.ts:170][E: packages/opencode/src/plugin/index.ts:181][E: packages/opencode/src/plugin/index.ts:219][E: packages/opencode/src/plugin/index.ts:224] `Plugin.trigger()` loops through `s.hooks`, skips missing hook functions, and awaits each matching callback with `(input, output)`.[E: packages/opencode/src/plugin/index.ts:284][E: packages/opencode/src/plugin/index.ts:289][E: packages/opencode/src/plugin/index.ts:291][E: packages/opencode/src/plugin/index.ts:292][E: packages/opencode/src/plugin/index.ts:294] The `event` hook is an exception to the `Plugin.trigger()` path because the EventV2 bridge invokes `hook["event"]?.(...)` directly inside the listener.[E: packages/opencode/src/plugin/index.ts:255][E: packages/opencode/src/plugin/index.ts:259]
...
| `provider` | `ProviderHook` with `id` and optional `models(provider, ctx)` [E: packages/plugin/src/index.ts:214][E: packages/plugin/src/index.ts:216] | V1 provider resolution calls `hook.provider.models(toPublicInfo(provider), { auth })` and rewrites provider models [E: packages/opencode/src/provider/provider.ts:1450][E: packages/opencode/src/provider/provider.ts:1462][E: packages/opencode/src/provider/provider.ts:1463] |
