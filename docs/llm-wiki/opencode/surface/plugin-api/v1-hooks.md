...
`packages/opencode/src/plugin/index.ts` loads built-in plugins first, then external plugins from config, and executes plugin loading sequentially so hook registration order remains deterministic.[E: packages/opencode/src/plugin/index.ts:65][E: packages/opencode/src/plugin/index.ts:166][E: packages/opencode/src/plugin/index.ts:177][E: packages/opencode/src/plugin/index.ts:215][E: packages/opencode/src/plugin/index.ts:221] `Plugin.trigger()` loops through `s.hooks`, skips missing hook functions, and awaits each matching callback with `(input, output)`.[E: packages/opencode/src/plugin/index.ts:280][E: packages/opencode/src/plugin/index.ts:287][E: packages/opencode/src/plugin/index.ts:289][E: packages/opencode/src/plugin/index.ts:290][E: packages/opencode/src/plugin/index.ts:292] The `event` hook is an exception to the `Plugin.trigger()` path because the EventV2 bridge invokes `hook["event"]?.(...)` directly inside the listener.[E: packages/opencode/src/plugin/index.ts:251][E: packages/opencode/src/plugin/index.ts:255]
...
| `tool` | record of `ToolDefinition` by tool id [E: packages/plugin/src/index.ts:226][E: packages/plugin/src/tool.ts:45] | `ToolRegistry` iterates `plugin.list()` and pushes `p.tool` definitions into custom tools [E: packages/opencode/src/tool/registry.ts:187][E: packages/opencode/src/tool/registry.ts:189][E: packages/opencode/src/tool/registry.ts:190] |
| `auth` | `AuthHook` with provider, optional loader, oauth/api methods [E: packages/plugin/src/index.ts:88][E: packages/plugin/src/index.ts:91] | `ProviderAuth` indexes `x.auth.provider`; provider resolution also invokes `plugin.auth.loader` for stored auth [E: packages/opencode/src/provider/auth.ts:116][E: packages/opencode/src/provider/auth.ts:120][E: packages/opencode/src/provider/provider.ts:1522][E: packages/opencode/src/provider/provider.ts:1525] |
| `provider` | `ProviderHook` with `id` and optional `models(provider, ctx)` [E: packages/plugin/src/index.ts:214][E: packages/plugin/src/index.ts:216] | V1 provider resolution calls `hook.provider.models(toPublicInfo(provider), { auth })` and rewrites provider models [E: packages/opencode/src/provider/provider.ts:1367][E: packages/opencode/src/provider/provider.ts:1379][E: packages/opencode/src/provider/provider.ts:1380] |
...
| `command.execute.before` | `(input: { command; sessionID; arguments }, output: { parts })` [E: packages/plugin/src/index.ts:262][E: packages/plugin/src/index.ts:265] | `SessionPrompt` triggers before command prompt execution [E: packages/opencode/src/session/prompt.ts:1459][E: packages/opencode/src/session/prompt.ts:1460] |
| `tool.execute.before` | `(input: { tool; sessionID; callID }, output: { args })` [E: packages/plugin/src/index.ts:266][E: packages/plugin/src/index.ts:269] | triggered before task tool execution, normal tool execution, MCP resource list/list-templates/read tools, and wrapped MCP tool execution [E: packages/opencode/src/session/prompt.ts:307][E: packages/opencode/src/session/tools.ts:102][E: packages/opencode/src/session/tools.ts:171][E: packages/opencode/src/session/tools.ts:255][E: packages/opencode/src/session/tools.ts:335][E: packages/opencode/src/session/tools.ts:395] |
...
| `tool.execute.after` | `(input: { tool; sessionID; callID; args }, output: { title; output; metadata })` [E: packages/plugin/src/index.ts:274][E: packages/plugin/src/index.ts:279] | triggered after task tool execution, normal tool execution, MCP resource list/list-templates/read tools, and wrapped MCP tool execution [E: packages/opencode/src/session/prompt.ts:389][E: packages/opencode/src/session/tools.ts:117][E: packages/opencode/src/session/tools.ts:204][E: packages/opencode/src/session/tools.ts:287][E: packages/opencode/src/session/tools.ts:369][E: packages/opencode/src/session/tools.ts:413] |
| `experimental.chat.messages.transform` | `(input: {}, output: { messages: { info; parts }[] })` [E: packages/plugin/src/index.ts:282][E: packages/plugin/src/index.ts:285] | triggered during compaction and prompt message preparation before model message conversion [E: packages/opencode/src/session/compaction.ts:350][E: packages/opencode/src/session/prompt.ts:1254] |
...
| `experimental.provider.small_model` | `(input: { provider }, output: { model? })` [E: packages/plugin/src/index.ts:297] | provider default small-model selection calls this hook before fallback priority list [E: packages/opencode/src/provider/provider.ts:1858][E: packages/opencode/src/provider/provider.ts:1859] |
...
| `experimental.text.complete` | `(input: { sessionID; messageID; partID }, output: { text })` [E: packages/plugin/src/index.ts:327][E: packages/plugin/src/index.ts:330] | session processor triggers at `text-end` before finalizing current text part [E: packages/opencode/src/session/processor.ts:510][E: packages/opencode/src/session/processor.ts:514] |
