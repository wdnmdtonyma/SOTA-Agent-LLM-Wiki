...
- `codex-rs/codex-mcp/src/rmcp_client.rs`: uncached listing creates initial `callable_name` and `callable_namespace` seeds before global normalization.[E: codex-rs/codex-mcp/src/rmcp_client.rs:345][E: codex-rs/codex-mcp/src/rmcp_client.rs:367][E: codex-rs/codex-mcp/src/rmcp_client.rs:373][E: codex-rs/codex-mcp/src/rmcp_client.rs:390]
- `codex-rs/codex-mcp/src/mcp/mod.rs`: defines `sanitize_responses_api_tool_name`; `tools.rs` imports and uses it before collision handling.[E: codex-rs/codex-mcp/src/mcp/mod.rs:404][E: codex-rs/codex-mcp/src/tools.rs:23][E: codex-rs/codex-mcp/src/tools.rs:174][E: codex-rs/codex-mcp/src/tools.rs:181]
...
- `LEGACY_MCP_TOOL_NAME_PREFIX` is the literal `mcp__`; when `prefix_mcp_tool_names` is true, it is added to the namespace unless the namespace already starts with that prefix.[E: codex-rs/codex-mcp/src/tools.rs:28][E: codex-rs/codex-mcp/src/tools.rs:147][E: codex-rs/codex-mcp/src/tools.rs:265]
...
3. Namespace and tool seed strings are sanitized with `sanitize_responses_api_tool_name`, and optional legacy prefixing is applied to namespace seeds.[E: codex-rs/codex-mcp/src/tools.rs:174][E: codex-rs/codex-mcp/src/tools.rs:181][E: codex-rs/codex-mcp/src/tools.rs:265]
...
- `list_tools_for_client_uncached` asks the underlying RMCP client for tools plus optional connector metadata, strips untrusted connector metadata for non-Codex-Apps servers, and computes callable name/namespace seeds before creating `ToolInfo`.[E: codex-rs/codex-mcp/src/rmcp_client.rs:351][E: codex-rs/codex-mcp/src/rmcp_client.rs:359][E: codex-rs/codex-mcp/src/rmcp_client.rs:367][E: codex-rs/codex-mcp/src/rmcp_client.rs:373][E: codex-rs/codex-mcp/src/rmcp_client.rs:390]
- Non-Codex-Apps servers cannot smuggle connector metadata into model-visible qualification: `sanitize_tool_connector_metadata` returns connector metadata only for the reserved Codex Apps MCP server and strips untrusted connector meta otherwise.[E: codex-rs/codex-mcp/src/rmcp_client.rs:410][E: codex-rs/codex-mcp/src/rmcp_client.rs:417][E: codex-rs/codex-mcp/src/rmcp_client.rs:421]
