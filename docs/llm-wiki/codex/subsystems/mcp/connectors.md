...
- `codex-rs/connectors/src/connector_runtime/mod.rs`: account/workspace-scoped live tool snapshots, one-time disk cold start, generation-guarded publication, and best-effort persistence。[E: codex-rs/connectors/src/connector_runtime/mod.rs:224][E: codex-rs/connectors/src/connector_runtime/mod.rs:255][E: codex-rs/connectors/src/connector_runtime/mod.rs:303]
...
- `ConnectorRuntimeManager` partitions live state by account id、ChatGPT user id、workspace classification；same identity shares an atomic snapshot, while a context reads disk only at construction and never treats disk as live authority。[E: codex-rs/connectors/src/connector_runtime/mod.rs:124][E: codex-rs/connectors/src/connector_runtime/mod.rs:169]
- Fetch tickets monotonically increase generation；a stale startup/hard-refresh completion cannot overwrite a newer accepted snapshot or persist out of order。[E: codex-rs/connectors/src/connector_runtime/mod.rs:224][E: codex-rs/connectors/src/connector_runtime/mod.rs:226][E: codex-rs/connectors/src/connector_runtime/mod.rs:255][E: codex-rs/connectors/src/connector_runtime/mod.rs:285][E: codex-rs/connectors/src/connector_runtime/mod.rs:303]
