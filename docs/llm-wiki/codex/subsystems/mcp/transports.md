...
- `codex-rs/codex-mcp/src/runtime.rs`: configured environment resolution and ambient local route-aware HTTP capability.[E: codex-rs/codex-mcp/src/runtime.rs:495][E: codex-rs/codex-mcp/src/runtime.rs:504][E: codex-rs/codex-mcp/src/runtime.rs:562]
- `codex-rs/exec-server/src/environment.rs`: environment-owned exec/filesystem/HTTP capabilities for local and remote execution backends.[E: codex-rs/exec-server/src/environment.rs:650][E: codex-rs/exec-server/src/environment.rs:658][E: codex-rs/exec-server/src/environment.rs:658]

## Config selection

- `McpRuntimeContext::resolve_server_environment` resolves the configured environment before `make_rmcp_client` receives it as `Result<Option<Arc<Environment>>, String>`。A registered environment is returned for either transport；a missing local stdio environment is an error，missing local HTTP is the ambient-client exception，and an unknown non-local id is an error。`make_rmcp_client` only consumes this pre-resolved result before branching on `Stdio` or `StreamableHttp`。[E: codex-rs/codex-mcp/src/runtime.rs:504][E: codex-rs/codex-mcp/src/runtime.rs:520][E: codex-rs/codex-mcp/src/runtime.rs:525][E: codex-rs/codex-mcp/src/runtime.rs:529][E: codex-rs/codex-mcp/src/runtime.rs:531][E: codex-rs/codex-mcp/src/runtime.rs:535][E: codex-rs/codex-mcp/src/rmcp_client.rs:1010][E: codex-rs/codex-mcp/src/rmcp_client.rs:1016][E: codex-rs/codex-mcp/src/rmcp_client.rs:1029][E: codex-rs/codex-mcp/src/rmcp_client.rs:1035]
- Stdio uses `LocalStdioServerLauncher` for a local environment and `ExecutorStdioServerLauncher` backed by the resolved environment for a non-local environment，then constructs `RmcpClient::new_stdio_client_with_protocol_mode` with the session protocol mode。[E: codex-rs/codex-mcp/src/rmcp_client.rs:1049][E: codex-rs/codex-mcp/src/rmcp_client.rs:1058][E: codex-rs/codex-mcp/src/rmcp_client.rs:1063][E: codex-rs/codex-mcp/src/rmcp_client.rs:1069][E: codex-rs/codex-mcp/src/rmcp_client.rs:1076]
- Streamable HTTP uses the ambient `RouteAwareHttpClient` when the resolution exception returns `None`，otherwise it uses `Environment::get_http_client()`；local environments own a route-aware client，while remote environments expose the executor RPC client as their HTTP capability。After resolving a bearer token，the path calls `RmcpClient::new_streamable_http_client_with_protocol_mode`。[E: codex-rs/codex-mcp/src/runtime.rs:495][E: codex-rs/codex-mcp/src/rmcp_client.rs:1086][E: codex-rs/codex-mcp/src/rmcp_client.rs:1089][E: codex-rs/codex-mcp/src/rmcp_client.rs:1092][E: codex-rs/codex-mcp/src/rmcp_client.rs:1097][E: codex-rs/exec-server/src/environment.rs:753][E: codex-rs/exec-server/src/environment.rs:763][E: codex-rs/exec-server/src/environment.rs:774]
