...
> `codex-rs/mcp-server` is the reverse direction from `subsys.mcp.client`: it lets external MCP clients call Codex itself through two tools, `codex` for starting a session and `codex-reply` for continuing an existing thread.[E: codex-rs/mcp-server/src/message_processor.rs:41][E: codex-rs/mcp-server/src/message_processor.rs:321][E: codex-rs/mcp-server/src/message_processor.rs:339][E: codex-rs/mcp-server/src/codex_tool_config.rs:105][E: codex-rs/mcp-server/src/codex_tool_config.rs:224]
...
- `MessageProcessor::new` creates a `ThreadManager` with `SessionSource::Mcp`, shared auth/config/environment state, a models manager and Apps tool cache, and installs the image-generation extension into its registry。[E: codex-rs/mcp-server/src/message_processor.rs:52][E: codex-rs/mcp-server/src/message_processor.rs:63][E: codex-rs/mcp-server/src/message_processor.rs:70][E: codex-rs/mcp-server/src/message_processor.rs:75][E: codex-rs/mcp-server/src/message_processor.rs:78][E: codex-rs/mcp-server/src/message_processor.rs:80]
...
- `handle_initialize` rejects double initialize, records client info into the Codex user-agent suffix, returns server info for `codex-mcp-server`, enables tools and tool-list-changed capabilities, and preserves the non-spec `serverInfo.user_agent` field.[E: codex-rs/mcp-server/src/message_processor.rs:209][E: codex-rs/mcp-server/src/message_processor.rs:216][E: codex-rs/mcp-server/src/message_processor.rs:226][E: codex-rs/mcp-server/src/message_processor.rs:234][E: codex-rs/mcp-server/src/message_processor.rs:237][E: codex-rs/mcp-server/src/message_processor.rs:257][E: codex-rs/mcp-server/src/message_processor.rs:284]
...
- `codex` parses `CodexToolCallParam`, converts it into a Codex `Config`, then spawns `run_codex_tool_session` so the message-processing loop is not blocked.[E: codex-rs/mcp-server/src/message_processor.rs:360][E: codex-rs/mcp-server/src/message_processor.rs:366][E: codex-rs/mcp-server/src/message_processor.rs:400][E: codex-rs/mcp-server/src/message_processor.rs:404]
...
`notifications/cancelled` looks up the thread id by request id, fetches the Codex thread, submits `Op::Interrupt` with the original MCP request id string, and removes the request-id mapping.[E: codex-rs/mcp-server/src/message_processor.rs:524][E: codex-rs/mcp-server/src/message_processor.rs:530][E: codex-rs/mcp-server/src/message_processor.rs:542][E: codex-rs/mcp-server/src/message_processor.rs:551][E: codex-rs/mcp-server/src/message_processor.rs:553][E: codex-rs/mcp-server/src/message_processor.rs:565]
