...
> 当前 TUI 有两类”弹层”：alternate-screen pager `Overlay` 用于 transcript/diff 等全屏查看；bottom-pane `BottomPaneView` 用于 composer 区域内的 modal/popup。不要再引用已删除的 exit-confirmation 设计文档。[E: codex-rs/tui/src/pager_overlay.rs:53][E: codex-rs/tui/src/bottom_pane/bottom_pane_view.rs:19][E: codex-rs/tui/src/bottom_pane/mod.rs:225]
...
app input handler 在 transcript shortcut 命中时调用 `tui.enter_alt_screen()`，再把 `self.overlay` 设成 `Overlay::new_transcript(self.transcript_cells.clone(), self.keymap.pager.clone())` 并 schedule frame。[E: codex-rs/tui/src/app/input.rs:178][E: codex-rs/tui/src/app/input.rs:180][E: codex-rs/tui/src/app/input.rs:181][E: codex-rs/tui/src/app/input.rs:182][E: codex-rs/tui/src/app/input.rs:183][E: codex-rs/tui/src/app/input.rs:185]

`DiffResult` 分支也是 alternate-screen static overlay：先 `on_diff_complete`，enter alt screen，把 diff text 转成 lines 或空 diff message，然后 `Overlay::new_static_with_lines(..., "D I F F", pager keymap)`。[E: codex-rs/tui/src/app/event_dispatch.rs:501][E: codex-rs/tui/src/app/event_dispatch.rs:503][E: codex-rs/tui/src/app/event_dispatch.rs:505][E: codex-rs/tui/src/app/event_dispatch.rs:506][E: codex-rs/tui/src/app/event_dispatch.rs:509][E: codex-rs/tui/src/app/event_dispatch.rs:511][E: codex-rs/tui/src/app/event_dispatch.rs:513][E: codex-rs/tui/src/app/event_dispatch.rs:514]
...
源码中直接实现 `BottomPaneView` 的 dialog/picker 包括 approval overlay、MCP server elicitation、request-user-input、app link、custom prompt、experimental features、feedback note、hooks browser、list selection、memories settings、multi-select picker、skills toggle、status line setup 和 title setup。[E: codex-rs/tui/src/bottom_pane/approval_overlay.rs:565][E: codex-rs/tui/src/bottom_pane/mcp_server_elicitation.rs:1507][E: codex-rs/tui/src/bottom_pane/request_user_input/mod.rs:1181][E: codex-rs/tui/src/bottom_pane/app_link_view.rs:688][E: codex-rs/tui/src/bottom_pane/custom_prompt_view.rs:128][E: codex-rs/tui/src/bottom_pane/experimental_features_view.rs:166][E: codex-rs/tui/src/bottom_pane/feedback_view.rs:93][E: codex-rs/tui/src/bottom_pane/hooks_browser_view.rs:570][E: codex-rs/tui/src/bottom_pane/list_selection_view.rs:952][E: codex-rs/tui/src/bottom_pane/memories_settings_view.rs:300][E: codex-rs/tui/src/bottom_pane/multi_select_picker.rs:517][E: codex-rs/tui/src/bottom_pane/skills_toggle_view.rs:234][E: codex-rs/tui/src/bottom_pane/status_line_setup.rs:373][E: codex-rs/tui/src/bottom_pane/title_setup.rs:347]

hooks browser 现在把 `SessionEnd` 作为独立 event row，并说明它在 session 结束前运行。skills toggle 的 display row 保留完整 skill 名，不再提前截断；宽度处理交给通用 list renderer。searchable list 为空时，empty message 也会与 search input 对齐。[E: codex-rs/tui/src/bottom_pane/hooks_browser_view.rs:738][E: codex-rs/tui/src/bottom_pane/hooks_browser_view.rs:746][E: codex-rs/tui/src/bottom_pane/hooks_browser_view.rs:754][E: codex-rs/tui/src/bottom_pane/hooks_browser_view.rs:762][E: codex-rs/tui/src/bottom_pane/skills_toggle_view.rs:138][E: codex-rs/tui/src/bottom_pane/skills_toggle_view.rs:147][E: codex-rs/tui/src/bottom_pane/skills_toggle_view.rs:148][E: codex-rs/tui/src/bottom_pane/list_selection_view.rs:1288][E: codex-rs/tui/src/bottom_pane/list_selection_view.rs:1289]

bottom pane 的 key routing 给 active view 第一优先级；Ctrl-C 也先给 active view 的 `on_ctrl_c`，view complete 后才 pop view 并 request redraw。[E: codex-rs/tui/src/bottom_pane/mod.rs:613][E: codex-rs/tui/src/bottom_pane/mod.rs:615][E: codex-rs/tui/src/bottom_pane/mod.rs:635][E: codex-rs/tui/src/bottom_pane/mod.rs:652][E: codex-rs/tui/src/bottom_pane/mod.rs:705][E: codex-rs/tui/src/bottom_pane/mod.rs:706][E: codex-rs/tui/src/bottom_pane/mod.rs:710][E: codex-rs/tui/src/bottom_pane/mod.rs:712]

## Gotchas

- exit confirmation 设计文档已不存在；当前可证实的退出语义应从 `AppEvent::Exit`、`handle_exit_mode` 和 bottom-pane/ChatWidget Ctrl-C 代码重建。[E: codex-rs/tui/src/app_event.rs:298][E: codex-rs/tui/src/app/event_dispatch.rs:393][E: codex-rs/tui/src/app/event_dispatch.rs:2468][E: codex-rs/tui/src/chatwidget/interaction.rs:364][E: codex-rs/tui/src/chatwidget/interaction.rs:409]
- alternate-screen overlay 和 bottom-pane modal 不共享同一个 stack；前者存在 `App.overlay`，后者存在 `BottomPane.view_stack`。[E: codex-rs/tui/src/app.rs:529][E: codex-rs/tui/src/bottom_pane/mod.rs:225]
