...
> TUI 事件系统有四条主入口：内部 `AppEvent` channel、active thread event channel、terminal `TuiEventStream`、app-server event stream；`App::run` 的 select loop 把它们分别送到 `handle_event`、`handle_active_thread_event`、`handle_tui_event` 和 `handle_app_server_event`。[E: codex-rs/tui/src/app.rs:1168][E: codex-rs/tui/src/app.rs:1170][E: codex-rs/tui/src/app.rs:1176][E: codex-rs/tui/src/app.rs:1195][E: codex-rs/tui/src/app.rs:1206]
...
`AppEvent` 是 TUI 内部动作总线，覆盖 thread/agent 操作、message history、session lifecycle、exit/logout、Codex op forwarding、file search、rate-limit refresh 和更多 UI actions。[E: codex-rs/tui/src/app_event.rs:146][E: codex-rs/tui/src/app_event.rs:148][E: codex-rs/tui/src/app_event.rs:153][E: codex-rs/tui/src/app_event.rs:159][E: codex-rs/tui/src/app_event.rs:179][E: codex-rs/tui/src/app_event.rs:198][E: codex-rs/tui/src/app_event.rs:207][E: codex-rs/tui/src/app_event.rs:246][E: codex-rs/tui/src/app_event.rs:249][E: codex-rs/tui/src/app_event.rs:257][E: codex-rs/tui/src/app_event.rs:271][E: codex-rs/tui/src/app_event.rs:282]

rate-limit refresh 有明确 origin：startup prefetch、`/status` command、`/usage` menu refresh 和 reset-credit consume；`RateLimitsLoaded` 带回 origin 与结果，供 UI 对应更新。[E: codex-rs/tui/src/app_event.rs:125][E: codex-rs/tui/src/app_event.rs:127][E: codex-rs/tui/src/app_event.rs:130][E: codex-rs/tui/src/app_event.rs:132][E: codex-rs/tui/src/app_event.rs:134][E: codex-rs/tui/src/app_event.rs:314][E: codex-rs/tui/src/app_event.rs:315][E: codex-rs/tui/src/app_event.rs:317][E: codex-rs/tui/src/app/event_dispatch.rs:866][E: codex-rs/tui/src/app/event_dispatch.rs:901]
...
关键分支包括 commit tick 到 `chat_widget.on_commit_tick`、shutdown-first exit 先显示 feedback 再 `handle_exit_mode`、fatal exit 直接返回 fatal reason、`CodexOp` 先 `prepare_local_op_submission` 再 submit active thread、`SubmitThreadOp` 按 thread id submit，`DiffResult` 切到 alternate-screen static overlay。[E: codex-rs/tui/src/app/event_dispatch.rs:311][E: codex-rs/tui/src/app/event_dispatch.rs:314][E: codex-rs/tui/src/app/event_dispatch.rs:316][E: codex-rs/tui/src/app/event_dispatch.rs:318][E: codex-rs/tui/src/app/event_dispatch.rs:333][E: codex-rs/tui/src/app/event_dispatch.rs:336][E: codex-rs/tui/src/app/event_dispatch.rs:337][E: codex-rs/tui/src/app/event_dispatch.rs:338][E: codex-rs/tui/src/app/event_dispatch.rs:439][E: codex-rs/tui/src/app/event_dispatch.rs:446][E: codex-rs/tui/src/app/event_dispatch.rs:450][E: codex-rs/tui/src/app/event_dispatch.rs:456]

`handle_exit_mode` 的 shutdown-first path 记录 pending shutdown thread，给 `shutdown_current_thread` 一个 2 秒 UI escape-hatch timeout，然后返回 user-requested exit；immediate path 清 pending id 后直接退出。[E: codex-rs/tui/src/app/event_dispatch.rs:2366][E: codex-rs/tui/src/app/event_dispatch.rs:2372][E: codex-rs/tui/src/app/event_dispatch.rs:2375][E: codex-rs/tui/src/app/event_dispatch.rs:2383][E: codex-rs/tui/src/app/event_dispatch.rs:2385][E: codex-rs/tui/src/app/event_dispatch.rs:2390][E: codex-rs/tui/src/app/event_dispatch.rs:2393][E: codex-rs/tui/src/app/event_dispatch.rs:2394][E: codex-rs/tui/src/app/event_dispatch.rs:2396]

## App-Server Events

`handle_app_server_event` 处理 lagged、server notification、server request 和 disconnect；disconnect 会给 chat widget 加错误并发送 `FatalExitRequest`。[E: codex-rs/tui/src/app/app_server_events.rs:31][E: codex-rs/tui/src/app/app_server_events.rs:36][E: codex-rs/tui/src/app/app_server_events.rs:37][E: codex-rs/tui/src/app/app_server_events.rs:45][E: codex-rs/tui/src/app/app_server_events.rs:49][E: codex-rs/tui/src/app/app_server_events.rs:53][E: codex-rs/tui/src/app/app_server_events.rs:55][E: codex-rs/tui/src/app/app_server_events.rs:56]

server notification 先处理 app-level effects：resolved server request 会 dismiss pending request，MCP status 更新刷新 expected servers，account rate limits/account updated 有专门分支更新 ChatWidget；其他 notification 再进入聊天协议处理。[E: codex-rs/tui/src/app/app_server_events.rs:61][E: codex-rs/tui/src/app/app_server_events.rs:67][E: codex-rs/tui/src/app/app_server_events.rs:68][E: codex-rs/tui/src/app/app_server_events.rs:72][E: codex-rs/tui/src/app/app_server_events.rs:75][E: codex-rs/tui/src/app/app_server_events.rs:78][E: codex-rs/tui/src/app/app_server_events.rs:79][E: codex-rs/tui/src/app/app_server_events.rs:83][E: codex-rs/tui/src/app/app_server_events.rs:93]

server request routing 把 MCP elicitation 中可交互的 app link、form 和 approval 变成 thread interactive request，再通过 `push_thread_interactive_request` 送进对应 thread 的 interactive request surface；`OpenAiForm`/`Url` fallback 会直接 decline，不进入 UI request surface。[E: codex-rs/tui/src/app/thread_routing.rs:271][E: codex-rs/tui/src/app/thread_routing.rs:278][E: codex-rs/tui/src/app/thread_routing.rs:289][E: codex-rs/tui/src/app/thread_routing.rs:292][E: codex-rs/tui/src/app/thread_routing.rs:301][E: codex-rs/tui/src/app/thread_routing.rs:305][E: codex-rs/tui/src/app/thread_routing.rs:309][E: codex-rs/tui/src/app/thread_routing.rs:313][E: codex-rs/tui/src/app/thread_routing.rs:342][E: codex-rs/tui/src/app/thread_routing.rs:349][E: codex-rs/tui/src/app/thread_routing.rs:353]
...
- `AppEvent::CodexOp` 是内部转发路径，不代表 app-server notification；真正的 server notifications 先由 `app_server_events.rs` 处理，再进入 `ChatWidget::handle_server_notification`。[E: codex-rs/tui/src/app_event.rs:244][E: codex-rs/tui/src/app/app_server_events.rs:45][E: codex-rs/tui/src/chatwidget/protocol.rs:4]
