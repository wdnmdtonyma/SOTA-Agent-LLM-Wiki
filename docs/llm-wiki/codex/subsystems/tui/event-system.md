...
`AppEvent` 是 TUI 内部动作总线，覆盖 thread/agent 操作、message history、session lifecycle、exit/logout、Codex op forwarding、file search、rate-limit refresh 和更多 UI actions。[E: codex-rs/tui/src/app_event.rs:179][E: codex-rs/tui/src/app_event.rs:181][E: codex-rs/tui/src/app_event.rs:186][E: codex-rs/tui/src/app_event.rs:192][E: codex-rs/tui/src/app_event.rs:213][E: codex-rs/tui/src/app_event.rs:239][E: codex-rs/tui/src/app_event.rs:250][E: codex-rs/tui/src/app_event.rs:298][E: codex-rs/tui/src/app_event.rs:301][E: codex-rs/tui/src/app_event.rs:309][E: codex-rs/tui/src/app_event.rs:320][E: codex-rs/tui/src/app_event.rs:331]

rate-limit refresh 有明确 origin：startup prefetch、`/status` command、`/usage` menu、reset picker 和 reset-credit consume；`RateLimitsLoaded` 带 origin、hard-stop generation 与结果，旧 generation 的 response 不会覆盖更新后的 hard-stop snapshot。[E: codex-rs/tui/src/app_event.rs:156][E: codex-rs/tui/src/app_event.rs:161][E: codex-rs/tui/src/app/event_dispatch.rs:886][E: codex-rs/tui/src/app/event_dispatch.rs:893][E: codex-rs/tui/src/app/event_dispatch.rs:940]
...
persistent-history batch path 使用 `LookupMessageHistoryBatch { thread_id, cursor, log_id }`，结果以 `HistoryLookupResponse::{Batch,BatchError}` 路由回原 thread channel；single-entry lookup 仍走同一 response enum 的 `Entry` variant。[E: codex-rs/tui/src/app/event_dispatch.rs:474][E: codex-rs/tui/src/app/event_dispatch.rs:482][E: codex-rs/tui/src/app/event_dispatch.rs:497]

transcript prompt edit 是显式 `ForkSessionForPromptEdit` route：dispatcher 读取完整 thread，在选中 user message 之前 fork（若它是首条则 start fresh），替换 widget 后把原 prompt 放回 composer；失败时也恢复 prompt。[E: codex-rs/tui/src/app/event_dispatch.rs:234][E: codex-rs/tui/src/app/event_dispatch.rs:250][E: codex-rs/tui/src/app/event_dispatch.rs:259][E: codex-rs/tui/src/app/event_dispatch.rs:270][E: codex-rs/tui/src/app/event_dispatch.rs:281][E: codex-rs/tui/src/app/event_dispatch.rs:293]

usage reset 由 picker/confirmation/consume/result AppEvents 串行驱动：confirmation 生成 idempotency key，consume 的 `Reset`/`AlreadyRedeemed` 结果触发一次 rate-limit refresh，再更新剩余 credits。[E: codex-rs/tui/src/app/event_dispatch.rs:996][E: codex-rs/tui/src/app/event_dispatch.rs:1020][E: codex-rs/tui/src/app/event_dispatch.rs:1036][E: codex-rs/tui/src/app/event_dispatch.rs:1052]

关键分支包括 commit tick 到 `chat_widget.on_commit_tick`、shutdown-first exit 先显示 feedback 再 `handle_exit_mode`、fatal exit 直接返回 fatal reason、`CodexOp` 先 `prepare_local_op_submission` 再 submit active thread、`SubmitThreadOp` 按 thread id submit，`DiffResult` 切到 alternate-screen static overlay。[E: codex-rs/tui/src/app/event_dispatch.rs:390][E: codex-rs/tui/src/app/event_dispatch.rs:393][E: codex-rs/tui/src/app/event_dispatch.rs:395][E: codex-rs/tui/src/app/event_dispatch.rs:397][E: codex-rs/tui/src/app/event_dispatch.rs:412][E: codex-rs/tui/src/app/event_dispatch.rs:415][E: codex-rs/tui/src/app/event_dispatch.rs:426][E: codex-rs/tui/src/app/event_dispatch.rs:426][E: codex-rs/tui/src/app/event_dispatch.rs:494][E: codex-rs/tui/src/app/event_dispatch.rs:501][E: codex-rs/tui/src/app/event_dispatch.rs:505][E: codex-rs/tui/src/app/event_dispatch.rs:511]

`handle_exit_mode` 的 shutdown-first path 记录 pending shutdown thread，给 `shutdown_current_thread` 一个 2 秒 UI escape-hatch timeout，然后返回 user-requested exit；immediate path 清 pending id 后直接退出。[E: codex-rs/tui/src/app/event_dispatch.rs:2468][E: codex-rs/tui/src/app/event_dispatch.rs:2474][E: codex-rs/tui/src/app/event_dispatch.rs:2477][E: codex-rs/tui/src/app/event_dispatch.rs:2485][E: codex-rs/tui/src/app/event_dispatch.rs:2487][E: codex-rs/tui/src/app/event_dispatch.rs:2492][E: codex-rs/tui/src/app/event_dispatch.rs:2495][E: codex-rs/tui/src/app/event_dispatch.rs:2496][E: codex-rs/tui/src/app/event_dispatch.rs:2498]
...
- UI 退出默认应走 `ExitMode::ShutdownFirst`，`Immediate` 是 last-resort escape hatch，注释明确可能丢背景任务、rollout flush 或 child cleanup。[E: codex-rs/tui/src/app_event.rs:274][E: codex-rs/tui/src/app_event.rs:277][E: codex-rs/tui/src/app_event.rs:1144][E: codex-rs/tui/src/app_event.rs:1146][E: codex-rs/tui/src/app_event.rs:1151][I]
