...
- `AppServerTransport` 表示 configured listener：`Stdio`、`UnixSocket { socket_path }`、`WebSocket { bind_address }`、`Off`；`DEFAULT_LISTEN_URL` 是 `stdio://` [E: codex-rs/app-server-transport/src/transport/mod.rs:76][E: codex-rs/app-server-transport/src/transport/mod.rs:77][E: codex-rs/app-server-transport/src/transport/mod.rs:78][E: codex-rs/app-server-transport/src/transport/mod.rs:79][E: codex-rs/app-server-transport/src/transport/mod.rs:80][E: codex-rs/app-server-transport/src/transport/mod.rs:115]。
- `from_listen_url` accepts `stdio://`, `unix://`, `unix://PATH`, `off`, and `ws://IP:PORT`; unsupported forms produce an error whose message lists those expected schemes [E: codex-rs/app-server-transport/src/transport/mod.rs:93][E: codex-rs/app-server-transport/src/transport/mod.rs:95][E: codex-rs/app-server-transport/src/transport/mod.rs:117][E: codex-rs/app-server-transport/src/transport/mod.rs:122][E: codex-rs/app-server-transport/src/transport/mod.rs:144][E: codex-rs/app-server-transport/src/transport/mod.rs:147][E: codex-rs/app-server-transport/src/transport/mod.rs:151][E: codex-rs/app-server-transport/src/transport/mod.rs:155][E: codex-rs/app-server-transport/src/transport/mod.rs:158]。
- `TransportEvent` carries connection opened/closed and incoming JSON-RPC messages; `ConnectionOrigin` distinguishes Stdio, InProcess, WebSocket, and RemoteControl [E: codex-rs/app-server-transport/src/transport/mod.rs:173][E: codex-rs/app-server-transport/src/transport/mod.rs:176][E: codex-rs/app-server-transport/src/transport/mod.rs:182][E: codex-rs/app-server-transport/src/transport/mod.rs:185][E: codex-rs/app-server-transport/src/transport/mod.rs:192][E: codex-rs/app-server-transport/src/transport/mod.rs:193][E: codex-rs/app-server-transport/src/transport/mod.rs:194][E: codex-rs/app-server-transport/src/transport/mod.rs:195][E: codex-rs/app-server-transport/src/transport/mod.rs:196]。
- app-server-local `ConnectionState` retains each connection's origin. On close the main loop removes that state, closes the RPC gate, notifies the outbound router, and starts processor cleanup; a stdio close terminates single-client mode, whereas closing other origins does not by itself terminate the process [E: codex-rs/app-server/src/transport.rs:40][E: codex-rs/app-server/src/transport.rs:41][E: codex-rs/app-server/src/lib.rs:1041][E: codex-rs/app-server/src/lib.rs:1045][E: codex-rs/app-server/src/lib.rs:1047][E: codex-rs/app-server/src/lib.rs:1053][E: codex-rs/app-server/src/lib.rs:1060]。
...
- Transport channels use bounded capacity `CHANNEL_CAPACITY = 128`; inbound JSON payloads parse to `JSONRPCMessage` and are wrapped as `TransportEvent::IncomingMessage` [E: codex-rs/app-server-transport/src/transport/mod.rs:25][E: codex-rs/app-server-transport/src/transport/mod.rs:205][E: codex-rs/app-server-transport/src/transport/mod.rs:211][E: codex-rs/app-server-transport/src/transport/mod.rs:213][E: codex-rs/app-server-transport/src/transport/mod.rs:222][E: codex-rs/app-server-transport/src/transport/mod.rs:228]。
- `OutboundConnectionState` lives in app-server local glue and stores initialized/experimental flags, opted-out notification methods, writer channel, and optional disconnect token [E: codex-rs/app-server/src/transport.rs:65][E: codex-rs/app-server/src/transport.rs:66][E: codex-rs/app-server/src/transport.rs:67][E: codex-rs/app-server/src/transport.rs:68][E: codex-rs/app-server/src/transport.rs:69][E: codex-rs/app-server/src/transport.rs:70]。
- `OutgoingMessage::AppServerNotification` 现在承载扁平化的 `ServerNotificationEnvelope`；envelope 除具体 notification 外还带 optional `emitted_at_ms`，当前 server 在 fan-out 前写入该 Unix 毫秒时间，而 optional 形态让客户端仍可解码旧 server 消息。[E: codex-rs/app-server-transport/src/outgoing_message.rs:25][E: codex-rs/app-server-transport/src/outgoing_message.rs:29][E: codex-rs/app-server-protocol/src/protocol/common.rs:2009][E: codex-rs/app-server-protocol/src/protocol/common.rs:2011][E: codex-rs/app-server-protocol/src/protocol/common.rs:2019]
...
4. inbound enqueue uses `try_send`; when the queue is full for a request, it attempts to send an overload JSON-RPC error to that request's writer, while full non-request events await `transport_event_tx.send(event)` [E: codex-rs/app-server-transport/src/transport/mod.rs:222][E: codex-rs/app-server-transport/src/transport/mod.rs:232][E: codex-rs/app-server-transport/src/transport/mod.rs:235][E: codex-rs/app-server-transport/src/transport/mod.rs:237][E: codex-rs/app-server-transport/src/transport/mod.rs:239][E: codex-rs/app-server-transport/src/transport/mod.rs:247][E: codex-rs/app-server-transport/src/transport/mod.rs:259]。
5. app-server outbound routing sends targeted messages directly and broadcasts only to initialized connections; notifications with experimental reasons or opted-out methods can be skipped per connection [E: codex-rs/app-server/src/transport.rs:101][E: codex-rs/app-server/src/transport.rs:110][E: codex-rs/app-server/src/transport.rs:112][E: codex-rs/app-server/src/transport.rs:117][E: codex-rs/app-server/src/transport.rs:119][E: codex-rs/app-server/src/transport.rs:201][E: codex-rs/app-server/src/transport.rs:206][E: codex-rs/app-server/src/transport.rs:215][E: codex-rs/app-server/src/transport.rs:219]。
6. outbound write to disconnect-capable connections uses `try_send` and disconnects on a full writer queue; non-disconnectable connections await send and disconnect only if the writer closes [E: codex-rs/app-server/src/transport.rs:157][E: codex-rs/app-server/src/transport.rs:158][E: codex-rs/app-server/src/transport.rs:160][E: codex-rs/app-server/src/transport.rs:164][E: codex-rs/app-server/src/transport.rs:166][E: codex-rs/app-server/src/transport.rs:170]。
7. `ConnectionClosed` removes the retained connection state, closes new RPC admission, sends `OutboundControlEvent::Closed`, and runs domain cleanup asynchronously; if the outbound router is gone the server stops, and in single-client mode a closed stdio origin also stops the server [E: codex-rs/app-server/src/lib.rs:1041][E: codex-rs/app-server/src/lib.rs:1045][E: codex-rs/app-server/src/lib.rs:1047][E: codex-rs/app-server/src/lib.rs:1053][E: codex-rs/app-server/src/lib.rs:1060]。

## Remote-control host device

remote-control WebSocket handshake 会附加 `x-codex-host-device-kind` header。macOS 上 `host_device_kind()` 用 2 秒 timeout 调用 `/usr/sbin/system_profiler -detailLevel mini SPHardwareDataType -json`，只在 `SPHardwareDataType[0].machine_name == "Mac mini"` 时返回 `"mac_mini"`；非 macOS 恒为 `None`，识别结果按进程缓存。[E: codex-rs/app-server-transport/src/transport/remote_control/host_device.rs:4][E: codex-rs/app-server-transport/src/transport/remote_control/host_device.rs:6][E: codex-rs/app-server-transport/src/transport/remote_control/host_device.rs:22][E: codex-rs/app-server-transport/src/transport/remote_control/host_device.rs:27][E: codex-rs/app-server-transport/src/transport/remote_control/host_device.rs:32][E: codex-rs/app-server-transport/src/transport/remote_control/host_device.rs:42][E: codex-rs/app-server-transport/src/transport/remote_control/host_device.rs:68][E: codex-rs/app-server-transport/src/transport/remote_control/host_device.rs:69][E: codex-rs/app-server-transport/src/transport/remote_control/websocket.rs:1295][E: codex-rs/app-server-transport/src/transport/remote_control/websocket.rs:1298]

这不是新的 client RPC method：它只影响 remote-control 出站 handshake 身份，客户端仍用现有 `remoteControl/*` methods 管理 pairing/status。

## 设计动机与权衡

- inbound overload behavior gives request callers a concrete retryable error while preserving response/notification delivery by awaiting the bounded queue on non-request messages [E: codex-rs/app-server-transport/src/transport/mod.rs:235][E: codex-rs/app-server-transport/src/transport/mod.rs:239][E: codex-rs/app-server-transport/src/transport/mod.rs:247][E: codex-rs/app-server-transport/src/transport/mod.rs:259][I]。
