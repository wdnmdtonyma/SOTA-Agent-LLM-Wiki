...
- `AppServerEvent` 统一表示 `Lagged`, `ServerNotification`, `ServerRequest`, `Disconnected` [E: codex-rs/app-server-client/src/lib.rs:97][E: codex-rs/app-server-client/src/lib.rs:98][E: codex-rs/app-server-client/src/lib.rs:99][E: codex-rs/app-server-client/src/lib.rs:101]。
