...
- fallback buffer 不增加模型 hard context window，只延后 auto-compaction scope threshold。[E: codex-rs/core/src/session/context_window.rs:84][E: codex-rs/core/src/session/context_window.rs:101][E: codex-rs/core/src/session/context_window.rs:107]
