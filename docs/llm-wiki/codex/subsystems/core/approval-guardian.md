...
| `codex-rs/core/src/guardian/approval_request.rs` | `GuardianApprovalRequest` enum、action JSON 序列化、protocol assessment action 映射。[E: codex-rs/core/src/guardian/approval_request.rs:17][E: codex-rs/core/src/guardian/approval_request.rs:259][E: codex-rs/core/src/guardian/approval_request.rs:375] |
...
| `codex-rs/core/src/guardian/review_session.rs` | reusable trunk/ephemeral sessions、review lock、subagent spawn、prompt submit、read-only review turn settings。[E: codex-rs/core/src/guardian/review_session.rs:93][E: codex-rs/core/src/guardian/review_session.rs:291][E: codex-rs/core/src/guardian/review_session.rs:607][E: codex-rs/core/src/guardian/review_session.rs:647][E: codex-rs/core/src/guardian/review_session.rs:751] |

## 数据模型

| 实体 | 当前形态 |
|---|---|
| `GuardianApprovalRequest` | 变体覆盖 `Shell`、`ExecCommand`、Unix `Execve`、`ApplyPatch`、`NetworkAccess`、`McpToolCall`、`RequestPermissions`。[E: codex-rs/core/src/guardian/approval_request.rs:17][E: codex-rs/core/src/guardian/approval_request.rs:18][E: codex-rs/core/src/guardian/approval_request.rs:26][E: codex-rs/core/src/guardian/approval_request.rs:36][E: codex-rs/core/src/guardian/approval_request.rs:44][E: codex-rs/core/src/guardian/approval_request.rs:50][E: codex-rs/core/src/guardian/approval_request.rs:59][E: codex-rs/core/src/guardian/approval_request.rs:71] |
| Action JSON | request 先序列化为 tool-specific JSON，长字符串会按 `GUARDIAN_MAX_ACTION_STRING_TOKENS` 截断。[E: codex-rs/core/src/guardian/approval_request.rs:216][E: codex-rs/core/src/guardian/approval_request.rs:259][E: codex-rs/core/src/guardian/approval_request.rs:270][E: codex-rs/core/src/guardian/approval_request.rs:287][E: codex-rs/core/src/guardian/approval_request.rs:316][E: codex-rs/core/src/guardian/approval_request.rs:330][E: codex-rs/core/src/guardian/approval_request.rs:349][E: codex-rs/core/src/guardian/approval_request.rs:366] |
...
5. `GuardianReviewSessionManager::run_review` 用 reuse key 管理 trunk；key mismatch 且 trunk 空闲时替换 trunk，key mismatch 或 trunk busy 时走 ephemeral review。[E: codex-rs/core/src/guardian/review_session.rs:324][E: codex-rs/core/src/guardian/review_session.rs:329][E: codex-rs/core/src/guardian/review_session.rs:343][E: codex-rs/core/src/guardian/review_session.rs:350][E: codex-rs/core/src/guardian/review_session.rs:401][E: codex-rs/core/src/guardian/review_session.rs:411][E: codex-rs/core/src/guardian/review_session.rs:414]
6. Guardian 子 Codex 通过 `run_codex_thread_interactive` spawn，source 是 `SubAgentSource::Other("guardian")`；review turn submit 时强制 `approval_policy: Never`、`permission_profile: read_only()`、collaboration mode `Default`。[E: codex-rs/core/src/guardian/review_session.rs:622][E: codex-rs/core/src/guardian/review_session.rs:629][E: codex-rs/core/src/guardian/review_session.rs:751][E: codex-rs/core/src/guardian/review_session.rs:765][E: codex-rs/core/src/guardian/review_session.rs:775][E: codex-rs/core/src/guardian/review_session.rs:777][E: codex-rs/core/src/guardian/review_session.rs:780][E: codex-rs/core/src/guardian/review_session.rs:781]
7. review prompt 构建前会把 parent session 已批准 hosts 同步到 guardian session 的 network approval service。[E: codex-rs/core/src/guardian/review_session.rs:705][E: codex-rs/core/src/guardian/review_session.rs:710][E: codex-rs/core/src/guardian/review_session.rs:712][E: codex-rs/core/src/guardian/review_session.rs:715]

## 设计动机与权衡

- Guardian 使用独立 child Codex 而不是 parent turn 内直接自评，是为了把审查运行在单独 prompt、read-only permission profile 和 `AskForApproval::Never` 下。[E: codex-rs/core/src/guardian/review_session.rs:622][E: codex-rs/core/src/guardian/review_session.rs:751][E: codex-rs/core/src/guardian/review_session.rs:775][E: codex-rs/core/src/guardian/review_session.rs:777][I]
- reusable trunk 降低重复 reviewer 启动成本；ephemeral review 在 key mismatch 或 trunk lock 竞争时避免串行阻塞。[E: codex-rs/core/src/guardian/review_session.rs:343][E: codex-rs/core/src/guardian/review_session.rs:401][E: codex-rs/core/src/guardian/review_session.rs:411][I]
