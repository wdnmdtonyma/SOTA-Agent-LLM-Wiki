...
symbols: [ModeKind, CollaborationMode, Settings, CollaborationModeMask, CollaborationModeState, CollaborationModeInstructions, WorldStateSection, PlanHandler, RequestUserInputHandler, ThreadSettingsOverrides]
...
| `codex-rs/protocol/src/config_types.rs` | `ModeKind`、visible modes、mode capability、`CollaborationMode`、settings/mask。[E: codex-rs/protocol/src/config_types.rs:610][E: codex-rs/protocol/src/config_types.rs:632][E: codex-rs/protocol/src/config_types.rs:648][E: codex-rs/protocol/src/config_types.rs:656][E: codex-rs/protocol/src/config_types.rs:726] |
| `codex-rs/protocol/src/protocol.rs` | collaboration mode prompt tags 与 `ThreadSettingsOverrides.collaboration_mode`。[E: codex-rs/protocol/src/protocol.rs:114][E: codex-rs/protocol/src/protocol.rs:115][E: codex-rs/protocol/src/protocol.rs:457][E: codex-rs/protocol/src/protocol.rs:502] |
| `codex-rs/core/src/context/world_state/collaboration_mode.rs` | `CollaborationModeState` 保存 mode snapshot 与非空 instructions，并实现 full/diff fragment rendering。[E: codex-rs/core/src/context/world_state/collaboration_mode.rs:9][E: codex-rs/core/src/context/world_state/collaboration_mode.rs:30][E: codex-rs/core/src/context/world_state/collaboration_mode.rs:50] |
| `codex-rs/core/src/session/world_state.rs` | 每 step 从当前 turn context 构造 typed world state，并按 feature gate 加入 collaboration section。[E: codex-rs/core/src/session/world_state.rs:17][E: codex-rs/core/src/session/world_state.rs:36][E: codex-rs/core/src/session/world_state.rs:70][E: codex-rs/core/src/session/world_state.rs:75] |
| `codex-rs/core/src/session/mod.rs` | session 默认 collaboration mode 与 initial context 注入。[E: codex-rs/core/src/session/mod.rs:620][E: codex-rs/core/src/session/mod.rs:622][E: codex-rs/core/src/session/mod.rs:3176][E: codex-rs/core/src/session/mod.rs:3208] |
...
| `CollaborationMode` | 字段是 `mode` 和 `settings`。[E: codex-rs/protocol/src/config_types.rs:653][E: codex-rs/protocol/src/config_types.rs:656][E: codex-rs/protocol/src/config_types.rs:657][E: codex-rs/protocol/src/config_types.rs:658] |
| `Settings` | 包含 `model`、可选 `reasoning_effort`、可选 `developer_instructions`。[E: codex-rs/protocol/src/config_types.rs:726][E: codex-rs/protocol/src/config_types.rs:728][E: codex-rs/protocol/src/config_types.rs:729][E: codex-rs/protocol/src/config_types.rs:730][E: codex-rs/protocol/src/config_types.rs:731] |
| `CollaborationModeMask` | 可选覆盖 mode/model/reasoning/developer instructions；`name` 是 metadata，不参与 `apply_mask` 的 runtime output。[E: codex-rs/protocol/src/config_types.rs:734][E: codex-rs/protocol/src/config_types.rs:737][E: codex-rs/protocol/src/config_types.rs:738][E: codex-rs/protocol/src/config_types.rs:739][E: codex-rs/protocol/src/config_types.rs:740][E: codex-rs/protocol/src/config_types.rs:741][E: codex-rs/protocol/src/config_types.rs:742][E: codex-rs/protocol/src/config_types.rs:707] |

## 控制流

1. session start 时构造 `ModeKind::Default` 的 `CollaborationMode`，settings 取当前 model、config reasoning effort，developer instructions 为 None。[E: codex-rs/core/src/session/mod.rs:620][E: codex-rs/core/src/session/mod.rs:622][E: codex-rs/core/src/session/mod.rs:623][E: codex-rs/core/src/session/mod.rs:624][E: codex-rs/core/src/session/mod.rs:625][E: codex-rs/core/src/session/mod.rs:626][E: codex-rs/core/src/session/mod.rs:627]
...
3. `ThreadSettingsOverrides.collaboration_mode` 的注释说明该字段优先于 model、effort 和 developer instructions。[E: codex-rs/protocol/src/protocol.rs:502][E: codex-rs/protocol/src/protocol.rs:503][E: codex-rs/protocol/src/protocol.rs:504]
...
- model 和 reasoning effort 暂时存放在 `CollaborationMode.settings`，session start 处还有 TODO 说明未来可能整合 config.model/config.model_reasoning_effort 与 collaboration mode。[E: codex-rs/core/src/session/mod.rs:620][E: codex-rs/protocol/src/config_types.rs:667][E: codex-rs/protocol/src/config_types.rs:671][I]
- thread settings fallback 使用 `with_updates(model, effort, None)`，避免只改 model/effort 时意外清掉 active mode 或 developer instructions。[E: codex-rs/core/src/session/handlers.rs:142][E: codex-rs/core/src/session/handlers.rs:148][E: codex-rs/protocol/src/config_types.rs:681][E: codex-rs/protocol/src/config_types.rs:692][I]
- runtime hard gate 主要体现在 tool handlers 和 prompt instructions；Plan template 禁止 mutating work，但 `ModeKind` enum 本身并不是全局 filesystem write lock。[E: codex-rs/core/src/tools/handlers/plan.rs:84][E: codex-rs/core/src/tools/handlers/request_user_input.rs:65][E: codex-rs/collaboration-mode-templates/templates/plan.md:34][E: codex-rs/protocol/src/config_types.rs:648][I]
