...
- `RolloutRecorder` 只持有 command sender、writer task observability 和 rollout path；actual file I/O 由 `RolloutWriterState` 执行。[E: codex-rs/rollout/src/recorder.rs:85][E: codex-rs/rollout/src/recorder.rs:86][E: codex-rs/rollout/src/recorder.rs:87][E: codex-rs/rollout/src/recorder.rs:88][E: codex-rs/rollout/src/recorder.rs:1632]
- `RolloutRecorderParams` 只有 `Create` 和 `Resume` 两种形态；create carries thread/session metadata and dynamic tools, resume carries an existing path.[E: codex-rs/rollout/src/recorder.rs:93][E: codex-rs/rollout/src/recorder.rs:94][E: codex-rs/rollout/src/recorder.rs:96][E: codex-rs/rollout/src/recorder.rs:104][E: codex-rs/rollout/src/recorder.rs:105][E: codex-rs/rollout/src/recorder.rs:112][E: codex-rs/rollout/src/recorder.rs:113]
- `RolloutCmd` serializes `AddItems`, `Persist`, `Flush`, and `Shutdown` through the writer task.[E: codex-rs/rollout/src/recorder.rs:117][E: codex-rs/rollout/src/recorder.rs:118][E: codex-rs/rollout/src/recorder.rs:118][E: codex-rs/rollout/src/recorder.rs:121][E: codex-rs/rollout/src/recorder.rs:126]
...
- `codex_history::RolloutItem` 用 `rollout_payload::RolloutItemWire` 做 tag=`type` 的 JSON；`ResponseItemEnvelope` 允许把 harness metadata 与 raw `ResponseItem` 分开存。[E: codex-rs/history/src/lib.rs:122][E: codex-rs/history/src/rollout_payload.rs:22][E: codex-rs/history/src/lib.rs:39]

## 关键文件

| 文件 | 角色 |
|---|---|
| `codex-rs/rollout/src/recorder.rs` | JSONL recorder, background writer, load/resume helpers, list fallback/repair path.[E: codex-rs/rollout/src/recorder.rs:85][E: codex-rs/rollout/src/recorder.rs:451][E: codex-rs/rollout/src/recorder.rs:1002][E: codex-rs/rollout/src/recorder.rs:1632] |
...
| `codex-rs/state/src/runtime/threads.rs` | SQLite thread metadata listing and incremental `apply_rollout_items` target.[E: codex-rs/state/src/runtime/threads.rs:433][E: codex-rs/state/src/runtime/threads.rs:978] |
...
2. `persist` and `flush` use oneshot acknowledgements so callers wait for the writer's I/O result, not only for enqueue success.[E: codex-rs/rollout/src/recorder.rs:966][E: codex-rs/rollout/src/recorder.rs:967][E: codex-rs/rollout/src/recorder.rs:967][E: codex-rs/rollout/src/recorder.rs:988][E: codex-rs/rollout/src/recorder.rs:988][E: codex-rs/rollout/src/recorder.rs:974]
3. `shutdown` sends `RolloutCmd::Shutdown` and waits for the writer acknowledgement before returning.[E: codex-rs/rollout/src/recorder.rs:1088][E: codex-rs/rollout/src/recorder.rs:1091][E: codex-rs/rollout/src/recorder.rs:1092]
4. `RolloutWriterState` carries writer/deferred file info/pending items/session meta/path; `flush` and `shutdown` return early only when the writer is still deferred and there are no pending items.[E: codex-rs/rollout/src/recorder.rs:1632][E: codex-rs/rollout/src/recorder.rs:1633][E: codex-rs/rollout/src/recorder.rs:1634][E: codex-rs/rollout/src/recorder.rs:1635][E: codex-rs/rollout/src/recorder.rs:1636][E: codex-rs/rollout/src/recorder.rs:1638][E: codex-rs/rollout/src/recorder.rs:1662][E: codex-rs/rollout/src/recorder.rs:1667]
5. `load_rollout_items` reads JSONL line-by-line, skips blanks, counts parse errors, skips legacy `ghost_snapshot` lines, and treats the first `SessionMeta` as the canonical thread id.[E: codex-rs/rollout/src/recorder.rs:1002][E: codex-rs/rollout/src/recorder.rs:992][E: codex-rs/rollout/src/recorder.rs:993][E: codex-rs/rollout/src/recorder.rs:1022][E: codex-rs/rollout/src/recorder.rs:1002][E: codex-rs/rollout/src/recorder.rs:1037][E: codex-rs/rollout/src/recorder.rs:1052]

## 控制流：list 与 SQLite mirror

1. `list_threads_with_db_fallback` has a `StateDbOnly` repair mode that returns a DB page or an empty default if DB listing is unavailable.[E: codex-rs/rollout/src/recorder.rs:451][E: codex-rs/rollout/src/recorder.rs:476][E: codex-rs/rollout/src/recorder.rs:477][E: codex-rs/rollout/src/recorder.rs:493]
2. Normal listing scans filesystem first, overfetching where needed, so it can repair stale/missing SQLite rows before returning DB-backed or filesystem-backed pages.[E: codex-rs/rollout/src/recorder.rs:496][E: codex-rs/rollout/src/recorder.rs:504][E: codex-rs/rollout/src/recorder.rs:506][E: codex-rs/rollout/src/recorder.rs:678][E: codex-rs/rollout/src/recorder.rs:695]
3. When metadata filters require filesystem fallback, listing records a fallback and returns a filesystem scan page enriched from state DB where possible.[E: codex-rs/rollout/src/recorder.rs:681][E: codex-rs/rollout/src/recorder.rs:687][E: codex-rs/rollout/src/recorder.rs:688]
4. If SQLite listing still fails, the recorder records a DB-error fallback and returns the filesystem page instead of failing the list.[E: codex-rs/rollout/src/recorder.rs:685][E: codex-rs/rollout/src/recorder.rs:714]
...
2. Full-file reconcile treats Paginated metadata updates as SQLite-only: rollout seeds a missing row, while an existing row keeps explicit title、git info and memory mode rather than being overwritten by stale JSONL-derived values。[E: codex-rs/rollout/src/state_db.rs:556][E: codex-rs/rollout/src/state_db.rs:563][E: codex-rs/rollout/src/state_db.rs:564][E: codex-rs/rollout/src/state_db.rs:565][E: codex-rs/rollout/src/state_db.rs:566][E: codex-rs/rollout/src/state_db.rs:584]
3. Incremental apply requires either an explicit builder or a builder derived from the item batch; missing builder only warns and returns.[E: codex-rs/rollout/src/state_db.rs:664][E: codex-rs/rollout/src/state_db.rs:678][E: codex-rs/rollout/src/state_db.rs:679][E: codex-rs/rollout/src/state_db.rs:682][E: codex-rs/rollout/src/state_db.rs:687]
4. `codex_state::StateRuntime::apply_rollout_items` reads or builds `ThreadMetadata`, applies each item via `apply_rollout_item`, preserves existing git info, then upserts metadata and memory mode.[E: codex-rs/state/src/runtime/threads.rs:978][E: codex-rs/state/src/runtime/threads.rs:987][E: codex-rs/state/src/runtime/threads.rs:991][E: codex-rs/state/src/runtime/threads.rs:994][E: codex-rs/state/src/runtime/threads.rs:997][E: codex-rs/state/src/runtime/threads.rs:1008][E: codex-rs/state/src/runtime/threads.rs:1012]
...
- `record_canonical_items` does not itself filter raw input; callers that accept raw `RolloutItem`s must use the shared policy before writing durable replay history.[E: codex-rs/rollout/src/recorder.rs:948][E: codex-rs/rollout/src/recorder.rs:952][E: codex-rs/rollout/src/policy.rs:27]
- `load_rollout_items` is best-effort for malformed lines: bad JSON increments `parse_errors` and replay continues.[E: codex-rs/rollout/src/recorder.rs:997][E: codex-rs/rollout/src/recorder.rs:1022][E: codex-rs/rollout/src/recorder.rs:1002]
