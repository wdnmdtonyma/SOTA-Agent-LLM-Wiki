...
| `codex-rs/state/src/runtime/threads.rs` | Thread metadata reads/lists/upserts and incremental rollout item application.[E: codex-rs/state/src/runtime/threads.rs:433][E: codex-rs/state/src/runtime/threads.rs:469][E: codex-rs/state/src/runtime/threads.rs:1016] |
...
| `ThreadMetadata` | id, rollout path, timestamps, source, model, cwd, title/preview, sandbox/approval, tokens, archive, optional section + sparse position + entered-at, git | Canonical SQLite representation combines rollout-derived fields with SQLite-only organization metadata。[E: codex-rs/state/src/model/thread_metadata.rs:125][E: codex-rs/state/src/model/thread_metadata.rs:127][E: codex-rs/state/src/model/thread_metadata.rs:129][E: codex-rs/state/src/model/thread_metadata.rs:137][E: codex-rs/state/src/model/thread_metadata.rs:155][E: codex-rs/state/src/model/thread_metadata.rs:159][E: codex-rs/state/src/model/thread_metadata.rs:163][E: codex-rs/state/src/model/thread_metadata.rs:165][E: codex-rs/state/src/model/thread_metadata.rs:167][E: codex-rs/state/src/model/thread_metadata.rs:173][E: codex-rs/state/src/model/thread_metadata.rs:175][E: codex-rs/state/src/model/thread_metadata.rs:177][E: codex-rs/state/src/model/thread_metadata.rs:179][E: codex-rs/state/src/model/thread_metadata.rs:183] |
| `ThreadMetadataBuilder` | id, rollout path, timestamps, source, cwd, provider | Builder input used when applying item batches without reparsing filenames.[E: codex-rs/state/src/model/thread_metadata.rs:192][E: codex-rs/state/src/model/thread_metadata.rs:194][E: codex-rs/state/src/model/thread_metadata.rs:196][E: codex-rs/state/src/model/thread_metadata.rs:198][E: codex-rs/state/src/model/thread_metadata.rs:204] |
...
5. `StateRuntime::apply_rollout_items` reads existing metadata or builds defaults, applies each item, preserves existing git info, updates `updated_at`, then upserts metadata and memory mode.[E: codex-rs/state/src/runtime/threads.rs:1016][E: codex-rs/state/src/runtime/threads.rs:1027][E: codex-rs/state/src/runtime/threads.rs:1032][E: codex-rs/state/src/runtime/threads.rs:1035][E: codex-rs/state/src/runtime/threads.rs:1042][E: codex-rs/state/src/runtime/threads.rs:1044][E: codex-rs/state/src/runtime/threads.rs:1048][E: codex-rs/state/src/runtime/threads.rs:1051]
...
- `ResponseItem`s are still accepted by `apply_rollout_item`, but the current response projection function is empty.[E: codex-rs/state/src/extract.rs:24][E: codex-rs/state/src/extract.rs:138]
