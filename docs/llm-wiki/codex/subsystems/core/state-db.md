...
| `codex-rs/state/src/runtime/threads.rs` | Thread metadata reads/lists/upserts and incremental rollout item application.[E: codex-rs/state/src/runtime/threads.rs:433][E: codex-rs/state/src/runtime/threads.rs:469][E: codex-rs/state/src/runtime/threads.rs:978] |
...
| `codex-rs/state/src/extract.rs` | Field projection from rollout items into `ThreadMetadata`.[E: codex-rs/state/src/extract.rs:15][E: codex-rs/state/src/extract.rs:38] |
...
| `codex-rs/state/src/runtime/logs.rs` | Logs insert, per-partition pruning, and startup retention maintenance.[E: codex-rs/state/src/runtime/logs.rs:3][E: codex-rs/state/src/runtime/logs.rs:11][E: codex-rs/state/src/runtime/logs.rs:39][E: codex-rs/state/src/runtime/logs.rs:291] |
...
| `ThreadMetadata` | id, rollout path, timestamps, source, model, cwd, title/preview, sandbox/approval, tokens, archive, optional section + sparse position + entered-at, git | Canonical SQLite representation combines rollout-derived fields with SQLite-only organization metadata。[E: codex-rs/state/src/model/thread_metadata.rs:101][E: codex-rs/state/src/model/thread_metadata.rs:103][E: codex-rs/state/src/model/thread_metadata.rs:105][E: codex-rs/state/src/model/thread_metadata.rs:125][E: codex-rs/state/src/model/thread_metadata.rs:131][E: codex-rs/state/src/model/thread_metadata.rs:135][E: codex-rs/state/src/model/thread_metadata.rs:139][E: codex-rs/state/src/model/thread_metadata.rs:141][E: codex-rs/state/src/model/thread_metadata.rs:145][E: codex-rs/state/src/model/thread_metadata.rs:149][E: codex-rs/state/src/model/thread_metadata.rs:151][E: codex-rs/state/src/model/thread_metadata.rs:153][E: codex-rs/state/src/model/thread_metadata.rs:155][E: codex-rs/state/src/model/thread_metadata.rs:157] |
| `ThreadMetadataBuilder` | id, rollout path, timestamps, source, cwd, provider | Builder input used when applying item batches without reparsing filenames.[E: codex-rs/state/src/model/thread_metadata.rs:167][E: codex-rs/state/src/model/thread_metadata.rs:169][E: codex-rs/state/src/model/thread_metadata.rs:171][E: codex-rs/state/src/model/thread_metadata.rs:173][E: codex-rs/state/src/model/thread_metadata.rs:175][E: codex-rs/state/src/model/thread_metadata.rs:177][E: codex-rs/state/src/model/thread_metadata.rs:179][E: codex-rs/state/src/model/thread_metadata.rs:192][E: codex-rs/state/src/model/thread_metadata.rs:194] |
| `ThreadsPage` | items, parent ids, next anchor | SQLite listing returns keyset pagination metadata and parent-thread mapping.[E: codex-rs/state/src/model/thread_metadata.rs:77][E: codex-rs/state/src/model/thread_metadata.rs:79][E: codex-rs/state/src/model/thread_metadata.rs:81][E: codex-rs/state/src/model/thread_metadata.rs:83] |
...
4. `thread_queue()` 暴露 durable user-message queue；thread 删除时 `delete_thread_queue`。[E: codex-rs/state/src/runtime.rs:285][E: codex-rs/state/src/runtime/threads.rs:1131]
...
1. `rollout_item_affects_thread_metadata` accepts `SessionMeta`/`TurnContext`, legacy token/user/goal/settings events（含 `ThreadSettingsApplied`）, plus Paginated `ItemCompleted(UserMessage)`。[E: codex-rs/state/src/extract.rs:38][E: codex-rs/state/src/extract.rs:45][E: codex-rs/state/src/extract.rs:47]
...
3. `TurnContext` updates cwd fallback, model, reasoning effort, sandbox policy, and approval mode.[E: codex-rs/state/src/extract.rs:88][E: codex-rs/state/src/extract.rs:92][E: codex-rs/state/src/extract.rs:94][E: codex-rs/state/src/extract.rs:94][E: codex-rs/state/src/extract.rs:96][E: codex-rs/state/src/extract.rs:98]
4. `UserMessage` initializes first-user-message/preview/title; `ThreadGoalUpdated` can fill preview; `TokenCount` records total tokens.[E: codex-rs/state/src/extract.rs:103][E: codex-rs/state/src/extract.rs:105][E: codex-rs/state/src/extract.rs:107][E: codex-rs/state/src/extract.rs:141][E: codex-rs/state/src/extract.rs:147][E: codex-rs/state/src/extract.rs:115][E: codex-rs/state/src/extract.rs:119]
5. `StateRuntime::apply_rollout_items` reads existing metadata or builds defaults, applies each item, preserves existing git info, updates `updated_at`, then upserts metadata and memory mode.[E: codex-rs/state/src/runtime/threads.rs:978][E: codex-rs/state/src/runtime/threads.rs:987][E: codex-rs/state/src/runtime/threads.rs:991][E: codex-rs/state/src/runtime/threads.rs:994][E: codex-rs/state/src/runtime/threads.rs:997][E: codex-rs/state/src/runtime/threads.rs:1003][E: codex-rs/state/src/runtime/threads.rs:1008][E: codex-rs/state/src/runtime/threads.rs:1012]

## 控制流：query/backfill/logs

1. `list_threads` and relationship listing both call `list_threads_matching`, centralizing SQLite thread pagination and filters.[E: codex-rs/state/src/runtime/threads.rs:433][E: codex-rs/state/src/runtime/threads.rs:439][E: codex-rs/state/src/runtime/threads.rs:446][E: codex-rs/state/src/runtime/threads.rs:463][E: codex-rs/state/src/runtime/threads.rs:469]
...
7. Logs insert uses a `logs_pool` transaction and prunes within the same transaction.[E: codex-rs/state/src/runtime/logs.rs:11][E: codex-rs/state/src/runtime/logs.rs:16][E: codex-rs/state/src/runtime/logs.rs:39][E: codex-rs/state/src/runtime/logs.rs:40]
8. Logs startup maintenance deletes logs older than 10 days and runs a passive WAL checkpoint.[E: codex-rs/state/src/runtime/logs.rs:3][E: codex-rs/state/src/runtime/logs.rs:291][E: codex-rs/state/src/runtime/logs.rs:297][E: codex-rs/state/src/runtime/logs.rs:301]
