...
| `codex-rs/state/src/extract.rs` | Field projection from rollout items into `ThreadMetadata`.[E: codex-rs/state/src/extract.rs:15][E: codex-rs/state/src/extract.rs:39] |
...
1. `rollout_item_affects_thread_metadata` accepts `SessionMeta`/`TurnContext`, legacy token/user/goal/settings events（含 `ThreadSettingsApplied`）, plus Paginated `ItemCompleted(UserMessage)`。[E: codex-rs/state/src/extract.rs:39][E: codex-rs/state/src/extract.rs:46][E: codex-rs/state/src/extract.rs:48]
...
3. `TurnContext` updates cwd fallback, model, reasoning effort, sandbox policy, and approval mode.[E: codex-rs/state/src/extract.rs:94][E: codex-rs/state/src/extract.rs:98][E: codex-rs/state/src/extract.rs:100][E: codex-rs/state/src/extract.rs:100][E: codex-rs/state/src/extract.rs:102][E: codex-rs/state/src/extract.rs:104]
4. `UserMessage` initializes first-user-message/preview/title; `ThreadGoalUpdated` can fill preview; `TokenCount` records total tokens.[E: codex-rs/state/src/extract.rs:109][E: codex-rs/state/src/extract.rs:111][E: codex-rs/state/src/extract.rs:113][E: codex-rs/state/src/extract.rs:147][E: codex-rs/state/src/extract.rs:153][E: codex-rs/state/src/extract.rs:121][E: codex-rs/state/src/extract.rs:125]
5. `StateRuntime::apply_rollout_items` reads existing metadata or builds defaults, applies each item, preserves existing git info, updates `updated_at`, then upserts metadata and memory mode.[E: codex-rs/state/src/runtime/threads.rs:1042][E: codex-rs/state/src/runtime/threads.rs:1053][E: codex-rs/state/src/runtime/threads.rs:1058][E: codex-rs/state/src/runtime/threads.rs:1061][E: codex-rs/state/src/runtime/threads.rs:1068][E: codex-rs/state/src/runtime/threads.rs:1070][E: codex-rs/state/src/runtime/threads.rs:1074][E: codex-rs/state/src/runtime/threads.rs:1077]

## 控制流：query/backfill/logs

1. `list_threads` and relationship listing both call `list_threads_matching`, centralizing SQLite thread pagination and filters.[E: codex-rs/state/src/runtime/threads.rs:435][E: codex-rs/state/src/runtime/threads.rs:441][E: codex-rs/state/src/runtime/threads.rs:448][E: codex-rs/state/src/runtime/threads.rs:465][E: codex-rs/state/src/runtime/threads.rs:471]
