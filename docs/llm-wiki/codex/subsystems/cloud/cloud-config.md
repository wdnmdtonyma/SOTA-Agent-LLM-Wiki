...
`cloud_config_bundle_loader` 构造 `CloudConfigBundleService`，经 `cloud_config_bundle_loader_for_service` spawn 一条 task：先 `get_latest()` 再 `refresh_cache_in_background()`；新的 refresh task 会替换并 abort 旧 task。[E: codex-rs/cloud-config/src/bundle_loader.rs:42][E: codex-rs/cloud-config/src/bundle_loader.rs:48][E: codex-rs/cloud-config/src/bundle_loader.rs:57][E: codex-rs/cloud-config/src/bundle_loader.rs:58][E: codex-rs/cloud-config/src/bundle_loader.rs:21][E: codex-rs/cloud-config/src/bundle_loader.rs:27][E: codex-rs/cloud-config/src/bundle_loader.rs:70][E: codex-rs/cloud-config/src/bundle_loader.rs:71][E: codex-rs/cloud-config/src/bundle_loader.rs:72] `cloud_config_bundle_loader_for_storage` 先用 storage/auth 参数创建 shared `AuthManager`，再委托 loader。[E: codex-rs/cloud-config/src/bundle_loader.rs:59][E: codex-rs/cloud-config/src/bundle_loader.rs:70][E: codex-rs/cloud-config/src/bundle_loader.rs:72][E: codex-rs/cloud-config/src/bundle_loader.rs:75][E: codex-rs/cloud-config/src/bundle_loader.rs:76][E: codex-rs/cloud-config/src/bundle_loader.rs:75]
...
`CloudConfigBundle` 包含 `config_toml` 与 `requirements_toml` 两个 buckets；`CloudConfigBundleLayers::from_bundle` 把它们转换为 enterprise-managed config layers 和 requirements layers。[E: codex-rs/config/src/cloud_config_bundle.rs:25][E: codex-rs/config/src/cloud_config_bundle.rs:26][E: codex-rs/config/src/cloud_config_bundle.rs:27][E: codex-rs/config/src/cloud_config_bundle.rs:92][E: codex-rs/config/src/cloud_config_bundle.rs:94][E: codex-rs/config/src/cloud_config_bundle.rs:96][E: codex-rs/config/src/cloud_config_bundle.rs:100][E: codex-rs/config/src/cloud_config_bundle.rs:121][E: codex-rs/config/src/cloud_config_bundle.rs:129][E: codex-rs/config/src/cloud_config_bundle.rs:115]
...
`load_config_layers_state` 在未忽略 managed requirements 时 await cloud bundle loader，把 enterprise-managed requirements 保存到 requirements layers，把 enterprise-managed config layers 插入 system layer 之后、user/profile/project/runtime layers 之前。[E: codex-rs/config/src/loader/mod.rs:204][E: codex-rs/config/src/loader/mod.rs:205][E: codex-rs/config/src/loader/mod.rs:211][E: codex-rs/config/src/loader/mod.rs:214]
