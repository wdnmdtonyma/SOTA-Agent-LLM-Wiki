...
> Linux sandbox backend accepts a serialized `PermissionProfile`, resolves it to runtime filesystem/network policies, then normally uses a two-stage bubblewrap helper: the outer stage builds mount/user/pid/network namespaces, and the inner stage applies seccomp/no_new_privs before exec. Legacy Landlock filesystem enforcement is an explicit fallback path.[E: codex-rs/linux-sandbox/src/linux_run_main.rs:84][E: codex-rs/linux-sandbox/src/linux_run_main.rs:151][E: codex-rs/linux-sandbox/src/linux_run_main.rs:172][E: codex-rs/linux-sandbox/src/linux_run_main.rs:182][E: codex-rs/linux-sandbox/src/linux_run_main.rs:192][E: codex-rs/linux-sandbox/src/linux_run_main.rs:217][E: codex-rs/linux-sandbox/src/linux_run_main.rs:240][E: codex-rs/linux-sandbox/src/linux_run_main.rs:254]
...
Linux sandbox 节点覆盖 `codex-rs/linux-sandbox/src` helper 的 CLI、bwrap argv、Landlock/seccomp、proxy route activation 和 helper exec path。`SandboxManager::transform` 负责把 helper executable 插到 argv[0]，并给 helper 传入 permission-profile 参数；真正执行 helper 主逻辑的是 `codex_linux_sandbox::run_main()`。[E: codex-rs/sandboxing/src/manager.rs:375][E: codex-rs/sandboxing/src/manager.rs:389][E: codex-rs/sandboxing/src/manager.rs:397][E: codex-rs/sandboxing/src/manager.rs:402][E: codex-rs/linux-sandbox/src/lib.rs:23]

## 关键 crate/文件

- `codex-rs/linux-sandbox/src/linux_run_main.rs`: CLI parser、permission-profile resolution、两阶段 outer/inner flow、legacy fallback guard、bwrap fallback、inner seccomp command generation。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:84][E: codex-rs/linux-sandbox/src/linux_run_main.rs:151][E: codex-rs/linux-sandbox/src/linux_run_main.rs:289][E: codex-rs/linux-sandbox/src/linux_run_main.rs:306][E: codex-rs/linux-sandbox/src/linux_run_main.rs:324][E: codex-rs/linux-sandbox/src/linux_run_main.rs:1397]
- `codex-rs/linux-sandbox/src/bwrap.rs`: filesystem namespace 与 bubblewrap argv 生成。[E: codex-rs/linux-sandbox/src/bwrap.rs:60][E: codex-rs/linux-sandbox/src/bwrap.rs:87][E: codex-rs/linux-sandbox/src/bwrap.rs:234][E: codex-rs/linux-sandbox/src/bwrap.rs:374]
...
- `codex-rs/linux-sandbox/src/proxy_routing.rs`: managed network proxy route spec、host bridge、sandbox namespace bridge、proxy env rewrite。[E: codex-rs/linux-sandbox/src/proxy_routing.rs:145]
- `codex-rs/linux-sandbox/src/launcher.rs`: system/bundled bubblewrap selection、`--argv0`/`--perms` support probing、exec handoff。[E: codex-rs/linux-sandbox/src/launcher.rs:36][E: codex-rs/linux-sandbox/src/launcher.rs:47][E: codex-rs/linux-sandbox/src/launcher.rs:55][E: codex-rs/linux-sandbox/src/launcher.rs:60][E: codex-rs/linux-sandbox/src/launcher.rs:80][E: codex-rs/linux-sandbox/src/launcher.rs:121][E: codex-rs/linux-sandbox/src/launcher.rs:122][E: codex-rs/linux-sandbox/src/launcher.rs:126]
...
- `LandlockCommand`: CLI struct，保留 historical type name but carries sandbox-policy cwd, optional command cwd, serialized `--permission-profile`, legacy fallback flag, inner-stage flag, proxy flags, `no_proc`, and trailing command.[E: codex-rs/linux-sandbox/src/linux_run_main.rs:84][E: codex-rs/linux-sandbox/src/linux_run_main.rs:88][E: codex-rs/linux-sandbox/src/linux_run_main.rs:97][E: codex-rs/linux-sandbox/src/linux_run_main.rs:105][E: codex-rs/linux-sandbox/src/linux_run_main.rs:111][E: codex-rs/linux-sandbox/src/linux_run_main.rs:119][E: codex-rs/linux-sandbox/src/linux_run_main.rs:127][E: codex-rs/linux-sandbox/src/linux_run_main.rs:131][E: codex-rs/linux-sandbox/src/linux_run_main.rs:137][E: codex-rs/linux-sandbox/src/linux_run_main.rs:141]
...
1. `run_main` 解析 `LandlockCommand`，拒绝空 command，并校验 inner mode 参数组合。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:151][E: codex-rs/linux-sandbox/src/linux_run_main.rs:152][E: codex-rs/linux-sandbox/src/linux_run_main.rs:164][E: codex-rs/linux-sandbox/src/linux_run_main.rs:167]
2. `resolve_permission_profile` requires `--permission-profile`, then derives runtime filesystem and network policies via `PermissionProfile::to_runtime_permissions`.[E: codex-rs/linux-sandbox/src/linux_run_main.rs:168][E: codex-rs/linux-sandbox/src/linux_run_main.rs:289][E: codex-rs/linux-sandbox/src/linux_run_main.rs:292][E: codex-rs/linux-sandbox/src/linux_run_main.rs:292][E: codex-rs/linux-sandbox/src/linux_run_main.rs:294]
3. `ensure_legacy_landlock_mode_supports_policy` rejects legacy fallback when the resolved filesystem policy needs direct runtime enforcement under the network policy/cwd.[E: codex-rs/linux-sandbox/src/linux_run_main.rs:173][E: codex-rs/linux-sandbox/src/linux_run_main.rs:306][E: codex-rs/linux-sandbox/src/linux_run_main.rs:312][E: codex-rs/linux-sandbox/src/linux_run_main.rs:312][E: codex-rs/linux-sandbox/src/linux_run_main.rs:318]
4. inner stage 由 `--apply-seccomp-then-exec` 触发：如果存在 proxy route spec 则先 `activate_proxy_routes_in_netns`，然后调用 `apply_permission_profile_to_current_thread` 安装 seccomp/no_new_privs 相关限制，最后 `exec_or_panic` 用户命令。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:182][E: codex-rs/linux-sandbox/src/linux_run_main.rs:183][E: codex-rs/linux-sandbox/src/linux_run_main.rs:187][E: codex-rs/linux-sandbox/src/linux_run_main.rs:192][E: codex-rs/linux-sandbox/src/linux_run_main.rs:196][E: codex-rs/linux-sandbox/src/linux_run_main.rs:199]
5. 如果 filesystem 是 full disk write 且无需 proxy route，`run_main` 可以跳过 bwrap mount namespace，只在当前线程应用网络/seccomp 相关限制后 exec。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:204][E: codex-rs/linux-sandbox/src/linux_run_main.rs:205][E: codex-rs/linux-sandbox/src/linux_run_main.rs:209][E: codex-rs/linux-sandbox/src/linux_run_main.rs:212]
6. 非 legacy outer path 会为 managed network 准备 host proxy route spec，serialize permission profile into the inner command, then call `run_bwrap_with_proc_fallback`.[E: codex-rs/linux-sandbox/src/linux_run_main.rs:217][E: codex-rs/linux-sandbox/src/linux_run_main.rs:217][E: codex-rs/linux-sandbox/src/linux_run_main.rs:232][E: codex-rs/linux-sandbox/src/linux_run_main.rs:240][E: codex-rs/linux-sandbox/src/linux_run_main.rs:1409][E: codex-rs/linux-sandbox/src/linux_run_main.rs:1425][E: codex-rs/linux-sandbox/src/linux_run_main.rs:1427]
7. `run_bwrap_with_proc_fallback` 根据 network policy 选 `BwrapNetworkMode`，做 `/proc` preflight，构造 bwrap argv，必要时插入 `--argv0 codex-linux-sandbox`，最后 exec bwrap。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:324][E: codex-rs/linux-sandbox/src/linux_run_main.rs:331][E: codex-rs/linux-sandbox/src/linux_run_main.rs:337][E: codex-rs/linux-sandbox/src/linux_run_main.rs:346][E: codex-rs/linux-sandbox/src/linux_run_main.rs:351][E: codex-rs/linux-sandbox/src/linux_run_main.rs:359][E: codex-rs/linux-sandbox/src/linux_run_main.rs:360]
8. legacy path 不走 bwrap，而是直接在当前线程应用 permission profile 的 Landlock filesystem/seccomp restrictions，再 exec 用户命令。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:254][E: codex-rs/linux-sandbox/src/linux_run_main.rs:256][E: codex-rs/linux-sandbox/src/linux_run_main.rs:261]
...
- full filesystem bubblewrap flags 包括 `--new-session`、`--die-with-parent`、`--bind / /`、`--unshare-user`、`--unshare-pid`、可选 `--unshare-net`、可选 `--proc /proc`，最后 `--` 后接 command。[E: codex-rs/linux-sandbox/src/bwrap.rs:268][E: codex-rs/linux-sandbox/src/bwrap.rs:269][E: codex-rs/linux-sandbox/src/bwrap.rs:270][E: codex-rs/linux-sandbox/src/bwrap.rs:271][E: codex-rs/linux-sandbox/src/bwrap.rs:276][E: codex-rs/linux-sandbox/src/bwrap.rs:278][E: codex-rs/linux-sandbox/src/bwrap.rs:279][E: codex-rs/linux-sandbox/src/bwrap.rs:283][E: codex-rs/linux-sandbox/src/bwrap.rs:286]
- restricted filesystem path 先生成 read-only 或 tmpfs root baseline，再按 writable roots 绑定 `--bind`，按 read-only subpaths 重放 `--ro-bind`，按 unreadable roots 使用 mask/tmpfs/ro-bind-data 等方式隐藏。[E: codex-rs/linux-sandbox/src/bwrap.rs:374][E: codex-rs/linux-sandbox/src/bwrap.rs:440][E: codex-rs/linux-sandbox/src/bwrap.rs:467][E: codex-rs/linux-sandbox/src/bwrap.rs:552][E: codex-rs/linux-sandbox/src/bwrap.rs:567][E: codex-rs/linux-sandbox/src/bwrap.rs:596][E: codex-rs/linux-sandbox/src/bwrap.rs:609]
...
- managed network proxy flow 先在 host namespace 为 loopback proxy endpoints 创建 UDS route spec，再在 sandbox netns 中启动 local TCP listener 并把 proxy env 改写到 `127.0.0.1:<local_port>`。[E: codex-rs/linux-sandbox/src/proxy_routing.rs:126][E: codex-rs/linux-sandbox/src/proxy_routing.rs:145][E: codex-rs/linux-sandbox/src/proxy_routing.rs:171]
...
- `run_bwrap_with_proc_fallback` 独立处理 `/proc` preflight，说明 Linux backend 允许在无法安全 mount `/proc` 的环境中退化到 no-proc bwrap argv，而不是立即放弃整个 sandbox。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:337][E: codex-rs/linux-sandbox/src/linux_run_main.rs:343][E: codex-rs/linux-sandbox/src/linux_run_main.rs:346]
- system/bundled bwrap launcher 同时存在；system path 需要 probe `--argv0` 与 `--perms`，bundled launcher 默认支持 argv0 override 并可按 `CODEX_BWRAP_SHA256` 校验资源 digest。[E: codex-rs/linux-sandbox/src/launcher.rs:55][E: codex-rs/linux-sandbox/src/launcher.rs:60][E: codex-rs/linux-sandbox/src/launcher.rs:99][E: codex-rs/linux-sandbox/src/launcher.rs:106][E: codex-rs/linux-sandbox/src/launcher.rs:121][E: codex-rs/linux-sandbox/src/launcher.rs:122][E: codex-rs/linux-sandbox/src/bundled_bwrap.rs:43][E: codex-rs/linux-sandbox/src/bundled_bwrap.rs:115][E: codex-rs/linux-sandbox/src/bundled_bwrap.rs:124]
...
- `CODEX_LINUX_SANDBOX_ARG0` 不是 shell 命令；它是 arg0 dispatch 识别 helper re-entry 的名字，`SandboxManager` 会用 `linux_sandbox_arg0_override` 生成这个 override。[E: codex-rs/sandboxing/src/manager.rs:402][E: codex-rs/sandboxing/src/manager.rs:684][E: codex-rs/sandboxing/src/manager.rs:685][E: codex-rs/sandboxing/src/manager.rs:688]
