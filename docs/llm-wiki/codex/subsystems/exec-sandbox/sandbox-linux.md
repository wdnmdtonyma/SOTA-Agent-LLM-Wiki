...
- `codex-rs/linux-sandbox/src/linux_run_main.rs`: CLI parser、permission-profile resolution、两阶段 outer/inner flow、legacy fallback guard、bwrap fallback、inner seccomp command generation。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:89][E: codex-rs/linux-sandbox/src/linux_run_main.rs:160][E: codex-rs/linux-sandbox/src/linux_run_main.rs:360][E: codex-rs/linux-sandbox/src/linux_run_main.rs:380][E: codex-rs/linux-sandbox/src/linux_run_main.rs:410][E: codex-rs/linux-sandbox/src/linux_run_main.rs:1530]
- `codex-rs/linux-sandbox/src/bwrap.rs`: filesystem namespace 与 bubblewrap argv 生成。[E: codex-rs/linux-sandbox/src/bwrap.rs:62][E: codex-rs/linux-sandbox/src/bwrap.rs:92][E: codex-rs/linux-sandbox/src/bwrap.rs:239][E: codex-rs/linux-sandbox/src/bwrap.rs:398]
- `codex-rs/linux-sandbox/src/landlock.rs`: `PermissionProfile`-driven no_new_privs, seccomp 网络过滤、ptrace/io_uring deny、legacy Landlock filesystem enforcement。[E: codex-rs/linux-sandbox/src/landlock.rs:42][E: codex-rs/linux-sandbox/src/landlock.rs:49][E: codex-rs/linux-sandbox/src/landlock.rs:69][E: codex-rs/linux-sandbox/src/landlock.rs:75][E: codex-rs/linux-sandbox/src/landlock.rs:79][E: codex-rs/linux-sandbox/src/landlock.rs:189][E: codex-rs/linux-sandbox/src/landlock.rs:195]
...
1. `run_main` 解析 `LandlockCommand`，拒绝空 command，并校验 inner mode 参数组合。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:160][E: codex-rs/linux-sandbox/src/linux_run_main.rs:161][E: codex-rs/linux-sandbox/src/linux_run_main.rs:174][E: codex-rs/linux-sandbox/src/linux_run_main.rs:180]
2. `resolve_permission_profile` requires `--permission-profile`, then derives runtime filesystem and network policies via `PermissionProfile::to_runtime_permissions`.[E: codex-rs/linux-sandbox/src/linux_run_main.rs:181][E: codex-rs/linux-sandbox/src/linux_run_main.rs:360][E: codex-rs/linux-sandbox/src/linux_run_main.rs:363][E: codex-rs/linux-sandbox/src/linux_run_main.rs:364][E: codex-rs/linux-sandbox/src/linux_run_main.rs:366]
3. `ensure_legacy_landlock_mode_supports_policy` rejects legacy fallback when the resolved filesystem policy needs direct runtime enforcement under the network policy/cwd.[E: codex-rs/linux-sandbox/src/linux_run_main.rs:186][E: codex-rs/linux-sandbox/src/linux_run_main.rs:380][E: codex-rs/linux-sandbox/src/linux_run_main.rs:388][E: codex-rs/linux-sandbox/src/linux_run_main.rs:390][E: codex-rs/linux-sandbox/src/linux_run_main.rs:392]
4. inner stage 由 `--apply-seccomp-then-exec` 触发：先校验 retained capabilities，若 managed proxy 则 `activate_proxy_routes_in_netns`，再 `apply_permission_profile_to_current_thread`（不装 Landlock FS），然后 `fork`；child `exec_or_panic` 用户命令，parent `waitpid` 并转发信号。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:197][E: codex-rs/linux-sandbox/src/linux_run_main.rs:223][E: codex-rs/linux-sandbox/src/linux_run_main.rs:226][E: codex-rs/linux-sandbox/src/linux_run_main.rs:230][E: codex-rs/linux-sandbox/src/linux_run_main.rs:235][E: codex-rs/linux-sandbox/src/linux_run_main.rs:246][E: codex-rs/linux-sandbox/src/linux_run_main.rs:255][E: codex-rs/linux-sandbox/src/linux_run_main.rs:260]
5. 如果 filesystem 是 full disk write 且无需 proxy route，`run_main` 可以跳过 bwrap mount namespace，只在当前线程应用网络/seccomp 相关限制后 exec。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:280][E: codex-rs/linux-sandbox/src/linux_run_main.rs:281][E: codex-rs/linux-sandbox/src/linux_run_main.rs:290]
6. 非 legacy outer path 会为 managed network 准备 host proxy route spec，serialize permission profile into the inner command, then call `run_bwrap_with_proc_fallback`.[E: codex-rs/linux-sandbox/src/linux_run_main.rs:293][E: codex-rs/linux-sandbox/src/linux_run_main.rs:297][E: codex-rs/linux-sandbox/src/linux_run_main.rs:304][E: codex-rs/linux-sandbox/src/linux_run_main.rs:312]
7. `run_bwrap_with_proc_fallback` 根据 network policy 选 `BwrapNetworkMode`，做 `/proc` preflight，构造 bwrap argv，必要时插入 `--argv0`，最后 exec bwrap。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:410][E: codex-rs/linux-sandbox/src/linux_run_main.rs:422][E: codex-rs/linux-sandbox/src/linux_run_main.rs:447][E: codex-rs/linux-sandbox/src/linux_run_main.rs:448]
8. legacy path 不走 bwrap，而是直接在当前线程应用 permission profile 的 Landlock filesystem/seccomp restrictions，再 exec 用户命令。[E: codex-rs/linux-sandbox/src/linux_run_main.rs:324][E: codex-rs/linux-sandbox/src/linux_run_main.rs:328][E: codex-rs/linux-sandbox/src/linux_run_main.rs:333]

## 策略生成细节

- `create_bwrap_command_args` 在 full disk write 且 full network 且没有 unreadable globs 时返回原始 command；如果 full disk write 但需要 network isolation，则生成 full filesystem bubblewrap flags。[E: codex-rs/linux-sandbox/src/bwrap.rs:239][E: codex-rs/linux-sandbox/src/bwrap.rs:246][E: codex-rs/linux-sandbox/src/bwrap.rs:250][E: codex-rs/linux-sandbox/src/bwrap.rs:251][E: codex-rs/linux-sandbox/src/bwrap.rs:253][E: codex-rs/linux-sandbox/src/bwrap.rs:259]
- full filesystem bubblewrap flags 包括 `--new-session`、`--die-with-parent`、`--bind / /`、`--dev /dev`、`--bind-try /dev/shm /dev/shm`、`--unshare-user`、`--unshare-pid`、`--unshare-ipc`、可选 `--unshare-net`、可选 `--proc /proc`，最后 `--` 后接 command。[E: codex-rs/linux-sandbox/src/bwrap.rs:273][E: codex-rs/linux-sandbox/src/bwrap.rs:276][E: codex-rs/linux-sandbox/src/bwrap.rs:280][E: codex-rs/linux-sandbox/src/bwrap.rs:283][E: codex-rs/linux-sandbox/src/bwrap.rs:288][E: codex-rs/linux-sandbox/src/bwrap.rs:289][E: codex-rs/linux-sandbox/src/bwrap.rs:290][E: codex-rs/linux-sandbox/src/bwrap.rs:292][E: codex-rs/linux-sandbox/src/bwrap.rs:295]
- restricted filesystem path 先生成 read-only 或 tmpfs root baseline，再按 writable roots 绑定 `--bind`，按 read-only subpaths 重放 `--ro-bind`，按 unreadable roots 使用 mask/tmpfs/ro-bind-data 等方式隐藏。[E: codex-rs/linux-sandbox/src/bwrap.rs:398][E: codex-rs/linux-sandbox/src/bwrap.rs:464][E: codex-rs/linux-sandbox/src/bwrap.rs:491][E: codex-rs/linux-sandbox/src/bwrap.rs:576][E: codex-rs/linux-sandbox/src/bwrap.rs:591][E: codex-rs/linux-sandbox/src/bwrap.rs:619][E: codex-rs/linux-sandbox/src/bwrap.rs:649]
- unreadable glob expansion uses existing-path expansion before constructing the mount overlay and is bounded by `MAX_UNREADABLE_GLOB_MATCHES`.[E: codex-rs/linux-sandbox/src/bwrap.rs:57][E: codex-rs/linux-sandbox/src/bwrap.rs:456][E: codex-rs/linux-sandbox/src/bwrap.rs:457]
- `apply_permission_profile_to_current_thread` derives runtime policies from `PermissionProfile`, sets no_new_privs only when seccomp is needed or legacy filesystem enforcement is active without full disk write, then installs seccomp and optional Landlock filesystem rules.[E: codex-rs/linux-sandbox/src/landlock.rs:42][E: codex-rs/linux-sandbox/src/landlock.rs:49][E: codex-rs/linux-sandbox/src/landlock.rs:69][E: codex-rs/linux-sandbox/src/landlock.rs:72][E: codex-rs/linux-sandbox/src/landlock.rs:75][E: codex-rs/linux-sandbox/src/landlock.rs:79][E: codex-rs/linux-sandbox/src/landlock.rs:92]
- seccomp filter 一律 deny `ptrace`、process_vm 和 `io_uring_*`；restricted network deny `connect`、`accept`、`bind`、`listen` 等，并只允许 `AF_UNIX` socket；proxy-routed mode 允许 `AF_INET`/`AF_INET6` socket but denies other socket families.[E: codex-rs/linux-sandbox/src/landlock.rs:189][E: codex-rs/linux-sandbox/src/landlock.rs:190][E: codex-rs/linux-sandbox/src/landlock.rs:191][E: codex-rs/linux-sandbox/src/landlock.rs:195][E: codex-rs/linux-sandbox/src/landlock.rs:201][E: codex-rs/linux-sandbox/src/landlock.rs:204][E: codex-rs/linux-sandbox/src/landlock.rs:228][E: codex-rs/linux-sandbox/src/landlock.rs:231][E: codex-rs/linux-sandbox/src/landlock.rs:238]
