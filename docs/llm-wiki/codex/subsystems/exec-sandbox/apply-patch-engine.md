...
> apply_patch engine 把 custom tool 或 shell-heredoc 里的 patch 文本解析成 add/delete/update hunks，再用 filesystem abstraction 计算替换、写文件、移动文件或删除文件。[E: codex-rs/apply-patch/src/parser.rs:129][E: codex-rs/apply-patch/src/lib.rs:277][E: codex-rs/apply-patch/src/lib.rs:362]
...
- `codex-rs/apply-patch/src/parser.rs`: patch 文本 parser、hunk AST、strict/lenient boundary handling 和 parse errors；streaming state lives in `streaming_parser.rs`.[E: codex-rs/apply-patch/src/parser.rs:52][E: codex-rs/apply-patch/src/parser.rs:61][E: codex-rs/apply-patch/src/parser.rs:129][E: codex-rs/apply-patch/src/parser.rs:138][E: codex-rs/apply-patch/src/parser.rs:177][E: codex-rs/apply-patch/src/parser.rs:185]
- `codex-rs/apply-patch/src/lib.rs`: public API、patch application、filesystem writes/deletes/moves、replacement computation 和 summary printing。[E: codex-rs/apply-patch/src/lib.rs:1][E: codex-rs/apply-patch/src/lib.rs:277][E: codex-rs/apply-patch/src/lib.rs:362][E: codex-rs/apply-patch/src/lib.rs:857]
- `codex-rs/apply-patch/src/invocation.rs`: shell command classifier，把 direct `apply_patch` 或 heredoc shell form 解析为 patch body。[E: codex-rs/apply-patch/src/invocation.rs:28][E: codex-rs/apply-patch/src/invocation.rs:106][E: codex-rs/apply-patch/src/invocation.rs:112]
...
- `Hunk`: `AddFile { path, contents }`、`DeleteFile { path }`、`UpdateFile { path, move_path, chunks }` 三种 patch action。[E: codex-rs/apply-patch/src/parser.rs:65][E: codex-rs/apply-patch/src/parser.rs:67][E: codex-rs/apply-patch/src/parser.rs:71]
...
- `UpdateFileChunk`: 每个 update chunk 包含 optional `change_context`、`old_lines`、`new_lines` 和 `is_end_of_file` 标志。[E: codex-rs/apply-patch/src/parser.rs:114][E: codex-rs/apply-patch/src/parser.rs:117][E: codex-rs/apply-patch/src/parser.rs:121]
- `ApplyPatchArgs`: parser 输出 `patch` 原文、`hunks` AST、optional `workdir` 和 optional `environment_id`。[E: codex-rs/apply-patch/src/lib.rs:92][E: codex-rs/apply-patch/src/lib.rs:95][E: codex-rs/apply-patch/src/lib.rs:96][E: codex-rs/apply-patch/src/lib.rs:97][E: codex-rs/apply-patch/src/lib.rs:98][E: codex-rs/apply-patch/src/lib.rs:99]
...
- `MaybeApplyPatchVerified`: classifier 的结果可能是 `Body`、`ShellParseError`、`CorrectnessError` 或 `NotApplyPatch`。[E: codex-rs/apply-patch/src/lib.rs:119][E: codex-rs/apply-patch/src/lib.rs:122][E: codex-rs/apply-patch/src/lib.rs:125][E: codex-rs/apply-patch/src/lib.rs:128]

## parser 控制流

1. `parse_patch` 当前调用 `parse_patch_text` 并使用 `ParseMode::Lenient`，因为 `PARSE_IN_STRICT_MODE` 常量是 false。[E: codex-rs/apply-patch/src/parser.rs:44][E: codex-rs/apply-patch/src/parser.rs:129][E: codex-rs/apply-patch/src/parser.rs:130][E: codex-rs/apply-patch/src/parser.rs:133][E: codex-rs/apply-patch/src/parser.rs:135]
2. `parse_patch_text` trim 输入，按 parse mode 校验 begin/end marker，把 patch delta 推入 `StreamingPatchParser`，finish hunks, carries `environment_id`, and returns `ApplyPatchArgs` with `workdir: None`.[E: codex-rs/apply-patch/src/parser.rs:177][E: codex-rs/apply-patch/src/parser.rs:178][E: codex-rs/apply-patch/src/parser.rs:179][E: codex-rs/apply-patch/src/parser.rs:185][E: codex-rs/apply-patch/src/parser.rs:186][E: codex-rs/apply-patch/src/parser.rs:187][E: codex-rs/apply-patch/src/parser.rs:188][E: codex-rs/apply-patch/src/parser.rs:189][E: codex-rs/apply-patch/src/parser.rs:192][E: codex-rs/apply-patch/src/parser.rs:193]
...
1. `apply_patch` 先 `parse_patch`，parse error 会打印 `Invalid patch:`，然后调用 `apply_hunks`。[E: codex-rs/apply-patch/src/lib.rs:277][E: codex-rs/apply-patch/src/lib.rs:285][E: codex-rs/apply-patch/src/lib.rs:290][E: codex-rs/apply-patch/src/lib.rs:312]
2. `apply_hunks` 调用 `apply_hunks_to_files`，成功后打印 summary；失败时先把 error 文本写到 stderr，若底层是 `std::io::Error` 则转为 IO error，否则包装为 `ApplyPatchError::IoError`。[E: codex-rs/apply-patch/src/lib.rs:316][E: codex-rs/apply-patch/src/lib.rs:325][E: codex-rs/apply-patch/src/lib.rs:327][E: codex-rs/apply-patch/src/lib.rs:332][E: codex-rs/apply-patch/src/lib.rs:337][E: codex-rs/apply-patch/src/lib.rs:340][E: codex-rs/apply-patch/src/lib.rs:345]
3. `apply_hunks_to_files` 拒绝空 hunk 列表，然后逐个 hunk 处理并记录 added/modified/deleted path sets。[E: codex-rs/apply-patch/src/lib.rs:362][E: codex-rs/apply-patch/src/lib.rs:369][E: codex-rs/apply-patch/src/lib.rs:391][E: codex-rs/apply-patch/src/lib.rs:547]
4. Add file 调用 `write_file_with_missing_parent_retry`；如果 parent directory missing，会尝试创建 parent 后再写一次。[E: codex-rs/apply-patch/src/lib.rs:396][E: codex-rs/apply-patch/src/lib.rs:401][E: codex-rs/apply-patch/src/lib.rs:619][E: codex-rs/apply-patch/src/lib.rs:631][E: codex-rs/apply-patch/src/lib.rs:644]
5. Delete file 先取 metadata，拒绝删除 directory，然后用 `RemoveOptions { recursive: false, force: false }` 删除 file。[E: codex-rs/apply-patch/src/lib.rs:418][E: codex-rs/apply-patch/src/lib.rs:424][E: codex-rs/apply-patch/src/lib.rs:427][E: codex-rs/apply-patch/src/lib.rs:430][E: codex-rs/apply-patch/src/lib.rs:431][E: codex-rs/apply-patch/src/lib.rs:432]
6. Update file 先 `derive_new_contents_from_chunks`，如果存在 `move_path` 则写 destination 并删除原 path，否则写回原 path。[E: codex-rs/apply-patch/src/lib.rs:456][E: codex-rs/apply-patch/src/lib.rs:460][E: codex-rs/apply-patch/src/lib.rs:464][E: codex-rs/apply-patch/src/lib.rs:525][E: codex-rs/apply-patch/src/lib.rs:533][E: codex-rs/apply-patch/src/lib.rs:542]
7. `derive_new_contents_from_chunks` 读取原文件文本，split 成 lines，计算 replacements，反向应用 replacements，并确保最终内容以 newline 结尾。[E: codex-rs/apply-patch/src/lib.rs:662][E: codex-rs/apply-patch/src/lib.rs:668][E: codex-rs/apply-patch/src/lib.rs:676][E: codex-rs/apply-patch/src/lib.rs:684][E: codex-rs/apply-patch/src/lib.rs:685][E: codex-rs/apply-patch/src/lib.rs:687][E: codex-rs/apply-patch/src/lib.rs:690]
8. `compute_replacements` 可用 `change_context` 先 seek；纯添加 chunk 可以插入到文件末尾或 final empty line 前；旧行匹配失败会返回包含 unified diff 的错误。[E: codex-rs/apply-patch/src/lib.rs:700][E: codex-rs/apply-patch/src/lib.rs:708][E: codex-rs/apply-patch/src/lib.rs:728][E: codex-rs/apply-patch/src/lib.rs:773][E: codex-rs/apply-patch/src/lib.rs:777]
9. `apply_replacements` 按 start index 倒序替换，避免前面的替换改变后续 replacement 的 index。[E: codex-rs/apply-patch/src/lib.rs:792][E: codex-rs/apply-patch/src/lib.rs:798][E: codex-rs/apply-patch/src/lib.rs:803][E: codex-rs/apply-patch/src/lib.rs:810]

## shell invocation classifier

- `maybe_parse_apply_patch` 识别 direct `[apply_patch, body]`，也识别 shell heredoc 形态并提取 patch body。[E: codex-rs/apply-patch/src/invocation.rs:106][E: codex-rs/apply-patch/src/invocation.rs:112]
...
- parser 默认 lenient mode，说明 engine 更愿意从裸 patch 或有限 heredoc boundary 中恢复 patch，而不是只接受严格裸 patch 文本。[E: codex-rs/apply-patch/src/parser.rs:44][E: codex-rs/apply-patch/src/parser.rs:129][E: codex-rs/apply-patch/src/parser.rs:133][E: codex-rs/apply-patch/src/parser.rs:216][E: codex-rs/apply-patch/src/parser.rs:219][E: codex-rs/apply-patch/src/parser.rs:226][E: codex-rs/apply-patch/src/parser.rs:230][E: codex-rs/apply-patch/src/parser.rs:231]
...
- Delete File 不会递归删除目录；目录 metadata 会导致错误。[E: codex-rs/apply-patch/src/lib.rs:424][E: codex-rs/apply-patch/src/lib.rs:430][E: codex-rs/apply-patch/src/lib.rs:431][E: codex-rs/apply-patch/src/lib.rs:432]
