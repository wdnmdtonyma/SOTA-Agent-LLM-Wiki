...
Restricted filesystem policy 默认保护 writable project roots 下的 `.git`、`.agents`、`.codex`；只有对具体 metadata path 的显式 write entry 才能形成更窄的例外。普通 workspace writable 并不等于这些 metadata children 可写。[E: codex-rs/protocol/src/permissions.rs:36][E: codex-rs/protocol/src/permissions.rs:41][E: codex-rs/protocol/src/permissions.rs:56][E: codex-rs/protocol/src/permissions.rs:71][E: codex-rs/protocol/src/permissions.rs:840][E: codex-rs/protocol/src/permissions.rs:841][E: codex-rs/protocol/src/permissions.rs:842]
