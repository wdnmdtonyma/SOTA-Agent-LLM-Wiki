...
`lib.rs` 公开 `shell_detect`、`bash`、`parse_command`、`powershell` 四个 parser 模块，并把 `is_dangerous_command`、`is_safe_command` 两个 safety **模块**重导出到 crate root；危险检测的主入口是前者中的 `dangerous_command_match`。[E: codex-rs/shell-command/src/lib.rs:3][E: codex-rs/shell-command/src/lib.rs:5][E: codex-rs/shell-command/src/lib.rs:7][E: codex-rs/shell-command/src/lib.rs:8][E: codex-rs/shell-command/src/lib.rs:10][E: codex-rs/shell-command/src/lib.rs:11][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:18][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:19]
...
- `codex-rs/shell-command/src/command_safety/is_dangerous_command.rs`: typed dangerous-command match、wrapper recursion 与 shell literal-command scanning。[E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:7][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:19][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:31][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:37][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:169]
...
- `DangerousCommandMatch` 区分强制删除 `ForcedRm` 和其它危险规则 `Other`；`dangerous_command_match` 返回 `Option<DangerousCommandMatch>`，使调用方不只得到 bool，还能区分命中类型。[E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:7][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:9][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:11][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:13][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:19]
...
6. `parse_shell_lc_literal_commands` 另走一条只用于 dangerous detection 的路径：它允许复杂但语法正确的 shell tree，收集每个 command node 的静态 literal words，略过 dynamic words 与 redirection；源码明确禁止用这个结果证明命令 safe。[E: codex-rs/shell-command/src/bash.rs:126][E: codex-rs/shell-command/src/bash.rs:128][E: codex-rs/shell-command/src/bash.rs:129][E: codex-rs/shell-command/src/bash.rs:130][E: codex-rs/shell-command/src/bash.rs:131][E: codex-rs/shell-command/src/bash.rs:133][E: codex-rs/shell-command/src/bash.rs:137][E: codex-rs/shell-command/src/bash.rs:144][E: codex-rs/shell-command/src/bash.rs:145]
7. `extract_bash_command` 只接受三段 argv `[shell, flag, script]`，flag 必须是 `-lc` 或 `-c`，shell type 必须是 zsh/bash/sh。[E: codex-rs/shell-command/src/bash.rs:98][E: codex-rs/shell-command/src/bash.rs:101][E: codex-rs/shell-command/src/bash.rs:103][E: codex-rs/shell-command/src/bash.rs:109]
...
- `dangerous_command_match` 先检查 direct exec，再对 complex shell 脚本中收集到的 literal command 递归检查，最后在 Windows 调用 Windows-specific danger parser；wrapper recursion 最深 8 层。[E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:16][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:19][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:27][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:31][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:35][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:37][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:45][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:47]
...
- safe/metadata 判定仍只接受 plain word-only subset，不用复杂 shell AST 来证明安全；dangerous detection 则可以从复杂 AST 中提取静态 literal command 来找危险证据。这是非对称的保守策略：可以因一个已知危险 literal 而拒绝，但不因未解析的 dynamic 部分而 auto-approve。[E: codex-rs/shell-command/src/bash.rs:118][E: codex-rs/shell-command/src/bash.rs:121][E: codex-rs/shell-command/src/bash.rs:126][E: codex-rs/shell-command/src/bash.rs:128][E: codex-rs/shell-command/src/bash.rs:130][E: codex-rs/shell-command/src/bash.rs:131][E: codex-rs/shell-command/src/command_safety/is_safe_command.rs:35][E: codex-rs/shell-command/src/command_safety/is_safe_command.rs:41][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:35][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:37]
...
- `find_git_subcommand` 会跳过 `-C`、`-c`、`--config-env`、`--git-dir` 等 global options 以定位 subcommand；`is_safe_git_command` 随后仍会把它们列入 unsafe global options，因此“能定位 subcommand”不等于 auto-approve。[E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:70][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:73][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:76][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:121][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:125][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:147][E: codex-rs/shell-command/src/command_safety/is_dangerous_command.rs:156][E: codex-rs/shell-command/src/command_safety/is_safe_command.rs:175][E: codex-rs/shell-command/src/command_safety/is_safe_command.rs:177][E: codex-rs/shell-command/src/command_safety/is_safe_command.rs:182][E: codex-rs/shell-command/src/command_safety/is_safe_command.rs:183][E: codex-rs/shell-command/src/command_safety/is_safe_command.rs:237][E: codex-rs/shell-command/src/command_safety/is_safe_command.rs:255]
