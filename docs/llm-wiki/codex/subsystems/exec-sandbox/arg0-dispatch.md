...
- `codex-rs/arg0/src/lib.rs`: 常量、dispatch path struct、argv0/argv1 branch、PATH alias tempdir、dotenv guard、runtime wrapper。[E: codex-rs/arg0/src/lib.rs:10][E: codex-rs/arg0/src/lib.rs:18][E: codex-rs/arg0/src/lib.rs:21][E: codex-rs/arg0/src/lib.rs:58][E: codex-rs/arg0/src/lib.rs:326]
...
- `codex-rs/shell-escalation/src/unix`: `codex-execve-wrapper` argv0 branch 调用 Unix shell escalation wrapper。[E: codex-rs/arg0/src/lib.rs:68][E: codex-rs/arg0/src/lib.rs:85][E: codex-rs/shell-escalation/src/unix/execve_wrapper.rs:22]
...
1. `arg0_dispatch` 从 `argv[0]` 的 file name 取 `exe_name`；取不到 file name 时使用空字符串继续匹配，函数返回 `Option<Arg0PathEntryGuard>`。[E: codex-rs/arg0/src/lib.rs:58][E: codex-rs/arg0/src/lib.rs:60][E: codex-rs/arg0/src/lib.rs:65][E: codex-rs/arg0/src/lib.rs:149][E: codex-rs/arg0/src/lib.rs:161]
...
6. 如果 `argv[1] == CODEX_CORE_APPLY_PATCH_ARG1`，dispatch 要求 `argv[2]` 是 patch body，用 `codex_apply_patch::apply_patch` 和 `codex_exec_server::LOCAL_FS` 执行 patch，并按结果 exit。[E: codex-rs/arg0/src/lib.rs:108][E: codex-rs/arg0/src/lib.rs:109][E: codex-rs/arg0/src/lib.rs:125][E: codex-rs/arg0/src/lib.rs:131][E: codex-rs/arg0/src/lib.rs:142]
7. 如果没有命中特殊入口，dispatch 先调用 `load_dotenv`，再创建 alias PATH entry、更新 `PATH`，最后返回 optional guard 让正常 CLI main 继续执行且保持 tempdir 存活。[E: codex-rs/arg0/src/lib.rs:145][E: codex-rs/arg0/src/lib.rs:147][E: codex-rs/arg0/src/lib.rs:149][E: codex-rs/arg0/src/lib.rs:158][E: codex-rs/arg0/src/lib.rs:161]
8. `arg0_dispatch_or_else` 先运行 `arg0_dispatch` 并保留返回的 optional guard，然后在固定 stack size 的主线程里创建 tokio runtime，构造 `Arg0DispatchPaths`，并把 paths 交给 CLI main future。[E: codex-rs/arg0/src/lib.rs:207][E: codex-rs/arg0/src/lib.rs:215][E: codex-rs/arg0/src/lib.rs:221][E: codex-rs/arg0/src/lib.rs:223][E: codex-rs/arg0/src/lib.rs:225][E: codex-rs/arg0/src/lib.rs:238][E: codex-rs/arg0/src/lib.rs:247][E: codex-rs/arg0/src/lib.rs:259]

## PATH alias 生成

- `prepare_path_entry_for_codex_aliases` 在 Codex home 下使用 `tmp/arg0` 作为 base root，Unix 上把 root chmod 为 0700，并清理陈旧 entries。[E: codex-rs/arg0/src/lib.rs:326][E: codex-rs/arg0/src/lib.rs:344][E: codex-rs/arg0/src/lib.rs:346][E: codex-rs/arg0/src/lib.rs:353][E: codex-rs/arg0/src/lib.rs:356][E: codex-rs/arg0/src/lib.rs:358]
- 函数创建 tempdir 和 `.lock` 文件，然后按 `cfg` 写入 aliases:所有平台都有 `apply_patch` 与 `applypatch`，Linux 额外有 `codex-linux-sandbox`，Unix 额外有 `codex-execve-wrapper`；Unix aliases 使用 symlink，Windows aliases 使用 `.bat` wrapper。[E: codex-rs/arg0/src/lib.rs:361][E: codex-rs/arg0/src/lib.rs:373][E: codex-rs/arg0/src/lib.rs:375][E: codex-rs/arg0/src/lib.rs:381][E: codex-rs/arg0/src/lib.rs:385][E: codex-rs/arg0/src/lib.rs:388][E: codex-rs/arg0/src/lib.rs:391][E: codex-rs/arg0/src/lib.rs:403]
- alias entry 会 prepend 到 `PATH`，并通过 `Arg0PathEntryGuard` 保持 tempdir 与 lock file 存活。[E: codex-rs/arg0/src/lib.rs:406][E: codex-rs/arg0/src/lib.rs:432][E: codex-rs/arg0/src/lib.rs:435]
- `linux_sandbox_exe_path` 优先返回 alias path；没有 alias 时回退 current executable path。[E: codex-rs/arg0/src/lib.rs:266][E: codex-rs/arg0/src/lib.rs:273][E: codex-rs/arg0/src/lib.rs:275]

## dotenv 与 runtime

- `.env` loading 在 tokio runtime 创建前执行；`set_filtered` 会跳过 key upper-case 后以 `CODEX_` 开头的 dotenv entries，只设置未命中该 prefix 的变量。[E: codex-rs/arg0/src/lib.rs:145][E: codex-rs/arg0/src/lib.rs:147][E: codex-rs/arg0/src/lib.rs:285][E: codex-rs/arg0/src/lib.rs:291][E: codex-rs/arg0/src/lib.rs:295][E: codex-rs/arg0/src/lib.rs:300][E: codex-rs/arg0/src/lib.rs:305][E: codex-rs/arg0/src/lib.rs:308]
- tokio runtime 的 worker stack size 由 `TOKIO_WORKER_STACK_SIZE_BYTES` 控制，当前值是 `16 * 1024 * 1024` bytes。[E: codex-rs/arg0/src/lib.rs:23][E: codex-rs/arg0/src/lib.rs:221][E: codex-rs/arg0/src/lib.rs:223][E: codex-rs/arg0/src/lib.rs:278][E: codex-rs/arg0/src/lib.rs:282]
...
- `.env` 禁止 `CODEX_` prefix，避免本地 `.env` 覆盖 Codex 内部控制环境变量。[E: codex-rs/arg0/src/lib.rs:285][E: codex-rs/arg0/src/lib.rs:299][E: codex-rs/arg0/src/lib.rs:305]
...
- core apply-patch argv1 branch 没有走 shell command string parser；它直接读取 `argv[2]` patch body，并在当前 process 内调用 apply_patch engine。[E: codex-rs/arg0/src/lib.rs:108][E: codex-rs/arg0/src/lib.rs:109][E: codex-rs/arg0/src/lib.rs:125]
- `load_dotenv` 的 `CODEX_` 检查发生在 key 层面；匹配该 prefix 的 dotenv entry 会被跳过而不是写入 process env。[E: codex-rs/arg0/src/lib.rs:291][E: codex-rs/arg0/src/lib.rs:300][E: codex-rs/arg0/src/lib.rs:305]
