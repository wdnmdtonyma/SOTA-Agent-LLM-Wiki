...
- `codex-rs/codex-api/src/error.rs`: endpoint-level `ApiError` variants。[E: codex-rs/codex-api/src/error.rs:9][E: codex-rs/codex-api/src/error.rs:23][E: codex-rs/codex-api/src/error.rs:35][E: codex-rs/codex-api/src/error.rs:37][E: codex-rs/codex-api/src/error.rs:39]
- `codex-rs/codex-api/src/api_bridge.rs`: maps `ApiError`/`TransportError` into core `CodexErr`。[E: codex-rs/codex-api/src/api_bridge.rs:19][E: codex-rs/codex-api/src/api_bridge.rs:57][E: codex-rs/codex-api/src/api_bridge.rs:71][E: codex-rs/codex-api/src/api_bridge.rs:105]
...
6. SSE `response.failed` classifies recognized provider error codes into typed `ApiError` including context window, quota, usage-not-included, cyber-policy, invalid request, and server overloaded; other parseable failed errors become `ApiError::Retryable`, while missing or unparseable error payloads remain `ApiError::Stream`。[E: codex-rs/codex-api/src/sse/responses.rs:395][E: codex-rs/codex-api/src/sse/responses.rs:396][E: codex-rs/codex-api/src/sse/responses.rs:401][E: codex-rs/codex-api/src/sse/responses.rs:403][E: codex-rs/codex-api/src/sse/responses.rs:404][E: codex-rs/codex-api/src/sse/responses.rs:404][E: codex-rs/codex-api/src/sse/responses.rs:416][E: codex-rs/codex-api/src/sse/responses.rs:419][E: codex-rs/codex-api/src/sse/responses.rs:421][E: codex-rs/codex-api/src/sse/responses.rs:427]
7. `map_api_error` maps typed `ApiError` variants to core errors: context window, quota, usage-not-included, retryable stream with delay, ordinary stream, server overloaded, invalid request, cyber-policy, and rate-limit stream。[E: codex-rs/codex-api/src/api_bridge.rs:19][E: codex-rs/codex-api/src/api_bridge.rs:22][E: codex-rs/codex-api/src/api_bridge.rs:23][E: codex-rs/codex-api/src/api_bridge.rs:24][E: codex-rs/codex-api/src/api_bridge.rs:24][E: codex-rs/codex-api/src/api_bridge.rs:30][E: codex-rs/codex-api/src/api_bridge.rs:40][E: codex-rs/codex-api/src/api_bridge.rs:52][E: codex-rs/codex-api/src/api_bridge.rs:55][E: codex-rs/codex-api/src/api_bridge.rs:167]
8. HTTP 503 body with error code `server_is_overloaded` or `slow_down` maps to `CodexErr::ServerOverloaded`; HTTP 400 image-data text maps to invalid image request; HTTP 429 usage-limit JSON can map to `UsageLimitReached` or `UsageNotIncluded`。[E: codex-rs/codex-api/src/api_bridge.rs:71][E: codex-rs/codex-api/src/api_bridge.rs:78][E: codex-rs/codex-api/src/api_bridge.rs:81][E: codex-rs/codex-api/src/api_bridge.rs:85][E: codex-rs/codex-api/src/api_bridge.rs:98][E: codex-rs/codex-api/src/api_bridge.rs:105][E: codex-rs/codex-api/src/api_bridge.rs:111][E: codex-rs/codex-api/src/api_bridge.rs:129][E: codex-rs/codex-api/src/api_bridge.rs:137]

## 设计动机与权衡

- Default provider conversion disables 429 retry but enables 5xx and transport retry, so rate limits normally surface to higher layers instead of being hidden by generic retry。[E: codex-rs/model-provider-info/src/lib.rs:309][E: codex-rs/model-provider-info/src/lib.rs:310][E: codex-rs/model-provider-info/src/lib.rs:310][E: codex-rs/model-provider-info/src/lib.rs:312][E: codex-rs/model-provider-info/src/lib.rs:313][E: codex-rs/model-provider-info/src/lib.rs:314][I]
- Retry is transport-level; stream item transport errors are represented by the bytes stream, while SSE semantic errors are parsed after the stream is established and represented as `ApiError`, not retried by `codex-client::run_with_retry`。[E: codex-rs/http-client/src/transport.rs:153][E: codex-rs/http-client/src/transport.rs:153][E: codex-rs/http-client/src/transport.rs:156][E: codex-rs/codex-api/src/sse/responses.rs:509][E: codex-rs/codex-api/src/sse/responses.rs:600][E: codex-rs/codex-api/src/sse/responses.rs:612][I]
- `map_api_error` preserves request tracking data for unexpected HTTP status through headers like `cf-ray`, request id, and identity auth errors。[E: codex-rs/codex-api/src/api_bridge.rs:151][E: codex-rs/codex-api/src/api_bridge.rs:152][E: codex-rs/codex-api/src/api_bridge.rs:153][E: codex-rs/codex-api/src/api_bridge.rs:157][E: codex-rs/codex-api/src/api_bridge.rs:172][E: codex-rs/codex-api/src/api_bridge.rs:173][E: codex-rs/codex-api/src/api_bridge.rs:176][E: codex-rs/codex-api/src/api_bridge.rs:216]

## gotcha

- `TransportError::RetryLimit` maps to core retry-limit with status 500 and no request id; HTTP 429 fallback maps to core retry-limit with actual status/request id when usage-limit JSON is not parsed into a richer error。[E: codex-rs/codex-api/src/api_bridge.rs:141][E: codex-rs/codex-api/src/api_bridge.rs:136][E: codex-rs/codex-api/src/api_bridge.rs:143][E: codex-rs/codex-api/src/api_bridge.rs:167][E: codex-rs/codex-api/src/api_bridge.rs:161][E: codex-rs/codex-api/src/api_bridge.rs:157]
- `ApiError::RateLimit` currently maps to `CodexErr::Stream`, not a distinct core rate-limit error variant。[E: codex-rs/codex-api/src/api_bridge.rs:167]
