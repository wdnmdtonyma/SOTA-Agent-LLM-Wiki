...
7. `map_api_error` maps typed `ApiError` variants to core errors: context window, quota, usage-not-included, retryable stream with delay, ordinary stream, server overloaded, invalid request, cyber-policy, and rate-limit stream。[E: codex-rs/codex-api/src/api_bridge.rs:19][E: codex-rs/codex-api/src/api_bridge.rs:22][E: codex-rs/codex-api/src/api_bridge.rs:23][E: codex-rs/codex-api/src/api_bridge.rs:24][E: codex-rs/codex-api/src/api_bridge.rs:24][E: codex-rs/codex-api/src/api_bridge.rs:30][E: codex-rs/codex-api/src/api_bridge.rs:40][E: codex-rs/codex-api/src/api_bridge.rs:52][E: codex-rs/codex-api/src/api_bridge.rs:55][E: codex-rs/codex-api/src/api_bridge.rs:180]
...
- Default provider conversion disables 429 retry but enables 5xx and transport retry, so rate limits normally surface to higher layers instead of being hidden by generic retry。[E: codex-rs/model-provider-info/src/lib.rs:387][E: codex-rs/model-provider-info/src/lib.rs:388][E: codex-rs/model-provider-info/src/lib.rs:388][E: codex-rs/model-provider-info/src/lib.rs:390][E: codex-rs/model-provider-info/src/lib.rs:391][E: codex-rs/model-provider-info/src/lib.rs:392][I]
- Retry is transport-level; stream item transport errors are represented by the bytes stream, while SSE semantic errors are parsed after the stream is established and represented as `ApiError`, not retried by `codex-client::run_with_retry`。[E: codex-rs/http-client/src/transport.rs:153][E: codex-rs/http-client/src/transport.rs:153][E: codex-rs/http-client/src/transport.rs:156][E: codex-rs/codex-api/src/sse/responses.rs:520][E: codex-rs/codex-api/src/sse/responses.rs:615][E: codex-rs/codex-api/src/sse/responses.rs:627][I]
- `map_api_error` preserves request tracking data for unexpected HTTP status through headers like `cf-ray`, request id, and identity auth errors。[E: codex-rs/codex-api/src/api_bridge.rs:151][E: codex-rs/codex-api/src/api_bridge.rs:152][E: codex-rs/codex-api/src/api_bridge.rs:153][E: codex-rs/codex-api/src/api_bridge.rs:157][E: codex-rs/codex-api/src/api_bridge.rs:185][E: codex-rs/codex-api/src/api_bridge.rs:186][E: codex-rs/codex-api/src/api_bridge.rs:189][E: codex-rs/codex-api/src/api_bridge.rs:229]
