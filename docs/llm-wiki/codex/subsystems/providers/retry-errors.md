...
- `codex-rs/codex-api/src/error.rs`: endpoint-level `ApiError` variants。[E: codex-rs/codex-api/src/error.rs:9][E: codex-rs/codex-api/src/error.rs:22][E: codex-rs/codex-api/src/error.rs:34][E: codex-rs/codex-api/src/error.rs:36][E: codex-rs/codex-api/src/error.rs:38]
...
8. HTTP 503 body with error code `server_is_overloaded` or `slow_down` maps to `CodexErr::ServerOverloaded`; HTTP 400 image-data text maps to invalid image request; HTTP 429 usage-limit JSON can map to `UsageLimitReached` or `UsageNotIncluded`。[E: codex-rs/codex-api/src/api_bridge.rs:71][E: codex-rs/codex-api/src/api_bridge.rs:78][E: codex-rs/codex-api/src/api_bridge.rs:81][E: codex-rs/codex-api/src/api_bridge.rs:84][E: codex-rs/codex-api/src/api_bridge.rs:98][E: codex-rs/codex-api/src/api_bridge.rs:105][E: codex-rs/codex-api/src/api_bridge.rs:111][E: codex-rs/codex-api/src/api_bridge.rs:129][E: codex-rs/codex-api/src/api_bridge.rs:137]
