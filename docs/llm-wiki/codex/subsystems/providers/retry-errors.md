...
> Retry/error handling spans three layers: provider config becomes `RetryPolicy`, `codex-client` retries transport/HTTP failures, and `codex-api` defines `ApiError` plus maps it into core `CodexErr`。[E: codex-rs/codex-api/src/provider.rs:16][E: codex-rs/codex-api/src/provider.rs:25][E: codex-rs/codex-api/src/provider.rs:29][E: codex-rs/codex-client/src/retry.rs:8][E: codex-rs/codex-client/src/retry.rs:23][E: codex-rs/codex-client/src/retry.rs:49][E: codex-rs/codex-api/src/error.rs:8][E: codex-rs/codex-api/src/api_bridge.rs:18]
...
6. SSE `response.failed` classifies recognized provider error codes into typed `ApiError` including context window, quota, usage-not-included, cyber-policy, invalid request, and server overloaded; other parseable failed errors become `ApiError::Retryable`, while missing or unparseable error payloads remain `ApiError::Stream`。[E: codex-rs/codex-api/src/sse/responses.rs:364][E: codex-rs/codex-api/src/sse/responses.rs:366][E: codex-rs/codex-api/src/sse/responses.rs:370][E: codex-rs/codex-api/src/sse/responses.rs:372][E: codex-rs/codex-api/src/sse/responses.rs:374][E: codex-rs/codex-api/src/sse/responses.rs:376][E: codex-rs/codex-api/src/sse/responses.rs:379][E: codex-rs/codex-api/src/sse/responses.rs:384][E: codex-rs/codex-api/src/sse/responses.rs:387][E: codex-rs/codex-api/src/sse/responses.rs:389][E: codex-rs/codex-api/src/sse/responses.rs:395]
7. `map_api_error` maps typed `ApiError` variants to core errors: context window, quota, usage-not-included, retryable stream with delay, ordinary stream, server overloaded, invalid request, cyber-policy, and rate-limit stream。[E: codex-rs/codex-api/src/api_bridge.rs:18][E: codex-rs/codex-api/src/api_bridge.rs:20][E: codex-rs/codex-api/src/api_bridge.rs:21][E: codex-rs/codex-api/src/api_bridge.rs:22][E: codex-rs/codex-api/src/api_bridge.rs:23][E: codex-rs/codex-api/src/api_bridge.rs:24][E: codex-rs/codex-api/src/api_bridge.rs:25][E: codex-rs/codex-api/src/api_bridge.rs:39][E: codex-rs/codex-api/src/api_bridge.rs:40][E: codex-rs/codex-api/src/api_bridge.rs:140]
8. HTTP 503 body with error code `server_is_overloaded` or `slow_down` maps to `CodexErr::ServerOverloaded`; HTTP 400 image-data text maps to invalid image request; HTTP 429 usage-limit JSON can map to `UsageLimitReached` or `UsageNotIncluded`。[E: codex-rs/codex-api/src/api_bridge.rs:50][E: codex-rs/codex-api/src/api_bridge.rs:57][E: codex-rs/codex-api/src/api_bridge.rs:60][E: codex-rs/codex-api/src/api_bridge.rs:63][E: codex-rs/codex-api/src/api_bridge.rs:77][E: codex-rs/codex-api/src/api_bridge.rs:85][E: codex-rs/codex-api/src/api_bridge.rs:87][E: codex-rs/codex-api/src/api_bridge.rs:99][E: codex-rs/codex-api/src/api_bridge.rs:107]

## 设计动机与权衡

- Default provider conversion disables 429 retry but enables 5xx and transport retry, so rate limits normally surface to higher layers instead of being hidden by generic retry。[E: codex-rs/model-provider-info/src/lib.rs:261][E: codex-rs/model-provider-info/src/lib.rs:262][E: codex-rs/model-provider-info/src/lib.rs:263][E: codex-rs/model-provider-info/src/lib.rs:264][E: codex-rs/model-provider-info/src/lib.rs:265][E: codex-rs/model-provider-info/src/lib.rs:266][I]
- Retry is transport-level; stream item transport errors are represented by the bytes stream, while SSE semantic errors are parsed after the stream is established and represented as `ApiError`, not retried by `codex-client::run_with_retry`。[E: codex-rs/codex-client/src/transport.rs:153][E: codex-rs/codex-client/src/transport.rs:154][E: codex-rs/codex-client/src/transport.rs:155][E: codex-rs/codex-api/src/sse/responses.rs:468][E: codex-rs/codex-api/src/sse/responses.rs:559][E: codex-rs/codex-api/src/sse/responses.rs:571][I]
- `map_api_error` preserves request tracking data for unexpected HTTP status through headers like `cf-ray`, request id, and identity auth errors。[E: codex-rs/codex-api/src/api_bridge.rs:116][E: codex-rs/codex-api/src/api_bridge.rs:121][E: codex-rs/codex-api/src/api_bridge.rs:122][E: codex-rs/codex-api/src/api_bridge.rs:123][E: codex-rs/codex-api/src/api_bridge.rs:127][E: codex-rs/codex-api/src/api_bridge.rs:144][E: codex-rs/codex-api/src/api_bridge.rs:145][E: codex-rs/codex-api/src/api_bridge.rs:148][E: codex-rs/codex-api/src/api_bridge.rs:188]

## gotcha

- `TransportError::RetryLimit` maps to core retry-limit with status 500 and no request id; HTTP 429 fallback maps to core retry-limit with actual status/request id when usage-limit JSON is not parsed into a richer error。[E: codex-rs/codex-api/src/api_bridge.rs:111][E: codex-rs/codex-api/src/api_bridge.rs:112][E: codex-rs/codex-api/src/api_bridge.rs:113][E: codex-rs/codex-api/src/api_bridge.rs:131][E: codex-rs/codex-api/src/api_bridge.rs:132][E: codex-rs/codex-api/src/api_bridge.rs:133]
- `ApiError::RateLimit` currently maps to `CodexErr::Stream`, not a distinct core rate-limit error variant。[E: codex-rs/codex-api/src/api_bridge.rs:140]
