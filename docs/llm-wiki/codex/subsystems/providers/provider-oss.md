...
> OSS providers 是本地 OpenAI-compatible provider defaults：Ollama 默认 `http://localhost:11434/v1`，LM Studio 默认 `http://localhost:1234/v1`，auth 为空、wire API 为 Responses、websocket 不支持；Ollama model management 使用 native `/api/*` endpoints，LM Studio probe/fetch/load 使用 OpenAI-compatible paths，download 走 `lms get` CLI。[E: codex-rs/model-provider-info/src/lib.rs:444][E: codex-rs/model-provider-info/src/lib.rs:445][E: codex-rs/model-provider-info/src/lib.rs:448][E: codex-rs/model-provider-info/src/lib.rs:449][E: codex-rs/model-provider-info/src/lib.rs:498][E: codex-rs/model-provider-info/src/lib.rs:500][E: codex-rs/model-provider-info/src/lib.rs:504][E: codex-rs/model-provider-info/src/lib.rs:507][E: codex-rs/model-provider-info/src/lib.rs:510][E: codex-rs/model-provider-info/src/lib.rs:518][E: codex-rs/model-provider-info/src/lib.rs:523][E: codex-rs/model-provider-info/src/lib.rs:531][E: codex-rs/model-provider-info/src/lib.rs:532][E: codex-rs/ollama/src/client.rs:83][E: codex-rs/ollama/src/client.rs:105][E: codex-rs/ollama/src/client.rs:161][E: codex-rs/lmstudio/src/client.rs:47][E: codex-rs/lmstudio/src/client.rs:96][E: codex-rs/lmstudio/src/client.rs:66][E: codex-rs/lmstudio/src/client.rs:172]
...
`model-provider-info` 定义 OSS provider 的 OpenAI-compatible Responses endpoint；`ollama` 和 `lmstudio` crates 是本地 server/model management helpers，负责 probe、fetch model list、pull/download/load model，不是 Responses request runtime。[E: codex-rs/model-provider-info/src/lib.rs:495][E: codex-rs/model-provider-info/src/lib.rs:507][E: codex-rs/model-provider-info/src/lib.rs:514][E: codex-rs/model-provider-info/src/lib.rs:523][E: codex-rs/model-provider-info/src/lib.rs:531][E: codex-rs/ollama/src/client.rs:35][E: codex-rs/lmstudio/src/client.rs:15][I]

## 关键 crate/文件

- `codex-rs/model-provider-info/src/lib.rs`: OSS provider id、default ports、base URL env overrides、provider info shape。[E: codex-rs/model-provider-info/src/lib.rs:422][E: codex-rs/model-provider-info/src/lib.rs:423][E: codex-rs/model-provider-info/src/lib.rs:425][E: codex-rs/model-provider-info/src/lib.rs:426][E: codex-rs/model-provider-info/src/lib.rs:495][E: codex-rs/model-provider-info/src/lib.rs:507][E: codex-rs/model-provider-info/src/lib.rs:514][E: codex-rs/model-provider-info/src/lib.rs:532]
...
- `OLLAMA_OSS_PROVIDER_ID` 是 `ollama`，`LMSTUDIO_OSS_PROVIDER_ID` 是 `lmstudio`；default ports 分别是 11434 和 1234。[E: codex-rs/model-provider-info/src/lib.rs:422][E: codex-rs/model-provider-info/src/lib.rs:423][E: codex-rs/model-provider-info/src/lib.rs:425][E: codex-rs/model-provider-info/src/lib.rs:426]
- `create_oss_provider_with_base_url` 创建 name `gpt-oss`、base_url、无 env_key/auth/aws/query/header/retry override、`requires_openai_auth = false`、`supports_websockets = false`。[E: codex-rs/model-provider-info/src/lib.rs:514][E: codex-rs/model-provider-info/src/lib.rs:516][E: codex-rs/model-provider-info/src/lib.rs:517][E: codex-rs/model-provider-info/src/lib.rs:518][E: codex-rs/model-provider-info/src/lib.rs:520][E: codex-rs/model-provider-info/src/lib.rs:521][E: codex-rs/model-provider-info/src/lib.rs:522][E: codex-rs/model-provider-info/src/lib.rs:524][E: codex-rs/model-provider-info/src/lib.rs:525][E: codex-rs/model-provider-info/src/lib.rs:526][E: codex-rs/model-provider-info/src/lib.rs:527][E: codex-rs/model-provider-info/src/lib.rs:528][E: codex-rs/model-provider-info/src/lib.rs:529][E: codex-rs/model-provider-info/src/lib.rs:530][E: codex-rs/model-provider-info/src/lib.rs:531][E: codex-rs/model-provider-info/src/lib.rs:532]
...
1. built-in registry 插入 `ollama` 和 `lmstudio` provider，二者都通过 `create_oss_provider(default_port, WireApi::Responses)` 构造。[E: codex-rs/model-provider-info/src/lib.rs:429][E: codex-rs/model-provider-info/src/lib.rs:440][E: codex-rs/model-provider-info/src/lib.rs:444][E: codex-rs/model-provider-info/src/lib.rs:445][E: codex-rs/model-provider-info/src/lib.rs:448][E: codex-rs/model-provider-info/src/lib.rs:449]
2. `create_oss_provider` 默认 URL 是 `http://localhost:{CODEX_OSS_PORT 或 default_port}/v1`，非空 `CODEX_OSS_BASE_URL` 会覆盖整个 base URL。[E: codex-rs/model-provider-info/src/lib.rs:495][E: codex-rs/model-provider-info/src/lib.rs:498][E: codex-rs/model-provider-info/src/lib.rs:500][E: codex-rs/model-provider-info/src/lib.rs:504][E: codex-rs/model-provider-info/src/lib.rs:507][E: codex-rs/model-provider-info/src/lib.rs:509][E: codex-rs/model-provider-info/src/lib.rs:511]
...
- `pull_with_reporter` 不能只看 HTTP status，因为 Ollama 可能在 200 OK stream 中返回 error event；源码在 Error event 上返回 `Pull failed`。[E: codex-rs/ollama/src/client.rs:227][E: codex-rs/ollama/src/client.rs:235][E: codex-rs/ollama/src/client.rs:235][E: codex-rs/ollama/src/client.rs:236]
...
- `CODEX_OSS_BASE_URL` 是全局 env override；同一进程里会影响 built-in Ollama 和 LM Studio 的 `create_oss_provider` 调用。[E: codex-rs/model-provider-info/src/lib.rs:445][E: codex-rs/model-provider-info/src/lib.rs:449][E: codex-rs/model-provider-info/src/lib.rs:507][E: codex-rs/model-provider-info/src/lib.rs:509][E: codex-rs/model-provider-info/src/lib.rs:511][I]
