...
> OSS providers 是本地 OpenAI-compatible provider defaults：Ollama 默认 `http://localhost:11434/v1`，LM Studio 默认 `http://localhost:1234/v1`，auth 为空、wire API 为 Responses、websocket 不支持；Ollama model management 使用 native `/api/*` endpoints，LM Studio probe/fetch/load 使用 OpenAI-compatible paths，download 走 `lms get` CLI。[E: codex-rs/model-provider-info/src/lib.rs:512][E: codex-rs/model-provider-info/src/lib.rs:513][E: codex-rs/model-provider-info/src/lib.rs:516][E: codex-rs/model-provider-info/src/lib.rs:517][E: codex-rs/model-provider-info/src/lib.rs:572][E: codex-rs/model-provider-info/src/lib.rs:574][E: codex-rs/model-provider-info/src/lib.rs:578][E: codex-rs/model-provider-info/src/lib.rs:581][E: codex-rs/model-provider-info/src/lib.rs:584][E: codex-rs/model-provider-info/src/lib.rs:592][E: codex-rs/model-provider-info/src/lib.rs:597][E: codex-rs/model-provider-info/src/lib.rs:605][E: codex-rs/model-provider-info/src/lib.rs:606][E: codex-rs/ollama/src/client.rs:100][E: codex-rs/ollama/src/client.rs:133][E: codex-rs/ollama/src/client.rs:189][E: codex-rs/lmstudio/src/client.rs:52][E: codex-rs/lmstudio/src/client.rs:101][E: codex-rs/lmstudio/src/client.rs:71][E: codex-rs/lmstudio/src/client.rs:177]
...
`model-provider-info` 定义 OSS provider 的 OpenAI-compatible Responses endpoint；`ollama` 和 `lmstudio` crates 是本地 server/model management helpers，负责 probe、fetch model list、pull/download/load model，不是 Responses request runtime。[E: codex-rs/model-provider-info/src/lib.rs:567][E: codex-rs/model-provider-info/src/lib.rs:581][E: codex-rs/model-provider-info/src/lib.rs:585][E: codex-rs/model-provider-info/src/lib.rs:597][E: codex-rs/model-provider-info/src/lib.rs:605][E: codex-rs/ollama/src/client.rs:43][E: codex-rs/lmstudio/src/client.rs:19][I]

## 关键 crate/文件

- `codex-rs/model-provider-info/src/lib.rs`: OSS provider id、default ports、base URL env overrides、provider info shape。[E: codex-rs/model-provider-info/src/lib.rs:490][E: codex-rs/model-provider-info/src/lib.rs:491][E: codex-rs/model-provider-info/src/lib.rs:492][E: codex-rs/model-provider-info/src/lib.rs:492][E: codex-rs/model-provider-info/src/lib.rs:567][E: codex-rs/model-provider-info/src/lib.rs:581][E: codex-rs/model-provider-info/src/lib.rs:585][E: codex-rs/model-provider-info/src/lib.rs:606]
...
- `OLLAMA_OSS_PROVIDER_ID` 是 `ollama`，`LMSTUDIO_OSS_PROVIDER_ID` 是 `lmstudio`；default ports 分别是 11434 和 1234。[E: codex-rs/model-provider-info/src/lib.rs:490][E: codex-rs/model-provider-info/src/lib.rs:491][E: codex-rs/model-provider-info/src/lib.rs:492][E: codex-rs/model-provider-info/src/lib.rs:492]
- `create_oss_provider_with_base_url` 创建 name `gpt-oss`、base_url、无 env_key/auth/aws/query/header/retry override、`requires_openai_auth = false`、`supports_websockets = false`。[E: codex-rs/model-provider-info/src/lib.rs:585][E: codex-rs/model-provider-info/src/lib.rs:589][E: codex-rs/model-provider-info/src/lib.rs:589][E: codex-rs/model-provider-info/src/lib.rs:592][E: codex-rs/model-provider-info/src/lib.rs:595][E: codex-rs/model-provider-info/src/lib.rs:595][E: codex-rs/model-provider-info/src/lib.rs:596][E: codex-rs/model-provider-info/src/lib.rs:598][E: codex-rs/model-provider-info/src/lib.rs:599][E: codex-rs/model-provider-info/src/lib.rs:600][E: codex-rs/model-provider-info/src/lib.rs:601][E: codex-rs/model-provider-info/src/lib.rs:601][E: codex-rs/model-provider-info/src/lib.rs:601][E: codex-rs/model-provider-info/src/lib.rs:604][E: codex-rs/model-provider-info/src/lib.rs:605][E: codex-rs/model-provider-info/src/lib.rs:606]
...
1. built-in registry 插入 `ollama` 和 `lmstudio` provider，二者都通过 `create_oss_provider(default_port, WireApi::Responses)` 构造。[E: codex-rs/model-provider-info/src/lib.rs:496][E: codex-rs/model-provider-info/src/lib.rs:512][E: codex-rs/model-provider-info/src/lib.rs:513][E: codex-rs/model-provider-info/src/lib.rs:516][E: codex-rs/model-provider-info/src/lib.rs:517]
2. `create_oss_provider` 默认 URL 是 `http://localhost:{CODEX_OSS_PORT 或 default_port}/v1`，非空 `CODEX_OSS_BASE_URL` 会覆盖整个 base URL。[E: codex-rs/model-provider-info/src/lib.rs:567][E: codex-rs/model-provider-info/src/lib.rs:572][E: codex-rs/model-provider-info/src/lib.rs:574][E: codex-rs/model-provider-info/src/lib.rs:578][E: codex-rs/model-provider-info/src/lib.rs:581][E: codex-rs/model-provider-info/src/lib.rs:581][E: codex-rs/model-provider-info/src/lib.rs:585]
...
- `CODEX_OSS_BASE_URL` 是全局 env override；同一进程里会影响 built-in Ollama 和 LM Studio 的 `create_oss_provider` 调用。[E: codex-rs/model-provider-info/src/lib.rs:513][E: codex-rs/model-provider-info/src/lib.rs:517][E: codex-rs/model-provider-info/src/lib.rs:581][E: codex-rs/model-provider-info/src/lib.rs:581][E: codex-rs/model-provider-info/src/lib.rs:585][I]
