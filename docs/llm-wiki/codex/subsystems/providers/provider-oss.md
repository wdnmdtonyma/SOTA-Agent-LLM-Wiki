...
> OSS providers 是本地 OpenAI-compatible provider defaults：Ollama 默认 `http://localhost:11434/v1`，LM Studio 默认 `http://localhost:1234/v1`，auth 为空、wire API 为 Responses、websocket 不支持；Ollama model management 使用 native `/api/*` endpoints，LM Studio probe/fetch/load 使用 OpenAI-compatible paths，download 走 `lms get` CLI。[E: codex-rs/model-provider-info/src/lib.rs:448][E: codex-rs/model-provider-info/src/lib.rs:449][E: codex-rs/model-provider-info/src/lib.rs:452][E: codex-rs/model-provider-info/src/lib.rs:453][E: codex-rs/model-provider-info/src/lib.rs:508][E: codex-rs/model-provider-info/src/lib.rs:510][E: codex-rs/model-provider-info/src/lib.rs:514][E: codex-rs/model-provider-info/src/lib.rs:517][E: codex-rs/model-provider-info/src/lib.rs:520][E: codex-rs/model-provider-info/src/lib.rs:528][E: codex-rs/model-provider-info/src/lib.rs:533][E: codex-rs/model-provider-info/src/lib.rs:541][E: codex-rs/model-provider-info/src/lib.rs:542][E: codex-rs/ollama/src/client.rs:83][E: codex-rs/ollama/src/client.rs:105][E: codex-rs/ollama/src/client.rs:161][E: codex-rs/lmstudio/src/client.rs:47][E: codex-rs/lmstudio/src/client.rs:96][E: codex-rs/lmstudio/src/client.rs:66][E: codex-rs/lmstudio/src/client.rs:172]
...
`model-provider-info` 定义 OSS provider 的 OpenAI-compatible Responses endpoint；`ollama` 和 `lmstudio` crates 是本地 server/model management helpers，负责 probe、fetch model list、pull/download/load model，不是 Responses request runtime。[E: codex-rs/model-provider-info/src/lib.rs:505][E: codex-rs/model-provider-info/src/lib.rs:517][E: codex-rs/model-provider-info/src/lib.rs:524][E: codex-rs/model-provider-info/src/lib.rs:533][E: codex-rs/model-provider-info/src/lib.rs:541][E: codex-rs/ollama/src/client.rs:35][E: codex-rs/lmstudio/src/client.rs:15][I]

## 关键 crate/文件

- `codex-rs/model-provider-info/src/lib.rs`: OSS provider id、default ports、base URL env overrides、provider info shape。[E: codex-rs/model-provider-info/src/lib.rs:426][E: codex-rs/model-provider-info/src/lib.rs:427][E: codex-rs/model-provider-info/src/lib.rs:429][E: codex-rs/model-provider-info/src/lib.rs:430][E: codex-rs/model-provider-info/src/lib.rs:505][E: codex-rs/model-provider-info/src/lib.rs:517][E: codex-rs/model-provider-info/src/lib.rs:524][E: codex-rs/model-provider-info/src/lib.rs:542]
...
- `OLLAMA_OSS_PROVIDER_ID` 是 `ollama`，`LMSTUDIO_OSS_PROVIDER_ID` 是 `lmstudio`；default ports 分别是 11434 和 1234。[E: codex-rs/model-provider-info/src/lib.rs:426][E: codex-rs/model-provider-info/src/lib.rs:427][E: codex-rs/model-provider-info/src/lib.rs:429][E: codex-rs/model-provider-info/src/lib.rs:430]
- `create_oss_provider_with_base_url` 创建 name `gpt-oss`、base_url、无 env_key/auth/aws/query/header/retry override、`requires_openai_auth = false`、`supports_websockets = false`。[E: codex-rs/model-provider-info/src/lib.rs:524][E: codex-rs/model-provider-info/src/lib.rs:526][E: codex-rs/model-provider-info/src/lib.rs:527][E: codex-rs/model-provider-info/src/lib.rs:528][E: codex-rs/model-provider-info/src/lib.rs:530][E: codex-rs/model-provider-info/src/lib.rs:531][E: codex-rs/model-provider-info/src/lib.rs:532][E: codex-rs/model-provider-info/src/lib.rs:534][E: codex-rs/model-provider-info/src/lib.rs:535][E: codex-rs/model-provider-info/src/lib.rs:536][E: codex-rs/model-provider-info/src/lib.rs:537][E: codex-rs/model-provider-info/src/lib.rs:538][E: codex-rs/model-provider-info/src/lib.rs:539][E: codex-rs/model-provider-info/src/lib.rs:540][E: codex-rs/model-provider-info/src/lib.rs:541][E: codex-rs/model-provider-info/src/lib.rs:542]
...
- `LMStudioClient` 保存 reqwest client 和 base_url；connection error 文案提示安装 LM Studio 并运行 `lms server start`。[E: codex-rs/lmstudio/src/client.rs:7][E: codex-rs/lmstudio/src/client.rs:8][E: codex-rs/lmstudio/src/client.rs:9][E: codex-rs/lmstudio/src/client.rs:12]

## 控制流

1. built-in registry 插入 `ollama` 和 `lmstudio` provider，二者都通过 `create_oss_provider(default_port, WireApi::Responses)` 构造。[E: codex-rs/model-provider-info/src/lib.rs:433][E: codex-rs/model-provider-info/src/lib.rs:448][E: codex-rs/model-provider-info/src/lib.rs:449][E: codex-rs/model-provider-info/src/lib.rs:452][E: codex-rs/model-provider-info/src/lib.rs:453]
2. `create_oss_provider` 默认 URL 是 `http://localhost:{CODEX_OSS_PORT 或 default_port}/v1`，非空 `CODEX_OSS_BASE_URL` 会覆盖整个 base URL。[E: codex-rs/model-provider-info/src/lib.rs:505][E: codex-rs/model-provider-info/src/lib.rs:508][E: codex-rs/model-provider-info/src/lib.rs:510][E: codex-rs/model-provider-info/src/lib.rs:514][E: codex-rs/model-provider-info/src/lib.rs:517][E: codex-rs/model-provider-info/src/lib.rs:519][E: codex-rs/model-provider-info/src/lib.rs:521]
...
10. LM Studio `download_model` 先找 `lms`，再执行 `lms get --yes <model>`，非零退出码返回 error。[E: codex-rs/lmstudio/src/client.rs:169][E: codex-rs/lmstudio/src/client.rs:172][E: codex-rs/lmstudio/src/client.rs:173][E: codex-rs/lmstudio/src/client.rs:181]

## 设计动机与权衡

- OSS provider 使用 OpenAI-compatible `/v1` 作为推理 base URL；Ollama 本地管理会把 `http://localhost:11434/v1` 转成 host root 后请求 `/api/tags` 和 `/api/pull`，LM Studio 下载模型依赖本机 `lms` CLI。[E: codex-rs/ollama/src/url.rs:8][E: codex-rs/ollama/src/url.rs:8][E: codex-rs/ollama/src/url.rs:12][E: codex-rs/ollama/src/client.rs:105][E: codex-rs/ollama/src/client.rs:161][E: codex-rs/lmstudio/src/client.rs:169][E: codex-rs/lmstudio/src/client.rs:172][I]
...
- `CODEX_OSS_BASE_URL` 是全局 env override；同一进程里会影响 built-in Ollama 和 LM Studio 的 `create_oss_provider` 调用。[E: codex-rs/model-provider-info/src/lib.rs:449][E: codex-rs/model-provider-info/src/lib.rs:453][E: codex-rs/model-provider-info/src/lib.rs:517][E: codex-rs/model-provider-info/src/lib.rs:519][E: codex-rs/model-provider-info/src/lib.rs:521][I]
