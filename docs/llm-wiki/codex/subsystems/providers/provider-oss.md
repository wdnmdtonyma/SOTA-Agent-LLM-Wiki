...
`model-provider-info` 定义 OSS provider 的 OpenAI-compatible Responses endpoint；`ollama` 和 `lmstudio` crates 是本地 server/model management helpers，负责 probe、fetch model list、pull/download/load model，不是 Responses request runtime。[E: codex-rs/model-provider-info/src/lib.rs:510][E: codex-rs/model-provider-info/src/lib.rs:522][E: codex-rs/model-provider-info/src/lib.rs:529][E: codex-rs/model-provider-info/src/lib.rs:538][E: codex-rs/model-provider-info/src/lib.rs:546][E: codex-rs/ollama/src/client.rs:43][E: codex-rs/lmstudio/src/client.rs:19][I]
