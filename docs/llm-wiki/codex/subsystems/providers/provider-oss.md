...
1. built-in registry 插入 `ollama` 和 `lmstudio` provider，二者都通过 `create_oss_provider(default_port, WireApi::Responses)` 构造。[E: codex-rs/model-provider-info/src/lib.rs:433][E: codex-rs/model-provider-info/src/lib.rs:444][E: codex-rs/model-provider-info/src/lib.rs:448][E: codex-rs/model-provider-info/src/lib.rs:449][E: codex-rs/model-provider-info/src/lib.rs:452][E: codex-rs/model-provider-info/src/lib.rs:453]
