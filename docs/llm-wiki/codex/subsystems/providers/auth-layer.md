...
- `HeaderAuthProvider` copies a predefined `AuthHeaders` map verbatim；`AuthManagerAuthProvider` instead reads the current managed auth snapshot on every request, follows token refresh only while account id、ChatGPT user id、workspace membership still match the startup identity anchor。[E: codex-rs/model-provider/src/auth.rs:113][E: codex-rs/model-provider/src/auth.rs:118][E: codex-rs/model-provider/src/auth.rs:120][E: codex-rs/model-provider/src/auth.rs:124][E: codex-rs/model-provider/src/auth.rs:131][E: codex-rs/model-provider/src/auth.rs:133][E: codex-rs/model-provider/src/auth.rs:141][E: codex-rs/model-provider/src/auth.rs:143][E: codex-rs/model-provider/src/auth.rs:149]
...
4. `auth_provider_from_auth_manager` wraps a manager plus expected identity；requests can see refreshed credentials for that identity, but an account/user/workspace switch yields no auth headers until account-scoped state is rebuilt。[E: codex-rs/model-provider/src/auth.rs:124][E: codex-rs/model-provider/src/auth.rs:131][E: codex-rs/model-provider/src/auth.rs:141][E: codex-rs/model-provider/src/auth.rs:147][E: codex-rs/model-provider/src/auth.rs:300][E: codex-rs/model-provider/src/auth.rs:305][E: codex-rs/model-provider/src/auth.rs:309]
