...
- `codex-rs/model-provider-info/src/lib.rs`: `ModelProviderInfo` schema、built-ins、validation、provider-to-API conversion。[E: codex-rs/model-provider-info/src/lib.rs:89][E: codex-rs/model-provider-info/src/lib.rs:89][E: codex-rs/model-provider-info/src/lib.rs:153][E: codex-rs/model-provider-info/src/lib.rs:241][E: codex-rs/model-provider-info/src/lib.rs:433]
...
4. `ModelProviderInfo::to_api_provider` 对 `Chatgpt | ChatgptAuthTokens | Headers | AgentIdentity | PersonalAccessToken` auth mode 且无 base_url override 时使用 `https://chatgpt.com/backend-api/codex`，其他默认使用 `https://api.openai.com/v1`，配置 base_url 时使用配置值。[E: codex-rs/model-provider-info/src/lib.rs:241][E: codex-rs/model-provider-info/src/lib.rs:242][E: codex-rs/model-provider-info/src/lib.rs:245][E: codex-rs/model-provider-info/src/lib.rs:247][E: codex-rs/model-provider-info/src/lib.rs:252][E: codex-rs/model-provider-info/src/lib.rs:254][E: codex-rs/model-provider-info/src/lib.rs:256][E: codex-rs/model-provider-info/src/lib.rs:259]
5. `to_api_provider` 构造 retry config，默认 request_max_retries 进入 max_attempts，base_delay 200ms，retry_429 false，retry_5xx true，retry_transport true。[E: codex-rs/model-provider-info/src/lib.rs:262][E: codex-rs/model-provider-info/src/lib.rs:263][E: codex-rs/model-provider-info/src/lib.rs:264][E: codex-rs/model-provider-info/src/lib.rs:265][E: codex-rs/model-provider-info/src/lib.rs:266][E: codex-rs/model-provider-info/src/lib.rs:267]
...
7. `built_in_model_providers` 返回 OpenAI、Amazon Bedrock、Ollama、LM Studio provider entries；`merge_configured_model_providers` 允许 Bedrock 覆盖 `base_url`、command `auth`、`http_headers` 与整组 AWS profile/region，其他 configured provider 仍只在 key 不存在时插入。[E: codex-rs/model-provider-info/src/lib.rs:461][E: codex-rs/model-provider-info/src/lib.rs:464][E: codex-rs/model-provider-info/src/lib.rs:466][E: codex-rs/model-provider-info/src/lib.rs:471][E: codex-rs/model-provider-info/src/lib.rs:472][E: codex-rs/model-provider-info/src/lib.rs:475][E: codex-rs/model-provider-info/src/lib.rs:478][E: codex-rs/model-provider-info/src/lib.rs:480][E: codex-rs/model-provider-info/src/lib.rs:484][E: codex-rs/model-provider-info/src/lib.rs:486][E: codex-rs/model-provider-info/src/lib.rs:488][E: codex-rs/model-provider-info/src/lib.rs:490][E: codex-rs/model-provider-info/src/lib.rs:498]

8. `ModelProvider` 现在还定义 `models_manager_without_cache`，默认使用 authoritative in-memory catalog，避免 hosted callers 意外写盘；configured OpenAI-compatible provider 会使用 `OpenAiModelsManager::new_without_cache` 保留远端发现而关闭 cache。[E: codex-rs/model-provider/src/provider.rs:203][E: codex-rs/model-provider/src/provider.rs:205][E: codex-rs/model-provider/src/provider.rs:207][E: codex-rs/model-provider/src/provider.rs:211][E: codex-rs/model-provider/src/provider.rs:214][E: codex-rs/model-provider/src/provider.rs:352][E: codex-rs/model-provider/src/provider.rs:366]
...
- Bedrock 作为 special-case runtime provider 存在：`create_model_provider` 对 Amazon Bedrock 走 `AmazonBedrockModelProvider`，内建 Bedrock provider 的默认 base URL 是 Mantle endpoint，并携带 AWS auth info。[E: codex-rs/model-provider/src/provider.rs:232][E: codex-rs/model-provider/src/provider.rs:236][E: codex-rs/model-provider/src/provider.rs:237][E: codex-rs/model-provider-info/src/lib.rs:46][E: codex-rs/model-provider-info/src/lib.rs:366][E: codex-rs/model-provider-info/src/lib.rs:370][E: codex-rs/model-provider-info/src/lib.rs:379]
- built-in providers 不被一般 user config 覆盖；`entry(key).or_insert(provider)` 只在 id 不存在时插入，这让 built-ins 的默认 URL/auth 行为稳定。[E: codex-rs/model-provider-info/src/lib.rs:497][E: codex-rs/model-provider-info/src/lib.rs:498][I]

## gotcha

- `api_key()` 只读取 `env_key` 指定的环境变量；变量缺失或为空会带上 `env_key_instructions` 形成 `EnvVarError`。[E: codex-rs/model-provider-info/src/lib.rs:283][E: codex-rs/model-provider-info/src/lib.rs:284][E: codex-rs/model-provider-info/src/lib.rs:286][E: codex-rs/model-provider-info/src/lib.rs:288][E: codex-rs/model-provider-info/src/lib.rs:290][E: codex-rs/model-provider-info/src/lib.rs:292]
- effective retry caps 使用 `min(100)`；配置很大的 retry 数会被截断到 100。[E: codex-rs/model-provider-info/src/lib.rs:31][E: codex-rs/model-provider-info/src/lib.rs:33][E: codex-rs/model-provider-info/src/lib.rs:302][E: codex-rs/model-provider-info/src/lib.rs:304][E: codex-rs/model-provider-info/src/lib.rs:309][E: codex-rs/model-provider-info/src/lib.rs:312]
...
- Generic provider 的默认 memory extraction/consolidation models 已分别是 `gpt-5.6-luna` 与 `gpt-5.6-terra`；provider 可通过 trait methods 覆盖这些 backend-specific ids。[E: codex-rs/model-provider/src/provider.rs:88][E: codex-rs/model-provider/src/provider.rs:90][E: codex-rs/model-provider/src/provider.rs:92][E: codex-rs/model-provider/src/provider.rs:94][E: codex-rs/model-provider/src/provider.rs:117][E: codex-rs/model-provider/src/provider.rs:127]
