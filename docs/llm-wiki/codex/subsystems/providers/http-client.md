...
- `codex-rs/codex-client/src/default_client.rs`: reqwest wrapper、request builder、trace header injection。[E: codex-rs/codex-client/src/default_client.rs:16][E: codex-rs/codex-client/src/default_client.rs:74][E: codex-rs/codex-client/src/default_client.rs:113][E: codex-rs/codex-client/src/default_client.rs:157]
- `codex-rs/codex-client/src/request.rs`: request/response structs、JSON/raw body、zstd compression。[E: codex-rs/codex-client/src/request.rs:9][E: codex-rs/codex-client/src/request.rs:16][E: codex-rs/codex-client/src/request.rs:43][E: codex-rs/codex-client/src/request.rs:85][E: codex-rs/codex-client/src/request.rs:210]
- `codex-rs/codex-client/src/transport.rs`: `HttpTransport` trait 和 reqwest execute/stream implementation。[E: codex-rs/codex-client/src/transport.rs:26][E: codex-rs/codex-client/src/transport.rs:32][E: codex-rs/codex-client/src/transport.rs:91][E: codex-rs/codex-client/src/transport.rs:123]
- `codex-rs/backend-client/src/client.rs`: ChatGPT/Codex backend API client、auth headers、path styles。[E: codex-rs/backend-client/src/client.rs:98][E: codex-rs/backend-client/src/client.rs:116][E: codex-rs/backend-client/src/client.rs:127]

## 数据模型

- `CodexHttpClient` wraps `reqwest::Client`；`CodexRequestBuilder` 保存 reqwest builder、method、url，并通过 methods 委托设置 headers、bearer、timeout、json、body。[E: codex-rs/codex-client/src/default_client.rs:16][E: codex-rs/codex-client/src/default_client.rs:18][E: codex-rs/codex-client/src/default_client.rs:51][E: codex-rs/codex-client/src/default_client.rs:52][E: codex-rs/codex-client/src/default_client.rs:53][E: codex-rs/codex-client/src/default_client.rs:54][E: codex-rs/codex-client/src/default_client.rs:74][E: codex-rs/codex-client/src/default_client.rs:88][E: codex-rs/codex-client/src/default_client.rs:95][E: codex-rs/codex-client/src/default_client.rs:99][E: codex-rs/codex-client/src/default_client.rs:106]
- `Request` 保存 method、url、headers、optional body、compression、timeout；`RequestBody` 分 JSON 和 raw bytes。[E: codex-rs/codex-client/src/request.rs:16][E: codex-rs/codex-client/src/request.rs:19][E: codex-rs/codex-client/src/request.rs:43][E: codex-rs/codex-client/src/request.rs:47]
...
- `backend_client::Client` 保存 base_url、reqwest client、bearer token、user agent、account id、FedRAMP flag 和 path style。[E: codex-rs/backend-client/src/client.rs:116][E: codex-rs/backend-client/src/client.rs:118][E: codex-rs/backend-client/src/client.rs:120][E: codex-rs/backend-client/src/client.rs:124]
...
7. `backend-client::Client::new` 把 `chatgpt.com`/`chat.openai.com` 归一化到 `/backend-api`，并 trim trailing slash。[E: codex-rs/backend-client/src/client.rs:128][E: codex-rs/backend-client/src/client.rs:132][E: codex-rs/backend-client/src/client.rs:135][E: codex-rs/backend-client/src/client.rs:136][E: codex-rs/backend-client/src/client.rs:137][E: codex-rs/backend-client/src/client.rs:139][E: codex-rs/backend-client/src/client.rs:144]
8. backend headers 会写 user-agent、Authorization、ChatGPT-Account-Id、X-OpenAI-Fedramp。[E: codex-rs/backend-client/src/client.rs:197][E: codex-rs/backend-client/src/client.rs:206][E: codex-rs/backend-client/src/client.rs:212][E: codex-rs/backend-client/src/client.rs:217]
9. backend `PathStyle` 决定 Codex API path 是 `/api/codex/...`，ChatGPT API path 是 `/wham/...`。[E: codex-rs/backend-client/src/client.rs:98][E: codex-rs/backend-client/src/client.rs:101][E: codex-rs/backend-client/src/client.rs:105]
...
- `backend-client` 直接保存 `reqwest::Client`，而 generic provider transport 通过 `codex-client::HttpTransport` 暴露 execute/stream；两条 HTTP client path 的抽象层级不同。[E: codex-rs/backend-client/src/client.rs:119][E: codex-rs/codex-client/src/transport.rs:27][E: codex-rs/codex-client/src/transport.rs:28][E: codex-rs/codex-client/src/transport.rs:29][I]

## gotcha

- `RequestCompression::Zstd` 只支持 JSON body；如果调用者传 raw body 又要求压缩，会在 prepare 阶段返回 error。[E: codex-rs/codex-client/src/request.rs:88][E: codex-rs/codex-client/src/request.rs:90][E: codex-rs/codex-client/src/request.rs:109][E: codex-rs/codex-client/src/request.rs:115]
- transport retry 不会自动 retry 任意 stream item error；`ReqwestTransport::stream` 建立 stream 后的 bytes stream item error 仍是 `TransportError`。[E: codex-rs/codex-client/src/transport.rs:18][E: codex-rs/codex-client/src/transport.rs:147][E: codex-rs/codex-client/src/transport.rs:149][I]
- backend `RequestError::is_unauthorized` 只对 unexpected status 401 返回 true，network/parse 等错误不是 unauthorized。[E: codex-rs/backend-client/src/client.rs:40][E: codex-rs/backend-client/src/client.rs:45]
