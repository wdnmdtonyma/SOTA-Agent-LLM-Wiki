...
- `create_amazon_bedrock_provider` sets name `Amazon Bedrock`，但 built-in `base_url` 现在为 `None`，让 runtime 按 region 派生 Mantle endpoint；configured non-empty base URL 因而是明确 endpoint override。默认 AWS profile/region 为 None，wire API 是 Responses，`requires_openai_auth = false`、`supports_websockets = false`。[E: codex-rs/model-provider-info/src/lib.rs:366][E: codex-rs/model-provider-info/src/lib.rs:369][E: codex-rs/model-provider-info/src/lib.rs:370][E: codex-rs/model-provider-info/src/lib.rs:374][E: codex-rs/model-provider-info/src/lib.rs:379][E: codex-rs/model-provider-info/src/lib.rs:383][E: codex-rs/model-provider-info/src/lib.rs:394][E: codex-rs/model-provider-info/src/lib.rs:395]
