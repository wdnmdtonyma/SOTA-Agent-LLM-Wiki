...
- `codex-rs/model-provider/src/amazon_bedrock/mod.rs`: Bedrock overrides model discovery to always return `StaticModelsManager`；config catalog 优先，否则 Mantle 用 `static_model_catalog`，Runtime 用优先 global 的 `static_runtime_model_catalog`。[E: codex-rs/model-provider/src/amazon_bedrock/mod.rs:312][E: codex-rs/model-provider/src/amazon_bedrock/mod.rs:185][E: codex-rs/model-provider/src/amazon_bedrock/runtime_catalog.rs:8]
...
- `ModelMessages` 除 instruction template 外还可携带 approval、collaboration-mode、auto-review、permission 和 model-owned token-budget messages；token-budget defaults 包含 reminder threshold/template、context-window guidance、fallback prompt 与 buffer。[E: codex-rs/protocol/src/openai_models.rs:522][E: codex-rs/protocol/src/openai_models.rs:523][E: codex-rs/protocol/src/openai_models.rs:527][E: codex-rs/protocol/src/openai_models.rs:531][E: codex-rs/protocol/src/openai_models.rs:534][E: codex-rs/protocol/src/openai_models.rs:544]

## 控制流

1. Core config loads `model_catalog_json` into a `ModelsResponse`, rejects an empty catalog, and passes it through `Config::to_models_manager_config`.[E: codex-rs/core/src/config/mod.rs:1649][E: codex-rs/core/src/config/mod.rs:1657][E: codex-rs/core/src/config/mod.rs:2078][E: codex-rs/core/src/config/mod.rs:2087][E: codex-rs/core/src/config/mod.rs:2101][E: codex-rs/core/src/config/mod.rs:2104]
...
3. `AmazonBedrockModelProvider::models_manager` bypasses `/models` refresh and returns `StaticModelsManager` for either a config-supplied catalog or `default_model_catalog()`。Runtime catalog 把 `global.` 变体排在 `us.` 前面。[E: codex-rs/model-provider/src/amazon_bedrock/mod.rs:312][E: codex-rs/model-provider/src/amazon_bedrock/mod.rs:185][E: codex-rs/model-provider/src/amazon_bedrock/runtime_catalog.rs:8]
