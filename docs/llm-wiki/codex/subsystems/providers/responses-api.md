...
> Responses API subsystem defines Codex 的 canonical streaming request/response shape，并把 `ResponsesApiRequest` 通过 `ResponsesClient` 编码后 POST 到 provider path `responses`，再把 HTTP SSE stream 交给 `spawn_response_stream`。[E: codex-rs/codex-api/src/common.rs:260][E: codex-rs/codex-api/src/common.rs:80][E: codex-rs/codex-api/src/common.rs:394][E: codex-rs/codex-api/src/endpoint/responses.rs:102][E: codex-rs/codex-api/src/endpoint/responses.rs:115][E: codex-rs/codex-api/src/endpoint/responses.rs:167][E: codex-rs/codex-api/src/endpoint/responses.rs:171][E: codex-rs/codex-api/src/endpoint/responses.rs:184]
...
`codex-api/src/common.rs` 定义 request/event/stream shared types，`endpoint/responses.rs` 负责 HTTP POST 和 SSE stream handoff，`endpoint/session.rs` 负责 provider URL、auth、retry/telemetry wrapper，`responses-api-proxy` 是本地 forwarding/debug service 而不是 normal provider runtime。[E: codex-rs/codex-api/src/common.rs:260][E: codex-rs/codex-api/src/common.rs:80][E: codex-rs/codex-api/src/common.rs:394][E: codex-rs/codex-api/src/endpoint/responses.rs:102][E: codex-rs/codex-api/src/endpoint/session.rs:48][E: codex-rs/codex-api/src/endpoint/session.rs:122][E: codex-rs/responses-api-proxy/src/lib.rs:73][I]

## 关键 crate/文件

- `codex-rs/codex-api/src/common.rs`: Responses request fields、websocket request conversion、ResponseEvent、ResponseStream、text controls。[E: codex-rs/codex-api/src/common.rs:80][E: codex-rs/codex-api/src/common.rs:260][E: codex-rs/codex-api/src/common.rs:287][E: codex-rs/codex-api/src/common.rs:374][E: codex-rs/codex-api/src/common.rs:394]
...
- `ResponsesApiRequest` includes model、instructions、input、tools、tool_choice、parallel_tool_calls、reasoning、store、stream、optional `stream_options`、include、service_tier、prompt_cache_key、text、client_metadata。[E: codex-rs/codex-api/src/common.rs:260][E: codex-rs/codex-api/src/common.rs:261][E: codex-rs/codex-api/src/common.rs:263][E: codex-rs/codex-api/src/common.rs:264][E: codex-rs/codex-api/src/common.rs:230][E: codex-rs/codex-api/src/common.rs:267][E: codex-rs/codex-api/src/common.rs:268][E: codex-rs/codex-api/src/common.rs:269][E: codex-rs/codex-api/src/common.rs:270][E: codex-rs/codex-api/src/common.rs:271][E: codex-rs/codex-api/src/common.rs:273][E: codex-rs/codex-api/src/common.rs:274][E: codex-rs/codex-api/src/common.rs:276][E: codex-rs/codex-api/src/common.rs:278][E: codex-rs/codex-api/src/common.rs:280][E: codex-rs/codex-api/src/common.rs:284]
- `StreamOptions` currently carries `reasoning_summary_delivery = sequential_cutoff`；HTTP request 转 websocket request 时该字段也被 clone，因此两种 transport 共享 reasoning-summary delivery contract。[E: codex-rs/codex-api/src/common.rs:173][E: codex-rs/codex-api/src/common.rs:168][E: codex-rs/codex-api/src/common.rs:169][E: codex-rs/codex-api/src/common.rs:173][E: codex-rs/codex-api/src/common.rs:174][E: codex-rs/codex-api/src/common.rs:273][E: codex-rs/codex-api/src/common.rs:273][E: codex-rs/codex-api/src/common.rs:287][E: codex-rs/codex-api/src/common.rs:261]
- `TextControls` carries optional verbosity and optional JSON schema format; `TextFormat` stores type、strict、schema、name。[E: codex-rs/codex-api/src/common.rs:185][E: codex-rs/codex-api/src/common.rs:187][E: codex-rs/codex-api/src/common.rs:189][E: codex-rs/codex-api/src/common.rs:191][E: codex-rs/codex-api/src/common.rs:193][E: codex-rs/codex-api/src/common.rs:199][E: codex-rs/codex-api/src/common.rs:201][E: codex-rs/codex-api/src/common.rs:203]
- `ResponseEvent` is the normalized streaming event enum for created/completed/output item/text delta/tool call delta/reasoning/rate-limit/model metadata。[E: codex-rs/codex-api/src/common.rs:80][E: codex-rs/codex-api/src/common.rs:77][E: codex-rs/codex-api/src/common.rs:99][E: codex-rs/codex-api/src/common.rs:107][E: codex-rs/codex-api/src/common.rs:108][E: codex-rs/codex-api/src/common.rs:113][E: codex-rs/codex-api/src/common.rs:122][E: codex-rs/codex-api/src/common.rs:126][E: codex-rs/codex-api/src/common.rs:129][E: codex-rs/codex-api/src/common.rs:130]
- `ResponseStream` is a `futures::Stream` over an mpsc receiver of `Result<ResponseEvent, ApiError>` and carries an optional upstream request id。[E: codex-rs/codex-api/src/common.rs:394][E: codex-rs/codex-api/src/common.rs:395][E: codex-rs/codex-api/src/common.rs:397][E: codex-rs/codex-api/src/common.rs:400][E: codex-rs/codex-api/src/common.rs:401][E: codex-rs/codex-api/src/common.rs:404]

## 控制流

1. `create_text_param_for_request` returns `None` only when both verbosity and output_schema are absent; otherwise it builds `TextControls` and wraps output schema as strict/non-strict `json_schema` format named `codex_output_schema`。[E: codex-rs/codex-api/src/common.rs:374][E: codex-rs/codex-api/src/common.rs:379][E: codex-rs/codex-api/src/common.rs:383][E: codex-rs/codex-api/src/common.rs:384][E: codex-rs/codex-api/src/common.rs:385][E: codex-rs/codex-api/src/common.rs:386][E: codex-rs/codex-api/src/common.rs:387][E: codex-rs/codex-api/src/common.rs:389]
...
5. Core 在生成 non-OpenAI provider 的 Responses input 时，除清理 internal chat-message passthrough metadata 外，还移除 `FunctionCall.encrypted_function_args`；OpenAI provider 保留这两类内部延续字段。[E: codex-rs/core/src/client.rs:787][E: codex-rs/core/src/client.rs:788][E: codex-rs/core/src/client.rs:789][E: codex-rs/core/src/client.rs:791][E: codex-rs/core/src/client.rs:792][E: codex-rs/core/src/client.rs:900]
...
8. delegated/session HTTP fallback 仍保留：`ModelClient::force_http_fallback` 在 WebSocket 已启用时把 `disable_websockets` 设为 true、清掉 cached websocket session，并记 `codex.transport.fallback_to_http`。后续 `responses_websocket_enabled()` 看到该 flag 后只走 HTTP Responses。Guardian/delegated child 可继承 parent 的 HTTP fallback，避免子会话重新尝试已失败的 WebSocket。[E: codex-rs/core/src/client.rs:562][E: codex-rs/core/src/client.rs:569][E: codex-rs/core/src/client.rs:926][E: codex-rs/core/src/client.rs:2020]

## 设计动机与权衡

- HTTP Responses and websocket Responses share request shape through `impl From<&ResponsesApiRequest> for ResponseCreateWsRequest`, so fields like tools、reasoning、stream_options、text、client_metadata stay aligned across transports。[E: codex-rs/codex-api/src/common.rs:287][E: codex-rs/codex-api/src/common.rs:252][E: codex-rs/codex-api/src/common.rs:255][E: codex-rs/codex-api/src/common.rs:260][E: codex-rs/codex-api/src/common.rs:261][E: codex-rs/codex-api/src/common.rs:266][E: codex-rs/codex-api/src/common.rs:307][I]
...
- `client_metadata` trace keys for websocket request headers are inserted by `response_create_client_metadata`; `ResponsesClient::stream_request` only serializes the body and adds conversation/subagent headers, so the negative part is an implementation-scope inference。[E: codex-rs/codex-api/src/common.rs:344][E: codex-rs/codex-api/src/common.rs:350][E: codex-rs/codex-api/src/common.rs:356][E: codex-rs/codex-api/src/common.rs:363][E: codex-rs/codex-api/src/endpoint/responses.rs:115][E: codex-rs/codex-api/src/endpoint/responses.rs:118][E: codex-rs/codex-api/src/endpoint/responses.rs:122][E: codex-rs/codex-api/src/endpoint/responses.rs:127][I]
