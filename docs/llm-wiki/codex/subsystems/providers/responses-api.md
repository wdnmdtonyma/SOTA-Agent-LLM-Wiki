...
5. Core 在生成 non-OpenAI provider 的 Responses input 时，除清理 internal chat-message passthrough metadata 外，还移除 `FunctionCall.encrypted_function_args`；OpenAI provider 保留这两类内部延续字段。[E: codex-rs/core/src/client.rs:797][E: codex-rs/core/src/client.rs:798][E: codex-rs/core/src/client.rs:799][E: codex-rs/core/src/client.rs:801][E: codex-rs/core/src/client.rs:802][E: codex-rs/core/src/client.rs:910]
