...
> Codex skills 系统从 config layer、plugin roots、extra roots 和 repo `.agents/skills` roots 组成 `SkillRoot` 列表，递归发现 `SKILL.md`，解析 frontmatter/metadata/dependencies/policy，把可隐式调用的 skills 渲染进提示词，并在显式提及时读取完整 skill body 注入 turn。[E: codex-rs/core-skills/src/loader.rs:237][E: codex-rs/core-skills/src/loader.rs:265][E: codex-rs/core-skills/src/loader.rs:282][E: codex-rs/core-skills/src/loader.rs:498][E: codex-rs/core-skills/src/model.rs:15][E: codex-rs/core-skills/src/render.rs:160][E: codex-rs/core-skills/src/injection.rs:58]
...
Plugin roots 会带 `plugin_id`、`plugin_namespace` 和 `plugin_root`，进入 loader 后以 User scope 参与发现；skill name 优先使用传入的 plugin namespace，否则从 ancestor plugin manifest 推导 namespace。[E: codex-rs/core-skills/src/loader.rs:266][E: codex-rs/core-skills/src/loader.rs:270][E: codex-rs/core-skills/src/loader.rs:271][E: codex-rs/core-skills/src/loader.rs:272][E: codex-rs/core-skills/src/loader.rs:751][E: codex-rs/core-skills/src/loader.rs:757][E: codex-rs/core-skills/src/loader.rs:760]

## File discovery 与 parsing

`discover_skills_under_root` 只扫描目录 roots；user/admin/repo skills 会跟随 symlinked directories，system skills 不跟随；扫描会跳过 dotfiles，发现 `SKILL.md` 时调用 `parse_skill_file`。[E: codex-rs/core-skills/src/loader.rs:498][E: codex-rs/core-skills/src/loader.rs:513][E: codex-rs/core-skills/src/loader.rs:543][E: codex-rs/core-skills/src/loader.rs:545][E: codex-rs/core-skills/src/loader.rs:567][E: codex-rs/core-skills/src/loader.rs:581][E: codex-rs/core-skills/src/loader.rs:623]

`parse_skill_file` 读取 `SKILL.md`、要求 frontmatter、解析 YAML，某些第三方 scalar field YAML error 会尝试 line-oriented repair；缺少 name 时用父目录名作为 default name。[E: codex-rs/core-skills/src/loader.rs:659][E: codex-rs/core-skills/src/loader.rs:667][E: codex-rs/core-skills/src/loader.rs:673][E: codex-rs/core-skills/src/loader.rs:675][E: codex-rs/core-skills/src/loader.rs:677][E: codex-rs/core-skills/src/loader.rs:689][E: codex-rs/core-skills/src/loader.rs:694]

Loaded metadata 会经过 length validation，最终 `SkillMetadata` 保存 resolved canonical skill path、scope 和 plugin_id。[E: codex-rs/core-skills/src/loader.rs:710][E: codex-rs/core-skills/src/loader.rs:713][E: codex-rs/core-skills/src/loader.rs:724][E: codex-rs/core-skills/src/loader.rs:726][E: codex-rs/core-skills/src/loader.rs:733][E: codex-rs/core-skills/src/loader.rs:734][E: codex-rs/core-skills/src/loader.rs:735]

## Prompt rendering 与 injection

`default_skill_metadata_budget` 从 context window 计算 token budget，否则回退到 character budget；`build_available_skills` 只渲染 allowed-for-implicit skills，为 prompt 构造 skill root aliases、skill lines、render report 和 warning。[E: codex-rs/core-skills/src/render.rs:143][E: codex-rs/core-skills/src/render.rs:147][E: codex-rs/core-skills/src/render.rs:155][E: codex-rs/core-skills/src/render.rs:160][E: codex-rs/core-skills/src/render.rs:165][E: codex-rs/core-skills/src/render.rs:177]

`build_skill_injections` 只处理显式提到的 skills，读取对应 `SKILL.md` 全文并输出 `SkillInjection { name, path, contents }`；读取失败只产生 warning，不阻断整个 turn。[E: codex-rs/core-skills/src/injection.rs:58][E: codex-rs/core-skills/src/injection.rs:65][E: codex-rs/core-skills/src/injection.rs:75][E: codex-rs/core-skills/src/injection.rs:80][E: codex-rs/core-skills/src/injection.rs:90][E: codex-rs/core-skills/src/injection.rs:96]

显式提及收集先处理 structured `UserInput::Skill`，再扫描文本里的 `$skill-name`，显式 links 按 path 解析，plain names 只有不歧义时才采用。[E: codex-rs/core-skills/src/injection.rs:133][E: codex-rs/core-skills/src/injection.rs:135][E: codex-rs/core-skills/src/injection.rs:138][E: codex-rs/core-skills/src/injection.rs:144][E: codex-rs/core-skills/src/injection.rs:163]
...
- 可发现 metadata 与显式正文注入是两条路径：available skills prompt 不读取每个 `SKILL.md` 全文，explicit injection 才读取全文。[E: codex-rs/core-skills/src/render.rs:160][E: codex-rs/core-skills/src/injection.rs:58]
