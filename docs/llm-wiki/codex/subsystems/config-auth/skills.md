...
kind: subsystem
tier: T2
source: [codex-rs/core-skills/src/loader.rs, codex-rs/core-skills/src/loader/discovery.rs, codex-rs/core-skills/src/loader/namespace.rs, codex-rs/core-skills/src/root_loader.rs, codex-rs/core-skills/src/model.rs, codex-rs/core-skills/src/injection.rs, codex-rs/core-skills/src/render.rs, codex-rs/ext/skills/src/render.rs, codex-rs/ext/skills/src/tools/list.rs, codex-rs/ext/skills/src/tools/read.rs, codex-rs/ext/skills/src/provider/executor.rs, codex-rs/core-plugins/src/manifest.rs, codex-rs/core-plugins/src/agent_plugin_manifest.rs, codex-rs/skills/src/lib.rs, docs/skills.md]
symbols: [SkillMetadata, SkillRoot, SkillLoadOutcome, SkillDiscovery, SkillNamespaceResolver, discover_skills, build_skill_injections, HostSkillsCatalogInWorldState, build_available_skills, capped_skill_metadata_budget, ListTool, ReadTool, ExecutorSkillProvider, install_system_skills]
...
> Codex skills 系统从 config layer、plugin roots、extra roots 和 repo `.agents/skills` roots 组成 `SkillRoot` 列表，递归发现 `SKILL.md`，解析 frontmatter/metadata/dependencies/policy，把可隐式调用的 skills 渲染进提示词，并在显式提及时读取完整 skill body 注入 turn。[E: codex-rs/core-skills/src/loader.rs:240][E: codex-rs/core-skills/src/loader.rs:268][E: codex-rs/core-skills/src/loader.rs:287][E: codex-rs/core-skills/src/loader.rs:493][E: codex-rs/core-skills/src/model.rs:15][E: codex-rs/core-skills/src/render.rs:155][E: codex-rs/core-skills/src/injection.rs:72]
...
`SkillPolicy` 支持 `allow_implicit_invocation` 和 product restrictions；product filtering 会保留匹配当前 product 的 skills，并同步裁剪 file-system map。[E: codex-rs/core-skills/src/model.rs:53][E: codex-rs/core-skills/src/model.rs:54][E: codex-rs/core-skills/src/model.rs:56][E: codex-rs/core-skills/src/model.rs:36][E: codex-rs/core-skills/src/model.rs:134][E: codex-rs/core-skills/src/model.rs:138][E: codex-rs/core-skills/src/model.rs:147]
...
显式交给 URI parser 的 plugin root `plugin.json` 会走 Agent Plugins parser，其 compatibility projection 默认把 skills root 设为 `./skills`；其它 manifest location 仍走 legacy parser。注意默认 discovery allow-list 尚不含 root `plugin.json`，所以 parser support 不等于默认 discovery 已接线。[E: codex-rs/core-plugins/src/manifest.rs:242][E: codex-rs/core-plugins/src/manifest.rs:245][E: codex-rs/core-plugins/src/manifest.rs:248][E: codex-rs/core-plugins/src/agent_plugin_manifest.rs:158][E: codex-rs/core-plugins/src/agent_plugin_manifest.rs:166][E: codex-rs/exec-server-protocol/src/protocol.rs:46][E: codex-rs/exec-server-protocol/src/protocol.rs:49][U]
...
显式提及收集先处理 structured `UserInput::Skill`，再扫描文本里的 `$skill-name`，显式 links 按 path 解析，plain names 只有不歧义时才采用。[E: codex-rs/core-skills/src/injection.rs:160][E: codex-rs/core-skills/src/injection.rs:179]

## Ext skills catalog、resource tools 与预算

新的 `ext/skills` catalog renderer 将 skill metadata 预算设为 context window 的 2%，并封顶 4,000 tokens；未知 context window 时回退到 8,000 characters。超预算时先 round-robin 缩短 descriptions；若连无 description 的最小行也放不下，则保留能容纳的 name/locator 行并省略其余 skills，同时生成 truncation/omission warning。[E: codex-rs/ext/skills/src/render.rs:18][E: codex-rs/ext/skills/src/render.rs:20][E: codex-rs/ext/skills/src/render.rs:26][E: codex-rs/ext/skills/src/render.rs:100][E: codex-rs/ext/skills/src/render.rs:135][E: codex-rs/ext/skills/src/render.rs:147][E: codex-rs/ext/skills/src/render.rs:307][E: codex-rs/ext/skills/src/render.rs:329][E: codex-rs/ext/skills/src/render.rs:348]
...
- 可发现 metadata 与显式正文注入是两条路径：available skills prompt 不读取每个 `SKILL.md` 全文，explicit injection 才读取全文。[E: codex-rs/core-skills/src/render.rs:155][E: codex-rs/core-skills/src/injection.rs:72]
- Product restriction 过滤不是安装失败；它会从当前 product 的 outcome 中删除不匹配 skills，并裁剪关联 file-system map。[E: codex-rs/core-skills/src/model.rs:134][E: codex-rs/core-skills/src/model.rs:138][E: codex-rs/core-skills/src/model.rs:147]
