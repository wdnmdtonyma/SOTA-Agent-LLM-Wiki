...
`Stage` 有 `UnderDevelopment`、`Experimental`、`Stable`、`Deprecated` 和 `Removed`；helper 只对 experimental stage 暴露 menu name、description 和 announcement。[E: codex-rs/features/src/lib.rs:41][E: codex-rs/features/src/lib.rs:41][E: codex-rs/features/src/lib.rs:44][E: codex-rs/features/src/lib.rs:45][E: codex-rs/features/src/lib.rs:51][E: codex-rs/features/src/lib.rs:52][E: codex-rs/features/src/lib.rs:55][E: codex-rs/features/src/lib.rs:59][E: codex-rs/features/src/lib.rs:66][E: codex-rs/features/src/lib.rs:75]
