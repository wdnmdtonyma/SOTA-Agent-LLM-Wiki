...
`AuthKeyringBackendKind` 有 `Direct` 和 `Secrets` 两种；默认值在 Windows 上是 `Secrets`，其他平台是 `Direct`。[E: codex-rs/config/src/types.rs:120][E: codex-rs/config/src/types.rs:120][E: codex-rs/config/src/types.rs:122][E: codex-rs/config/src/types.rs:124][E: codex-rs/config/src/types.rs:127][E: codex-rs/config/src/types.rs:129][E: codex-rs/config/src/types.rs:132] runtime config 的 `auth_keyring_backend_kind()` 不直接用这个 default，而是由 `SecretAuthStorage` feature 决定：开启时返回 `Secrets`，关闭时返回 `Direct`。[E: codex-rs/core/src/config/auth_keyring.rs:10][E: codex-rs/core/src/config/auth_keyring.rs:11][E: codex-rs/core/src/config/auth_keyring.rs:13][E: codex-rs/core/src/config/auth_keyring.rs:47][E: codex-rs/core/src/config/auth_keyring.rs:50][E: codex-rs/core/src/config/auth_keyring.rs:53]
...
- local dev build 会把 configured `Keyring`/`Auto` CLI auth storage 解析成 `File`，这会绕过 keyring 与 secrets backend。[E: codex-rs/core/src/config/mod.rs:286][E: codex-rs/core/src/config/mod.rs:290][E: codex-rs/core/src/config/mod.rs:293][E: codex-rs/core/src/config/mod.rs:294][E: codex-rs/core/src/config/mod.rs:3799][E: codex-rs/core/src/config/mod.rs:3800]
- `ChatgptAuthTokens` 形态会强制使用 `Ephemeral` storage，不跟随配置的 auth credentials store mode。[E: codex-rs/login/src/auth/manager.rs:1521][E: codex-rs/login/src/auth/manager.rs:1525][E: codex-rs/login/src/auth/manager.rs:1526]
