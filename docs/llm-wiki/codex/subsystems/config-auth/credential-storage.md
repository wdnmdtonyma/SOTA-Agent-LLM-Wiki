...
- local dev build 会把 configured `Keyring`/`Auto` CLI auth storage 解析成 `File`，这会绕过 keyring 与 secrets backend。[E: codex-rs/core/src/config/mod.rs:267][E: codex-rs/core/src/config/mod.rs:274][E: codex-rs/core/src/config/mod.rs:275]
