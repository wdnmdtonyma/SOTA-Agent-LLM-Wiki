...
你是执行者。把本 wiki(`Best/docs/llm-wiki/codex/`)从"只有骨架"填成完整的、给 agent 检索的 LLM wiki。文档对象是 OpenAI **Codex** 真实源码(`Best/codex/`,相对本目录 `../../../codex/`,147-crate Rust workspace + TS/Py SDK)。要细到每个工具的字段与设计动机。
