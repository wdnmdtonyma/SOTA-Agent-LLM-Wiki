...
`pyproject.toml` 声明 package name 是 `openai-codex`，版本是 `0.0.0-dev`，classifier 已标记 Production/Stable，runtime dependency 包含 `pydantic>=2.12` 和 pinned `openai-codex-cli-bin==0.147.0`。[E: sdk/python/pyproject.toml:5][E: sdk/python/pyproject.toml:6][E: sdk/python/pyproject.toml:15][E: sdk/python/pyproject.toml:19]
...
`CodexConfig` fields are `codex_bin`, `launch_args_override`, `config_overrides`, `cwd`, `env`, `client_name`, `client_title`, `client_version`, and `experimental_api`; default binary resolution uses the pinned `openai-codex-cli-bin` package unless `codex_bin` or `launch_args_override` overrides it.[E: sdk/python/src/openai_codex/client.py:194][E: sdk/python/src/openai_codex/client.py:201][E: sdk/python/src/openai_codex/client.py:202][E: sdk/python/src/openai_codex/client.py:209][E: sdk/python/src/openai_codex/client.py:111][E: sdk/python/src/openai_codex/client.py:176][E: sdk/python/src/openai_codex/client.py:243]
...
Generated flat methods on `Codex` wrap thread lifecycle: `thread_start`, `thread_list`, `thread_resume`, `thread_fork`, `thread_archive`, and `thread_unarchive`; `models()` is an adjacent public helper. start/resume/fork map public `ApprovalMode` and `Sandbox` to generated app-server params.[E: sdk/python/src/openai_codex/api.py:132][E: sdk/python/src/openai_codex/api.py:151][E: sdk/python/src/openai_codex/api.py:163][E: sdk/python/src/openai_codex/api.py:169][E: sdk/python/src/openai_codex/api.py:172][E: sdk/python/src/openai_codex/api.py:203][E: sdk/python/src/openai_codex/api.py:219][E: sdk/python/src/openai_codex/api.py:231][E: sdk/python/src/openai_codex/api.py:237][E: sdk/python/src/openai_codex/api.py:254][E: sdk/python/src/openai_codex/api.py:266][E: sdk/python/src/openai_codex/api.py:273][E: sdk/python/src/openai_codex/api.py:277][E: sdk/python/src/openai_codex/api.py:284]

`Thread.run()` starts a turn via `Thread.turn()`, consumes the returned `TurnHandle.stream()`, and closes the generator; `Thread.turn()` normalizes public input to wire input, constructs `TurnStartParams`, calls `CodexClient.turn_start`, and returns `TurnHandle`.[E: sdk/python/src/openai_codex/api.py:537][E: sdk/python/src/openai_codex/api.py:544][E: sdk/python/src/openai_codex/api.py:571][E: sdk/python/src/openai_codex/api.py:573][E: sdk/python/src/openai_codex/api.py:578][E: sdk/python/src/openai_codex/api.py:593][E: sdk/python/src/openai_codex/api.py:595][E: sdk/python/src/openai_codex/api.py:603][E: sdk/python/src/openai_codex/api.py:605][E: sdk/python/src/openai_codex/api.py:609][E: sdk/python/src/openai_codex/api.py:610]

`TurnHandle` exposes `steer()`, `interrupt()`, `stream()`, and `run()`; `stream()` registers turn notification routing, yields notifications until the matching `turn/completed`, and unregisters routing in finally.[E: sdk/python/src/openai_codex/api.py:721][E: sdk/python/src/openai_codex/api.py:729][E: sdk/python/src/openai_codex/api.py:737][E: sdk/python/src/openai_codex/api.py:741][E: sdk/python/src/openai_codex/api.py:743][E: sdk/python/src/openai_codex/api.py:746][E: sdk/python/src/openai_codex/api.py:749][E: sdk/python/src/openai_codex/api.py:751][E: sdk/python/src/openai_codex/api.py:755][E: sdk/python/src/openai_codex/api.py:757]

## Async surface

`AsyncCodex` wraps `AsyncCodexClient`, initializes lazily on context entry or first awaited API use, protects initialization with `asyncio.Lock`, and mirrors login/account/thread/model helpers after `_ensure_initialized()`.[E: sdk/python/src/openai_codex/api.py:289][E: sdk/python/src/openai_codex/api.py:297][E: sdk/python/src/openai_codex/api.py:298][E: sdk/python/src/openai_codex/api.py:301][E: sdk/python/src/openai_codex/api.py:303][E: sdk/python/src/openai_codex/api.py:310][E: sdk/python/src/openai_codex/api.py:313][E: sdk/python/src/openai_codex/api.py:317][E: sdk/python/src/openai_codex/api.py:319][E: sdk/python/src/openai_codex/api.py:341][E: sdk/python/src/openai_codex/api.py:393]
...
`AsyncThread` mirrors sync turn/run/read/name/compact methods and returns `AsyncTurnHandle`; async turn streaming registers the same turn route, awaits `next_turn_notification`, and stops on matching `turn/completed`.[E: sdk/python/src/openai_codex/api.py:625][E: sdk/python/src/openai_codex/api.py:632][E: sdk/python/src/openai_codex/api.py:661][E: sdk/python/src/openai_codex/api.py:666][E: sdk/python/src/openai_codex/api.py:679][E: sdk/python/src/openai_codex/api.py:698][E: sdk/python/src/openai_codex/api.py:707][E: sdk/python/src/openai_codex/api.py:766][E: sdk/python/src/openai_codex/api.py:788][E: sdk/python/src/openai_codex/api.py:791][E: sdk/python/src/openai_codex/api.py:794][E: sdk/python/src/openai_codex/api.py:797][E: sdk/python/src/openai_codex/api.py:803]
...
Python generator 会把 generated `PlanType` 固定改写为 `str, Enum`，并通过 `_missing_` 为任意非空、尚未知的 runtime plan string 创建动态 enum member。这样使用较新 `codex_bin` 时，account payload 的新 plan value 仍保持 typed，而不是因 SDK catalog 滞后而 validation 失败。[E: sdk/python/scripts/update_sdk_artifacts.py:701][E: sdk/python/scripts/update_sdk_artifacts.py:712][E: sdk/python/scripts/update_sdk_artifacts.py:719][E: sdk/python/scripts/update_sdk_artifacts.py:726][E: sdk/python/src/openai_codex/generated/v2_all.py:2698][E: sdk/python/src/openai_codex/generated/v2_all.py:2715][E: sdk/python/src/openai_codex/generated/v2_all.py:2722]

这是 generated protocol 的前向兼容修复，不是高层 `Codex`/`Thread` API 新增。`self_serve_business_prolite` 现已是静态 enum member；回归仍用该值做 account payload round-trip，未知非空 string 继续走 `_missing_`。[E: sdk/python/src/openai_codex/generated/v2_all.py:2705][E: sdk/python/src/openai_codex/generated/v2_all.py:2716][E: sdk/python/tests/test_client_rpc_methods.py:46][E: sdk/python/tests/test_client_rpc_methods.py:48][E: sdk/python/tests/test_client_rpc_methods.py:60]
