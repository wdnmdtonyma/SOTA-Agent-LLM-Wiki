...
`Codex` constructor 接收 `CodexOptions`，从中取 `codexPathOverride`、`env`、`config`、`configOverrides` 创建 `CodexExec`；`startThread()` 返回没有 id 的新 `Thread`，`resumeThread(id)` 返回带已有 id 的 `Thread`。[E: sdk/typescript/src/codex.ts:15][E: sdk/typescript/src/codex.ts:16][E: sdk/typescript/src/codex.ts:17][E: sdk/typescript/src/codex.ts:25][E: sdk/typescript/src/codex.ts:26][E: sdk/typescript/src/codex.ts:36][E: sdk/typescript/src/codex.ts:37]
...
`CodexOptions` 包含 `codexPathOverride`、`baseUrl`、`apiKey`、`config`、`configOverrides` 和 `env`。`config` 是 structured JSON object，SDK flatten 成 dotted `--config key=value`；`configOverrides` 是 raw `string[]`，按原样追加 `--config`，插在 structured flatten 之后、SDK-managed/thread-specific overrides 之前。[E: sdk/typescript/src/codexOptions.ts:5][E: sdk/typescript/src/codexOptions.ts:16][E: sdk/typescript/src/codexOptions.ts:21][E: sdk/typescript/src/codex.ts:16][E: sdk/typescript/src/exec.ts:94][E: sdk/typescript/src/exec.ts:100][E: sdk/typescript/src/exec.ts:261][E: sdk/typescript/src/exec.ts:267]

`ThreadOptions` 暴露 model、sandbox mode、working directory、skip git repo check、reasoning effort、network access、web search mode/legacy flag、approval policy 和 additional directories；`TurnOptions` 只有 per-turn `outputSchema` 和 `AbortSignal`。[E: sdk/typescript/src/threadOptions.ts:20][E: sdk/typescript/src/threadOptions.ts:21][E: sdk/typescript/src/threadOptions.ts:22][E: sdk/typescript/src/threadOptions.ts:23][E: sdk/typescript/src/threadOptions.ts:24][E: sdk/typescript/src/threadOptions.ts:25][E: sdk/typescript/src/threadOptions.ts:26][E: sdk/typescript/src/threadOptions.ts:27][E: sdk/typescript/src/threadOptions.ts:28][E: sdk/typescript/src/threadOptions.ts:29][E: sdk/typescript/src/turnOptions.ts:3][E: sdk/typescript/src/turnOptions.ts:5]
...
`CodexExec.run()` command args 从 `["exec", "--experimental-json"]` 开始；SDK 先 append structured `config` flatten，再 append raw `configOverrides`，随后才是 `openai_base_url`、`--model`、`--sandbox`、`--cd`、`--add-dir`、`--skip-git-repo-check`、`--output-schema`、`resume <threadId>` 和 `--image`。[E: sdk/typescript/src/exec.ts:92][E: sdk/typescript/src/exec.ts:94][E: sdk/typescript/src/exec.ts:100][E: sdk/typescript/src/exec.ts:106][E: sdk/typescript/src/exec.ts:113][E: sdk/typescript/src/exec.ts:121][E: sdk/typescript/src/exec.ts:125][E: sdk/typescript/src/exec.ts:135][E: sdk/typescript/src/exec.ts:139][E: sdk/typescript/src/exec.ts:166][E: sdk/typescript/src/exec.ts:170]

`CodexExec.run()` spawn CLI process 后把 prompt 写入 stdin，按 stdout line 逐行 yield JSONL string；如果进程 exit code 非 0 或被 signal 终止，SDK 把 stderr 拼进 thrown `Error`。[E: sdk/typescript/src/exec.ts:196][E: sdk/typescript/src/exec.ts:208][E: sdk/typescript/src/exec.ts:237][E: sdk/typescript/src/exec.ts:244][E: sdk/typescript/src/exec.ts:247]
