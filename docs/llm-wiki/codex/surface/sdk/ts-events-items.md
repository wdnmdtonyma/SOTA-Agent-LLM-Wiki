...
symbols: [ThreadEvent, ThreadStartedEvent, TurnCompletedEvent, typescript::ItemCompletedEvent, ThreadItem, typescript::AgentMessageItem, CommandExecutionItem, typescript::FileChangeItem, typescript::McpToolCallItem, TodoListItem]
...
| `item.updated` | `item` | item update。 | [E: sdk/typescript/src/events.ts:53] |
...
| `reasoning` | `ReasoningItem` | `id`、`text`。 | [E: sdk/typescript/src/items.ts:83][E: sdk/typescript/src/items.ts:84][E: sdk/typescript/src/items.ts:85] |
...
| `todo_list` | `TodoListItem` | items，每个 item 有 text/completed。 | [E: sdk/typescript/src/items.ts:104][E: sdk/typescript/src/items.ts:105][E: sdk/typescript/src/items.ts:113][E: sdk/typescript/src/items.ts:114][E: sdk/typescript/src/items.ts:115] |
