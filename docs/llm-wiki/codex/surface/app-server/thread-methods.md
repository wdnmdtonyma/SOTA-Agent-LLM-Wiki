...
- `thread/queue/*`、`thread/revert`、`thread/rollback`、`thread/settings/update`、`thread/attachment/*` 分别做什么？
...
`thread/increment_elicitation`、`thread/decrement_elicitation`、六个 `thread/queue/*`、`thread/settings/update`、`thread/memoryMode/set`、`memory/status`、`memory/reset`、background terminals、`thread/search`、`thread/searchOccurrences`、七个 `project/*` 与 `thread/timeline/list` 带 experimental 标记。`thread/revert`、`thread/turns/list`、`thread/items/list` 与三个 `thread/attachment/*` 在 target 上是稳定 wire。[E: codex-rs/app-server-protocol/src/protocol/common.rs:592][E: codex-rs/app-server-protocol/src/protocol/common.rs:638][E: codex-rs/app-server-protocol/src/protocol/common.rs:673][E: codex-rs/app-server-protocol/src/protocol/common.rs:693][E: codex-rs/app-server-protocol/src/protocol/common.rs:706][E: codex-rs/app-server-protocol/src/protocol/common.rs:761][E: codex-rs/app-server-protocol/src/protocol/common.rs:772][E: codex-rs/app-server-protocol/src/protocol/common.rs:857][E: codex-rs/app-server-protocol/src/protocol/common.rs:863][E: codex-rs/app-server-protocol/src/protocol/common.rs:1091]

`thread/searchOccurrences` 在单个 thread 的可见 user message 与 final assistant message 中做 case-insensitive literal substring 搜索；该 request 明确 `serialization: None`，可并发读 persisted paginated history。[E: codex-rs/app-server-protocol/src/protocol/v2/thread.rs:1570][E: codex-rs/app-server-protocol/src/protocol/v2/thread.rs:1574][E: codex-rs/thread-store/src/local/thread_history/search.rs:126][E: codex-rs/thread-store/src/local/thread_history/search.rs:144][E: codex-rs/thread-store/src/local/thread_history/search.rs:400][E: codex-rs/thread-store/src/local/thread_history/search.rs:405][E: codex-rs/app-server-protocol/src/protocol/common.rs:840][E: codex-rs/app-server-protocol/src/protocol/common.rs:844]
...
六个 `thread/queue/{add,list,update,delete,reorder,start}` 是 durable per-thread user submission queue 的 experimental RPC。语义与门控见 `subsys.core.thread-queue`。[E: codex-rs/app-server-protocol/src/protocol/common.rs:631]

`thread/rollback` 仍是稳定 wire，但对非 `codex-tui` 客户端发送 deprecation notice：`thread/rollback is deprecated and will be removed soon`。它只服务 Legacy history：`num_turns >= 1`，提交 `Op::ThreadRollback`，Paginated thread 直接拒绝。[E: codex-rs/app-server/src/request_processors/thread_processor.rs:33][E: codex-rs/app-server/src/request_processors/thread_processor.rs:34][E: codex-rs/app-server/src/request_processors/thread_processor.rs:820][E: codex-rs/app-server/src/request_processors/thread_processor.rs:2362][E: codex-rs/app-server/src/request_processors/thread_processor.rs:2373][E: codex-rs/app-server/src/request_processors/thread_processor.rs:2403][E: codex-rs/app-server-protocol/src/protocol/v2/thread.rs:1232]

`thread/revert` 是 Paginated 替代：processor 先关停并卸下 live thread，store 锁 live writer 后按 `before_turn_id` 写新 immutable rollout，CAS 替换 SQLite path，再内部 reload 同一 thread id。`ThreadRevertResponse.thread.turns` 按 `Thread` 约定为空，用 `turns_backwards_cursor` / `items_backwards_cursor` 再拉 history。它不回滚磁盘文件改动。target 上该方法不再带 `#[experimental]`。[E: codex-rs/app-server-protocol/src/protocol/common.rs:761][E: codex-rs/app-server/src/request_processors/thread_processor.rs:2173][E: codex-rs/thread-store/src/local/revert_thread.rs:19][E: codex-rs/thread-store/src/local/revert_thread.rs:35][E: codex-rs/thread-store/src/local/revert_thread.rs:40][E: codex-rs/app-server/src/request_processors/thread_processor.rs:2232][E: codex-rs/app-server-protocol/src/protocol/v2/thread.rs:1259][E: codex-rs/app-server-protocol/src/protocol/v2/thread.rs:1268][E: codex-rs/app-server-protocol/src/protocol/v2/thread.rs:1276][E: codex-rs/app-server-protocol/src/protocol/v2/thread_data.rs:293]
...
`account/usage/read` 不是 thread method，但 `GetAccountTokenUsageParams.thread_id` 存在时改读 backend thread usage，返回 `GetAccountTokenUsageResponse.thread_usage`。字段模型见 `subsys.core.token-budget`。[E: codex-rs/app-server-protocol/src/protocol/common.rs:1312]

## 方法 catalog

本轮新增 3 个稳定 `thread/attachment/{add,list,remove}`，以及 experimental `memory/status`。`turn/settings/update` 不在本表，收在 turn catalog。
...
| `ThreadRollback` | `thread/rollback` | `v2::ThreadRollbackParams` | `v2::ThreadRollbackResponse` | stable | [E: codex-rs/app-server-protocol/src/protocol/common.rs:756] |
| `ThreadRevert` | `thread/revert` | `v2::ThreadRevertParams` | `v2::ThreadRevertResponse` | stable | [E: codex-rs/app-server-protocol/src/protocol/common.rs:761] |
| `ThreadList` | `thread/list` | `v2::ThreadListParams` | `v2::ThreadListResponse` | params-inspected | [E: codex-rs/app-server-protocol/src/protocol/common.rs:766] |
| `ProjectList` | `project/list` | `v2::ProjectListParams` | `v2::ProjectListResponse` | experimental: project/list | [E: codex-rs/app-server-protocol/src/protocol/common.rs:773] |
| `ProjectRead` | `project/read` | `v2::ProjectReadParams` | `v2::ProjectReadResponse` | experimental: project/read | [E: codex-rs/app-server-protocol/src/protocol/common.rs:779] |
| `ProjectCreate` | `project/create` | `v2::ProjectCreateParams` | `v2::ProjectCreateResponse` | experimental: project/create | [E: codex-rs/app-server-protocol/src/protocol/common.rs:785] |
| `ProjectImport` | `project/import` | `v2::ProjectImportParams` | `v2::ProjectImportResponse` | experimental: project/import | [E: codex-rs/app-server-protocol/src/protocol/common.rs:791] |
| `ProjectUpdate` | `project/update` | `v2::ProjectUpdateParams` | `v2::ProjectUpdateResponse` | experimental: project/update | [E: codex-rs/app-server-protocol/src/protocol/common.rs:797] |
| `ProjectMove` | `project/move` | `v2::ProjectMoveParams` | `v2::ProjectMoveResponse` | experimental: project/move | [E: codex-rs/app-server-protocol/src/protocol/common.rs:803] |
| `ProjectDelete` | `project/delete` | `v2::ProjectDeleteParams` | `v2::ProjectDeleteResponse` | experimental: project/delete | [E: codex-rs/app-server-protocol/src/protocol/common.rs:809] |
| `ThreadSectionList` | `threadSection/list` | `v2::ThreadSectionListParams` | `v2::ThreadSectionListResponse` | stable | [E: codex-rs/app-server-protocol/src/protocol/common.rs:814] |
| `ThreadSectionCreate` | `threadSection/create` | `v2::ThreadSectionCreateParams` | `v2::ThreadSectionCreateResponse` | stable | [E: codex-rs/app-server-protocol/src/protocol/common.rs:819] |
| `ThreadSectionUpdate` | `threadSection/update` | `v2::ThreadSectionUpdateParams` | `v2::ThreadSectionUpdateResponse` | stable | [E: codex-rs/app-server-protocol/src/protocol/common.rs:824] |
| `ThreadSectionDelete` | `threadSection/delete` | `v2::ThreadSectionDeleteParams` | `v2::ThreadSectionDeleteResponse` | stable | [E: codex-rs/app-server-protocol/src/protocol/common.rs:829] |
| `ThreadSearch` | `thread/search` | `v2::ThreadSearchParams` | `v2::ThreadSearchResponse` | experimental: thread/search | [E: codex-rs/app-server-protocol/src/protocol/common.rs:835] |
| `ThreadSearchOccurrences` | `thread/searchOccurrences` | `v2::ThreadSearchOccurrencesParams` | `v2::ThreadSearchOccurrencesResponse` | experimental: thread/searchOccurrences | [E: codex-rs/app-server-protocol/src/protocol/common.rs:841] |
| `ThreadLoadedList` | `thread/loaded/list` | `v2::ThreadLoadedListParams` | `v2::ThreadLoadedListResponse` | stable | [E: codex-rs/app-server-protocol/src/protocol/common.rs:847] |
| `ThreadRead` | `thread/read` | `v2::ThreadReadParams` | `v2::ThreadReadResponse` | stable | [E: codex-rs/app-server-protocol/src/protocol/common.rs:852] |
| `ThreadTurnsList` | `thread/turns/list` | `v2::ThreadTurnsListParams` | `v2::ThreadTurnsListResponse` | stable | [E: codex-rs/app-server-protocol/src/protocol/common.rs:857] |
| `ThreadItemsList` | `thread/items/list` | `v2::ThreadItemsListParams` | `v2::ThreadItemsListResponse` | stable | [E: codex-rs/app-server-protocol/src/protocol/common.rs:863] |
| `ThreadInjectItems` | `thread/inject_items` | `v2::ThreadInjectItemsParams` | `v2::ThreadInjectItemsResponse` | stable | [E: codex-rs/app-server-protocol/src/protocol/common.rs:870] |
| `ThreadTimelineList` | `thread/timeline/list` | `v2::ThreadTimelineListParams` | `v2::ThreadTimelineListResponse` | experimental: thread/timeline/list | [E: codex-rs/app-server-protocol/src/protocol/common.rs:1092] |

目标 `client_request_definitions` 里 thread/memory/section/project/timeline/attachment 方法共 56 个（含 `memory/status`、`memory/reset`、3 个 `thread/attachment/*` 与 7 个 `project/*`）。`account/usage/read` 不在本表，但是 thread usage 的读取入口。[E: codex-rs/app-server-protocol/src/protocol/common.rs:559][E: codex-rs/app-server-protocol/src/protocol/common.rs:673][E: codex-rs/app-server-protocol/src/protocol/common.rs:707][E: codex-rs/app-server-protocol/src/protocol/common.rs:773][E: codex-rs/app-server-protocol/src/protocol/common.rs:870][E: codex-rs/app-server-protocol/src/protocol/common.rs:1092][E: codex-rs/app-server-protocol/src/protocol/common.rs:1312]
