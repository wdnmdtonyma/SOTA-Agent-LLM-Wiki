...
目标 HEAD 没有新增 turn/review/realtime wire method，但 `ThreadRealtimeStartParams` 扩为 V3-aware shape：新增 transcript-tail flush、`CodexResponseHandoffMode` 与 role-bearing `initialItems`；`initialItems` 只支持 realtime V3，最多 128 items 与 8,192 estimated text tokens。[E: codex-rs/app-server-protocol/src/protocol/v2/realtime.rs:68][E: codex-rs/app-server-protocol/src/protocol/v2/realtime.rs:74][E: codex-rs/app-server-protocol/src/protocol/v2/realtime.rs:77][E: codex-rs/app-server-protocol/src/protocol/v2/realtime.rs:86][E: codex-rs/app-server-protocol/src/protocol/v2/realtime.rs:89][E: codex-rs/app-server-protocol/src/protocol/v2/realtime.rs:99][E: codex-rs/app-server-protocol/src/protocol/v2/realtime.rs:101][E: codex-rs/app-server-protocol/src/protocol/v2/realtime.rs:103][E: codex-rs/app-server-protocol/src/protocol/v2/realtime.rs:123][E: codex-rs/app-server-protocol/src/protocol/v2/realtime.rs:127]
