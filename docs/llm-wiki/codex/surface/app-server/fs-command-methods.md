...
`ClientRequestSerializationScope` 明确有 command process、process handle、fuzzy file search session 和 fs watch scope，宏调用里相应方法使用这些 serialization 函数。[E: codex-rs/app-server-protocol/src/protocol/common.rs:129][E: codex-rs/app-server-protocol/src/protocol/common.rs:134][E: codex-rs/app-server-protocol/src/protocol/common.rs:135][E: codex-rs/app-server-protocol/src/protocol/common.rs:136][E: codex-rs/app-server-protocol/src/protocol/common.rs:137][E: codex-rs/app-server-protocol/src/protocol/common.rs:944][E: codex-rs/app-server-protocol/src/protocol/common.rs:1269][E: codex-rs/app-server-protocol/src/protocol/common.rs:1294][E: codex-rs/app-server-protocol/src/protocol/common.rs:1396]
