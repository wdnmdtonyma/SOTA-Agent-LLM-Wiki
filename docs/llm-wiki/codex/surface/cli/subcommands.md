...
| `exec` | `Exec(ExecCli)` | alias `e`;拒绝 root remote | 非交互执行；继承 interactive shared options、合并 root config overrides，然后调用 `codex_exec::run_main()`。[E: codex-rs/cli/src/main.rs:126][E: codex-rs/cli/src/main.rs:127][E: codex-rs/cli/src/main.rs:1002][E: codex-rs/cli/src/main.rs:1003][E: codex-rs/cli/src/main.rs:1010][E: codex-rs/cli/src/main.rs:1016] | `codex-rs/cli/src/main.rs:127` |
