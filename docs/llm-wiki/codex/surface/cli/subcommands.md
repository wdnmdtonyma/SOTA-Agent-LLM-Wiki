...
| `doctor` | `Doctor(DoctorCommand)` | 拒绝 root remote | 诊断本地安装、配置、认证和 runtime health。报告按 Environment/Configuration/Desktop App/Updates/Connectivity/Background Server 分组。[E: codex-rs/cli/src/main.rs:175][E: codex-rs/cli/src/doctor.rs:168][E: codex-rs/cli/src/doctor/output.rs:26][E: codex-rs/cli/src/main.rs:1587][E: codex-rs/cli/src/main.rs:1593] | `codex-rs/cli/src/main.rs:175` |
