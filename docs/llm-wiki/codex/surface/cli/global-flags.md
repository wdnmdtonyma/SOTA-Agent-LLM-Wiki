...
| `--strict-config` | `codex_tui::Cli::strict_config` | bool false | interactive root 可用；有 subcommand 时会先走 `reject_root_strict_config_for_subcommand()`，只让 allow-list 继承 root strict config。[E: codex-rs/tui/src/cli.rs:17][E: codex-rs/tui/src/cli.rs:17][E: codex-rs/cli/src/main.rs:989][E: codex-rs/cli/src/main.rs:996][E: codex-rs/cli/src/main.rs:2203][E: codex-rs/cli/src/main.rs:2218] | `codex-rs/tui/src/cli.rs:17` |
...
| `--enable FEATURE` | `FeatureToggles::enable` | repeatable string | 转为 `features.<feature>=true` root config override；unknown feature 通过 `is_known_feature_key()` 报错。[E: codex-rs/cli/src/main.rs:888][E: codex-rs/cli/src/main.rs:890][E: codex-rs/cli/src/main.rs:890][E: codex-rs/cli/src/main.rs:913][E: codex-rs/cli/src/main.rs:917][E: codex-rs/cli/src/main.rs:926][E: codex-rs/cli/src/main.rs:930] | `codex-rs/cli/src/main.rs:879` |
| `--disable FEATURE` | `FeatureToggles::disable` | repeatable string | 转为 `features.<feature>=false` root config override，和 `--enable` 一样先校验 feature key。[E: codex-rs/cli/src/main.rs:892][E: codex-rs/cli/src/main.rs:895][E: codex-rs/cli/src/main.rs:921][E: codex-rs/cli/src/main.rs:921][E: codex-rs/cli/src/main.rs:926] | `codex-rs/cli/src/main.rs:883` |
| `--remote ADDR` | `InteractiveRemoteOptions::remote` | optional string | 连接 remote app-server endpoint；interactive root 直接传入 `run_interactive_tui()`，`resume`/`fork` 用 subcommand 值覆盖 root 值，`archive`/`delete`/`unarchive` 也通过 session archive path 合并 root/subcommand remote 值。[E: codex-rs/cli/src/main.rs:899][E: codex-rs/cli/src/main.rs:900][E: codex-rs/cli/src/main.rs:1008][E: codex-rs/cli/src/main.rs:848][E: codex-rs/cli/src/main.rs:851][E: codex-rs/cli/src/main.rs:1287][E: codex-rs/cli/src/main.rs:1297][E: codex-rs/cli/src/main.rs:1309][E: codex-rs/cli/src/main.rs:1324][E: codex-rs/cli/src/main.rs:1354] | `codex-rs/cli/src/main.rs:892` |
| `--remote-auth-token-env ENV_VAR` | `InteractiveRemoteOptions::remote_auth_token_env` | optional string | 指定 bearer token 所在环境变量；interactive/session wrappers 会合并 root/subcommand 值，非 interactive/session path 会被 `reject_remote_mode_for_subcommand()` 拒绝。[E: codex-rs/cli/src/main.rs:908][E: codex-rs/cli/src/main.rs:908][E: codex-rs/cli/src/main.rs:1009][E: codex-rs/cli/src/main.rs:848][E: codex-rs/cli/src/main.rs:851][E: codex-rs/cli/src/main.rs:1289][E: codex-rs/cli/src/main.rs:1297][E: codex-rs/cli/src/main.rs:1309][E: codex-rs/cli/src/main.rs:1324][E: codex-rs/cli/src/main.rs:2157][E: codex-rs/cli/src/main.rs:2159] | `codex-rs/cli/src/main.rs:897` |
...
| `-m, --model MODEL` | `SharedCliOptions::model` | optional string | 指定 agent model；exec path destructure 后写入 `ConfigOverrides.model`，未指定且 `--oss` 为 true 时尝试 provider 默认 model。[E: codex-rs/utils/cli/src/shared_options.rs:23][E: codex-rs/utils/cli/src/shared_options.rs:23][E: codex-rs/exec/src/lib.rs:262][E: codex-rs/exec/src/lib.rs:264][E: codex-rs/exec/src/lib.rs:403] | `codex-rs/utils/cli/src/shared_options.rs:22` |
...
`codex exec` 入口会调用 `SharedCliOptions::inherit_exec_root_options()` 继承 root interactive shared options；该函数对 unset 的 scalar 才复制 root 值，对 images/add-dir 采用合并策略，并把 sandbox、approve-for-me 与 dangerous bypass 视为互斥的一组选择，保留 subcommand 自己显式选择的那一组。[E: codex-rs/cli/src/main.rs:1021][E: codex-rs/cli/src/main.rs:1022][E: codex-rs/utils/cli/src/shared_options.rs:91][E: codex-rs/utils/cli/src/shared_options.rs:92][E: codex-rs/utils/cli/src/shared_options.rs:134][E: codex-rs/utils/cli/src/shared_options.rs:146]
