...
| `resume` | `Command::Resume(ResumeArgs)` | nested subcommand | 恢复 previous session；解析到 thread id 后发 `thread/resume`，否则 fallback 到 `thread/start`。[E: codex-rs/exec/src/cli.rs:151][E: codex-rs/exec/src/lib.rs:716][E: codex-rs/exec/src/lib.rs:819][E: codex-rs/exec/src/lib.rs:835] | `codex-rs/exec/src/cli.rs:151` |
