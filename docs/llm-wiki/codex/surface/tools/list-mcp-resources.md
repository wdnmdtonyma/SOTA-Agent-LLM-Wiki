...
单 server 输出包含 `server`、`resources` 和 camelCase `nextCursor`；all-server 输出按 server 名排序并展开为带 `server` 字段的 resources，`nextCursor` 为 none。[E: codex-rs/core/src/tools/handlers/mcp_resource.rs:135][E: codex-rs/core/src/tools/handlers/mcp_resource.rs:139][E: codex-rs/core/src/tools/handlers/mcp_resource.rs:141][E: codex-rs/core/src/tools/handlers/mcp_resource.rs:149][E: codex-rs/core/src/tools/handlers/mcp_resource.rs:157]
