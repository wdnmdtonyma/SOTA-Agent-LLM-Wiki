...
| `referenced_image_paths` | absolute path array | 否 | 最多 5 个。[E: codex-rs/ext/image-generation/src/tool.rs:91][E: codex-rs/ext/image-generation/src/tool.rs:92][E: codex-rs/ext/image-generation/src/tool.rs:415] |
...
两个 image-source 字段互斥；两者都省略时创建 generate request，有任一 image source 时创建 edit request。两类请求都固定 `gpt-image-2`、auto background/quality/size。[E: codex-rs/ext/image-generation/src/tool.rs:420][E: codex-rs/ext/image-generation/src/tool.rs:422][E: codex-rs/ext/image-generation/src/tool.rs:425]
