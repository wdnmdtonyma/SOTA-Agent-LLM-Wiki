...
| concrete handler | `ExecCommandHandler` 保存 `ExecCommandHandlerOptions`，`spec_plan.rs` 的 unified-exec 分支构造并注册它。[E: codex-rs/core/src/tools/handlers/unified_exec/exec_command.rs:50][E: codex-rs/core/src/tools/handlers/unified_exec/exec_command.rs:58][E: codex-rs/core/src/tools/spec_plan.rs:685] |
...
| `max_output_tokens` | `number` | 否 | `10000 tokens` | schema 描述输出 token 预算默认 10000 tokens。[E: codex-rs/core/src/tools/handlers/shell_spec.rs:55][E: codex-rs/core/src/tools/handlers/shell_spec.rs:57] | runtime 默认常量是 `10_000`，输出再受 truncation policy cap，并按 token policy 截断 raw bytes 的 lossy UTF-8 文本。[E: codex-rs/core/src/unified_exec/mod.rs:70][E: codex-rs/core/src/unified_exec/mod.rs:189][E: codex-rs/core/src/unified_exec/mod.rs:190][E: codex-rs/core/src/tools/context.rs:413][E: codex-rs/core/src/tools/context.rs:413][E: codex-rs/core/src/tools/context.rs:414][E: codex-rs/core/src/tools/context.rs:443] |
...
`build_tool_router` 调用 `build_tool_specs_and_registry`，后者通过 `add_tool_sources` 进入 `add_shell_tools`。[E: codex-rs/core/src/tools/spec_plan.rs:158][E: codex-rs/core/src/tools/spec_plan.rs:165][E: codex-rs/core/src/tools/spec_plan.rs:608][E: codex-rs/core/src/tools/spec_plan.rs:636] `add_shell_tools` 先取 `tool_environment_mode()`，没有 environment 时直接返回。[E: codex-rs/core/src/tools/spec_plan.rs:666][E: codex-rs/core/src/tools/spec_plan.rs:639][E: codex-rs/core/src/tools/spec_plan.rs:670][E: codex-rs/core/src/tools/spec_plan.rs:671]
...
当结果是 `ConfigShellToolType::UnifiedExec` 时，`spec_plan.rs` 通过普通 `add` 注册 `ExecCommandHandler` 与 `WriteStdinHandler`，并把 `ShellCommandHandler` 通过 `add_dispatch_only` 包成 hidden legacy tool；visible-spec 构建只收集 direct exposure 的 runtime specs。[E: codex-rs/protocol/src/openai_models.rs:278][E: codex-rs/protocol/src/openai_models.rs:281][E: codex-rs/core/src/tools/spec_plan.rs:126][E: codex-rs/core/src/tools/spec_plan.rs:130][E: codex-rs/core/src/tools/spec_plan.rs:253][E: codex-rs/core/src/tools/spec_plan.rs:258][E: codex-rs/core/src/tools/spec_plan.rs:259][E: codex-rs/core/src/tools/spec_plan.rs:261][E: codex-rs/core/src/tools/spec_plan.rs:683][E: codex-rs/core/src/tools/spec_plan.rs:684][E: codex-rs/core/src/tools/spec_plan.rs:685][E: codex-rs/core/src/tools/spec_plan.rs:694][E: codex-rs/core/src/tools/spec_plan.rs:698]

## 6 parallel support

`ExecCommandHandler::supports_parallel_tool_calls()` 返回 `true`。[E: codex-rs/core/src/tools/handlers/unified_exec/exec_command.rs:96][E: codex-rs/core/src/tools/handlers/unified_exec/exec_command.rs:97] router 查询 registry 的支持位，找不到时才回退 false。[E: codex-rs/core/src/tools/router.rs:115][E: codex-rs/core/src/tools/router.rs:117][E: codex-rs/core/src/tools/router.rs:118]
