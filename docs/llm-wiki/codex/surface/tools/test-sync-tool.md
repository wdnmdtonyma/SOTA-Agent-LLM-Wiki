...
> `test_sync_tool` 是 Codex integration tests 使用的内部 Function 工具；当前 spec 与 handler 都在 `codex-rs/core/src/tools/handlers/` 下，只有模型 metadata 的 `experimental_supported_tools` 包含 `"test_sync_tool"` 时才注册。[E: codex-rs/core/src/tools/handlers/test_sync_spec.rs:51][E: codex-rs/core/src/tools/handlers/test_sync_spec.rs:53][E: codex-rs/core/src/tools/spec_plan.rs:865][E: codex-rs/core/src/tools/spec_plan.rs:869][E: codex-rs/core/src/tools/spec_plan.rs:871]
...
`add_core_utility_tools` 只有在 `turn_context.model_info.experimental_supported_tools` 中找到 `"test_sync_tool"` 时，才把 `TestSyncHandler` 加入 registry。[E: codex-rs/core/src/tools/spec_plan.rs:865][E: codex-rs/core/src/tools/spec_plan.rs:869][E: codex-rs/core/src/tools/spec_plan.rs:871]
