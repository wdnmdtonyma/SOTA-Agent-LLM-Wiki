...
`send_input` 注册在 V1 collaboration 分支：`collab_tools_enabled` true 且 `multi_agent_v2_enabled` false。V1 exposure 在 `search_tool_enabled` true 时为 `Deferred`，否则为 `Direct`。[E: codex-rs/core/src/tools/spec_plan.rs:825][E: codex-rs/core/src/tools/spec_plan.rs:827][E: codex-rs/core/src/tools/spec_plan.rs:884][E: codex-rs/core/src/tools/spec_plan.rs:887][E: codex-rs/core/src/tools/spec_plan.rs:888][E: codex-rs/core/src/tools/spec_plan.rs:890][E: codex-rs/core/src/tools/spec_plan.rs:904]
...
| `message` / `items` | 否，但二选一 | schema 同时允许 legacy text 和 structured items；runtime `parse_collab_input` 要求二选一且拒绝空文本/空 items。[E: codex-rs/core/src/tools/handlers/multi_agents_spec.rs:155][E: codex-rs/core/src/tools/handlers/multi_agents_spec.rs:161][E: codex-rs/core/src/tools/handlers/multi_agents_common.rs:141][E: codex-rs/core/src/tools/handlers/multi_agents_common.rs:144][E: codex-rs/core/src/tools/handlers/multi_agents_common.rs:148][E: codex-rs/core/src/tools/handlers/multi_agents_common.rs:159] |
...
`AgentControl::send_input` 根据输入是否开启 turn 做 execution-capacity 检查，再把 input 转成 `Op` 送进目标 thread，并统一处理 thread request 结果。[E: codex-rs/core/src/agent/control.rs:142][E: codex-rs/core/src/agent/control.rs:146][E: codex-rs/core/src/agent/control.rs:147][E: codex-rs/core/src/agent/control.rs:151][E: codex-rs/core/src/agent/control.rs:155]
