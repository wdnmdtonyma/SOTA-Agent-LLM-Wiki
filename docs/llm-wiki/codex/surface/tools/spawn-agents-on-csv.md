...
runner 构造时会把全局 `agent_default_subagent_model` / reasoning defaults 经和普通 spawn 相同的 model-override helper 应用到 worker config。job loop 再按 concurrency 取 pending items，构造 worker prompt 并通过 `spawn_agent_with_metadata` 启动 worker；worker 的 session source label 是 `agent_job:{job_id}`，这是 `report_agent_job_result` worker-only 门控的依据。[E: codex-rs/core/src/tools/handlers/agent_jobs.rs:126][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:204][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:206][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:214][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:219][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:222][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:225][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:226]
