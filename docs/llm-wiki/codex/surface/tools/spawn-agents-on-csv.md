...
| handler | `agent_jobs.rs` re-export `spawn_agents_on_csv::SpawnAgentsOnCsvHandler`；handler 只匹配 function payload。[E: codex-rs/core/src/tools/handlers/agent_jobs.rs:37][E: codex-rs/core/src/tools/handlers/agent_jobs/spawn_agents_on_csv.rs:58][E: codex-rs/core/src/tools/handlers/agent_jobs/spawn_agents_on_csv.rs:60] |
...
`agent_jobs_tools_enabled` 要求 `Feature::SpawnCsv` 已启用且 collaboration tools 已启用；满足时 `spec_plan.rs` 加入 `SpawnAgentsOnCsvHandler`。[E: codex-rs/core/src/tools/spec_plan.rs:349][E: codex-rs/core/src/tools/spec_plan.rs:354][E: codex-rs/core/src/tools/spec_plan.rs:355][E: codex-rs/core/src/tools/spec_plan.rs:871][E: codex-rs/core/src/tools/spec_plan.rs:872]
...
| `max_concurrency` / `max_workers` | 否 | `max_workers` 是 alias；handler 取 `max_concurrency.or(max_workers)`，再按默认 16、硬上限 64 和 agent max threads normalize。[E: codex-rs/core/src/tools/handlers/agent_jobs_spec.rs:40][E: codex-rs/core/src/tools/handlers/agent_jobs_spec.rs:48][E: codex-rs/core/src/tools/handlers/agent_jobs/spawn_agents_on_csv.rs:184][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:39][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:40][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:143][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:145] |
| `max_runtime_seconds` | 否 | per-worker runtime cap；0 被拒绝，缺省可由 config fallback。[E: codex-rs/core/src/tools/handlers/agent_jobs_spec.rs:54][E: codex-rs/core/src/tools/handlers/agent_jobs/spawn_agents_on_csv.rs:160][E: codex-rs/core/src/tools/handlers/agent_jobs/spawn_agents_on_csv.rs:162][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:153][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:157] |
...
runner 构造时会把全局 `agent_default_subagent_model` / reasoning defaults 经和普通 spawn 相同的 model-override helper 应用到 worker config。job loop 再按 concurrency 取 pending items，构造 worker prompt 并通过 `spawn_agent_with_metadata` 启动 worker；worker 的 session source label 是 `agent_job:{job_id}`，这是 `report_agent_job_result` worker-only 门控的依据。[E: codex-rs/core/src/tools/handlers/agent_jobs.rs:125][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:126][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:134][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:204][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:206][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:214][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:219][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:222][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:225][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:226]

loop 结束后会导出 CSV snapshot；如果 job 没有被取消，则标记 completed。[E: codex-rs/core/src/tools/handlers/agent_jobs.rs:325][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:331][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:332][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:335]

## 输出

成功 output 是 serialized `SpawnAgentsOnCsvResult` 文本，包含 `job_id`、`status`、`output_csv_path`、总数/完成/失败计数、`job_error` 和最多 5 条 failed item summaries。[E: codex-rs/core/src/tools/handlers/agent_jobs.rs:65][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:66][E: codex-rs/core/src/tools/handlers/agent_jobs.rs:73][E: codex-rs/core/src/tools/handlers/agent_jobs/spawn_agents_on_csv.rs:248][E: codex-rs/core/src/tools/handlers/agent_jobs/spawn_agents_on_csv.rs:253][E: codex-rs/core/src/tools/handlers/agent_jobs/spawn_agents_on_csv.rs:284][E: codex-rs/core/src/tools/handlers/agent_jobs/spawn_agents_on_csv.rs:299]
