...
| handler | V2 module re-export `list_agents::Handler as ListAgentsHandler`；`spec_plan.rs` 用 `ListAgentsHandlerV2` 注册。[E: codex-rs/core/src/tools/handlers/multi_agents_v2.rs:31][E: codex-rs/core/src/tools/spec_plan.rs:48][E: codex-rs/core/src/tools/spec_plan.rs:840] |
...
`list_agents` 注册在 `collab_tools_enabled && multi_agent_v2_enabled` 分支；旧 V1 分支没有对应的 `list_agents` add 调用[I]。[E: codex-rs/core/src/tools/spec_plan.rs:786][E: codex-rs/core/src/tools/spec_plan.rs:788][E: codex-rs/core/src/tools/spec_plan.rs:789][E: codex-rs/core/src/tools/spec_plan.rs:839][E: codex-rs/core/src/tools/spec_plan.rs:840]
...
| 字段 | 必填 | 说明 |
|---|---:|---|
| `path_prefix` | 否 | task-path prefix 过滤器；schema 文案要求不带 trailing slash，runtime 在当前 session source 的 agent path 上 resolve。[E: codex-rs/core/src/tools/handlers/multi_agents_spec.rs:299][E: codex-rs/core/src/tools/handlers/multi_agents_spec.rs:301][E: codex-rs/core/src/agent/control.rs:359][E: codex-rs/core/src/agent/control.rs:365][E: codex-rs/core/src/agent/control.rs:370][E: codex-rs/core/src/agent/control.rs:373] |
...
`AgentControl::register_session_root` 只在当前 turn 没有 parent thread 时登记 root thread。[E: codex-rs/core/src/agent/control.rs:264][E: codex-rs/core/src/agent/control.rs:269][E: codex-rs/core/src/agent/control.rs:270]

`AgentControl::list_agents` 会 resolve 可选 prefix、读取 live agents、按 path/id 排序；如果 root path 匹配且 root thread 可取，会把 `/root` 与它的当前 status 加入输出。[E: codex-rs/core/src/agent/control.rs:359][E: codex-rs/core/src/agent/control.rs:365][E: codex-rs/core/src/agent/control.rs:375][E: codex-rs/core/src/agent/control.rs:376][E: codex-rs/core/src/agent/control.rs:389][E: codex-rs/core/src/agent/control.rs:391][E: codex-rs/core/src/agent/control.rs:394][E: codex-rs/core/src/agent/control.rs:395][E: codex-rs/core/src/agent/control.rs:397][E: codex-rs/core/src/agent/control.rs:399]

对每个 live agent，control 跳过没有 thread id 的 metadata，按 prefix 过滤，拿 thread status，并优先用 agent path 作为 `agent_name`，缺失 path 时回退 thread id。[E: codex-rs/core/src/agent/control.rs:403][E: codex-rs/core/src/agent/control.rs:404][E: codex-rs/core/src/agent/control.rs:407][E: codex-rs/core/src/agent/control.rs:414][E: codex-rs/core/src/agent/control.rs:417][E: codex-rs/core/src/agent/control.rs:421][E: codex-rs/core/src/agent/control.rs:424]
