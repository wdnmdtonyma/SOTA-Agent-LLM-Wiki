...
symbols: [DynamicToolSpec, DynamicToolFunctionSpec, DynamicToolNamespaceSpec, DynamicToolHandler, DynamicToolCallItem, DynamicToolResponse, add_dynamic_tools, request_dynamic_tool]
