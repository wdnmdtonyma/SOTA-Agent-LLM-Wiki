...
handler 构造 protocol `RequestUserInputArgs` 时，Plan mode 设置 `isBlocking=true`，其他获准 mode 设置 false；`auto_resolution_ms` 固定为 `None`。[E: codex-rs/core/src/tools/handlers/request_user_input.rs:75][E: codex-rs/core/src/tools/handlers/request_user_input.rs:85][E: codex-rs/core/src/tools/handlers/request_user_input.rs:86]
...
`CoreToolRuntime::is_builtin_control_tool()` 返回 `true`。[E: codex-rs/core/src/tools/handlers/request_user_input.rs:168]
