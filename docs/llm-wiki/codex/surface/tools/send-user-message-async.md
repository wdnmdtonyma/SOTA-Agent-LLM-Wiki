...
kind: tool
tier: T1
source: [codex-rs/core/src/tools/handlers/send_message_to_user_async.rs, codex-rs/core/src/tools/spec_plan.rs, codex-rs/core/tests/suite/request_user_input_async.rs, codex-rs/protocol/src/items.rs, codex-rs/protocol/src/protocol.rs, codex-rs/tools/src/tool_executor.rs, codex-rs/features/src/lib.rs]
...
- 它在什么门控下才会进入 `ToolRegistry`（feature **或** catalog 名）？
