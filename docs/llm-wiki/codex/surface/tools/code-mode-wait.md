...
`wait` 不单独 gate；`build_code_mode_executors` 在 `CodeMode`/`CodeModeOnly` 下和 `exec` 同时返回 `CodeModeWaitHandler`。[E: codex-rs/core/src/tools/spec_plan.rs:483][E: codex-rs/core/src/tools/spec_plan.rs:487][E: codex-rs/core/src/tools/spec_plan.rs:488][E: codex-rs/core/src/tools/spec_plan.rs:530][E: codex-rs/core/src/tools/spec_plan.rs:539]

reserved names 也在 code mode 有效时同时插入 `exec` 和 `wait`。[E: codex-rs/core/src/tools/spec_plan.rs:1010][E: codex-rs/core/src/tools/spec_plan.rs:1011][E: codex-rs/core/src/tools/spec_plan.rs:1012][E: codex-rs/core/src/tools/spec_plan.rs:1013]
