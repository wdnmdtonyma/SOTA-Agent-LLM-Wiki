...
`add_core_utility_tools` 要求存在非空 tool suggest candidates,并会注册 `RequestPluginInstallHandler`;只有 `ListTool` presentation 才额外注册 `list_available_plugins_to_install`。[E: codex-rs/core/src/tools/spec_plan.rs:743] [E: codex-rs/core/src/tools/spec_plan.rs:746] [E: codex-rs/core/src/tools/spec_plan.rs:748] [E: codex-rs/core/src/tools/spec_plan.rs:749] [E: codex-rs/core/src/tools/spec_plan.rs:753]

spec tests 证明即使 `tool_search` 不可见,`request_plugin_install` 仍可见,因为安装请求工具不依赖 search tool capability。[E: codex-rs/core/src/tools/spec_plan_tests.rs:985] [E: codex-rs/core/src/tools/spec_plan_tests.rs:988] [E: codex-rs/core/src/tools/spec_plan_tests.rs:1001] [E: codex-rs/core/src/tools/spec_plan_tests.rs:1003] [E: codex-rs/core/src/tools/spec_plan_tests.rs:1005]
