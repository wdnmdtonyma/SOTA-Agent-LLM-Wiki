...
> 这些 `codex-rs/protocol/src` 文件定义用户输入、Responses input/output item、dynamic tool payload、request tool payload、plan tool payload、session metadata 与 rollout persistence item。[E: codex-rs/protocol/src/user_input.rs:15][E: codex-rs/protocol/src/models.rs:675][E: codex-rs/protocol/src/models.rs:814][E: codex-rs/protocol/src/dynamic_tools.rs:13][E: codex-rs/protocol/src/request_permissions.rs:50][E: codex-rs/protocol/src/request_user_input.rs:32][E: codex-rs/protocol/src/plan_tool.rs:24][E: codex-rs/protocol/src/protocol.rs:3078][E: codex-rs/protocol/src/protocol.rs:3206]
...
| Symbol | Shape | 字段/变体 | 定义锚 |
|---|---|---|---|
| `ResponseInputItem` | tagged enum | 5 variants: `Message`, `FunctionCallOutput`, `McpToolCallOutput`, `CustomToolCallOutput`, `ToolSearchOutput`。[E: codex-rs/protocol/src/models.rs:675][E: codex-rs/protocol/src/models.rs:675][E: codex-rs/protocol/src/models.rs:684][E: codex-rs/protocol/src/models.rs:691][E: codex-rs/protocol/src/models.rs:691][E: codex-rs/protocol/src/models.rs:704] | `models.rs:677` |
| `ContentItem` | tagged enum | `InputText`、`InputImage { image_url, detail? }`、`InputAudio { audio_url }`、`OutputText`。[E: codex-rs/protocol/src/models.rs:715][E: codex-rs/protocol/src/models.rs:715][E: codex-rs/protocol/src/models.rs:715][E: codex-rs/protocol/src/models.rs:725][E: codex-rs/protocol/src/models.rs:726] | `models.rs:715` |
| `AgentMessageInputContent` | tagged enum | `InputText` or `EncryptedContent`; helper returns plaintext only when all parts are `InputText`。[E: codex-rs/protocol/src/models.rs:734][E: codex-rs/protocol/src/models.rs:736][E: codex-rs/protocol/src/models.rs:737][E: codex-rs/protocol/src/models.rs:738][E: codex-rs/protocol/src/models.rs:745][E: codex-rs/protocol/src/models.rs:746][E: codex-rs/protocol/src/models.rs:751] | `models.rs:735` |
| `ImageDetail` | enum | `Auto`, `Low`, `High`, `Original`; default constant is `High`。[E: codex-rs/protocol/src/models.rs:753][E: codex-rs/protocol/src/models.rs:753][E: codex-rs/protocol/src/models.rs:758][E: codex-rs/protocol/src/models.rs:758][E: codex-rs/protocol/src/models.rs:758][E: codex-rs/protocol/src/models.rs:762] | `models.rs:756` |
| `MessagePhase` | enum | `Commentary`, `FinalAnswer`；`ResponseInputItem::Message.phase` 是 optional。[E: codex-rs/protocol/src/models.rs:683][E: codex-rs/protocol/src/models.rs:771][E: codex-rs/protocol/src/models.rs:772][E: codex-rs/protocol/src/models.rs:772] | `models.rs:771` |
...
| `ExecutedToolCall` | struct | tool `name` + raw/truncated arguments；每个 argument 最多 8 KiB，整个 request attempted-tool metadata 最多 32 KiB，normal prompt fairness 分摊，retained history 可优先保留最近 calls。[E: codex-rs/protocol/src/models/executed_tool_calls.rs:9][E: codex-rs/protocol/src/models/executed_tool_calls.rs:11][E: codex-rs/protocol/src/models/executed_tool_calls.rs:49][E: codex-rs/protocol/src/models/executed_tool_calls.rs:54][E: codex-rs/protocol/src/models/executed_tool_calls.rs:81][E: codex-rs/protocol/src/models/executed_tool_calls.rs:103][E: codex-rs/protocol/src/models/executed_tool_calls.rs:136][E: codex-rs/protocol/src/models/executed_tool_calls.rs:241] | `models/executed_tool_calls.rs:243` |
| `ResponseItem` | tagged enum | 17 variants: `AdditionalTools`, `Message`, `AgentMessage`, `Reasoning`, `LocalShellCall`, `FunctionCall`, `ToolSearchCall`, `FunctionCallOutput`, `CustomToolCall`, `CustomToolCallOutput`, `ToolSearchOutput`, `WebSearchCall`, `ImageGenerationCall`, `Compaction`, `CompactionTrigger`, `ContextCompaction`, `Other`。[E: codex-rs/protocol/src/models.rs:847][E: codex-rs/protocol/src/models.rs:847][E: codex-rs/protocol/src/models.rs:855][E: codex-rs/protocol/src/models.rs:1078] | `models.rs:847` |
...
| Symbol | Shape | 字段/变体 | 定义锚 |
|---|---|---|---|
| `ThreadHistoryMode` | enum | `Legacy`（default）或 `Paginated`。[E: codex-rs/protocol/src/protocol.rs:711][E: codex-rs/protocol/src/protocol.rs:711][E: codex-rs/protocol/src/protocol.rs:711] | `protocol.rs:708` |
...
| `SessionMeta` | struct | thread/session identity、source/agent fields、provider/instructions/tools/capability roots，并记录 `history_mode`、optional inherited `history_base`、subagent 自有 history 起点及 initial context-window identity。[E: codex-rs/protocol/src/protocol.rs:2864] | `protocol.rs:2865` |
...
| `RolloutItem` | tagged enum | 现位于 `history` crate，9 variants: `SessionMeta`, `ResponseItem`, `InterAgentCommunication`, `InterAgentCommunicationMetadata`, `Compacted`, `TurnContext`, `WorldState`, `SecurityRiskScore`, `EventMsg`。[E: codex-rs/history/src/lib.rs:94][E: codex-rs/history/src/lib.rs:95][E: codex-rs/history/src/lib.rs:95][E: codex-rs/history/src/lib.rs:95][E: codex-rs/history/src/lib.rs:95][E: codex-rs/history/src/lib.rs:100][E: codex-rs/history/src/lib.rs:100][E: codex-rs/history/src/lib.rs:101][E: codex-rs/history/src/lib.rs:102][E: codex-rs/history/src/lib.rs:103] | `history/src/lib.rs:94` |
| `CompactedItem` | struct | `message`, optional `replacement_history`, optional `window_number`, optional `first_window_id`, optional `previous_window_id`, optional `window_id`。[E: codex-rs/history/src/lib.rs:141][E: codex-rs/history/src/lib.rs:141][E: codex-rs/history/src/lib.rs:141][E: codex-rs/history/src/lib.rs:144][E: codex-rs/history/src/lib.rs:145][E: codex-rs/history/src/lib.rs:145][E: codex-rs/history/src/lib.rs:145] | `history/src/lib.rs:141` |
...
| Symbol | Shape | 字段/变体 | 定义锚 |
|---|---|---|---|
| `Thread` | struct | Adds independently persisted optional `section` and `section_entered_at`, plus a `turns` list；`thread/read` only materializes history when `includeTurns=true`。[E: codex-rs/app-server-protocol/src/protocol/v2/thread_data.rs:186][E: codex-rs/app-server-protocol/src/protocol/v2/thread_data.rs:204][E: codex-rs/app-server-protocol/src/protocol/v2/thread_data.rs:207][E: codex-rs/app-server-protocol/src/protocol/v2/thread_data.rs:252][E: codex-rs/app-server/src/request_processors/thread_processor.rs:2300][E: codex-rs/app-server/src/request_processors/thread_processor.rs:2315][E: codex-rs/app-server/src/request_processors/thread_processor.rs:2327] | `thread_data.rs:184` |
| `Turn` | struct | `items` + `items_view` + status/error and optional `started_at` / `completed_at` / `duration_ms`; paginated summary reads can distinguish summary payload from full hydration。[E: codex-rs/app-server-protocol/src/protocol/v2/thread_data.rs:257][E: codex-rs/app-server-protocol/src/protocol/v2/thread_data.rs:262][E: codex-rs/app-server-protocol/src/protocol/v2/thread_data.rs:262][E: codex-rs/app-server-protocol/src/protocol/v2/thread_data.rs:273][E: codex-rs/app-server-protocol/src/protocol/v2/thread_data.rs:273][E: codex-rs/app-server-protocol/src/protocol/v2/thread_data.rs:273] | `thread_data.rs:256` |
...
- `RolloutItem` persists model/provider items, protocol events, inter-agent communication metadata, and world-state snapshots; replay/resume can therefore reconstruct state from `SessionMeta`, `TurnContext`, `ResponseItem`, `InterAgentCommunication`, compaction records, `WorldState`, and `EventMsg` lines。[E: codex-rs/protocol/src/protocol.rs:3206][E: codex-rs/protocol/src/protocol.rs:3206][E: codex-rs/protocol/src/protocol.rs:3206][E: codex-rs/protocol/src/protocol.rs:3214][E: codex-rs/protocol/src/protocol.rs:3216][E: codex-rs/protocol/src/protocol.rs:3217][E: codex-rs/protocol/src/protocol.rs:3218][E: codex-rs/protocol/src/protocol.rs:3219][I]
