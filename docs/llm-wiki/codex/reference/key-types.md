...
| `CodexAuth` | enum | `ApiKey`, `Chatgpt`, `ChatgptAuthTokens`, `AgentIdentity`, `PersonalAccessToken`, `BedrockApiKey`。[E: codex-rs/login/src/auth/manager.rs:72][E: codex-rs/login/src/auth/manager.rs:73][E: codex-rs/login/src/auth/manager.rs:74][E: codex-rs/login/src/auth/manager.rs:76][E: codex-rs/login/src/auth/manager.rs:77][E: codex-rs/login/src/auth/manager.rs:78] | `login/src/auth/manager.rs` |
