...
| `CodexThread` | struct | public thread conduit，组合 `Arc<Session>` 与 `SessionIo`；submit/next_event 代理到 `io`，thread-specific reads/control 代理到 session。[E: codex-rs/core/src/codex_thread.rs:179][E: codex-rs/core/src/codex_thread.rs:180][E: codex-rs/core/src/codex_thread.rs:181][E: codex-rs/core/src/codex_thread.rs:207] | `core/src/codex_thread.rs` |
| `TurnContext` | struct | single-turn context: sub/trace id、realtime/code-mode state、config/auth/model/provider/telemetry、session source/history/parent thread、environment/cwd、instructions、collaboration/personality、permission/network/sandbox、dynamic tools、metadata/extension/timing state。[E: codex-rs/core/src/session/turn_context.rs:282][E: codex-rs/core/src/session/turn_context.rs:283][E: codex-rs/core/src/session/turn_context.rs:285][E: codex-rs/core/src/session/turn_context.rs:286][E: codex-rs/core/src/session/turn_context.rs:289][E: codex-rs/core/src/session/turn_context.rs:294][E: codex-rs/core/src/session/turn_context.rs:304][E: codex-rs/core/src/session/turn_context.rs:306][E: codex-rs/core/src/session/turn_context.rs:309][E: codex-rs/core/src/session/turn_context.rs:327][E: codex-rs/core/src/session/turn_context.rs:329][E: codex-rs/core/src/session/turn_context.rs:330] | `core/src/session/turn_context.rs` |
...
| Symbol | Kind | 当前字段/方法/变体 | 定义处 |
|---|---|---|---|
| `ActiveTurn` | struct | `task: Option<RunningTask>`, `turn_state`; current active turn has one task slot plus shared mutable state。[E: codex-rs/core/src/state/turn.rs:34][E: codex-rs/core/src/state/turn.rs:35][E: codex-rs/core/src/state/turn.rs:36] | `core/src/state/turn.rs` |
| `TaskKind` | enum | `Regular`, `Review`, `Compact`。[E: codex-rs/core/src/state/turn.rs:70][E: codex-rs/core/src/state/turn.rs:71][E: codex-rs/core/src/state/turn.rs:72][E: codex-rs/core/src/state/turn.rs:73] | `core/src/state/turn.rs` |
| `RunningTask` | struct | `done`, `kind`, erased task, cancellation token, abort-on-drop handle, turn context, agent execution guard 与 turn-duration timer。[E: codex-rs/core/src/state/turn.rs:76][E: codex-rs/core/src/state/turn.rs:77][E: codex-rs/core/src/state/turn.rs:78][E: codex-rs/core/src/state/turn.rs:79][E: codex-rs/core/src/state/turn.rs:80][E: codex-rs/core/src/state/turn.rs:81][E: codex-rs/core/src/state/turn.rs:82][E: codex-rs/core/src/state/turn.rs:83][E: codex-rs/core/src/state/turn.rs:86] | `core/src/state/turn.rs` |
| `TurnState` | struct | pending approval/request/user-input/elicitation/dynamic-tool responders, pending input, mailbox phase, permissions, strict review state, tool calls, memory citation flag and token usage snapshot。[E: codex-rs/core/src/state/turn.rs:91][E: codex-rs/core/src/state/turn.rs:92][E: codex-rs/core/src/state/turn.rs:93][E: codex-rs/core/src/state/turn.rs:94][E: codex-rs/core/src/state/turn.rs:95][E: codex-rs/core/src/state/turn.rs:97][E: codex-rs/core/src/state/turn.rs:98][E: codex-rs/core/src/state/turn.rs:99][E: codex-rs/core/src/state/turn.rs:100][E: codex-rs/core/src/state/turn.rs:101][E: codex-rs/core/src/state/turn.rs:102][E: codex-rs/core/src/state/turn.rs:103][E: codex-rs/core/src/state/turn.rs:104] | `core/src/state/turn.rs` |
...
| Symbol | Kind | 当前字段/方法/变体 | 定义处 |
|---|---|---|---|
| `Config` | struct | merged runtime config: provenance/warnings/model/service/review/context/auto-compact/provider/personality/permissions and many more fields beyond the initial block。[E: codex-rs/core/src/config/mod.rs:616] | `core/src/config/mod.rs` |
| `ConfigBuilder` | struct | `codex_home`, CLI/harness/loader overrides, strict mode, cloud config bundle, thread config loader and fallback cwd。[E: codex-rs/core/src/config/mod.rs:1384][E: codex-rs/core/src/config/mod.rs:1385][E: codex-rs/core/src/config/mod.rs:1386][E: codex-rs/core/src/config/mod.rs:1387][E: codex-rs/core/src/config/mod.rs:1388][E: codex-rs/core/src/config/mod.rs:1389][E: codex-rs/core/src/config/mod.rs:1390][E: codex-rs/core/src/config/mod.rs:1391][E: codex-rs/core/src/config/mod.rs:1392] | `core/src/config/mod.rs` |
...
| `Feature` / `FEATURES` | enum/registry | feature enum includes active flags plus removed compatibility flags；当前 registry 共 133 条 `FeatureSpec`，`UnifiedExec` 默认全平台 `true`。[E: codex-rs/features/src/lib.rs:93][E: codex-rs/features/src/lib.rs:904][E: codex-rs/features/src/lib.rs:943][E: codex-rs/features/src/lib.rs:946] | `features/src/lib.rs` |
...
- Removed compatibility feature flags such as `GhostCommit`/`JsRepl` may still parse old config keys, but their registry stage is `Removed`.[E: codex-rs/features/src/lib.rs:913][E: codex-rs/features/src/lib.rs:915][E: codex-rs/features/src/lib.rs:997]
